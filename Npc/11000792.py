...
class Main(Script):
    ...
    def button(self) -> Option:
        if (self.state, self.index) == (1, 0):
            ...
            return Option.NEXT
        elif (self.state, self.index) == (9030, 1):
            return Option.CLOSE
        elif (self.state, self.index) == (9031, 0):
            return Option.NEXT
        elif (self.state, self.index) == (9031, 1):
            return Option.NEXT
        elif (self.state, self.index) == (9031, 2):
            return Option.NEXT
        elif (self.state, self.index) == (9031, 3):
            return Option.CLOSE
            ...
            return Option.NEXT
        elif (self.state, self.index) == (1000, 4):
            return Option.SELECTABLE_DISTRACTOR
            ...
            return Option.NEXT
        elif (self.state, self.index) == (1111, 1):
            return Option.NEXT
        elif (self.state, self.index) == (1111, 2):
            return Option.CLOSE
