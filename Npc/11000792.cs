...
public class _11000792 : NpcScript {
    ...
    protected override NpcTalkButton Button() {
        return (Id, Index) switch {
            ...
            (9030, 0) => NpcTalkButton.Next,
            (9030, 1) => NpcTalkButton.Close,
            (9031, 0) => NpcTalkButton.Next,
            (9031, 1) => NpcTalkButton.Next,
            (9031, 2) => NpcTalkButton.Next,
            (9031, 3) => NpcTalkButton.Close,
            ...
            (1000, 3) => NpcTalkButton.Next,
            (1000, 4) => NpcTalkButton.SelectableDistractor,
            (1001, 0) => NpcTalkButton.Close,
            (1002, 0) => NpcTalkButton.Close,
            (1011, 0) => NpcTalkButton.Next,
            (1011, 1) => NpcTalkButton.Close,
            ...
            (1111, 1) => NpcTalkButton.Next,
            (1111, 2) => NpcTalkButton.Close,
            (1112, 0) => NpcTalkButton.Next,
            (1112, 1) => NpcTalkButton.Close,
            (2000, 0) => NpcTalkButton.Close,
            (2100, 0) => NpcTalkButton.Close,
