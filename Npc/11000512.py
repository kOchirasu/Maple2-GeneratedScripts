...
class Main(Script):
    ...
    def button(self) -> Option:
        if (self.state, self.index) == (1, 0):
            ...
            return Option.CLOSE
        elif (self.state, self.index) == (1700, 0):
            return Option.NEXT
        elif (self.state, self.index) == (1700, 1):
            return Option.SELECTABLE_DISTRACTOR
        elif (self.state, self.index) == (1701, 0):
            return Option.CLOSE
        elif (self.state, self.index) == (1702, 0):
            return Option.CLOSE
        elif (self.state, self.index) == (1711, 0):
            return Option.CLOSE
        elif (self.state, self.index) == (1712, 0):
            return Option.CLOSE
            ...
            return Option.CLOSE
        elif (self.state, self.index) == (4200, 0):
            return Option.NEXT
        elif (self.state, self.index) == (4200, 1):
            return Option.CLOSE
        elif (self.state, self.index) == (4300, 0):
            return Option.NEXT
        elif (self.state, self.index) == (4300, 1):
            return Option.CLOSE
