...
class 시작_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[901,902,903], visible=False, interval=0, fade=10) # 벽 해제
...
class 시작_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=3001, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3002, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3003, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3004, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3101, visible=False, initial_sequence='Dmg_A')
...
class 관문_02_시작_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=3005, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3006, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3007, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3008, visible=False, initial_sequence='Dmg_A')
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=101, text_id=40010) # 적을 모두 처치하시오
...
class 관문_03_시작_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=3301, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=3302, visible=False, initial_sequence='Dmg_A')
...
class 지역클리어(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6006], visible=False, interval=0, fade=10) # 벽 해제
