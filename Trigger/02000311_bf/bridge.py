...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3011,3012,3013,3014,3015,3016,3017,3018], visible=False, start_delay=0, interval=0, fade=0)
...
class 차단(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3001,3002,3003,3004,3005,3006,3007,3008,3009,3010], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3011,3012,3013,3014,3015,3016,3017,3018], visible=True, start_delay=0, interval=0, fade=0)
