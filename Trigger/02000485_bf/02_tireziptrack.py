...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002047], state=0) # MakeTireZipTrack
...
class GuideInteract(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002047], state=1) # MakeTireZipTrack

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002047], arg2=0):
            return TireSpawn()
