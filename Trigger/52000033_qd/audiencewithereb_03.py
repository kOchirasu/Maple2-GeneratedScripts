...
class ErebTalk_01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class ErebTalk_02(common.Trigger):
    def on_enter(self):
...
class ErebTalk_03(common.Trigger):
    def on_enter(self):
...
class ErebTalk_04(common.Trigger):
    def on_enter(self):
...
class ErebTalk_05(common.Trigger):
    def on_enter(self):
...
class ErebTalk_06(common.Trigger):
    def on_enter(self):
...
class ErebTalk_07(common.Trigger):
    def on_enter(self):
