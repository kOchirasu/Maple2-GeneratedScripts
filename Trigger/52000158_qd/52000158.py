...
class 커닝시티전경_01(common.Trigger):
    def on_enter(self):
...
class 커닝시티전경_02(common.Trigger):
    def on_enter(self):
...
class 돌아왔다준비_01(common.Trigger):
    def on_enter(self):
