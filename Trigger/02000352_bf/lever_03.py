...
class 열림상태(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6060,6061,6062,6063], visible=False, interval=200, fade=15) # 빨간선 사라지게
        self.set_mesh(trigger_ids=[6160,6161,6162,6163], visible=True, interval=200, fade=0) # 파란선 나타나게
