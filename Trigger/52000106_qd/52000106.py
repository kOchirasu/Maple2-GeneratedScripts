...
# ########################그림자의침략 마무리########################
class 그림자의침략완료01(common.Trigger):
    def on_enter(self):
...
class 그림자의침략완료02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
...
class 그림자의침략완료03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.reset_camera(interpolationTime=0.5)
...
# ########################할아버지의 물품 조사########################
class 할아버지의물품조사01(common.Trigger):
    def on_enter(self):
...
class 리엔을떠나다08_1(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
