...
class LineStart(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[1101,1103]):
            ...
            self.set_mesh(trigger_ids=[1002], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[1003], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[1004], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[1005], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[1006], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2001], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2002], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2003], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2004], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2005], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2006], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2007], visible=False, start_delay=0, interval=0, fade=0)
            self.set_mesh(trigger_ids=[2008], visible=False, start_delay=0, interval=0, fade=0)
...
class CableOn_01(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[12000302], state=0):
            ...
            # self.set_mesh(trigger_ids=[2007], visible=True, start_delay=0, interval=0, fade=0)
            # self.set_mesh(trigger_ids=[2008], visible=True, start_delay=0, interval=0, fade=0)
            # self.set_mesh(trigger_ids=[2009], visible=True, start_delay=0, interval=0, fade=0)
