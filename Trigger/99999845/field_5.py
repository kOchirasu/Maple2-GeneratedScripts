...
class End_01(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            self.set_visible_breakable_object(trigger_ids=[1004], visible=False)
            self.set_visible_breakable_object(trigger_ids=[1005], visible=False)
            self.set_visible_breakable_object(trigger_ids=[1006], visible=False)
