...
class End_02(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            # self.set_visible_breakable_object(trigger_ids=[1007], visible=False)
            # self.set_visible_breakable_object(trigger_ids=[1008], visible=False)
            # self.set_visible_breakable_object(trigger_ids=[1009], visible=False)
            # self.set_visible_breakable_object(trigger_ids=[1010], visible=False)
            # self.set_visible_breakable_object(trigger_ids=[1011], visible=False)
            # self.set_visible_breakable_object(trigger_ids=[1012], visible=False)
            return 대기(self.ctx)
