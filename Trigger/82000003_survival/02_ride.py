...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(triggerIds=[6100,6200,6300,6400,6500,6600,6700,6800], visible=False)
...
class Ride01_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_buff(boxIds=[110], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
    ...
    def on_exit(self) -> None:
        ...
        self.set_effect(triggerIds=[6100], visible=True)
        # MushBalloon Disappear Sound
...
class Ride02_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MushBalloon Flying Loop Sound
        self.add_buff(boxIds=[120], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
    ...
    def on_exit(self) -> None:
        ...
        self.set_effect(triggerIds=[6200], visible=True)
        # MushBalloon Disappear Sound
...
class Ride03_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MushBalloon Flying Loop Sound
        self.add_buff(boxIds=[130], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
    ...
    def on_exit(self) -> None:
        ...
        self.set_effect(triggerIds=[6300], visible=True)
        # MushBalloon Disappear Sound
...
class Ride04_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MushBalloon Flying Loop Sound
        self.add_buff(boxIds=[140], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
...
class Ride05_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MushBalloon Flying Loop Sound
        self.add_buff(boxIds=[150], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
    ...
    def on_exit(self) -> None:
        ...
        self.set_effect(triggerIds=[6500], visible=True)
        # MushBalloon Disappear Sound
...
class Ride06_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MushBalloon Flying Loop Sound
        self.add_buff(boxIds=[160], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
    ...
    def on_exit(self) -> None:
        ...
        self.set_effect(triggerIds=[6600], visible=True)
        # MushBalloon Disappear Sound
...
class Ride07_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MushBalloon Flying Loop Sound
        self.add_buff(boxIds=[170], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
    ...
    def on_exit(self) -> None:
        ...
        self.set_effect(triggerIds=[6700], visible=True)
        # MushBalloon Disappear Sound
...
class Ride08_StartPatrol(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MushBalloon Flying Loop Sound
        self.add_buff(boxIds=[180], skillId=70001081, level=1, isPlayer=True, isSkillSet=False)
    ...
    def on_exit(self) -> None:
        ...
        self.set_effect(triggerIds=[6800], visible=True)
        # MushBalloon Disappear Sound
