...
class Setting(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_buff(boxId=9000, skillId=71000076)
...
class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=14, key='RelicMobRemove', value=1)
        self.set_user_value(triggerId=15, key='RelicMobRemove', value=1)
