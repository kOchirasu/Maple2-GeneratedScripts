...
class Setting(common.Trigger):
    def on_enter(self):
        ...
        self.set_mesh(triggerIds=[3101,3110,3111], visible=True, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage01
        self.set_mesh(triggerIds=[3102,3120,3121], visible=True, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage02
        self.set_mesh(triggerIds=[3103,3130,3131], visible=True, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage03
        self.set_mesh(triggerIds=[3104,3140,3141], visible=True, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage04
        self.set_mesh(triggerIds=[3105,3150,3151], visible=True, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage05
        ...
        self.set_effect(triggerIds=[5001], visible=False) # Sound_IronDoorOpen_StageEnter
        self.set_effect(triggerIds=[5002,5100,5101], visible=False) # Sound_IronDoorOpen_IceMelt_Stage01
        self.set_effect(triggerIds=[5003,5200,5201], visible=False) # Sound_IronDoorOpen_IceMelt_Stage02
        self.set_effect(triggerIds=[5004,5300,5301], visible=False) # Sound_IronDoorOpen_IceMelt_Stage03
        self.set_effect(triggerIds=[5005,5400,5401], visible=False) # Sound_IronDoorOpen_IceMelt_Stage04
        self.set_effect(triggerIds=[5006,5500,5501], visible=False) # Sound_IronDoorOpen_IceMelt_Stage05
...
class StageEnter(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[8100,8101,8102,8103,8104,8105,8106,8107,8108], visible=False) # StageEnter
        ...
        self.set_effect(triggerIds=[5001], visible=True) # Sound_IronDoorOpen_StageEnter

    def on_tick(self) -> common.Trigger:
        if self.user_value(key='StageClear01', value=1):
            return StageClear01(self.ctx)


class StageClear01(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[8200,8201,8202,8203,8204,8205,8206,8207,8208,8209,8210,8211,8212], visible=False) # Stage01
        self.set_actor(triggerId=4001, visible=True, initialSequence='Opened') # IronDoor_Stage01
        self.set_mesh(triggerIds=[3101,3110,3111], visible=False, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage01
        ...
        self.set_effect(triggerIds=[5002,5100,5101], visible=True) # Sound_IronDoorOpen_IceMelt_Stage01

    def on_tick(self) -> common.Trigger:
        if self.user_value(key='StageClear02', value=1):
            return StageClear02(self.ctx)


class StageClear02(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[8300,8301,8302,8303,8304,8305,8306,8307,8308,8309,8310,8311,8312], visible=False) # Stage02
        self.set_actor(triggerId=4002, visible=True, initialSequence='Opened') # IronDoor_Stage02
        self.set_mesh(triggerIds=[3102,3120,3121], visible=False, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage02
        ...
        self.set_effect(triggerIds=[5003,5200,5201], visible=True) # Sound_IronDoorOpen_IceMelt_Stage02

    def on_tick(self) -> common.Trigger:
        if self.user_value(key='StageClear03', value=1):
            return StageClear03(self.ctx)


class StageClear03(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[8400,8401,8402,8403,8404,8405,8406,8407,8408,8409,8410,8411,8412], visible=False) # Stage03
        self.set_actor(triggerId=4003, visible=True, initialSequence='Opened') # IronDoor_Stage03
        self.set_mesh(triggerIds=[3103,3130,3131], visible=False, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage03
        ...
        self.set_effect(triggerIds=[5004,5300,5301], visible=True) # Sound_IronDoorOpen_IceMelt_Stage03

    def on_tick(self) -> common.Trigger:
        if self.user_value(key='StageClear04', value=1):
            return StageClear04(self.ctx)


class StageClear04(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[8500,8501,8502,8503,8504,8505,8506,8507,8508,8509,8510,8511,8512], visible=False) # Stage04
        self.set_actor(triggerId=4004, visible=True, initialSequence='Opened') # IronDoor_Stage04
        self.set_mesh(triggerIds=[3104,3140,3141], visible=False, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage04
        ...
        self.set_effect(triggerIds=[5005,5400,5401], visible=True) # Sound_IronDoorOpen_IceMelt_Stage04

    def on_tick(self) -> common.Trigger:
        if self.user_value(key='StageClear05', value=1):
            return StageClear05(self.ctx)


class StageClear05(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[8600,8601,8602,8603,8604,8605,8606,8607,8608,8609,8610,8611,8612], visible=False) # Stage05
        self.set_actor(triggerId=4005, visible=True, initialSequence='Opened') # IronDoor_Stage05
        self.set_mesh(triggerIds=[3105,3150,3151], visible=False, arg3=0, delay=0, scale=0) # DoorBarrier_StairsBarrier_Stage05
        ...
        self.set_effect(triggerIds=[5006,5500,5501], visible=True) # Sound_IronDoorOpen_IceMelt_Stage05
...
class BossStagePortalOpen(common.Trigger):
    def on_enter(self):
