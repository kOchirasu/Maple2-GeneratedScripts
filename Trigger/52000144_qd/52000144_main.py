...
class 로베와대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$52000144_QD__52000144_MAIN__0$', duration=3000, align='right')
...
class 로베와대화_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__1$', duration=3000, illust_id='Robe_normal', align='right')
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__2$', duration=3500, illust_id='Robe_normal', align='right')
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__3$', duration=3500, illust_id='Robe_normal', align='right')
...
class 로베와대화_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000144_QD__52000144_MAIN__4$', duration=4179, align='right')
...
class 로베와대화_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__5$', duration=3000, illust_id='Robe_normal', align='right')
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__6$', duration=3500, illust_id='Robe_normal', align='right')
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__7$', duration=4000, illust_id='Robe_normal', align='right')
...
class 로베와대화_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000144_QD__52000144_MAIN__8$', duration=3000, align='right')
...
class 로베와대화_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__9$', duration=3000, illust_id='Robe_normal', align='right')
        self.add_cinematic_talk(npc_id=11003401, msg='$52000144_QD__52000144_MAIN__10$', duration=2500, illust_id='Robe_normal', align='right')
...
class 로베와대화_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_sequence(sequence_names=['Knight_Bore_A'])
        self.add_cinematic_talk(npc_id=0, msg='$52000144_QD__52000144_MAIN__11$', duration=3000, align='right')
