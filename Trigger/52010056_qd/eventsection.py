...
class Idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh_animation(trigger_ids=[9005], visible=True, start_delay=0, interval=0)
        self.set_mesh(trigger_ids=[9006], visible=False)
        self.set_mesh_animation(trigger_ids=[9006], visible=False, start_delay=0, interval=0)
        ...
        self.set_effect(trigger_ids=[5005], visible=False) # 포탈 생성
        self.set_effect(trigger_ids=[5006], visible=False) # 포탈 생성
        self.set_effect(trigger_ids=[5007], visible=False) # 포탈 생성
        self.set_effect(trigger_ids=[5008], visible=False) # 포탈 사운드
        self.set_effect(trigger_ids=[5009], visible=False) # 포탈 사운드
        self.set_effect(trigger_ids=[5010], visible=False) # 포탈 사운드
        self.set_effect(trigger_ids=[5011], visible=False) # 몸체 이펙트
        self.set_effect(trigger_ids=[5012], visible=False) # 몸체 이펙트
        self.set_effect(trigger_ids=[5013], visible=False) # 포탈 사운드
        self.set_effect(trigger_ids=[5014], visible=False) # 트리스탄 바닥이펙트
        ...
        self.set_effect(trigger_ids=[5108], visible=False)
        self.set_effect(trigger_ids=[5109], visible=False)
        self.set_effect(trigger_ids=[5110], visible=False)
        self.set_effect(trigger_ids=[5111], visible=False)
        self.set_effect(trigger_ids=[5112], visible=False)
        self.set_effect(trigger_ids=[5113], visible=False)
        self.set_effect(trigger_ids=[5114], visible=False)
        self.set_effect(trigger_ids=[5115], visible=False)
        self.set_effect(trigger_ids=[5116], visible=False)
        self.set_effect(trigger_ids=[5117], visible=False)
        self.set_effect(trigger_ids=[5118], visible=False)
        ...
        self.set_effect(trigger_ids=[5206], visible=False)
        self.set_effect(trigger_ids=[5207], visible=False)
        self.set_effect(trigger_ids=[5208], visible=False)
        self.set_effect(trigger_ids=[5209], visible=False)
        self.set_effect(trigger_ids=[5210], visible=False)
        self.set_effect(trigger_ids=[5211], visible=False)
        self.set_effect(trigger_ids=[5212], visible=False)
        self.set_effect(trigger_ids=[5213], visible=False)
        self.set_effect(trigger_ids=[5214], visible=False)
        self.set_effect(trigger_ids=[5215], visible=False)
        self.set_effect(trigger_ids=[5216], visible=False)
        self.set_effect(trigger_ids=[5218], visible=False)
        self.set_effect(trigger_ids=[5218], visible=False)
        self.set_effect(trigger_ids=[5301], visible=False)
        self.set_effect(trigger_ids=[5302], visible=False)
        self.set_effect(trigger_ids=[5303], visible=False)
        self.set_effect(trigger_ids=[5304], visible=False)
...
class 인트로_지역소개(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.show_caption(type='VerticalCaption', title='$52010056_QD__EventSection__54$', desc='$52010056_QD__EventSection__0$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=3500, scale=1)
...
class 크림슨스피어_대사_B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=123, msg='$52010056_QD__EventSection__8$', duration=2800, delay_tick=0)
        self.add_balloon_talk(spawn_id=124, msg='$52010056_QD__EventSection__8$', duration=2800, delay_tick=0)
        self.add_balloon_talk(spawn_id=125, msg='$52010056_QD__EventSection__8$', duration=2800, delay_tick=0)
        self.add_balloon_talk(spawn_id=126, msg='$52010056_QD__EventSection__8$', duration=2800, delay_tick=0)
...
class 시작연출_지역소개(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml') # 페이드 아웃 끔
        self.show_caption(type='VerticalCaption', title='$52010056_QD__EventSection__12$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=3500, scale=1)
...
class 트리스탄_침입(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=111, msg='$52010056_QD__EventSection__13$', duration=2800, delay_tick=0)
        self.add_balloon_talk(spawn_id=112, msg='$52010056_QD__EventSection__14$', duration=2800, delay_tick=0)
...
class 보초_쓰러짐(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=111, sequence_name='Dead_B', duration=1E+09)
        self.set_npc_emotion_loop(spawn_id=112, sequence_name='Dead_B', duration=1E+09)
...
class 트리스탄_대사B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__16$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 트리스탄대사_A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__23$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 트리스탄대사_B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__24$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 크림슨발록대사_A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003817, msg='$52010056_QD__EventSection__25$', duration=2800, illust_id='balrog_normal', align='Center')
...
class 인페르녹의혼_흡수연출_A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Attack_02_B', duration=1E+09)
...
class 인페르녹의혼_흡수연출_F(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__30$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 인페르녹의혼_흡수연출_G(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003821, msg='$52010056_QD__EventSection__31$', duration=2800, align='Center')
...
class 인페르녹의혼_흡수연출_H(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003821, msg='$52010056_QD__EventSection__32$', duration=2800, align='Center')
...
class 인페르녹의혼_흡수연출_I(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__33$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 인페르녹의혼_흡수연출_K(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__35$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 각성_전투준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
        self.set_mesh(trigger_ids=[9005], visible=False)
        self.set_mesh_animation(trigger_ids=[9005], visible=False, start_delay=0, interval=0)
        self.set_mesh(trigger_ids=[9006], visible=True)
        self.set_mesh_animation(trigger_ids=[9006], visible=True, start_delay=0, interval=0)
...
class 크림슨발록군단생성_A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[701], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[702], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[703], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[704], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[705], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[706], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[707], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[708], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[709], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[710], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[711], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[712], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[713], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[714], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[715], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[716], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[717], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[718], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[719], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[720], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[721], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[722], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[723], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[724], auto_target=True) # 크림슨 스피어1: 11003816
...
class 필살기연출_준비A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[103], auto_target=True) # 트리스탄
        self.spawn_monster(spawn_ids=[808], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[809], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[810], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[811], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[812], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[813], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[814], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[815], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[816], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[817], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[818], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[819], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[820], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[821], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[822], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[823], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[824], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[825], auto_target=True) # 크림슨 스피어1: 11003816
        self.spawn_monster(spawn_ids=[826], auto_target=True) # 크림슨 스피어1: 11003816
...
class 필살기연출_준비B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=103, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=808, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=809, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=810, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=811, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=812, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=813, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=814, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=815, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=816, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=817, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=818, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=819, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=820, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=821, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=822, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=823, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=824, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=825, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=826, sequence_name='Attack_Idle_A', duration=9999999)
...
class 트리스탄_대사_H(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__44$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 트리스탄_대사D(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__46$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 트리스탄_대사E(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003812, msg='$52010056_QD__EventSection__47$', duration=2800, illust_id='Tristan_normal', align='Center')
...
class 필살기연출_모션A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=103, sequence_name='Attack_02_B', duration=9999999)
...
class 필살기연출_모션B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=103, sequence_name='Attack_01_B', duration=9999999)
...
class 바닥이펙트_A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=808, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=809, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_C(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=810, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_D(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=811, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_E(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=812, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_F(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=813, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_G(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=814, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_H(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=815, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_I(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=816, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_J(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=817, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_K(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=818, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_L(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=819, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_M(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=820, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_N(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=821, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_O(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=822, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_P(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=823, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_Q(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=824, sequence_name='Damg_A', duration=9999999)
...
class 바닥이펙트_R(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=825, sequence_name='Damg_A', duration=9999999)
        self.set_effect(trigger_ids=[5202], visible=True)
...
class 크림슨발록_대사_L(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003817, msg='$52010056_QD__EventSection__50$', duration=2800, illust_id='balrog_normal', align='Center')
...
class 마지막연출_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5304], visible=False)
        self.reset_camera(interpolation_time=0)
        self.set_npc_emotion_loop(spawn_id=104, sequence_name='Attack_Idle_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=801, sequence_name='Dead_01_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=808, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=809, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=810, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=811, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=812, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=813, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=814, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=815, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=816, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=817, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=818, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=819, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=820, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=821, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=822, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=823, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=824, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=825, sequence_name='Dead_A', duration=9999999)
        self.set_npc_emotion_loop(spawn_id=826, sequence_name='Dead_A', duration=9999999)
