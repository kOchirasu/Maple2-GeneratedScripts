...
class 경비병_외침(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[903], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[904], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[905], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[906], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[907], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[908], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[909], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[910], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[911], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[912], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[913], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[914], animationEffect=True)
        # 크림슨 스피어: 29000386
        self.create_monster(spawnIds=[915], animationEffect=True)
        # 크림슨 스피어: 29000386
