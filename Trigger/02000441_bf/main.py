...
class idle(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[85000], visible=True, arg3=0, arg4=0, arg5=0)
        ...
        set_interact_object(triggerIds=[10001096], state=0)
        set_interact_object(triggerIds=[10001097], state=2)
        set_interact_object(triggerIds=[10001098], state=2)
...
class mermaid_02_talk(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__0$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__1$', arg4=2, arg5=1)
...
class scene_01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__2$', arg4=3, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__19$', arg4=3, arg5=3)
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__3$', arg4=3, arg5=6)
...
class scene_02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__4$', arg4=2, arg5=1)
...
class open_door_01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__5$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__6$', arg4=2, arg5=1)
...
class battle_01(state.State):
    def on_enter(self):
        set_local_camera(cameraId=8100, enable=True) # LocalTargetCamera
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__7$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__8$', arg4=2, arg5=1)
        create_monster(spawnIds=[201,202,203,204], arg2=True)

    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[201,202]):
            return battle_01_2()


class battle_01_2(state.State):
    def on_enter(self):
        create_monster(spawnIds=[20101,20202,20303,20404,20505,20606,20708,20408], arg2=True)

    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[20101,20202,20303,20404,20505,20606,20708,20408]):
            return battle_02()
...
class battle_02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__9$', arg4=3, arg5=1)
...
class open_door_03(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__10$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__11$', arg4=2, arg5=0)
    ...
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=6000):
            return open_door_03_2()


class open_door_03_2(state.State):
    def on_tick(self) -> state.State:
        if user_detected(boxIds=[707]):
            return open_door_03_3()


class open_door_03_3(state.State):
    def on_enter(self):
        create_monster(spawnIds=[205,206,207,208,209], arg2=True)
        set_user_value(triggerId=2038806, key='monster_respawn', value=1)

    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[209]):
            return battle_03()


class battle_03(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__12$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__13$', arg4=2, arg5=2)
...
class battle_04(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__14$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__15$', arg4=2, arg5=2)
...
class ship_01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000441_BF__MAIN__16$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000441_BF__MAIN__17$', arg4=2, arg5=2)
...
class ship_01_1(state.State):
    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[301,302,303,304,305]):
            return ship_01_2()

    def on_exit(self):
        create_monster(spawnIds=[401,402], arg2=True)
        set_user_value(triggerId=2038805, key='monster_buff', value=1)


class ship_01_2(state.State):
    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[401,402]):
            return ship_02()


class ship_02(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10001097], state=1)
        set_interact_object(triggerIds=[10001098], state=1)
        set_event_ui(type=1, arg2='$02000441_BF__MAIN__18$', arg3='3000')
...
class ending_03(state.State):
    def on_enter(self):
        move_user(mapId=2000442, portalId=0)
