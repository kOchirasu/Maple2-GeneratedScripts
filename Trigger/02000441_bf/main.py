...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[85000], visible=True, start_delay=0, interval=0, fade=0)
...
class mermaid_02_talk(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000441_BF__MAIN__0$', time=2, arg5=0)
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$02000441_BF__MAIN__2$', time=3, arg5=0)
...
class open_door_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000441_BF__MAIN__5$', time=2, arg5=0)
...
class battle_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_local_camera(camera_id=8100, enable=True) # LocalTargetCamera
        self.set_dialogue(type=1, spawn_id=102, script='$02000441_BF__MAIN__7$', time=2, arg5=0)
...
class battle_01_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[20101,20202,20303,20404,20505,20606,20708,20408], auto_target=True)
...
class open_door_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$02000441_BF__MAIN__11$', time=2, arg5=0)
...
class battle_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000441_BF__MAIN__12$', time=2, arg5=0)
...
class battle_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$02000441_BF__MAIN__14$', time=2, arg5=0)
...
class ship_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000441_BF__MAIN__16$', time=2, arg5=0)
...
class ship_01_1(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.spawn_monster(spawn_ids=[401,402], auto_target=True)
...
class ending_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_user(map_id=2000442, portal_id=0)
