...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3300,3301,3302,3303,3304,3305,3306,3307,3308,3309], visible=False, start_delay=0, interval=0, fade=0) # Pattern_Ground
        self.set_mesh(trigger_ids=[3310,3311,3312,3313,3314,3315,3316,3317,3318,3319], visible=False, start_delay=0, interval=0, fade=0) # Pattern_LightOn
...
class Pattern01_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3300], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_A01
...
class Pattern01_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3310], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_A01
...
class Pattern01_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3310], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_A01
...
class Pattern02_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3301], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_A02
...
class Pattern02_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3311], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_A02
...
class Pattern02_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3311], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_A02
...
class Pattern03_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3302], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_A03
...
class Pattern03_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3312], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_A03
...
class Pattern03_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3312], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_A03
...
class Pattern04_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3303], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_B01
...
class Pattern04_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3313], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_B01
...
class Pattern04_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3313], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_B01
...
class Pattern05_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3304], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_B02
...
class Pattern05_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3314], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_B02
...
class Pattern05_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3314], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_B02
...
class Pattern06_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3305], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_C01
...
class Pattern06_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3315], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_C01
...
class Pattern06_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3315], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_C01
...
class Pattern07_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3306], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_D01
...
class Pattern07_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3316], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_D01
...
class Pattern07_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3316], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_D01
...
class Pattern08_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3307], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_D02
...
class Pattern08_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3317], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_D02
...
class Pattern08_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3317], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_D02
...
class Pattern09_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3308], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_E01
...
class Pattern09_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3318], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_E01
...
class Pattern09_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3318], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_E01
...
class Pattern10_Pick(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3309], visible=True, start_delay=0, interval=0, fade=0) # Pattern_Ground_E02
...
class Pattern10_CorrectAnswer(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_user_value(trigger_id=4, key='CorrectThirdPiece', value=1) # 정답
        self.set_mesh(trigger_ids=[3319], visible=True, start_delay=100, interval=0, fade=5) # Pattern_LightOn_E02
...
class Pattern10_Reset02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3319], visible=False, start_delay=100, interval=0, fade=5) # Pattern_LightOn_E02
