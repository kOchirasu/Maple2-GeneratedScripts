...
class start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$02000536_BF__MAIN__0$', desc='$02000536_BF__MAIN__1$', align='centerRight', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2)
...
class 하렌인사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Bore_A', duration=5000)
        self.add_cinematic_talk(npc_id=23300001, msg='$02000536_BF__MAIN__2$', align='center', duration=4000)
...
class 하렌인사2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=23300001, msg='$02000536_BF__MAIN__3$', align='center', duration=4000)
...
class 던전클리어(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[9999], visible=False)
