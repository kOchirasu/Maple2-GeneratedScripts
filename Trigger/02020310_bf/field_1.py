...
class Block_1(state.State):
    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[1104,1150,1151,1152,1157,1158,1159,1160,1161]):
            side_npc_talk(type='talk', npcId=11004582, illust='Eone_normal', script='$02020310_BF__FIELD_1__0$', duration=5000)
...
class Block_2(state.State):
    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[1105,1153,1154,1162,1163,1164,1165,1166]):
            side_npc_talk(type='talk', npcId=11004582, illust='Eone_normal', script='$02020310_BF__FIELD_1__1$', duration=5000)
...
class Block_3(state.State):
    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[1106,1155,1156,1167,1168,1169,1170,1171,1172]):
            side_npc_talk(type='talk', npcId=11004582, illust='Eone_normal', script='$02020310_BF__FIELD_1__2$', duration=5000)
...
class CableDelay_04(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__3$', arg3='3000')
...
class CableDelay_05(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__4$', arg3='3000')
...
class CableDelay_06(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__5$', arg3='3000')
...
class CableDelay_04_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__6$', arg3='1000')
...
class CableDelay_05_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__7$', arg3='1000')
...
class CableDelay_06_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__8$', arg3='1000')
...
class CableDelay_04_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__9$', arg3='1000')
...
class CableDelay_05_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__10$', arg3='1000')
...
class CableDelay_06_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__11$', arg3='1000')
...
class CableDelay_04_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__12$', arg3='1000')
...
class CableDelay_05_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__13$', arg3='1000')
...
class CableDelay_06_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__14$', arg3='1000')
...
class CableDelay_04_5(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            ...
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__15$', arg3='5000')
            return CableOff_04()
...
class CableDelay_05_5(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            ...
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__16$', arg3='5000')
            return CableOff_05()
...
class CableDelay_06_5(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            ...
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_1__17$', arg3='5000')
            return CableOff_06()
