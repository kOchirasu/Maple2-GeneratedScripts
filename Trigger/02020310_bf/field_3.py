...
class CableDelay_13(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__0$', arg3='3000')
...
class CableDelay_14(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__1$', arg3='3000')
...
class CableDelay_15(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__2$', arg3='3000')
...
class CableDelay_16(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__3$', arg3='3000')
...
class CableDelay_17(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__4$', arg3='3000')
...
class CableDelay_18(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__5$', arg3='3000')
...
class CableDelay_13_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__6$', arg3='1000')
...
class CableDelay_14_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__7$', arg3='1000')
...
class CableDelay_15_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__8$', arg3='1000')
...
class CableDelay_16_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__9$', arg3='1000')
...
class CableDelay_17_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__10$', arg3='1000')
...
class CableDelay_18_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__11$', arg3='1000')
...
class CableDelay_13_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__12$', arg3='1000')
...
class CableDelay_14_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__13$', arg3='1000')
...
class CableDelay_15_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__14$', arg3='1000')
...
class CableDelay_16_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__15$', arg3='1000')
...
class CableDelay_17_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__16$', arg3='1000')
...
class CableDelay_18_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__17$', arg3='1000')
...
class CableDelay_13_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__18$', arg3='1000')
...
class CableDelay_14_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__19$', arg3='1000')
...
class CableDelay_15_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__20$', arg3='1000')
...
class CableDelay_16_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__21$', arg3='1000')
...
class CableDelay_17_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__22$', arg3='1000')
...
class CableDelay_18_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_3__23$', arg3='1000')
