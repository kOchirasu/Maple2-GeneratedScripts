...
class CableDelay_19_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$02020310_BF__FIELD_4__12$', duration=5000)
...
class CableDelay_20_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$02020310_BF__FIELD_4__13$', duration=5000)
...
class CableDelay_21_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$02020310_BF__FIELD_4__14$', duration=5000)
