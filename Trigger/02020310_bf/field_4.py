...
class CableDelay_19(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__0$', arg3='3000')
...
class CableDelay_20(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__1$', arg3='3000')
...
class CableDelay_21(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=2000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__2$', arg3='3000')
...
class CableDelay_19_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__3$', arg3='1000')
...
class CableDelay_20_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__4$', arg3='1000')
...
class CableDelay_21_2(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=3000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__5$', arg3='1000')
...
class CableDelay_19_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__6$', arg3='1000')
...
class CableDelay_20_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__7$', arg3='1000')
...
class CableDelay_21_3(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__8$', arg3='1000')
...
class CableDelay_19_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__9$', arg3='1000')
...
class CableDelay_20_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__10$', arg3='1000')
...
class CableDelay_21_4(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            set_event_ui(type=1, arg2='$02020310_BF__FIELD_4__11$', arg3='1000')
...
class CableDelay_19_5(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            side_npc_talk(type='talk', npcId=11004582, illust='Eone_serious', script='$02020310_BF__FIELD_4__12$', duration=5000)
...
class CableDelay_20_5(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            side_npc_talk(type='talk', npcId=11004582, illust='Eone_serious', script='$02020310_BF__FIELD_4__13$', duration=5000)
...
class CableDelay_21_5(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=1000):
            side_npc_talk(type='talk', npcId=11004582, illust='Eone_serious', script='$02020310_BF__FIELD_4__14$', duration=5000)
