...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=3101, visible=False, initial_sequence='Attack_Idle_A')
        self.set_actor(trigger_id=3102, visible=False, initial_sequence='Attack_Idle_A')
        self.set_local_camera(camera_id=8017, enable=False) # LocalTargetCamera
        ...
        self.set_mesh(trigger_ids=[3001,3002,3003,3004], visible=False)
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__20$', duration=5000, align='left')
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__21$', duration=3000, align='left')
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__22$', duration=3000, align='left')
...
class scene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__23$', duration=3000, align='left')
...
class scene_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Attack_Idle_A', duration=3000)
...
class scene_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[201,202,205,204], auto_target=True)
        self.reset_camera(interpolation_time=0)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class scene_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_visible_breakable_object(trigger_ids=[2201,2202,2203,2204,2205,2206,2207,2208,2209,2210,2211,2212,2213,2214,2215,2216,2217,2218,2219,2220], visible=False)
        self.set_visible_breakable_object(trigger_ids=[2221,2222,2223,2224,2225,2226,2227,2228,2229,2230,2231,2232,2233,2234,2235,2236,2237,2238,2239,2240], visible=False)
        self.set_visible_breakable_object(trigger_ids=[2251,2252,2253,2254,2255,2256,2257,2258,2259,2260,2261,2262,2263,2264,2265,2266,2267,2268,2269,2270], visible=False)
...
class scene_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[201,202,203], auto_target=True)
...
class scene_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[206,207,203,202], auto_target=True)
...
class phase_b_scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__27$', duration=5000, align='left')
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__28$', duration=5000, align='left')
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__17$', duration=3000, align='left')
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__18$', duration=3000, align='left')
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__19$', duration=5000, align='left')
...
class phase_b_scene_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[212,213], auto_target=True)
...
class phase_b_scene_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[214,216], auto_target=True)
...
class phase_b_scene_12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[209,210], auto_target=True)
...
class phase_b_scene_13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[211,211], auto_target=True)
...
class phase_b_scene_14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[213,214], auto_target=True)
...
class phase_b_scene_15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[215,216], auto_target=True)
...
class phase_b_scene_16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[210,211], auto_target=True)
...
class phase_b_scene_18(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[212,213,214], auto_target=True)
...
class phase_b_scene_end_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_pc_emotion_loop(sequence_name='Emotion_Disappoint_Idle_A', duration=7000)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class phase_b_scene_end_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.destroy_monster(spawn_ids=[124], arg2=True)
        ...
        self.set_pc_emotion_sequence(sequence_names=['Emotion_Disappoint_Idle_A','Emotion_Disappoint_Idle_A','Emotion_Disappoint_Idle_A','Emotion_Disappoint_Idle_A'])
        self.add_cinematic_talk(npc_id=11004034, illust_id='LapentaMage_Idle', msg='$52000099_QD__MAIN__33$', duration=4000, align='Left')
        self.add_cinematic_talk(npc_id=11003087, illust_id='11003087', msg='$52000099_QD__MAIN__34$', duration=2000, align='Right')
...
class phase_b_scene_end_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11000076, illust_id='11000076', msg='$52000099_QD__MAIN__29$', duration=5000, align='left')
        self.add_cinematic_talk(npc_id=11004034, illust_id='LapentaMage_Idle', msg='$52000099_QD__MAIN__30$', duration=5000, align='left')
        self.set_actor(trigger_id=3101, visible=False, initial_sequence='Regen_A')
        self.set_actor(trigger_id=3102, visible=False, initial_sequence='Regen_A')
...
class phase_b_scene_end_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11000076, illust_id='11000076', msg='$52000099_QD__MAIN__31$', duration=5000, align='left')
...
class phase_c_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[117], auto_target=True)
...
class phase_c_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[118], auto_target=True)
...
class phase_c_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[120], auto_target=True)
...
class phase_c_16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_visible_breakable_object(trigger_ids=[2201,2202,2203,2204,2205,2206,2207,2208,2209,2210,2211,2212,2213,2214,2215,2216,2217,2218,2219,2220], visible=False)
        self.set_visible_breakable_object(trigger_ids=[2221,2222,2223,2224,2225,2226,2227,2228,2229,2230,2231,2232,2233,2234,2235,2236,2237,2238,2239,2240], visible=False)
        self.set_visible_breakable_object(trigger_ids=[2251,2252,2253,2254,2255,2256,2257,2258,2259,2260,2261,2262,2263,2264,2265,2266,2267,2268,2269,2270,3101,3102], visible=False)
        self.spawn_monster(spawn_ids=[201,202,205,204], auto_target=True)
        self.spawn_monster(spawn_ids=[211,212,215,214], auto_target=True)
        self.spawn_monster(spawn_ids=[215,216,217,218], auto_target=True)
...
class phase_b_skip_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=3101, visible=False)
        self.set_actor(trigger_id=3102, visible=False)
        self.destroy_monster(spawn_ids=[124], arg2=True) # 전두용 오르데 삭제
        self.destroy_monster(spawn_ids=[126], arg2=True)
        self.destroy_monster(spawn_ids=[110], arg2=True)
        self.destroy_monster(spawn_ids=[111], arg2=True)
        self.destroy_monster(spawn_ids=[112], arg2=True)
        self.destroy_monster(spawn_ids=[113], arg2=True)
        self.destroy_monster(spawn_ids=[114], arg2=True)
        self.destroy_monster(spawn_ids=[115], arg2=True)
        self.destroy_monster(spawn_ids=[116], arg2=True)
        self.destroy_monster(spawn_ids=[117], arg2=True)
        self.destroy_monster(spawn_ids=[118], arg2=True)
        self.destroy_monster(spawn_ids=[119], arg2=True)
        self.destroy_monster(spawn_ids=[120], arg2=True)
        self.destroy_monster(spawn_ids=[121], arg2=True)
...
class phase_b_skip_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[126], auto_target=True) # 비전두용 오르데 소환
        self.spawn_monster(spawn_ids=[106], auto_target=True) # 비전투 라네모네 소환
        self.spawn_monster(spawn_ids=[110], auto_target=True)
        self.spawn_monster(spawn_ids=[111], auto_target=True)
        self.spawn_monster(spawn_ids=[112], auto_target=True)
        self.spawn_monster(spawn_ids=[113], auto_target=True)
...
class phase_end_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[126], auto_target=True) # 비전투 오르데 소환
        self.spawn_monster(spawn_ids=[110], auto_target=True)
        self.spawn_monster(spawn_ids=[106], auto_target=True) # 비전투 라네모네 소환
        self.spawn_monster(spawn_ids=[111], auto_target=True)
        self.set_effect(trigger_ids=[7101], visible=True)
