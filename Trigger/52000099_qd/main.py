...
class 퀘스트체크50100520(common.Trigger):
...
class 퀘스트체크50100540(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class phase_b_scene_02(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class phase_b_scene_03(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_04(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return phase_b_scene_05(self.ctx)


class phase_b_scene_05(common.Trigger):
    def on_enter(self):
        self.set_skip()
...
class phase_b_scene_06(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_07(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_08(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_09(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_10(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_11(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_12(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_13(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_14(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_15(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_16(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_17(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[212,213], animationEffect=True)
...
class phase_b_scene_18(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_19(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class phase_b_scene_end(common.Trigger):
    def on_enter(self):
        self.set_visible_breakable_object(triggerIds=[2201,2202,2203,2204,2205,2206,2207,2208,2209,2210,2211,2212,2213,2214,2215,2216,2217,2218,2219,2220], visible=True)
        self.set_visible_breakable_object(triggerIds=[2221,2222,2223,2224,2225,2226,2227,2228,2229,2230,2231,2232,2233,2234,2235,2236,2237,2238,2239,2240], visible=True)
        self.set_visible_breakable_object(triggerIds=[2251,2252,2253,2254,2255,2256,2257,2258,2259,2260,2261,2262,2263,2264,2265,2266,2267,2268,2269,2270], visible=True)
...
class phase_b_scene_end_02(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_end_03(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_end_04(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_end_05(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_end_06(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=3101, visible=True, initialSequence='Idle_A')
...
class phase_b_scene_end_07(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7004], visible=True)
        self.move_user(mapId=52000099, portalId=2)
...
class phase_b_scene_end_07_ready(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=3102, visible=True, initialSequence='Idle_A')
...
class phase_b_scene_end_08(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_end_09(common.Trigger):
    def on_enter(self):
...
class phase_b_scene_end_10(common.Trigger):
    def on_enter(self):
...
class phase_c_01(common.Trigger):
    def on_enter(self):
...
class phase_c_02(common.Trigger):
    def on_enter(self):
...
class phase_c_03(common.Trigger):
    def on_enter(self):
...
class phase_c_04(common.Trigger):
    def on_enter(self):
...
class phase_c_05(common.Trigger):
    def on_enter(self):
...
class phase_c_06(common.Trigger):
    def on_enter(self):
...
class phase_c_07(common.Trigger):
    def on_enter(self):
...
class phase_c_08(common.Trigger):
    def on_enter(self):
...
class phase_c_09(common.Trigger):
    def on_enter(self):
...
class phase_c_10(common.Trigger):
    def on_enter(self):
...
class phase_c_11(common.Trigger):
    def on_enter(self):
...
class phase_c_12(common.Trigger):
    def on_enter(self):
...
class phase_c_13(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[8022], returnView=False)
...
class phase_c_14(common.Trigger):
    def on_enter(self):
...
class phase_c_15(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class phase_c_16(common.Trigger):
    def on_enter(self):
        self.set_visible_breakable_object(triggerIds=[2201,2202,2203,2204,2205,2206,2207,2208,2209,2210,2211,2212,2213,2214,2215,2216,2217,2218,2219,2220], visible=False)
        self.set_visible_breakable_object(triggerIds=[2221,2222,2223,2224,2225,2226,2227,2228,2229,2230,2231,2232,2233,2234,2235,2236,2237,2238,2239,2240], visible=False)
...
class phase_c_end(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class phase_b_skip_1(common.Trigger):
    def on_enter(self):
...
class phase_b_skip_2(common.Trigger):
    def on_enter(self):
...
class phase_b_skip_3(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=121, patrolName='MS2PatrolData_2081')
        self.move_npc(spawnId=120, patrolName='MS2PatrolData_2082')
        self.move_npc(spawnId=119, patrolName='MS2PatrolData_2083')
...
class phase_b_skip_4(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.move_user(mapId=52000099, portalId=3)
...
class phase_b_skip_5(common.Trigger):
    def on_enter(self):
        self.set_visible_breakable_object(triggerIds=[2201,2202,2203,2204,2205,2206,2207,2208,2209,2210,2211,2212,2213,2214,2215,2216,2217,2218,2219,2220], visible=False)
        self.set_visible_breakable_object(triggerIds=[2221,2222,2223,2224,2225,2226,2227,2228,2229,2230,2231,2232,2233,2234,2235,2236,2237,2238,2239,2240], visible=False)
        self.set_visible_breakable_object(triggerIds=[2251,2252,2253,2254,2255,2256,2257,2258,2259,2260,2261,2262,2263,2264,2265,2266,2267,2268,2269,2270,3101,3102], visible=False)
...
class phase_b_skip_end(common.Trigger):
    def on_enter(self):
        self.set_skip()
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class phase_end_01(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=3101, visible=False)
        self.set_actor(triggerId=3102, visible=False)
        self.set_visible_breakable_object(triggerIds=[2201,2202,2203,2204,2205,2206,2207,2208,2209,2210,2211,2212,2213,2214,2215,2216,2217,2218,2219,2220], visible=False)
...
class phase_end_02(common.Trigger):
    def on_enter(self):
...
class phase_end_03(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[112], animationEffect=True)
        self.set_effect(triggerIds=[7102], visible=True)
...
class phase_end_04(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[113], animationEffect=True)
        self.set_effect(triggerIds=[7103], visible=True)
...
class phase_end_05(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[114], animationEffect=True)
        self.set_effect(triggerIds=[7104], visible=True)
...
class phase_end_06(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[115], animationEffect=True)
        self.set_effect(triggerIds=[7105], visible=True)
...
class phase_end_07(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[116], animationEffect=True)
        self.set_effect(triggerIds=[7106], visible=True)
...
class phase_end_08(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[117], animationEffect=True)
        self.set_effect(triggerIds=[7107], visible=True)
...
class phase_end_09(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[118], animationEffect=True)
        self.set_effect(triggerIds=[7108], visible=True)
...
class phase_end_10(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[119], animationEffect=True)
        self.set_effect(triggerIds=[7109], visible=True)
...
class phase_end_11(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[120], animationEffect=True)
        self.set_effect(triggerIds=[7110], visible=True)
...
class phase_end_12(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[121], animationEffect=True)
        self.set_effect(triggerIds=[7111], visible=True)
...
class phase_end(common.Trigger):
    def on_enter(self):
        self.set_local_camera(cameraId=8023, enable=False) # LocalTargetCamera
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class phase_c_end_02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
