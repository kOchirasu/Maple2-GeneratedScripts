...
class 퀘스트체크50100300_1(common.Trigger):
...
class 퀘스트체크50100310_1(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 퀘스트체크50100311_1(common.Trigger):
    def on_tick(self) -> common.Trigger:
