...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3005,3006,3007,3008,3009,3010,3011,3012], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3102,3103,3104,3105], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3160,3161,3162,3163,3164], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3200,3201,3202,3203,3204,3205,3206,3207,3208,3209,3210,3211,3212], visible=True, start_delay=0, interval=0, fade=0)
...
class 에르다대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003069, illust_id='SnowQueen_normal', msg='$52000086_QD__50001540__0$', align='Right', duration=3000)
...
class 에르다대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003069, illust_id='SnowQueen_normal', msg='$52000086_QD__50001540__1$', align='Right', duration=4000)
...
class 설눈이대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003068, illust_id='Seolnunyi_normal', msg='$52000086_QD__50001540__2$', align='right', duration=4000)
...
class 비에른대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003075, illust_id='SnowKing_normal', msg='$52000086_QD__50001540__3$', align='left', duration=4000)
...
class 설눈이대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003068, illust_id='Seolnunyi_normal', msg='$52000086_QD__50001540__4$', align='right', duration=4000)
...
class 비에른방향전환(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003068, illust_id='Seolnunyi_normal', msg='$52000086_QD__50001540__5$', align='right', duration=2000)
...
class 비에른공격(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003068, illust_id='Seolnunyi_normal', msg='$52000086_QD__50001540__6$', align='right', duration=1000)
...
class 설눈이스턴(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=1001, sequence_name='Stun_A', duration=1E+12)
...
class 에르다대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=302, enable=True)
        self.add_cinematic_talk(npc_id=11003069, illust_id='SnowQueen_normal', msg='$52000086_QD__50001540__7$', align='right', duration=2500)
...
class 비에른대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003075, illust_id='SnowKing_normal', msg='$52000086_QD__50001540__8$', align='left', duration=4000)
        self.add_cinematic_talk(npc_id=11003068, illust_id='Seolnunyi_normal', msg='$52000086_QD__50001540__9$', align='right', duration=3000)
...
class 비에른대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003075, illust_id='SnowKing_normal', msg='$52000086_QD__50001540__10$', align='left', duration=3000)
...
class 에르다대사04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003069, illust_id='SnowQueen_normal', msg='$52000086_QD__50001540__11$', align='Right', duration=3000)
...
class 에르다대사05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=1002, sequence_name='AttackReady_01_A', duration=1E+12)
        self.add_cinematic_talk(npc_id=11003069, illust_id='SnowQueen_normal', msg='$52000086_QD__50001540__12$', align='Right', duration=4000)
...
class 연출종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=1005, sequence_name='AttackReady_01_A', duration=1E+12)
...
class 감지대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3105], visible=False, start_delay=0, interval=0, fade=0)
...
class 비에른대사04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003075, illust_id='SnowKing_normal', msg='$52000086_QD__50001540__13$', align='left', duration=4000)
...
class 비에른대사05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003075, illust_id='SnowKing_normal', msg='$52000086_QD__50001540__14$', align='left', duration=5000)
