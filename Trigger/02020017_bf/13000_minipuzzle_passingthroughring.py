...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000232], state=2) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거
...
class PassingThroughRing_Success(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000232], state=1) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거

    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[12000232], stateValue=0):
