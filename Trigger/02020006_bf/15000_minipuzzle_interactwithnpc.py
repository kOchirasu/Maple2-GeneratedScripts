...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000250], state=2) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001151 걸어서 71001051 제거
...
class InteractWithNpc_Success(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000250], state=1) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001151 걸어서 71001051 제거

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[12000250], arg2=0):
