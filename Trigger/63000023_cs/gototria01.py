...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_effect(triggerIds=[7200], visible=False) # Voice BravoNJabeth 00001598
...
# 최초 입장
class WalkWithJacey01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class WalkWithJacey02(common.Trigger):
    def on_enter(self):
...
class WalkWithJacey03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class Dialogue11(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Talk_A')
...
class Dialogue12(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7002], visible=False) # Voice Bravo 00001462
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Idle_A')
        self.remove_cinematic_talk()
...
class Dialogue13(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Talk_A')
...
class Dialogue14(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7102], visible=False) # Voice Jabeth 00001550
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Idle_A')
        self.remove_cinematic_talk()
...
class Dialogue15(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Talk_A')
...
class Dialogue16(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Idle_A')
        self.remove_cinematic_talk()
        self.set_skip()
...
class Dialogue17(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Talk_A')
...
class Dialogue18(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7003], visible=False) # Voice Bravo 00001463
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Idle_A')
        self.remove_cinematic_talk()
...
class Dialogue19(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Talk_A')
...
class Dialogue20(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Idle_A')
        self.remove_cinematic_talk()
        self.set_skip()
...
class Dialogue21(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Talk_A')
...
class Dialogue22(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7103], visible=False) # Voice Jabeth 00001551
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Idle_A')
        self.remove_cinematic_talk()
...
class TalkJacey01(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class TalkJacey02(common.Trigger):
    def on_enter(self):
...
class TalkJacey03(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7200], visible=False) # Voice BravoNJabeth 00001598
...
class JaceyLeave01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1500):
            return JaceyLeave02(self.ctx)


class JaceyLeave02(common.Trigger):
    def on_enter(self):
...
class JaceyLeave03(common.Trigger):
    def on_enter(self):
...
class JaceyLeave04(common.Trigger):
    def on_enter(self):
...
class JaceyLeave05(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[201,301])
        self.create_monster(spawnIds=[202,302], animationEffect=False)
...
class JaceyLeave06(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class GetCloseToTheCar01(common.Trigger):
    def on_enter(self):
...
class GetCloseToTheCar02(common.Trigger):
    def on_enter(self):
...
class GetInTheCar01(common.Trigger):
    def on_enter(self):
...
class GetInTheCar02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[6000], visible=False) # CarIdle
...
class GetInTheCar03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class CarMoving01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=3500):
            return CarMoving02(self.ctx)


class CarMoving02(common.Trigger):
    def on_enter(self):
        self.set_breakable(triggerIds=[4000], enable=False)
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class CarMoving03(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[6001], visible=False) # CarMovingAway
