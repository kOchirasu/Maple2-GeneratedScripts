...
class DungeonStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000015, script='$02000401_BF__MADRICANSIEGE__0$', time=4, arg5=0)
...
class 던전시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1001, script='$02000401_BF__MADRICANSIEGE__1$', time=3, arg5=0)
...
class 암전(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_npc_range(range_ids=[1901,1902,1903,1904,1905,1906,1907,1908,1909,1910,1911,1912,1913,1914,1915,1916,1917,1918,1919], is_auto_targeting=False)
...
class 던전종료연출01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1903, script='$02000401_BF__MADRICANSIEGE__3$', time=3, arg5=0)
...
class 던전종료연출02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1902, script='$02000401_BF__MADRICANSIEGE__4$', time=4, arg5=0)
