...
class Object_Off(common.Trigger):
    def on_enter(self):
...
class Event_A_02(common.Trigger):
    def on_enter(self):
...
class Event_A_03(common.Trigger):
    def on_enter(self):
...
class Event_A_04(common.Trigger):
    def on_enter(self):
...
class Event_A_05(common.Trigger):
    def on_enter(self):
...
class Event_A_06(common.Trigger):
    def on_enter(self):
...
class Event_A_Skip_01(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[101], animationEffect=True) # 엘레나
...
class Event_A_Skip_02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=101, patrolName='MS2PatrolData_3001')
        self.set_effect(triggerIds=[5002], visible=True)
...
class Event_A_End(common.Trigger):
    def on_enter(self):
...
class Battle_A_Ready(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
...
class Battle_B_Ready(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
