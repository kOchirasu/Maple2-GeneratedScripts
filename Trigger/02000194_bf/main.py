...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3005,3006,3007], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3001,3002,3003,3004], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3101,3102,3103,3104], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3201,3202,3203], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3301,3302,3303,3304], visible=True, start_delay=0, interval=0, fade=0)
...
class 던전시작(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        self.set_mesh(trigger_ids=[3005,3006,3007], visible=False, start_delay=0, interval=0, fade=0)
...
class 시작2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001054], state=0):
            self.set_mesh(trigger_ids=[3101,3102,3103,3104], visible=False, start_delay=0, interval=0, fade=0)
...
class 오브젝트2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001055], state=0):
            self.set_mesh(trigger_ids=[3201,3202,3203], visible=False, start_delay=0, interval=0, fade=0)
...
class 오브젝트3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001056], state=0):
            self.set_mesh(trigger_ids=[3301,3302,3303,3304], visible=False, start_delay=0, interval=0, fade=0)
...
class 오브젝트4(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001057], state=0):
            ...
            self.set_mesh(trigger_ids=[3001,3002,3003,3004], visible=False, start_delay=0, interval=0, fade=0)
            return 종료(self.ctx)
