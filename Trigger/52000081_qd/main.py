...
class PC말풍선01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__0$', time=2, arg5=0)
...
class PC말풍선02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__1$', time=3, arg5=0)
...
class PC말풍선03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__2$', time=1, arg5=0)
        self.set_pc_emotion_loop(sequence_name='Push_A', duration=10000)
...
class 몹소환(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__3$', time=2, arg5=0)
        self.set_pc_emotion_loop(sequence_name='Push_A', duration=15000)
...
class PC구출03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=1002, sequence_name='Attack_01_D', duration=2000)
...
class PC구출04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[601], visible=False)
        self.set_pc_emotion_loop(sequence_name='Idle_A', duration=10000)
...
class 검사대화01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=1002, sequence_name='Bore_A', duration=1500)
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__4$', align='left', duration=3000)
...
class 검사대화02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__5$', align='left', duration=3000)
...
class PC말풍선04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__6$', time=3, arg5=0)
...
class PC말풍선05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__7$', time=3, arg5=0)
...
class 검사대화03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__17$', align='left', duration=2000)
...
class PC말풍선06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__8$', time=3, arg5=0)
...
class PC말풍선07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__9$', time=3, arg5=0)
...
class PC말풍선08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000081_QD__MAIN__10$', time=3, arg5=0)
...
class 검사대화04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__11$', align='left', duration=3000)
...
class 검사대화05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__12$', align='left', duration=3000)
...
class 검사대화06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__13$', align='left', duration=3000)
...
class 검사대화07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__14$', align='left', duration=3000)
...
class 검사대화08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__15$', align='left', duration=3000)
...
class 검사대화09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004022, illust_id='11004022', msg='$52000081_QD__MAIN__16$', align='left', duration=3000)
