...
class Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1100,1101,1102,1103,1104,1105,1106,1107,1108,1109,1110], visible=False, start_delay=0, interval=0, fade=10)
...
class Start_02(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        # self.set_mesh(trigger_ids=[741], visible=False, start_delay=0, interval=0, fade=10)
        self.set_effect(trigger_ids=[6661], visible=False)


class Step_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[1000,1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012], visible=True, start_delay=0, interval=100, fade=10)
    ...
    def on_exit(self) -> None:
        ...
        # self.set_mesh(trigger_ids=[742], visible=False, start_delay=0, interval=0, fade=10)
        self.set_effect(trigger_ids=[6662], visible=False)


class Step_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[1020,1021,1022,1023,1024,1025,1026,1027,1028,1029,1030,1031,1032], visible=True, start_delay=0, interval=100, fade=10)
    ...
    def on_exit(self) -> None:
        ...
        # self.set_mesh(trigger_ids=[743], visible=False, start_delay=0, interval=0, fade=10)
        self.set_effect(trigger_ids=[6663], visible=False)


class Step_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[1040,1041,1042,1043,1044,1045,1046,1047,1048,1049,1050,1051,1052,1053,1054,1055,1056,1057,1058,1059,1060], visible=True, start_delay=0, interval=100, fade=10)
