...
class 대기(common.Trigger):
    def on_enter(self):
        ...
        self.move_user(mapId=2000393, portalId=1)
...
class 캐릭터선택대기(common.Trigger):
    ...
    def on_exit(self):
        ...
        self.move_user(mapId=2000393, portalId=2)


class 천둥선택(common.Trigger):
    def on_enter(self):
