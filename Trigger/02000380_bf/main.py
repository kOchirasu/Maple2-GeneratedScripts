...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2005,2006,2007,2008], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[2010,2011,2012], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[2020,2021,2022,2023], visible=True, start_delay=0, interval=0, fade=0)
...
class Start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera_path(path_ids=[8001,8002,8003], return_view=True)
        self.spawn_monster(spawn_ids=[101])
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__0$', time=3, arg5=0)
...
class Start_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__2$', time=3, arg5=0)
...
class Start_03_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2001,2002,2003,2004], visible=False, start_delay=0, interval=10, fade=10)
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__4$', time=2, arg5=0)
...
class Start_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__5$', time=3, arg5=0)
...
class Start_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__6$', time=3, arg5=0)
...
class Start_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__7$', time=3, arg5=0)
...
class Start_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2010,2011,2012], visible=False, start_delay=0, interval=10, fade=10)
...
class Portal_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=4001, visible=True, initial_sequence='ry_functobj_door_A01_On')
        self.set_portal(portal_id=11, visible=True, enable=True, minimap_visible=False)
...
class Portal_12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=4001, visible=True, initial_sequence='ry_functobj_door_A01_On')
        self.set_portal(portal_id=12, visible=True, enable=True, minimap_visible=False)
...
class Start_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__8$', time=3, arg5=0)
    ...
    def on_exit(self) -> None:
        # self.set_mesh(trigger_ids=[2005,2006,2007,2008], visible=True, start_delay=0, interval=0, fade=0)
        pass
...
class Start_09_02(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        self.set_mesh(trigger_ids=[2005,2006,2007,2008], visible=False, start_delay=0, interval=0, fade=10)
        ...
        self.set_portal(portal_id=13, visible=True, enable=False, minimap_visible=False)
...
class Round_2_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__9$', time=3, arg5=0)
...
class Round_2_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__10$', time=3, arg5=0)
...
class Round_2_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__11$', time=3, arg5=0)
...
class Round_2_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[2013,2014,2015], visible=False, start_delay=0, interval=10, fade=10)
...
class Round_2_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__12$', time=3, arg5=0)
...
class Round_2_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__13$', time=3, arg5=0)
...
class Round_2_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__14$', time=3, arg5=0)
...
class Round_2_12(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        self.set_portal(portal_id=23, visible=True, enable=False, minimap_visible=False)
...
class Round_3_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_2208')
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__15$', time=3, arg5=0)
...
class Round_3_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_2208')
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__16$', time=3, arg5=0)
...
class Round_3_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000380_BF__MAIN__17$', time=3, arg5=0)
