...
class Start_03_02(common.Trigger):
    def on_enter(self):
...
class Portal_10(common.Trigger):
    def on_enter(self):
...
class Portal_11(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=4001, visible=True, initialSequence='ry_functobj_door_A01_On')
...
class Portal_12(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=4001, visible=True, initialSequence='ry_functobj_door_A01_On')
...
class Start_09_02(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class Round_2_02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return Round_2_03(self.ctx)


class Round_2_03(common.Trigger):
    def on_enter(self):
...
class Round_2_04(common.Trigger):
    def on_enter(self):
...
class Round_2_05(common.Trigger):
    def on_enter(self):
...
class Round_2_06(common.Trigger):
    def on_enter(self):
...
class Round_2_08(common.Trigger):
    def on_enter(self):
...
class Round_2_09(common.Trigger):
    def on_enter(self):
...
class Round_2_10(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=110, textId=40009, duration=5000) # 포탈 이용하세요
...
class Portal_21(common.Trigger):
    def on_enter(self):
...
class Portal_22(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=4004, visible=True, initialSequence='ry_functobj_door_A01_On')
...
class Round_2_11(common.Trigger):
    def on_enter(self):
...
class Round_2_12(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.count_users(boxId=703, boxId=1):
...
class Round_3_02(common.Trigger):
    def on_enter(self):
...
class Round_3_03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=101, patrolName='MS2PatrolData_2208')
...
class Round_3_04(common.Trigger):
    def on_enter(self):
