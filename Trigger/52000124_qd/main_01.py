...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[401,402], auto_target=True) # 레논 추종자
        self.add_cinematic_talk(npc_id=11000069, msg='$52000124_QD__MAIN_01__0$', duration=2000, align='left')
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11000069, msg='$52000124_QD__MAIN_01__1$', duration=2000, align='left')
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003304, msg='$52000124_QD__MAIN_01__2$', duration=2000, align='left')
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003304, msg='$52000124_QD__MAIN_01__4$', duration=2000, align='left')
...
class scene_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11000069, msg='$52000124_QD__MAIN_01__5$', duration=2000, align='left')
...
class scene_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003304, msg='$52000124_QD__MAIN_01__6$', duration=2000, align='left')
...
class scene_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003304, msg='$52000124_QD__MAIN_01__7$', duration=2000, align='left')
...
class battle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[601,602], auto_target=True) # 레논 추종자
...
class winready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[302], auto_target=True) # 연출용 카트반
...
class scene_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003196, illust_id='Katvan_normal', msg='$52000124_QD__MAIN_01__9$', duration=3000, align='Center')
...
class scene_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[301], auto_target=True) # 퀘스트 카트반
