...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[102], auto_target=True) # 이름 없는 부랑자 연출
...
class talk_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003209, msg='$52000126_QD__MAIN__0$', duration=2000, align='Left')
        self.spawn_monster(spawn_ids=[301], auto_target=True) # 11003214
        self.spawn_monster(spawn_ids=[302], auto_target=True) # 11003213
        self.spawn_monster(spawn_ids=[303], auto_target=True) # 11003212
...
class talk_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003209, msg='$52000126_QD__MAIN__1$', duration=2000, align='Left')
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003214, msg='$52000126_QD__MAIN__2$', duration=3000, align='Left')
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003214, msg='$52000126_QD__MAIN__3$', duration=3000, align='Left')
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003214, msg='$52000126_QD__MAIN__4$', duration=4000, align='Left')
...
class scene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003214, msg='$52000126_QD__MAIN__5$', duration=3000, align='Left')
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=302, sequence_name='Attack_Idle_A', duration=7000)
        self.set_npc_emotion_loop(spawn_id=303, sequence_name='Attack_Idle_A', duration=7000)
        self.add_cinematic_talk(npc_id=11003213, msg='$52000126_QD__MAIN__6$', duration=2000, align='Left')
...
class battle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[601,602,603], auto_target=True) # 디쓰리 몬스터
