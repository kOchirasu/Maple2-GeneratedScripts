...
class 전투02(common.Trigger):
    def on_enter(self):
        ...
        self.create_monster(spawnIds=[12101,12102,12201,12202,12203,12204,12205,12206], animationEffect=False)

    def on_tick(self) -> common.Trigger:
        if self.monster_dead(boxIds=[12101,12102,12201,12202,12203,12204,12205,12206]):
            return 전투03(self.ctx)


class 전투03(common.Trigger):
    def on_enter(self):
        ...
        self.create_monster(spawnIds=[13101,13102,13103,13104,13105,13106,13107,13108,13201,13202,13203,13204], animationEffect=False)

    def on_tick(self) -> common.Trigger:
        if self.monster_dead(boxIds=[13101,13102,13103,13104,13105,13106,13107,13108,13201,13202,13203,13204]):
