...
class 카메라_캡션(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[5001,5002], return_view=True)
        self.show_caption(type='VerticalCaption', title='$02020025_BF__main__3$', desc='$02020025_BF__main__4$', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=5000, scale=2)
...
class 유저연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='$02020025_BF__main__5$', time=5, arg5=0)
...
class 카메라_콘대르설명1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=24110001, msg='$02020025_BF__main__0$', duration=4000, align='left')
...
class 유저연출_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$02020025_BF__main__6$', time=3, arg5=0)
...
class 카메라_콘대르설명2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=24110001, illust_id='Conder_normal', msg='$02020025_BF__main__1$', duration=4000, align='left')
...
class 카메라_콘대르설명3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=24110001, illust_id='Conder_normal', msg='$02020025_BF__main__2$', duration=4000, align='left')
