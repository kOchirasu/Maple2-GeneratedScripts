...
class 카메라_콘대르설명1(common.Trigger):
    def on_enter(self):
...
class 카메라_콘대르설명2(common.Trigger):
    def on_enter(self):
...
class 카메라_콘대르설명3(common.Trigger):
    def on_enter(self):
...
class 카메라_콘대르설명4(common.Trigger):
    def on_enter(self):
...
class 던전종료_A랭크이상(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[201])
        self.dungeon_clear()


class 던전종료_A랭크미만(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[201])
        self.dungeon_fail()
