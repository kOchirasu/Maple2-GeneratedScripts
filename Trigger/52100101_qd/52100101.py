...
class wait_01_02_003(common.Trigger):
    def on_enter(self):
...
class 구릉도착_01_2(common.Trigger):
    def on_enter(self):
...
class wait_01_04(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
...
class 클라디아바라봄_02(common.Trigger):
    def on_enter(self):
...
class 게오르크_04_02(common.Trigger):
    def on_enter(self):
