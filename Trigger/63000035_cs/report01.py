...
class Operator01(common.Trigger):
    def on_enter(self):
...
class OperatorSkip01(common.Trigger):
    def on_enter(self):
...
class Operator02(common.Trigger):
    def on_enter(self):
...
class OperatorSkip02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class MonitorOn01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class MonitorOn02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5000], visible=False) # Beep_Loop
...
class MonitorOn03(common.Trigger):
    def on_enter(self):
...
class KahnTalk01(common.Trigger):
    def on_enter(self):
...
class KahnTalk02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class KahnTalk03(common.Trigger):
    def on_enter(self):
...
class KahnTalk04(common.Trigger):
    def on_enter(self):
...
class KahnTalk05(common.Trigger):
    def on_enter(self):
...
class KahnTalk06(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
