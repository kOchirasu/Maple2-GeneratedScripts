...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[512], visible=True, start_delay=0, interval=0, fade=0) # 12 / Ground outter
        self.set_mesh(trigger_ids=[5120], visible=True, start_delay=0, interval=0, fade=0) # 12 / Ground inner
...
class Pass(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[512], visible=False, start_delay=0, interval=0, fade=2) # 12 / Ground outter
...
class Fail(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[512], visible=False, start_delay=0, interval=0, fade=2) # 12 / Ground outter
        self.set_mesh(trigger_ids=[5120], visible=False, start_delay=0, interval=0, fade=0) # 12 / Ground inner
