...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[711,712,713,714,715,716,717], visible=False, start_delay=0, interval=0, fade=0) # Banner10
...
class SetBanner(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.user_value(key='BannerNumber', value=70):
            self.set_mesh(trigger_ids=[717], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[700], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=69):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[709], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=68):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[708], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=67):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[707], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=66):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[706], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=65):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[705], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=64):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[704], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=63):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[703], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=62):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[702], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=61):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[701], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=60):
            self.set_mesh(trigger_ids=[716], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[700], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=59):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[709], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=58):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[708], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=57):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[707], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=56):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[706], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=55):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[705], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=54):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[704], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=53):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[703], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=52):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[702], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
        if self.user_value(key='BannerNumber', value=51):
            self.set_mesh(trigger_ids=[715], visible=True, start_delay=0, interval=0, fade=2)
            self.set_mesh(trigger_ids=[701], visible=True, start_delay=0, interval=0, fade=2)
            return NextWait(self.ctx)
