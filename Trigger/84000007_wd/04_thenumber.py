...
class BannerCheckIn(state.State):
    def on_tick(self) -> state.State:
        if count_users(boxId=9001, boxId=70, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=70)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=69, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=69)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=68, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=68)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=67, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=67)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=66, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=66)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=65, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=65)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=64, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=64)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=63, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=63)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=62, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=62)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=61, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=61)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=60, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=60)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=59, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=59)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=58, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=58)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=57, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=57)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=56, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=56)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=55, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=55)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=54, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=54)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=53, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=53)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=52, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=52)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
        if count_users(boxId=9001, boxId=51, operator='Equal'):
            set_user_value(triggerId=5, key='BannerNumber', value=51)
            set_user_value(triggerId=5, key='SetBanner', value=1)
            return Reset()
