...
class 치유의식_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003389, msg='$52010032_QD__MAIN__0$', duration=3000, illust_id='0', align='Left')
...
class 치유의식_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003389, msg='$52010032_QD__MAIN__1$', duration=3000, illust_id='0', align='Left')
...
class 치유의식_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003389, msg='$52010032_QD__MAIN__2$', duration=3000, illust_id='0', align='Left')
...
class 치유의식_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003390, msg='$52010032_QD__MAIN__3$', duration=3000, illust_id='0', align='Left')
