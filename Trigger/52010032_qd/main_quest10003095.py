...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5001], visible=False) # 나메드 치유 시전 이펙트
        self.set_effect(trigger_ids=[5002], visible=False) # 붉은 늑대의 심장 치유 이펙트
...
class Ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[101], auto_target=True) # 붉은늑대의심장:
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Dead_Idle_A', duration=100000000)
...
class 치유의식_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52010032_QD__MAIN_QUEST10003095__1$', duration=2000, delay_tick=2000)
...
class 치유의식_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Emotion_Dance_Event01', duration=7000)
...
class 치유의식_04_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Down_Idle_A', duration=100000000)
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52010032_QD__MAIN_QUEST10003095__8$', duration=2000, delay_tick=6000)
...
class 종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[202], auto_target=True) # 나메드:
