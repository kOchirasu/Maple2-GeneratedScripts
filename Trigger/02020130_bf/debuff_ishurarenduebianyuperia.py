...
class 셋트전투판스킬트리거셋팅1(common.Trigger):
    def on_enter(self):
...
class 셋트전투판마무리신호대기1(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 이슈라_디버프스킬끄기(common.Trigger):
    def on_enter(self):
...
class 렌듀비앙_디버프스킬끄기(common.Trigger):
    def on_enter(self):
...
class 유페리아_디버프스킬끄기(common.Trigger):
    def on_enter(self):
