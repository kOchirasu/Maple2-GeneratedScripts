...
class 던전미션_체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.user_value(key='IshuraSkillBreakClear', value=1) and self.user_value(key='YuperiaSkillBreakClear', value=1) and self.user_value(key='RenduebianSkillBreakClear', value=1):
        ...
        if self.check_npc_extra_data(spawnPointID='701', extraDataKey='brokenShieldRemainTick', extraDataValue='6000', operator='GreaterEqual') and self.check_npc_additional_effect(spawnId=701, additionalEffectId=70002171, level=1) and self.check_npc_extra_data(spawnPointID='702', extraDataKey='brokenShieldRemainTick', extraDataValue='6000', operator='GreaterEqual') and self.check_npc_additional_effect(spawnId=702, additionalEffectId=70002171, level=1) and self.check_npc_extra_data(spawnPointID='703', extraDataKey='brokenShieldRemainTick', extraDataValue='6000', operator='GreaterEqual') and self.check_npc_additional_effect(spawnId=703, additionalEffectId=70002171, level=1):
        ...
        if self.check_npc_extra_data(spawnPointID='701', extraDataKey='brokenShieldRemainTick', extraDataValue='8000', operator='GreaterEqual') and self.check_npc_additional_effect(spawnId=701, additionalEffectId=70002171, level=1):
        ...
        if self.check_npc_extra_data(spawnPointID='702', extraDataKey='brokenShieldRemainTick', extraDataValue='8000', operator='GreaterEqual') and self.check_npc_additional_effect(spawnId=702, additionalEffectId=70002171, level=1):
        ...
        if self.check_npc_extra_data(spawnPointID='703', extraDataKey='brokenShieldRemainTick', extraDataValue='8000', operator='GreaterEqual') and self.check_npc_additional_effect(spawnId=703, additionalEffectId=70002171, level=1):
...
class 던전미션_스킬브레이크저지_성공(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dungeon_mission_complete(missionId=23040004)
