...
class 던전미션_체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.check_npc_extra_data(spawn_point_id='701', extra_data_key='brokenShieldRemainTick', extra_data_value='6000', operator='GreaterEqual') and self.check_npc_additional_effect(spawn_id=701, additional_effect_id=70002171, level=1) and self.check_npc_extra_data(spawn_point_id='702', extra_data_key='brokenShieldRemainTick', extra_data_value='6000', operator='GreaterEqual') and self.check_npc_additional_effect(spawn_id=702, additional_effect_id=70002171, level=1) and self.check_npc_extra_data(spawn_point_id='703', extra_data_key='brokenShieldRemainTick', extra_data_value='6000', operator='GreaterEqual') and self.check_npc_additional_effect(spawn_id=703, additional_effect_id=70002171, level=1):
        ...
        if self.check_npc_extra_data(spawn_point_id='701', extra_data_key='brokenShieldRemainTick', extra_data_value='8000', operator='GreaterEqual') and self.check_npc_additional_effect(spawn_id=701, additional_effect_id=70002171, level=1):
        ...
        if self.check_npc_extra_data(spawn_point_id='702', extra_data_key='brokenShieldRemainTick', extra_data_value='8000', operator='GreaterEqual') and self.check_npc_additional_effect(spawn_id=702, additional_effect_id=70002171, level=1):
        ...
        if self.check_npc_extra_data(spawn_point_id='703', extra_data_key='brokenShieldRemainTick', extra_data_value='8000', operator='GreaterEqual') and self.check_npc_additional_effect(spawn_id=703, additional_effect_id=70002171, level=1):
