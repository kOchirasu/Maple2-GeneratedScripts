...
class 던전미션_체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.check_npc_additional_effect(spawnId=701, additionalEffectId=70002171, level=1):
        ...
        if self.check_npc_additional_effect(spawnId=702, additionalEffectId=70002171, level=1):
        ...
        if self.check_npc_additional_effect(spawnId=703, additionalEffectId=70002171, level=1):
...
class 던전미션_스킬브레이크저지_성공(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dungeon_mission_complete(missionId=23040005)
