...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[16003,16004], visible=False, interval=0, fade=0) # 벽 해제
...
class 관문_01_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8010,8011,8012,8013,8014], visible=False, interval=0, fade=10) # 벽 해제
...
class 관문_02_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[16017,16018], visible=False, interval=0, fade=10) # 벽 해제
