...
class start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[6000,6001,6002,6003,6004,6010,6011], visible=False) # 기빨고기빨리는이펙트
...
class PC놀람02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52010063_QD__main__0$', duration=3000, align='right') # 트리스탄…?
        # pc
...
class 인페르녹줌인02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003832, illust_id='infernog_nomal', msg='$52010063_QD__main__1$', duration=5000, align='right')
        self.set_effect(trigger_ids=[6000,6003], visible=False) # 인페르녹 기빨기 이펙트
        # 아니…?
        # 인페르녹
...
class 인페르녹줌인04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003832, illust_id='infernog_nomal', msg='$52010063_QD__main__3$', duration=5000, align='right')
...
class 부하대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003839, msg='$52010063_QD__main__4$', duration=3000, align='right') # 죄…죄송합니다!
        # 크림슨발록
...
class 부하대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003839, msg='$52010063_QD__main__5$', duration=3000, align='right') # 지금 당장 처단을…! />
...
class 인페르녹대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003832, illust_id='infernog_nomal', msg='$52010063_QD__main__6$', duration=4000, align='right')
        # 인페르녹
...
class 인페르녹대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003832, illust_id='infernog_nomal', msg='$52010063_QD__main__7$', duration=6000, align='right')
...
class 인페르녹대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003832, illust_id='infernog_nomal', msg='$52010063_QD__main__8$', duration=5000, align='right')
...
class 인페르녹대사05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003832, illust_id='infernog_nomal', msg='$52010063_QD__main__10$', duration=5000, align='right')
...
class 부하들준비00(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003839, msg='$52010063_QD__main__11$', duration=3000, align='right') # 받들겠습니다…!
...
class 전투전스킵완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[211], auto_target=True) # 몬스터 크림슨 발록
...
class 트리스탄구출02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=103, sequence_name='Dead_A', duration=5000) # 트리스탄
        self.set_effect(trigger_ids=[6004], visible=True) # 트리스탄 잡힌 효과 꺼짐
        self.add_cinematic_talk(npc_id=11003825, illust_id='Tristan_normal', msg='$52010063_QD__main__12$', duration=5000, align='right')
...
class 트리스탄구출03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[6010], visible=False) # 인페르녹 붉은 안개
...
class 트리스탄구출04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003825, illust_id='Tristan_normal', msg='$52010063_QD__main__13$', duration=3000, align='right')
...
class 전투후스킵완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[6000,6001,6002,6003,6004,6005,6010,6011], visible=False)
        self.move_user(map_id=52010063, portal_id=20) # 유저 전투 시작 위치로
        self.move_npc(spawn_id=103, patrol_name='MS2PatrolData_Tristan_walk') # 트리스탄 전진
...
class 콘대르_대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003534, illust='Conder_normal', script='$52010063_QD__main__15$', duration=12098, voice='ko/Npc/00002170')
...
class 블리체_대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_nomal', script='$52010063_QD__main__14$', duration=13000, voice='ko/Npc/00002153')
