...
class 연출시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_npc_emotion_loop(spawnId=101, sequenceName='Attack_02_B', duration=999999)
        # 트리스탄 기빨림 모션
...
class 인페르녹줌인04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11003832, illustId='infernog_nomal', msg='$52010063_QD__main__3$', duration=5000, align='right')
...
class 인페르녹대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11003832, illustId='infernog_nomal', msg='$52010063_QD__main__6$', duration=4000, align='right')
        # 인페르녹
...
class 인페르녹대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11003832, illustId='infernog_nomal', msg='$52010063_QD__main__7$', duration=6000, align='right')
...
class 인페르녹대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11003832, illustId='infernog_nomal', msg='$52010063_QD__main__8$', duration=5000, align='right')
...
class 인페르녹대사04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_npc_emotion_loop(spawnId=102, sequenceName='Attack_01_C, Attack_01_E', duration=4000)
        # 인페르녹
        # 나의 충실한 종복들이여. 실수를 만회할 기회를 주겠노라.\n침입자를 깨끗하게 정리하라." />
        self.set_npc_emotion_sequence(spawnId=102, sequenceName='Attack_03_D')
        # 인페르녹 뒤로
...
class 인페르녹대사05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11003832, illustId='infernog_nomal', msg='$52010063_QD__main__10$', duration=5000, align='right')
