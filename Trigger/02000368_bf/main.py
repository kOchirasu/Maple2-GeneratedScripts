...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3101,3102,3103,3104,3105,3106,3107,3108,3109,3110,3111,3112,3113,3114,3115,3116,3117,3118,3119,3120,3121,3122,3123,3124,3125,3126,3127,3128,3129,3130,3131,3132,3133,3134,3135,3136,3137,3138,3139,3140,3141,3142,3143,3144,3145,3146,3147], visible=False, start_delay=0, interval=0, fade=0)
        ...
        self.set_portal(portal_id=100, visible=False, enable=False, minimap_visible=False)
...
class 포털개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portal_id=30, visible=True, enable=True, minimap_visible=False)
        self.set_portal(portal_id=40, visible=True, enable=True, minimap_visible=False)
        self.set_portal(portal_id=50, visible=True, enable=True, minimap_visible=False)
        self.set_portal(portal_id=60, visible=True, enable=True, minimap_visible=False)
        self.set_portal(portal_id=70, visible=True, enable=True, minimap_visible=False)
        self.set_portal(portal_id=80, visible=True, enable=True, minimap_visible=False)
...
class 다리생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3101,3102,3103,3104,3105,3106,3107,3108,3109,3110,3111,3112,3113,3114,3115,3116,3117,3118,3119,3120,3121,3122,3123,3124,3125,3126,3127,3128,3129,3130,3131,3132,3133,3134,3135,3136,3137,3138,3139,3140,3141,3142,3143,3144,3145,3146,3147], visible=True, start_delay=0, interval=10, fade=0)
        self.set_portal(portal_id=100, visible=True, enable=True, minimap_visible=False)
