...
class standby(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.create_monster(spawnIds=[101,102,103,104,105,106,107,108,109], animationEffect=False)
        ...
        self.move_npc(spawnId=101, patrolName='MS2PatrolData_01_girl')
...
class scene1_ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.move_npc(spawnId=103, patrolName='MS2PatrolData_03_girlmaid_out')
...
class scene1_girlmonologue1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(triggerIds=[601], visible=False)
        # 맞지? 내 말.\n아빠 친구, 여기 왔었어.
        self.add_cinematic_talk(npcId=11004308, msg='$63000069_CS__63000069_MAIN__0$', duration=3000)
...
class scene1_girlmonologue2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004308, msg='$63000069_CS__63000069_MAIN__1$', duration=4500)
...
class scene1_girlmonologue3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 나한텐 아무도 없었어…\n아빠도… 아빠 친구도…
        self.add_cinematic_talk(npcId=11004308, msg='$63000069_CS__63000069_MAIN__2$', duration=5500)
...
class scene1_girlrealize2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004308, msg='$63000069_CS__63000069_MAIN__5$', duration=5000)
        self.set_npc_emotion_loop(spawnId=150, sequenceName='Talk_A', duration=4500)
