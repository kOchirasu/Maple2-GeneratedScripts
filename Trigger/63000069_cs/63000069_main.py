...
class scene1_girlmonologue2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=150, sequence_name='Talk_A', duration=4500)
        self.set_effect(trigger_ids=[601], visible=False)
...
class scene1_girlmonologue3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=150, sequence_name='Bore_B', duration=5500)
...
class scene1_girlrealize0(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=150, sequence_name='Damg_A', duration=100)
