...
class searching_check(common.Trigger):
    def on_enter(self):
...
class scene1_girlmonologue0(common.Trigger):
    def on_enter(self):
...
class scene1_girlmonologue1(common.Trigger):
    def on_enter(self):
...
class scene1_girlmonologue2(common.Trigger):
    def on_enter(self):
...
class scene1_girlmonologue3(common.Trigger):
    def on_enter(self):
...
class scene1_girlrealize0(common.Trigger):
    def on_enter(self):
...
class scene1_girlrealize1(common.Trigger):
    def on_enter(self):
...
class scene1_girlrealize2(common.Trigger):
    def on_enter(self):
...
class scene1_girlmonologue5(common.Trigger):
    def on_enter(self):
...
class scene_readytoend(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml') # 불끄기
        self.set_mesh(triggerIds=[4001], visible=False)
...
class sceneskip(common.Trigger):
    def on_enter(self):
...
class scene_fin_ready(common.Trigger):
    def on_enter(self):
