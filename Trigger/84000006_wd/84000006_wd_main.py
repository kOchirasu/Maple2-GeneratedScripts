...
class openingscene_1_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=101, msg='$84000006_WD__84000006_WD_MAIN__0$', duration=3000, delayTick=500)
...
class openingscene_1_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=101, msg='$84000006_WD__84000006_WD_MAIN__2$', duration=3000, delayTick=500)
...
class openingscene_1_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.play_system_sound_in_box(sound='System_WeddingSolo_01')
        # 몬스터 등장음
        self.add_balloon_talk(spawnId=201, msg='$84000006_WD__84000006_WD_MAIN__3$', duration=4000, delayTick=1000) # npc대사 : 결혼식...\n망친다...
        # npc대사 : 남의 행복...\n나의 불행...
        self.add_balloon_talk(spawnId=201, msg='$84000006_WD__84000006_WD_MAIN__4$', duration=4000, delayTick=5000)
...
class GameGuide01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_buff(boxIds=[9002], skillId=99940044, level=1, isPlayer=False, isSkillSet=True)
        ...
        self.side_npc_talk(npcId=11004772, illust='Conder_normal', duration=4000, script='$84000006_WD__84000006_WD_MAIN__5$')
...
class GameGuide02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npcId=11004772, illust='Conder_normal', duration=4000, script='$84000006_WD__84000006_WD_MAIN__6$')
...
class GameGuide03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npcId=11004772, illust='Conder_normal', duration=4000, script='$84000006_WD__84000006_WD_MAIN__7$')
...
class GameGuide04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npcId=11004772, illust='Conder_normal', duration=4000, script='$84000006_WD__84000006_WD_MAIN__8$')
...
class GameGuide05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npcId=11004772, illust='Conder_normal', duration=4000, script='$84000006_WD__84000006_WD_MAIN__9$')
...
class Pinata_Fight(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npcId=11004772, illust='Conder_normal', duration=4000, script='$84000006_WD__84000006_WD_MAIN__12$')
...
class Pinata_Fight2(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(boxIds=[201]):
            self.add_balloon_talk(spawnId=201, msg='$84000006_WD__84000006_WD_MAIN__14$', duration=3000, delayTick=1000) # 몬스터 대사 : 오늘도... 혼자야...
            self.set_timer(timerId='4', seconds=20, startDelay=0, interval=0) # 타이머4 설정 : 타이머UI 감추기용
...
class Pinata_Revive(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=101, msg='$84000006_WD__84000006_WD_MAIN__18$', duration=5000, delayTick=100)
...
class Pinata_Revive2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(triggerIds=[3001], visible=True) # NPC 레인보우 피냐타 이펙트
        # NPC 레인보우 피냐타 대사: 구해주셔서 고마워요!\n결혼 축하해요!
        self.add_balloon_talk(spawnId=101, msg='$84000006_WD__84000006_WD_MAIN__22$', duration=5000, delayTick=100)
...
class Pinata_Fireworks(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=1002, key='Fireworks', value=1)
...
class Finale(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_timer(timerId='5', seconds=150, startDelay=0, interval=1)
        # NPC 레인보우 피냐타: 남은 시간,\n친구들과 재밌게 보내세요!
        self.add_balloon_talk(spawnId=101, msg='$84000006_WD__84000006_WD_MAIN__25$', duration=5000, delayTick=3000)
