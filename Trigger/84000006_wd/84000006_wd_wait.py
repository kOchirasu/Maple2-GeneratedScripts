...
class 대기(trigger_api.Trigger):
    def on_enter(self):
        self.add_balloon_talk(spawnId=102, msg='$84000006_WD__84000006_WD_WAIT__0$', duration=5000, delayTick=1000) # npc대사 : 애프터파티에 오신 것을 환영해요!
...
class 대기2(trigger_api.Trigger):
    def on_enter(self):
        self.add_balloon_talk(spawnId=102, msg='$84000006_WD__84000006_WD_WAIT__1$', duration=5000, delayTick=1000) # npc대사 : 애프터파티에 오신 것을 환영해요!
