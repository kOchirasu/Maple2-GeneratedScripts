...
class 진행중일때20002276(common.Trigger):
    def on_enter(self):
...
class 완료가능할때20002276(common.Trigger):
    def on_enter(self):
...
class 완료시01_50100520(common.Trigger):
    def on_enter(self):
...
class 완료시02_20002277(common.Trigger):
    def on_enter(self):
...
class 완료시03_20002277(common.Trigger):
    def on_enter(self):
...
class 완료시04_20002277(common.Trigger):
    def on_enter(self):
...
class 완료시05_20002277(common.Trigger):
    def on_enter(self):
...
class 완료시06_20002277(common.Trigger):
    def on_enter(self):
...
class 완료시07_20002277(common.Trigger):
    def on_enter(self):
...
class 완료시08_20002277(common.Trigger):
    def on_enter(self):
...
class 완료20002277(common.Trigger):
    def on_enter(self):
...
class 이동52000091(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
