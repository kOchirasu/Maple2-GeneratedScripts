...
class Event_01_02(common.Trigger):
    def on_enter(self):
...
class Event_01_03(common.Trigger):
    def on_enter(self):
...
class Event_02_02(common.Trigger):
    def on_enter(self):
...
class Event_02_03(common.Trigger):
    def on_enter(self):
...
class Event_03_02(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.show_guide_summary(entityId=200, textId=20105201) # 화로를 공격하여 불을 붙이세요
