...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[81004], visible=False)
        ...
        self.set_mesh(trigger_ids=[75011,75012,75013], visible=True, start_delay=1000, interval=500, fade=8) # 물 삭제
        self.set_mesh(trigger_ids=[75001,75002,75003], visible=False, start_delay=1000, interval=500, fade=8) # 물 삭제
...
class Event_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera(trigger_id=80001, enable=True)
...
class Event_02_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.show_guide_summary(entity_id=200, text_id=20105201) # 화로를 공격하여 불을 붙이세요
        self.set_dialogue(type=1, spawn_id=992, script='$02010052_BF__MAIN__4$', time=3, arg5=0) # 카나 말풍선 대사
...
class Event_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera(trigger_id=80002, enable=True)
...
class Event_03_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[9999], auto_target=True) # 공격 카나 생성
