...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[7542], visible=False) # 얼음이 어는 소리
        self.set_mesh(trigger_ids=[6083,6084,6085,6086,6087,6088,6089,6090], visible=False, start_delay=0, interval=0, fade=0) # 얼음!
        self.set_mesh(trigger_ids=[6071,6072,6073,6074,6075,6076,6077,6078,6079,6080,6081,6082], visible=False, start_delay=0, interval=0, fade=0) # 벽 해제
        self.set_effect(trigger_ids=[7005], visible=False) # 횃불에 불이 붙는 이펙트
...
class freeze(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6071,6072,6073,6074,6075,6076,6077,6078,6079,6080,6081,6082], visible=True, start_delay=80, interval=100, fade=8) # 얼음!
...
class burn_state(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6071,6072,6073,6074,6075,6076,6077,6078,6079,6080,6081,6082], visible=False, start_delay=800, interval=100, fade=8) # 벽 해제
        self.set_mesh(trigger_ids=[600001], visible=False, start_delay=0, interval=0, fade=0) # 벽 해제 (투명 벽)
...
class spawn_state(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[510,511,512,513,514,515], auto_target=True) # 카나 정령 몬스터 등장
        self.set_timer(timer_id='1', seconds=1, interval=0)
...
class block_spawn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[6083,6084,6085,6086,6087,6088,6089,6090], visible=True, start_delay=80, interval=500, fade=8) # 얼음!
