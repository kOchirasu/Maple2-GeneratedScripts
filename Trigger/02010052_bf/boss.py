...
class Idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6801,6802,6803,6804,6805,6806,6807,6808,6809,6810,6811,6812,6813,6814,6815,6816,6817,6818,6819,6820,6821,6822,6823,6824,6825,6826,6827,6828,6829,6830,6831,6832,6833,6834,6835,6836,6837,6838,6839,6840,6841,6842,6843,6844,6845,6846,6847,6848,6849,6850,6851,6852,6853,6854,6855,6856,6857,6858,6859,6860,6861,6862,6863,6864,6865,6866,6867,6868,6869,6870,6871,6872,6873,6874,6875,6876,6877,6878,6879,6880,6881,6882,6883,6884,6885,6886,6887,6888,6889,6890,6891,6892,6893,6894,6895,6896,6897,6898,6899,6900], visible=False, start_delay=0, interval=0, fade=0) # 블록 없음
        self.set_effect(trigger_ids=[7031], visible=False) # 횃불에 불이 붙는 이펙트
        self.set_effect(trigger_ids=[7032], visible=False) # 횃불에 불이 붙는 이펙트
        self.set_effect(trigger_ids=[7033], visible=False) # 횃불에 불이 붙는 이펙트
        self.set_effect(trigger_ids=[7034], visible=False) # 횃불에 불이 붙는 이펙트
        self.set_effect(trigger_ids=[7035], visible=False) # 횃불에 불이 붙는 이펙트
        self.set_effect(trigger_ids=[7999], visible=False) # 인트로 사운드
        self.set_effect(trigger_ids=[7910], visible=False) # 카나 텔레포트
        self.set_effect(trigger_ids=[7911], visible=False) # 카나 텔레포트
        self.set_effect(trigger_ids=[7912], visible=False) # 카나 텔레포트
...
class Boss_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6801,6802,6803,6804,6805,6806,6807,6808,6809,6810], visible=True, start_delay=80, interval=70, fade=8) # 얼음!
        self.set_timer(timer_id='1', seconds=1)
...
class Boss_01c(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=995, script='$02010052_BF__BOSS__0$', time=3, arg5=0) # 카나 말풍선 대사
        self.spawn_monster(spawn_ids=[120], auto_target=False) # 화로 (107)
        self.spawn_monster(spawn_ids=[621,622,623,624,625], auto_target=True) # 몬스터 웨이브
...
class burn_state_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6801,6802,6803,6804,6805,6806,6807,6808,6809,6810], visible=False, start_delay=800, interval=100, fade=0) # 벽 해제
        self.set_mesh(trigger_ids=[600003], visible=False, start_delay=800, interval=100, fade=0) # 벽 해제
        self.set_effect(trigger_ids=[7910], visible=True) # 카나 텔레포트
...
class Boss_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6821,6822,6823,6824,6825,6826,6827,6828,6829,6830], visible=True, start_delay=80, interval=70, fade=8) # 얼음!
        self.set_timer(timer_id='1', seconds=1)
...
class Boss_02c(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_guide_summary(entity_id=200, text_id=20105201) # 화로를 공격하여 불을 붙이세요
        self.set_dialogue(type=1, spawn_id=996, script='$02010052_BF__BOSS__2$', time=3, arg5=0) # 카나 말풍선 대사
        self.spawn_monster(spawn_ids=[121], auto_target=False) # 화로 (107)
        self.spawn_monster(spawn_ids=[631,632,633,634,635], auto_target=True) # 몬스터 웨이브
...
class burn_state_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6821,6822,6823,6824,6825,6826,6827,6828,6829,6830], visible=False, start_delay=800, interval=100, fade=0) # 벽 해제
        self.set_mesh(trigger_ids=[600004], visible=False, start_delay=800, interval=100, fade=0) # 벽 해제
        self.set_effect(trigger_ids=[7911], visible=True) # 카나 텔레포트
...
class Boss_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6830,6831,6832,6833,6834,6835,6836,6837,6838,6839,6840], visible=True, start_delay=80, interval=70, fade=8) # 얼음!
        self.set_timer(timer_id='1', seconds=1)
...
class Boss_03c(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_guide_summary(entity_id=200, text_id=20105201) # 화로를 공격하여 불을 붙이세요
        self.set_dialogue(type=1, spawn_id=997, script='$02010052_BF__BOSS__4$', time=3, arg5=0) # 카나 말풍선 대사
        self.spawn_monster(spawn_ids=[641,642,643,644,645], auto_target=True) # 몬스터 웨이브
...
class burn_state_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6830,6831,6832,6833,6834,6835,6836,6837,6838,6839,6840], visible=False, start_delay=800, interval=100, fade=0) # 벽 해제
        self.set_mesh(trigger_ids=[600005], visible=False, start_delay=800, interval=100, fade=0) # 벽 해제
        self.set_effect(trigger_ids=[7912], visible=True) # 카나 텔레포트
...
class Boss_battle_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[6701,6702,6703,6704,6705,6706,6707,6708,6709,6710,6711,6712,6713,6714,6715,6716,6717,6718,6719,6720,6721,6722,6723,6724,6725,6726,6727,6728,6729,6730,6731,6732,6733,6734,6735,6736,6737,6738,6739,6740,6741,6742,6743,6744,6745,6746,6747,6748,6749,6750,6751,6752,6753,6754,6755,6756,6757,6758,6759,6760,6761,6762,6763,6764,6765,6766,6767,6768,6769,6770,6771,6772,6773,6774,6775,6776,6777,6778,6779,6780,6781,6782,6783,6784,6785,6786,6787,6788,6789,6790,6791,6792,6793,6794,6795,6796,6797,6798,6799], visible=False, start_delay=80, interval=50, fade=0) # 벽 해제
...
class Clear_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera(trigger_id=80006, enable=True)
        ...
        self.set_timer(timer_id='5', seconds=5, ara3='1', interval=0)
...
class end(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[6890,6891,6892,6893,6894,6895], visible=False, start_delay=80, interval=10, fade=0) # 벽 해제
