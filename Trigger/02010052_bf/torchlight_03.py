...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=20499, visible=False, initial_sequence='Closed')
        self.set_actor(trigger_id=20501, visible=True, initial_sequence='Closed') # 얼어붙은 문
        self.set_mesh(trigger_ids=[20500], visible=True, start_delay=1, interval=1, fade=1) # 철문
        self.set_effect(trigger_ids=[7002], visible=False) # 횃불에 불이 붙는 이펙트
        self.set_effect(trigger_ids=[7003], visible=False) # 횃불에 불이 붙는 이펙트
    ...
    def on_exit(self) -> None:
        ...
        self.set_actor(trigger_id=8001, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=8002, visible=False, initial_sequence='Dmg_A')
...
class burn_state_complete(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6021,6022,6023,6024,6025,6026,6027,6028,6029,6030,6031,6032], visible=False, start_delay=800, interval=100, fade=8) # 벽 해제
...
class spawn_state(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[5100,5101,5102,5103,5104,5105,5106,5107,5108,5109,5110], visible=False, start_delay=800, interval=100, fade=8) # 카나 위에 있는 벽 해제
        self.set_effect(trigger_ids=[7902], visible=True) # 카나 사라짐
        self.destroy_monster(spawn_ids=[9999]) # 카나 사라짐
        self.set_actor(trigger_id=8100, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=8006, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=8007, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=8008, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=8009, visible=False, initial_sequence='Dmg_A')
        self.set_actor(trigger_id=8010, visible=False, initial_sequence='Dmg_A')
        self.spawn_monster(spawn_ids=[199], auto_target=True) # 얼음이 녹으며 등장하는 몬스터들 (중간)
        self.spawn_monster(spawn_ids=[321,322,323,324,325], auto_target=True) # 얼음이 녹으며 등장하는 몬스터들
...
class monsterkill(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=20501, visible=False, initial_sequence='Closed') # 얼어붙은 문
        self.set_mesh(trigger_ids=[20500], visible=False, start_delay=0, interval=0, fade=0) # 철문
