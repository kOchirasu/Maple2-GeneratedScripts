...
class 라딘에게돌아가_대기(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[9000], questIds=[50001760], questStates=[3]):
...
class 트럭으로가세요_대기(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[9000], questIds=[50001763], questStates=[3]):
...
class 공주님과기사연출_대기(common.Trigger):
    def on_enter(self):
...
class 공주님과기사연출_시작(common.Trigger):
    def on_enter(self):
...
class 공주님과기사연출_스킵완료(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
...
class 공주님과기사연출_종료(common.Trigger):
    def on_enter(self):
...
class 제이든호출_연출준비(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[110])
...
class 제이든호출_연출시작(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 제이든호출_스킵완료(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=4)
...
class 제이든호출_연출종료(common.Trigger):
    def on_enter(self):
        self.reset_camera(interpolationTime=2)
...
class 몬스터추가스폰01(common.Trigger):
    def on_enter(self):
...
class 몬스터추가스폰105(common.Trigger):
    def on_enter(self):
...
class 몬스터추가스폰106(common.Trigger):
    def on_enter(self):
...
class 몬스터추가스폰107(common.Trigger):
    def on_enter(self):
...
class 몬스터추가스폰108(common.Trigger):
    def on_enter(self):
...
class 몬스터추가스폰109(common.Trigger):
    def on_enter(self):
...
class 세리하첫등장연출_대기(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 세리하첫등장연출_준비(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 세리하첫등장연출_시작(common.Trigger):
    def on_enter(self):
...
class 레지스탕스등장01(common.Trigger):
    def on_enter(self):
...
class 레지스탕스등장02(common.Trigger):
    def on_enter(self):
...
class 레지스탕스등장03(common.Trigger):
    def on_enter(self):
...
class 레지스탕스등장04(common.Trigger):
    def on_enter(self):
...
class 세리하첫등장연출_스킵완료(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=4)
...
class 세리하첫등장연출_종료(common.Trigger):
    def on_enter(self):
        self.reset_camera(interpolationTime=2)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
