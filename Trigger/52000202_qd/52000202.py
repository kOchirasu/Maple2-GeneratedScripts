...
class 시공의균열_02_01(common.Trigger):
    def on_enter(self):
...
class 시공의균열_02_02(common.Trigger):
    def on_enter(self):
...
class 시공의균열_03_02(common.Trigger):
    def on_enter(self):
