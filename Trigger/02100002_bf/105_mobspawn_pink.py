...
class Wait(state.State):
    def on_enter(self):
        ...
        destroy_monster(spawnIds=[50100,50075,50050,50025,50001,51001,51002,51003])
        set_effect(triggerIds=[5105], visible=False) # Normal Slime Rebirth Sound
        set_effect(triggerIds=[5205], visible=False) # Abnormal Slime Rebirth Sound
...
class Gauge100_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5105], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[50100], arg2=False) # 100%
...
class Gauge75_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5105], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[50075], arg2=False) # 75%
...
class Gauge50_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5105], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[50050], arg2=False) # 50%
...
class Gauge25_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5105], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[50025], arg2=False) # 25%
...
class Gauge1_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5105], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[50001], arg2=False) # 1%
...
class Spawn_Eater(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5205], visible=True) # Abnormal Slime Rebirth Sound
        create_monster(spawnIds=[51001], arg2=False)
...
class Spawn_Runner(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5205], visible=True) # Abnormal Slime Rebirth Sound
        create_monster(spawnIds=[51002], arg2=False)
