...
class Wait(state.State):
    def on_enter(self):
        ...
        destroy_monster(spawnIds=[10100,10075,10050,10025,10001,11001,11002,11003])
        set_effect(triggerIds=[5101], visible=False) # Normal Slime Rebirth Sound
        set_effect(triggerIds=[5201], visible=False) # Abnormal Slime Rebirth Sound
...
class Gauge100_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5101], visible=True) # Rebirth Sound
        create_monster(spawnIds=[10100], arg2=False) # 100%
...
class Gauge75_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5101], visible=True) # Rebirth Sound
        create_monster(spawnIds=[10075], arg2=False) # 75%
...
class Gauge50_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5101], visible=True) # Rebirth Sound
        create_monster(spawnIds=[10050], arg2=False) # 50%
...
class Gauge25_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5101], visible=True) # Rebirth Sound
        create_monster(spawnIds=[10025], arg2=False) # 25%
...
class Gauge1_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5101], visible=True) # Rebirth Sound
        create_monster(spawnIds=[10001], arg2=False) # 1%
...
class Spawn_Eater(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5201], visible=True) # Abnormal Slime Rebirth Sound
