...
class Wait(state.State):
    def on_enter(self):
        ...
        destroy_monster(spawnIds=[30100,30075,30050,30025,30001,31001,31002,31003])
        set_effect(triggerIds=[5103], visible=False) # Normal Slime Rebirth Sound
        set_effect(triggerIds=[5203], visible=False) # Abnormal Slime Rebirth Sound
...
class Gauge100_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5103], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[30100], arg2=False) # 100%
...
class Gauge75_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5103], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[30075], arg2=False) # 75%
...
class Gauge50_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5103], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[30050], arg2=False) # 50%
...
class Gauge25_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5103], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[30025], arg2=False) # 25%
...
class Gauge1_Normal(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5103], visible=True) # Normal Slime Rebirth Sound
        create_monster(spawnIds=[30001], arg2=False) # 1%
...
class Spawn_Eater(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5203], visible=True) # Abnormal Slime Rebirth Sound
        create_monster(spawnIds=[31001], arg2=False)
...
class Spawn_Runner(state.State):
    def on_enter(self):
        set_effect(triggerIds=[5203], visible=True) # Abnormal Slime Rebirth Sound
        create_monster(spawnIds=[31002], arg2=False)
