...
class 검은화면전환_01(common.Trigger):
    def on_enter(self):
...
class 검은화면전환_02(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 밝은화면전환_01(common.Trigger):
    def on_enter(self):
...
class 다시검은화면_01(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.set_cinematic_ui(type=1)
...
class 다시검은화면_02(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 부상병과대화_01(common.Trigger):
    def on_enter(self):
...
class 부상병과대화_02(common.Trigger):
    def on_enter(self):
...
class 부상병과대화_03(common.Trigger):
    def on_enter(self):
...
class 부상병과대화_04(common.Trigger):
    def on_enter(self):
...
class 부상병과대화_05(common.Trigger):
    def on_enter(self):
...
class 부상병과대화_06(common.Trigger):
    def on_enter(self):
...
class 부상병과대화_07(common.Trigger):
    def on_enter(self):
...
class 부상병과대화_08(common.Trigger):
    def on_enter(self):
