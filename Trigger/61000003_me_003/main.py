...
class 안내03(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[603], visible=True)
        # action name="PlaySystemSoundInBox" arg1="105" arg2="System_Quiz_Ready_01"/
...
class 문제1(common.Trigger):
    def on_enter(self):
        ...
        self.set_achievement(triggerId=100, type='trigger', achieve='dailyquest_start') # 길드 경험치 지급 / boxID="타겟박스id", 0이면 맵전체, type="GuildGainExp의 id" 2가 매시브이벤트
        ...
        self.set_event_ui(type=0, arg2='1,10') # OX 퀴즈 문제 뽑기, arg3=난이도(1~5)
...
class 문제1정답O(common.Trigger):
    def on_enter(self):
        ...
        # action name="아이템을생성한다" arg1="9001,9002,9003,9004,9005,9006,9007,9008,9009,9010,9011,9012,9013,9014,9015,9016,9017,9018,9019,9020,9021,9022,9023,9024,9025,9026,9027,9028,9029,9030,9031,9032,9033,9034,9035,9036,9037,9038,9039,9040,9041,9042,9043,9044,9045,9046,9047,9048,9049"/
        self.set_timer(timerId='5', seconds=5)
...
class 문제1정답X(common.Trigger):
    def on_enter(self):
        ...
        self.set_mesh(triggerIds=[3301,3302,3303,3304,3305,3306,3307,3308,3309,3310,3311,3312,3313,3314,3315,3316,3317,3318,3319,3320,3321,3322,3323,3324,3325,3326,3327,3328,3329,3330,3331,3332,3333,3334,3335,3336,3337,3338,3339,3340,3341,3342,3343,3344,3345,3346,3347,3348,3349,3350,3351,3352,3353,3354,3355], visible=False, arg3=0, delay=0, scale=0)
        self.set_mesh(triggerIds=[3502,3503,3504,3505,3506,3507,3508,3509,3510,3511,3512,3513,3514,3515,3516,3517,3518,3519,3520,3521], visible=False, arg3=0, delay=0, scale=0)
        # action name="아이템을생성한다" arg1="9101,9102,9103,9104,9105,9106,9107,9108,9109,9110,9111,9112,9113,9114,9115,9116,9117,9118,9119,9120,9121,9122,9123,9124,9125,9126,9127,9128,9129,9130,9131,9132,9133,9134,9135,9136,9137,9138,9139,9140,9141,9142,9143,9144,9145,9146,9147,9148,9149"/
        self.set_timer(timerId='5', seconds=5)
