...
class 대기(common.Trigger):
    def on_enter(self):
        self.set_skill(triggerIds=[1100], enable=False)
        self.set_effect(triggerIds=[1101], visible=False) # RockDrop
...
class 낙하01시작(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[1101], visible=True) # RockDrop
...
class 낙하01완료(common.Trigger):
    def on_enter(self):
        ...
        self.set_skill(triggerIds=[1100], enable=True)
