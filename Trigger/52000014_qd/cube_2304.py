...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[2304], visible=True, start_delay=0, interval=0, fade=0)
        self.set_effect(trigger_ids=[12304], visible=False) # Fire Cast Sound
...
class 무너짐01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2304], visible=False, start_delay=200, interval=0, fade=1)
