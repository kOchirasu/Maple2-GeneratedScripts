...
class 대기(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[7000,7001,7002,7003,7004,7005,7006,7007,7008,7009], visible=False, arg3=0, arg4=0, arg5=0)
...
class 패턴01생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7000], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7000], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴01생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7002], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7002], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴01생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7007], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7007], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴02생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7004], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴02낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7004], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴02생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7008], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴02낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7008], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7009], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7009], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7006], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7006], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7003], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7003], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴04생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7001], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴04낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7001], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴04생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7005], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴04낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7005], visible=False, arg3=0, arg4=0, arg5=500)
