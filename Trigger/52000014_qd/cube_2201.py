...
class 대기(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.user_detected(boxIds=[92201]):
...
class 무너짐01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[2202], visible=False, arg3=500, delay=0, scale=1)
        self.set_mesh(triggerIds=[2204], visible=False, arg3=750, delay=0, scale=1)
