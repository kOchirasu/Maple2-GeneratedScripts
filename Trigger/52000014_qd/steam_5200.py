...
class 발사01(common.Trigger):
    def on_enter(self):
        ...
        self.create_monster(spawnIds=[520], animationEffect=False)
...
class 발사02(common.Trigger):
    def on_enter(self):
        ...
        self.create_monster(spawnIds=[521], animationEffect=False)
...
class 딜레이02(common.Trigger):
    def on_enter(self):
        ...
        self.destroy_monster(spawnIds=[520])
...
class 초기화(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[521])
