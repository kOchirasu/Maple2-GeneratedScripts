...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[7200,7201,7202,7203,7204,7205,7206,7207,7208,7209], visible=False, arg3=0, delay=0, scale=0)
...
class 패턴01생성01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7200], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴01낙하01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7200], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴01생성02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7202], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴01낙하02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7202], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴01생성03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7207], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴01낙하03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7207], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴02생성02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7204], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴02낙하02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7204], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴02생성03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7208], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴02낙하03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7208], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴03생성01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7209], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴03낙하01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7209], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴03생성02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7206], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴03낙하02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7206], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴03생성03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7203], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴03낙하03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7203], visible=False, arg3=0, delay=0, scale=500)
...
class 패턴04생성01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7201], visible=True, arg3=0, delay=0, scale=1000)
...
class 패턴04낙하01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[7201], visible=False, arg3=0, delay=0, scale=500)
