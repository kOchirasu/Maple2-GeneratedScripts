...
class 대기(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[7500,7501,7502,7503,7504,7505,7506,7507,7508,7509], visible=False, arg3=0, arg4=0, arg5=0)
...
class 패턴01생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7500], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7500], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴01생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7502], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7502], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴01생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7507], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7507], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴02생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7504], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴02낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7504], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴02생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7508], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴02낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7508], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7509], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7509], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7506], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7506], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7503], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7503], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴04생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7501], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴04낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7501], visible=False, arg3=0, arg4=0, arg5=500)
