...
class 대기(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[7800,7801,7802,7803,7804,7805,7806,7807,7808,7809], visible=False, arg3=0, arg4=0, arg5=0)
...
class 시작딜레이01(state.State):
    def on_enter(self):
        set_timer(timerId='201', seconds=1)

    def on_tick(self) -> state.State:
        if time_expired(timerId='201'):
            return 랜덤생성01()
...
class 패턴01생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7801], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7801], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴01생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7805], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7805], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴01생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7807], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴01낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7807], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴02생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7808], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴02낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7808], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴02생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7804], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴02낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7804], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴02생성03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7802], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴02낙하03(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7802], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7809], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하01(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7809], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7803], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하02(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7803], visible=False, arg3=0, arg4=0, arg5=500)
...
class 패턴03생성04(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7806], visible=True, arg3=0, arg4=0, arg5=1000)
...
class 패턴03낙하04(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[7806], visible=False, arg3=0, arg4=0, arg5=500)
