...
class 시작(common.Trigger):
    def on_enter(self):
        ...
        self.side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300006_PHASE_5__1$', duration=3176)
