...
class 패이즈_4_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300005_PHASE_4__0$', duration=3176)
...
class 추가대화(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Angry', script='$52100301_QD__300005_PHASE_4__1$', duration=3176)
...
class 추가대화_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300005_PHASE_4__2$', duration=3176)
...
class 엘리베이터_대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300005_PHASE_4__3$', duration=3176)
