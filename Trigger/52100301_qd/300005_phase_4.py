...
class 패이즈_4_시작(state.State):
    def on_enter(self):
        ...
        side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300005_PHASE_4__0$', duration=3176)
...
class 추가대화(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=29500101, illust='ArcheonBlack_Angry', script='$52100301_QD__300005_PHASE_4__1$', duration=3176)
...
class 추가대화_2(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300005_PHASE_4__2$', duration=3176)
...
class 엘리베이터_대기(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300005_PHASE_4__3$', duration=3176)
...
class 길막열기(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$52100301_QD__300005_PHASE_4__4$', arg3='4000')
