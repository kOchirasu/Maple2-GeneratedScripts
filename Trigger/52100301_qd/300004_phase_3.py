...
class 패이즈_3_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300004_PHASE_3__0$', duration=3176)
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300004_PHASE_3__1$', duration=3176)
