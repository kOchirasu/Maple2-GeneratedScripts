...
class 패이즈_3_시작(state.State):
    def on_enter(self):
        ...
        side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300004_PHASE_3__0$', duration=3176)
        side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$52100301_QD__300004_PHASE_3__1$', duration=3176)
...
class 가이드(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$52100301_QD__300004_PHASE_3__2$', arg3='4000')
