...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[301,302,303,304,305,306,307,308,309,310,311,312,313,314,315,316,317,318,319,320,321,322,323,324,325,326,327,328,329,330,331,332,333,334,335,336,337,338,339,340,341,342,343,344,345,346,347,348,349,350,351,352,353,354,355], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[400,401,402,403,404,405,406,407,408,409,410,411,412,413,414,415,416], visible=False, start_delay=0, interval=0, fade=0)
...
class 엘리트스폰(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_random_mesh(trigger_ids=[301,302,303,304,305,306,307,308,309,310,311,312,313,314,315,316,317,318,319,320,321,322,323,324,325,326,327,328,329,330,331,332,333,334,335,336,337,338,339,340,341,342,343,344,345,346,347,348,349,350,351,352,353,354,355], visible=False, start_delay=56, interval=0, fade=30)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2001]):
            ...
            # mesh.xml 에 있던 내용 2001스폰 아이디의 몬스터가 전투 상태로 되기 전에 죽어버리면 mesh.xml 내용이 작동 안하는 버그가 있어서 mesh.xml  내용을 이 main.xml에 포함시키는 형태로 수정했음
            self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
            self.set_mesh(trigger_ids=[400,401,402,403,404,405,406,407,408,409,410,411,412,413,414,415,416], visible=True, start_delay=0, interval=100, fade=0)
