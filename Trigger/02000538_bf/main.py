...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[5000], visible=False)
        ...
        self.set_skill(trigger_ids=[9005], enable=False)
...
class ready2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[101,1011,1012,1013,1014], auto_target=True)
...
class 방으로이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[1081], auto_target=True)
        self.side_npc_talk(npc_id=11004644, illust='SlaveMan3_normal', duration=4000, script='$02000538_BF__MAIN__2$')
        self.spawn_monster(spawn_ids=[1015,1016,1017], auto_target=True)
...
class 방몬스터생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[102,1021,1022], auto_target=True)
...
class 첫번째전투판파괴(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[1023,1024], auto_target=True)
...
class 세번째판몬스터생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[103,1031,1032,1033], auto_target=True)
...
class 몬스터추가생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[104,1041,1042,1043,1044], auto_target=True)
...
class 몬스터추가생성2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[107,1071], auto_target=True)
...
class 다섯번째판몬스터생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[1082], auto_target=True)
        self.enable_spawn_point_pc(spawn_id=1, is_enable=False)
        self.enable_spawn_point_pc(spawn_id=2, is_enable=True)
        self.spawn_monster(spawn_ids=[105,1051,1052,1053,1054,1055], auto_target=True)
