...
class 세번째판몬스터생성(common.Trigger):
    def on_enter(self):
...
class 다섯번째판몬스터생성(common.Trigger):
    def on_enter(self):
...
class 마지막전투판파괴2(common.Trigger):
    def on_enter(self):
