...
class ready_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000442_BF__MAIN__0$', time=2, arg5=0)
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000442_BF__MAIN__6$', time=2, arg5=0)
...
class boss_leftTurn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=302, script='$02000442_BF__MAIN__7$', time=3, arg5=0)
...
class boss_rightTurn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.move_npc(spawn_id=102, patrol_name='MS2PatrolData_2003')
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_2003')
        self.set_dialogue(type=1, spawn_id=301, script='$02000442_BF__MAIN__9$', time=3, arg5=0)
...
class boss_leftTurn_b_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 난파가 될 시 멈출 블록들
        self.set_dialogue(type=1, spawn_id=305, script='$02000442_BF__MAIN__10$', time=3, arg5=0)
...
class Ending_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.set_dialogue(type=1, spawn_id=104, script='$02000442_BF__MAIN__11$', time=2, arg5=0)
