...
class Event_A_Ready(common.Trigger):
    def on_enter(self):
...
class Event_A_01(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=8003, visible=False, initialSequence='Idle_A')
...
class Event_B_01(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_WhiteFlash.xml')
...
class Event_B_02(common.Trigger):
    def on_enter(self):
...
class Event_C_01(common.Trigger):
    def on_enter(self):
...
class Event_C_02(common.Trigger):
    def on_enter(self):
...
class Event_C_03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class Event_C_04(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class Event_C_05(common.Trigger):
    def on_enter(self):
...
class Event_C_06(common.Trigger):
    def on_enter(self):
...
class Event_C_07(common.Trigger):
    def on_enter(self):
...
class Event_C_08(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=3, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class Event_C_09(common.Trigger):
    def on_enter(self):
...
class Event_C_10(common.Trigger):
    def on_enter(self):
...
class Event_C_11(common.Trigger):
    def on_enter(self):
...
class Event_C_12(common.Trigger):
    def on_enter(self):
...
class Event_C_13(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5002], visible=False)
        self.set_effect(triggerIds=[5003], visible=False)
...
class Event_C_14(common.Trigger):
    def on_enter(self):
...
class Event_C_15(common.Trigger):
    def on_enter(self):
...
class Event_C_Skip_01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class Event_C_Skip_02(common.Trigger):
    def on_enter(self):
        self.set_pc_emotion_loop(sequenceName='Down_Idle_A', duration=3000)
...
class Event_C_Exit(common.Trigger):
    def on_enter(self):
...
class Npc_All_Del(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[401])
