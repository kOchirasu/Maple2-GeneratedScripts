...
class 이도공간으로_01(common.Trigger):
    def on_enter(self):
...
class 이도공간으로_02(common.Trigger):
    def on_enter(self):
...
class 떠나기전_04_01(common.Trigger):
    def on_enter(self):
