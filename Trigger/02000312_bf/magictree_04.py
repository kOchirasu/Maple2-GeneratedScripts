...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1030,1031,1032,1033,1034], visible=True, start_delay=0, interval=0, fade=0) # 덩굴
...
class Remove(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_random_mesh(trigger_ids=[1030,1031,1032,1033,1034], visible=False, start_delay=5, interval=500, fade=100) # 덩굴
