...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1070,1071,1072], visible=True, start_delay=0, interval=0, fade=0) # 덩굴
...
class Remove(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_random_mesh(trigger_ids=[1070,1071,1072], visible=False, start_delay=3, interval=500, fade=100) # 덩굴
