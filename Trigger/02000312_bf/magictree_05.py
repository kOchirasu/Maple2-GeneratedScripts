...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1040,1041,1042,1043,1044], visible=True, start_delay=0, interval=0, fade=0) # 덩굴
...
class Remove(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_random_mesh(trigger_ids=[1040,1041,1042,1043,1044], visible=False, start_delay=5, interval=500, fade=100) # 덩굴
