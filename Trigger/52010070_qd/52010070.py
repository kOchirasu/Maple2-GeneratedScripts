...
class 룬블즈_일어남_02(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_03(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_04(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_04_01(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_05(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
...
class 룬블즈_일어남_07(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_08(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_09(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_09_01(common.Trigger):
    def on_enter(self):
...
class 룬블즈_일어남_10(common.Trigger):
    def on_enter(self):
