...
class 룬블즈_일어남_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=107, sequence_name='Bore_A', duration=4000)
        self.set_npc_emotion_loop(spawn_id=109, sequence_name='Attack_01_A', duration=4000)
...
class 에레브흑화_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004128, align='left', illust_id='Ishura_normal', msg='$52010070_QD__52010070__0$', duration=4000)
        self.add_cinematic_talk(npc_id=11004191, align='left', illust_id='11004022', msg='$52010070_QD__52010070__1$', duration=4000)
        self.add_cinematic_talk(npc_id=11004128, align='left', illust_id='Ishura_normal', msg='$52010070_QD__52010070__2$', duration=3000)
