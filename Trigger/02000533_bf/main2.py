...
class 서브몬스터1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=607, sequence_name='Sit_Down_A', duration=10000000)
        self.set_npc_emotion_loop(spawn_id=608, sequence_name='Sit_Down_A', duration=10000000)
        self.set_npc_emotion_loop(spawn_id=610, sequence_name='Bore_A', duration=10000000)
        self.add_balloon_talk(spawn_id=601, msg='$02000533_BF__MAIN2__0$', duration=3500, delay_tick=0)
...
class 서브몬스터3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[6601,6602,6607,6608,6609,6610], auto_target=True)
