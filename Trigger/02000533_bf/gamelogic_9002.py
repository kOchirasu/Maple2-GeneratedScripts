...
class 라운드1시작전UI(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__0$', arg3='3000')

    def on_tick(self) -> state.State:
        if wait_tick(waitTick=4000):
            lock_my_pc(isLock=True)
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__1$', arg3='6000')
...
class 라운드1진행(state.State):
    def on_tick(self) -> state.State:
        if widget_condition(type='TypingGame', name='Result', condition='1'):
            ...
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__2$', arg3='3000')
            return 라운드종료()
        if widget_condition(type='TypingGame', name='Result', condition='0'):
            widget_action(type='Round', func='RoundResult', widgetArg='0')
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__3$', arg3='3000')
            return 라운드종료()


class 라운드2시작전UI(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__4$', arg3='3000')

    def on_tick(self) -> state.State:
        if wait_tick(waitTick=4000):
            lock_my_pc(isLock=True)
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__5$', arg3='4000')
...
class 라운드2진행(state.State):
    def on_tick(self) -> state.State:
        if widget_condition(type='TypingGame', name='Result', condition='1'):
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__6$', arg3='3000')
            widget_action(type='Round', func='RoundResult', widgetArg='1')
            return 라운드종료()
        if widget_condition(type='TypingGame', name='Result', condition='0'):
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__7$', arg3='3000')
            widget_action(type='Round', func='RoundResult', widgetArg='0')
            return 라운드종료()
...
class 라운드3시작전UI(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__8$', arg3='3000')

    def on_tick(self) -> state.State:
        if wait_tick(waitTick=4000):
            lock_my_pc(isLock=True)
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__9$', arg3='3000')
...
class 라운드3진행(state.State):
    def on_tick(self) -> state.State:
        if widget_condition(type='TypingGame', name='Result', condition='1'):
            lock_my_pc(isLock=True)
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__10$', arg3='3000')
            widget_action(type='Round', func='RoundResult', widgetArg='1')
            return 라운드종료()
        if widget_condition(type='TypingGame', name='Result', condition='0'):
            set_event_ui(type=1, arg2='$02000533_BF__GAMELOGIC_9002__11$', arg3='3000')
            widget_action(type='Round', func='RoundResult', widgetArg='0')
            return 라운드종료()
...
class 게임성공종료(state.State):
    def on_enter(self):
        set_user_value(triggerId=9001, key='GameLogicEnd', value=1)
...
class 게임실패종료(state.State):
    def on_enter(self):
        set_user_value(triggerId=9001, key='GameLogicEnd', value=2)
        set_user_value(key='GameLogicStart', value=999) # 코드는 테스트 후 지워주세요
