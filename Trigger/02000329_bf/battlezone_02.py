...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[6603,6604], visible=False)
        self.set_mesh(trigger_ids=[1511,1512,1513,1514,1515,1516,1517,1518,1519,1520], visible=True, start_delay=0, interval=1000, fade=0)
...
class 섹터개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[19992], visible=False)
        self.set_mesh(trigger_ids=[1511,1512,1513,1514,1515,1516,1517,1518,1519,1520], visible=False, start_delay=0, interval=0, fade=10)
