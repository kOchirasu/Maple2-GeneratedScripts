...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[6605,6606,6607,6608], visible=False)
        self.set_mesh(trigger_ids=[1521,1522,1523,1524,1525,1526,1527,1528,1529,1530], visible=True, start_delay=0, interval=1000, fade=0)
...
class 섹터개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[19993], visible=False)
        self.set_mesh(trigger_ids=[1521,1522,1523,1524,1525,1526,1527,1528,1529,1530], visible=False, start_delay=0, interval=0, fade=10)
