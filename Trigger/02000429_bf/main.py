...
class 전멸던전실패연출01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npcId=11003536, illust='tristan_normal', duration=4000, script='$02000410_BF__ClearCheck__10$')
...
class 최종성공처리(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entityId=20041012, textId=20041012) # 인페르녹 몰아내기 성공 알림 메시지
    ...
    def on_exit(self) -> None:
        self.hide_guide_summary(entityId=20041012)
        # 인페르녹 몰아내기 성공 알림 메시지
