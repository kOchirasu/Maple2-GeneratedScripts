...
class 전투시작03(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(npcId=11003536, illust='infernog_nomal', duration=8900, script='$02000410_BF__PopUpCinema__2$', voice='ko/Monster/60000724')

    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=8900):
