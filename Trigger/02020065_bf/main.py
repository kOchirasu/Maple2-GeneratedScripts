...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[10001], visible=False)
        self.set_effect(trigger_ids=[10002], visible=False)
...
class 딜레이(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=998, enable=True)
...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023,2024,2025,2026,2027,2028,2029,2030,2031,2032], visible=False)
        ...
        # <무적 오브젝트 생성>
        self.set_user_value(trigger_id=99990002, key='Battle_1_SpawnStart', value=1)
        # <웨이브 시작>
...
class 포탑페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(trigger_id=99990003, key='Battle_2_Start', value=1)
        # <포탑 생성>
...
class 보스페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__4$')
        self.set_user_value(trigger_id=99990004, key='Battle_3_Start', value=1)
        self.set_timer(timer_id='1', seconds=180, start_delay=1, interval=1, v_offset=60)
        # <3라운드 게임 플레이 타임 설정>
...
class 성공_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__5$')
        self.set_user_value(trigger_id=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(trigger_id=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(trigger_id=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(trigger_id=99990005, key='Battle_2_SpawnStart', value=0)
...
class 성공_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_smile', duration=5000, script='$02020065_BF__MAIN__6$')
...
class 실패_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__7$')
        self.set_user_value(trigger_id=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(trigger_id=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(trigger_id=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(trigger_id=99990005, key='Battle_2_SpawnStart', value=0)
...
class 실패_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_normal', duration=5000, script='$02020065_BF__MAIN__8$')
...
class 실패(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.destroy_monster(spawn_ids=[-1])
        self.field_war_end(is_clear=False)
