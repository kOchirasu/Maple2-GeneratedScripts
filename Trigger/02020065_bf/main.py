...
class 대기(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[4001], visible=False) # <kfm이 없는 크리티아스 나무 더미>
...
class 딜레이(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02020065_BF__MAIN__0$', arg3='5000')
...
class 방폭(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02020065_BF__MAIN__1$', arg3='10000')
...
class 시작(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02020065_BF__MAIN__2$', arg3='5000')
...
class 포탑페이즈(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02020065_BF__MAIN__3$', arg3='5000')
...
class 보스페이즈(state.State):
    def on_enter(self):
        ...
        side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__4$')
...
class 성공_세팅(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__5$')
        set_user_value(triggerId=99990002, key='Battle_1_SpawnStart', value=0)
        set_user_value(triggerId=99990003, key='Battle_2_Start', value=0)
        set_user_value(triggerId=99990004, key='Battle_3_Start', value=0)
        set_user_value(triggerId=99990005, key='Battle_2_SpawnStart', value=0)
...
class 성공_추가대사(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003533, illust='Bliche_smile', duration=5000, script='$02020065_BF__MAIN__6$')
...
class 실패_세팅(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__MAIN__7$')
        set_user_value(triggerId=99990002, key='Battle_1_SpawnStart', value=0)
        set_user_value(triggerId=99990003, key='Battle_2_Start', value=0)
        set_user_value(triggerId=99990004, key='Battle_3_Start', value=0)
        set_user_value(triggerId=99990005, key='Battle_2_SpawnStart', value=0)
...
class 실패_추가대사(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020065_BF__MAIN__8$')
