...
class 대기(state.State):
    def on_enter(self):
        ...
        start_combine_spawn(groupId=[505], isStart=False) # combinespawngroup 테이블 참조
...
class 스폰_2(state.State):
    def on_enter(self):
        set_timer(timerId='1', seconds=45, clearAtZero=True)
        set_onetime_effect(id=1, enable=False, path='BG/Common/Sound/Eff_System_Dark_Intro_Chord_01.xml')
...
class 스폰_3(state.State):
    def on_enter(self):
        set_timer(timerId='2', seconds=45, clearAtZero=True)
        set_onetime_effect(id=1, enable=False, path='BG/Common/Sound/Eff_System_Dark_Intro_Chord_01.xml')
...
class 스폰_4(state.State):
    def on_enter(self):
        set_timer(timerId='3', seconds=45, clearAtZero=True)
        set_onetime_effect(id=1, enable=False, path='BG/Common/Sound/Eff_System_Dark_Intro_Chord_01.xml')
