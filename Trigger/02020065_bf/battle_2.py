...
class 대기(state.State):
    def on_enter(self):
        ...
        start_combine_spawn(groupId=[10000603], isStart=False) # 거대화 보급 상자
        start_combine_spawn(groupId=[10000604], isStart=False)
...
class 포탑소환_1(state.State):
    def on_enter(self):
        start_combine_spawn(groupId=[10000603], isStart=True) # 상자 소환 1
...
class 추가대사_1(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020065_BF__BATTLE_2__0$')
...
class 추가대사_2(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020065_BF__BATTLE_2__1$')
...
class 추가대사_3(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020065_BF__BATTLE_2__2$')
...
class 추가대사_4(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02020065_BF__BATTLE_2__3$', arg3='5000')
...
class 포탑소환_2(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020065_BF__BATTLE_2__4$')
...
class 포탑소환_3(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020065_BF__BATTLE_2__5$')
...
class 종료대기(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003536, illust='Neirin_smile', duration=5000, script='$02020065_BF__BATTLE_2__6$')
