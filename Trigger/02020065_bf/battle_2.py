...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(group_id=[10000603], is_start=False) # 거대화 보급 상자
        self.start_combine_spawn(group_id=[10000604], is_start=False)
...
class 추가대사_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_normal', duration=5000, script='$02020065_BF__BATTLE_2__2$')
...
class 포탑소환_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_surprise', duration=5000, script='$02020065_BF__BATTLE_2__4$')
...
class 포탑소환_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_surprise', duration=5000, script='$02020065_BF__BATTLE_2__5$')
...
class 종료대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_smile', duration=5000, script='$02020065_BF__BATTLE_2__6$')
