...
class 대기(common.Trigger):
    def on_enter(self):
        ...
        self.start_combine_spawn(groupId=[10000605], isStart=False)
...
class 보스_무적페이즈(common.Trigger):
    def on_enter(self):
        ...
        self.start_combine_spawn(groupId=[10000603], isStart=True)
        self.start_combine_spawn(groupId=[10000605], isStart=True)
...
class 보스_추가대사1(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020065_BF__BATTLE_3__2$')
...
class 보스_추가대사2(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020065_BF__BATTLE_3__3$')
