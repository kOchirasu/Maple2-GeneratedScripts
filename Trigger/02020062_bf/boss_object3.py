...
class 대기(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000113], state=2)
...
class 레버3_발동(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000113], state=1)
    ...
    def on_tick(self) -> common.Trigger:
        ...
        if self.all_of():
            return 종료(self.ctx)
        if self.object_interacted(interactIds=[12000113], stateValue=0):
