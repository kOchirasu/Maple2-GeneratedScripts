...
class 오브젝트소환(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=99990024, key='MovePanel01', value=1) # 이동 발판 트리거 생성
        self.set_user_value(triggerId=99990025, key='MovePanel02', value=1) # 이동 발판 트리거 생성
        self.set_user_value(triggerId=99990026, key='MovePanel03', value=1) # 이동 발판 트리거 생성
        self.set_user_value(triggerId=99990027, key='MovePanel04', value=1) # 이동 발판 트리거 생성
...
class 추가대사_1(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020062_BF__BATTLE_2__0$')
...
class 추가대사_2(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020062_BF__BATTLE_2__1$')
...
class 추가대사_3(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020062_BF__BATTLE_2__2$')
...
class 오브젝트소환_클리어(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=99990004, key='ObjectStart', value=2)
        self.set_user_value(triggerId=99990005, key='ObjectStart', value=2)
        self.set_user_value(triggerId=99990006, key='ObjectStart', value=2)
