...
class 발판초기화(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_breakable(trigger_ids=[2300,2301,2302,2303,2304,2305,2306,2307,2308], enable=False)
        self.set_visible_breakable_object(trigger_ids=[2300,2301,2302,2303,2304,2305,2306,2307,2308], visible=False)
