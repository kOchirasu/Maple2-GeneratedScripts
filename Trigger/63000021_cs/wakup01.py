...
class JaceyWalkIn01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class JaceyWalkIn02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=2000):
            return Trialogue01(self.ctx)


class Trialogue01(common.Trigger):
    def on_enter(self):
...
class Trialogue02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Trialogue03(common.Trigger):
    def on_enter(self):
...
class Trialogue04(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7101], visible=False) # Voice Bravo 00001458
...
class Trialogue05(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Talk_A')
...
class Trialogue06(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7002], visible=False) # Voice Jabeth 00001547
        self.set_npc_emotion_sequence(spawnId=301, sequenceName='Idle_A')
        self.remove_cinematic_talk()
...
class Trialogue07(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Talk_A')
...
class Trialogue08(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7102], visible=False) # Voice Bravo 00001459
        self.set_npc_emotion_sequence(spawnId=201, sequenceName='Idle_A')
        self.remove_cinematic_talk()
...
class Trialogue09(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Talk_A')
...
class Trialogue10(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class TwoMenWalkOut01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class TwoMenWalkOut02(common.Trigger):
    def on_enter(self):
...
class TwoMenWalkOut03(common.Trigger):
    def on_enter(self):
...
class TwoMenWalkOut04(common.Trigger):
    def on_enter(self):
...
class TwoMenWalkOut05(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7103], visible=False) # Voice Bravo 00001525 monologue
...
class TwoMenWalkOut06(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7003], visible=False) # Voice Jabeth 00001596 monologue
...
class TwoMenWalkOut07(common.Trigger):
    def on_enter(self):
...
class TwoMenWalkOut08(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7104], visible=False) # Voice Bravo 00001526 monologue
...
class StandUp01(common.Trigger):
    def on_enter(self):
...
class CallNextRoom05(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[6000], visible=True) # RadioInterference
...
class CallNextRoom06(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class SayGoodBye01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class SayGoodBye02(common.Trigger):
    def on_enter(self):
...
class SayGoodBye03(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
