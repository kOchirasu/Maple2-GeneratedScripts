...
class Wait(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000245], state=2) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001141 걸어서 71001041 제거
...
class TouchingInNumericalOrder_Success(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000245], state=1) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001141 걸어서 71001041 제거
