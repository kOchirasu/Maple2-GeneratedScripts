...
class CheckAnswer01_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000058], state=1)
        # Lever F
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000063], state=1)
        # Lever A
...
class CheckAnswer04_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000064], state=1)
        # Lever B
...
class CheckAnswer05_Delay(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[12000065], state=1)
        # Lever B
