...
class MelodyPlay01_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11202], visible=True) # Bell F
        set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_orange') # Bell F
...
class MelodyPlay01_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay03_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11204], visible=True) # Bell A
        set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_green') # Bell A
...
class MelodyPlay03_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11205], visible=True) # Bell B
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_blue') # Bell B
...
class MelodyPlay04_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell B
...
class MelodyPlay05_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11202], visible=True) # Bell HighC
        set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_orange') # Bell HighC
...
class MelodyPlay05_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell HighC
...
class CheckAnswer01_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000059], state=1) # Lever F
...
class CheckAnswer03_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000061], state=1) # Lever A
...
class CheckAnswer04_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000062], state=1) # Lever B
...
class CheckAnswer05_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000059], state=1) # Lever B
