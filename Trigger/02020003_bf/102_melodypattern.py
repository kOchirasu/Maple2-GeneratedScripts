...
class MelodyPlay01_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11201], visible=True) # Bell F
        set_actor(triggerId=11001, visible=True, initialSequence='ks_quest_musical_B01_red') # Bell F
...
class MelodyPlay01_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11001, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay04_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11208], visible=True) # Bell B
        set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_pink') # Bell B
...
class MelodyPlay04_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell B
...
class MelodyPlay05_Start(state.State):
    def on_enter(self):
        ...
        set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_yellow') # Bell HighC
...
class CheckAnswer01_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000058], state=1) # Lever F
