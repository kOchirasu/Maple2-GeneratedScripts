...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11206], visible=True) # Bell D
        self.set_actor(triggerId=11006, visible=True, initialSequence='ks_quest_musical_B01_navy') # Bell D
...
class MelodyPlay02_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11006, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell D
...
class CheckAnswer02_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000063], state=1) # Lever D
...
class CheckAnswer04_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000061], state=1) # Lever B
