...
class 클라디아대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=2000, sequence_name='Bore_A', duration=1333)
        self.add_cinematic_talk(npc_id=11004419, msg='$52100103_QD__MAIN__0$', duration=3000, align='left')
...
class 마를레네대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_3sec.xml')
        self.set_npc_emotion_loop(spawn_id=1000, sequence_name='Talk_A', duration=1333)
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__1$', duration=3000, align='left')
...
class 마를레네대사2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_rotation(spawn_id=1000, rotation=-45)
        self.set_npc_rotation(spawn_id=2000, rotation=45)
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__2$', duration=2000, align='left')
        self.add_cinematic_talk(npc_id=11004419, msg='$52100103_QD__MAIN__3$', duration=2000, align='left')
        self.set_npc_emotion_loop(spawn_id=3, sequence_name='Bore_A', duration=1333)
        self.select_camera(trigger_id=100, enable=True)
...
class 투르카대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004430, msg='$52100103_QD__MAIN__4$', duration=3000, align='left')
...
class PC돌아보기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=200, enable=True)
...
class 포탈오픈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=1002, enable=True)
...
class PC대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__5$', duration=3000, align='left')
...
class 투르카이동1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=1003, enable=True)
...
class PC이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004430, msg='$52100103_QD__MAIN__6$', duration=3000, align='left')
...
class PC말풍선대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52100103_QD__MAIN__7$', time=3)
...
class PC공격자세(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_loop(sequence_name='Attack_Idle_A', duration=30000)
...
class 투르카대사협박1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=202, rotation=45)
        self.set_npc_rotation(spawn_id=201, rotation=-45)
        self.set_npc_rotation(spawn_id=200, rotation=15)
        self.set_npc_rotation(spawn_id=203, rotation=-15)
        self.add_cinematic_talk(npc_id=11004430, msg='$52100103_QD__MAIN__8$', duration=3000, align='left')
        self.set_npc_emotion_loop(spawn_id=300, sequence_name='Bore_A', duration=1333)
...
class 마를레네협박(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__9$', duration=3000, align='left')
        self.set_npc_emotion_loop(spawn_id=1001, sequence_name='Talk_A', duration=1333)
...
class 투르카대사협박2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004430, msg='$52100103_QD__MAIN__10$', duration=6000, align='left')
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__11$', duration=2000, align='left')
        self.add_cinematic_talk(npc_id=11004430, msg='$52100103_QD__MAIN__12$', duration=3000, align='left')
        self.set_npc_emotion_loop(spawn_id=300, sequence_name='Bore_A', duration=1333)
...
class 클라디아대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004385, msg='$52100103_QD__MAIN__13$', duration=2000, align='left')
        self.add_cinematic_talk(npc_id=11004385, msg='$52100103_QD__MAIN__14$', duration=3500, align='left')
...
class 마를레네대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__15$', duration=2000, align='left')
        self.set_npc_rotation(spawn_id=1001, rotation=45)
...
class 클라디아마를레네바라보기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=2001, rotation=-90)
...
class 클라디아대사2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=2001, sequence_name='Talk_A', duration=1333)
        self.add_cinematic_talk(npc_id=11004385, msg='$52100103_QD__MAIN__16$', duration=4000, align='left')
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__17$', duration=3000, align='left')
...
class 투르카대사3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004430, msg='$52100103_QD__MAIN__18$', duration=3000, align='left')
        self.set_npc_emotion_loop(spawn_id=300, sequence_name='Bore_A', duration=1333)
...
class 클라디아퇴장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[600], visible=True)
        self.select_camera(trigger_id=1004, enable=True)
...
class 마를레네엔딩대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004395, msg='$52100103_QD__MAIN__19$', duration=2000, align='left')
