...
class Boss01Talk01(trigger_api.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11003068, script='$02000452_BF__01_BOSSBATTLE__0$', arg4=4) # 설눈이
...
class Boss01Talk02(trigger_api.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11003069, script='$02000452_BF__01_BOSSBATTLE__1$', arg4=5) # 에르다
...
class Boss02Talk01(trigger_api.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11003068, script='$02000452_BF__01_BOSSBATTLE__0$', arg4=3) # 설눈이
...
class Boss02Talk02(trigger_api.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11003069, script='$02000452_BF__01_BOSSBATTLE__1$', arg4=4) # 에르다
