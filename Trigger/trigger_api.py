...
class Trigger:
    ...
    def add_buff(self, box_ids: List[int], skill_id: int, level: int, is_player: bool=True, is_skill_set: bool=True, feature: str=None) -> None:
        """버프를걸어준다
    ...
    def add_cinematic_talk(self, npc_id: int, illust_id: str=None, msg: str=None, duration: int=0, align: Align=Align.Top, delay_tick: int=0, illust: str=None) -> None:
        """AddCinematicTalk
    ...
    def add_effect_nif(self, spawn_id: int, nif_path: str=None, is_outline: bool=False, scale: float=0.0, rotate_z: int=0) -> None:
        """AddEffectNif
    ...
    def add_user_value(self, value: int, key: str=None) -> None:
        """AddUserValue
    ...
    def arcade_spring_farm_spawn_monster(self, spawn_ids: List[int], score: int) -> None:
        ...
        Returns: None
        """
        self.ctx.ArcadeSpringFarmSpawnMonster(spawn_ids, score)
    ...
    def dark_stream_spawn_monster(self, spawn_ids: List[int], score: int) -> None:
        ...
        Returns: None
        """
        self.ctx.DarkStreamSpawnMonster(spawn_ids, score)
    ...
    def debug_string(self, value: str, feature: str=None) -> None:
        """DebugString
    ...
    def dungeon_mission_complete(self, mission_id: int, feature: str=None) -> None:
    ...
    def end_mini_game_round(self, winner_box_id: int, exp_rate: float=0.0, meso: float=0.0, is_only_winner: bool=False, is_gain_loser_bonus: bool=False, game_name: str=None) -> None:
        """EndMiniGameRound
    ...
    def field_game_constant(self, key: str, value: str, feature: str=None, locale: Locale=Locale.ALL) -> None:
        """FieldGameConstant
    ...
    def guild_vs_game_give_contribution(self, team_id: int, is_win: bool=False, desc: str=None) -> None:
    ...
    def guild_vs_game_give_reward(self, team_id: int, type: str=None, is_win: bool=False, desc: str=None) -> None:
    ...
    def guild_vs_game_log_won_by_default(self, team_id: int, desc: str=None) -> None:
    ...
    def guild_vs_game_score_by_user(self, box_id: int, score: int, desc: str=None) -> None:
    ...
    def limit_spawn_npc_count(self, limit_count: int, desc: str=None) -> None:
        """LimitSpawnNpcCount
    ...
    def mini_game_give_reward(self, winner_box_id: int, content_type: str, game_name: str=None) -> None:
        """MiniGameGiveReward
    ...
    def npc_to_patrol_in_box(self, box_id: int, npc_id: int, spawn_id: str=None, patrol_name: str=None) -> None:
        """NpcToPatrolInBox
    ...
    def patrol_condition_user(self, patrol_index: int, additional_effect_id: int, patrol_name: str=None) -> None:
        """PatrolConditionUser
    ...
    def set_actor(self, trigger_id: int, visible: bool=False, initial_sequence: str=None, arg4: bool=False, arg5: bool=False) -> None:
        """액터를설정한다
    ...
    def set_cinematic_ui(self, type: int, script: str=None, arg3: bool=False) -> None:
        """연출UI를설정한다
    ...
    def set_event_ui(self, type: int, arg2: str=None, arg3: str=None, arg4: str=None) -> None:
        """이벤트UI를설정한다
    ...
    def set_npc_emotion_loop(self, spawn_id: int, sequence_name: str=None, duration: float=0.0) -> None:
        """SetNpcEmotionLoop
    ...
    def set_skill(self, trigger_ids: List[int], enable: bool=False) -> None:
        ...
        Returns: None
        """
        self.ctx.SetSkill(trigger_ids, enable)
    ...
    def set_timer(self, timer_id: str=None, seconds: int=0, start_delay: int=0, interval: int=0, v_offset: int=0, type: str=None, desc: str=None) -> None:
        """타이머를설정한다
    ...
    def set_user_value_from_dungeon_reward_count(self, dungeon_reward_id: int, key: str=None) -> None:
    ...
    def set_user_value_from_guild_vs_game_score(self, team_id: int, key: str=None) -> None:
    ...
    def shadow_expedition_open_boss_gauge(self, max_gauge_point: int, title: str=None) -> None:
    ...
    def show_caption(self, type: str, title: str, desc: str=None, align: Align=Align.Top, offset_rate_x: float=0.0, offset_rate_y: float=0.0, duration: int=0, scale: float=0.0) -> None:
        """ShowCaption
    ...
    def side_npc_talk(self, npc_id: int, illust: str, duration: int, script: str, voice: str=None) -> None:
    ...
    def spawn_monster(self, spawn_ids: List[int], auto_target: bool=True, delay: int=0) -> None:
        ...
        Returns: None
        """
        self.ctx.SpawnMonster(spawn_ids, auto_target, delay)
    ...
    def wedding_user_to_patrol(self, entry_type: str, patrol_name: str=None, patrol_index: int=0) -> None:
        """WeddingUserToPatrol
    ...
    def widget_action(self, type: str, func: str, widget_arg: str=None, desc: str=None, widget_arg_num: int=0) -> None:
        """WidgetAction
    ...
    def write_log(self, log_name: str, event: str=None, trigger_id: int=0, sub_event: str=None, level: int=0) -> None:
        """로그를남긴다
    ...
    def npc_extra_data(self, spawn_point_id: str, extra_data_key: str) -> int:
        """CheckNpcExtraData

        Args:
            spawn_point_id (str): _description_.
    ...
    def monster_dead(self, spawn_ids: List[int], auto_target: bool=True) -> bool:
        ...
        Returns: None
        """
        return self.ctx.MonsterDead(spawn_ids, auto_target)
    ...
    def random_condition(self, weight: float, desc: str=None) -> bool:
        """랜덤조건
    ...
    def wait_seconds_user_value(self, key: str, desc: str=None) -> bool:
    ...
    def widget_value(self, type: str, name: str, desc: str=None) -> int:
        """WidgetCondition
