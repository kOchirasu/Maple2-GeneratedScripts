...
class 시작대기중(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[3201], visible=False, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[3202], visible=False, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[3203], visible=False, arg3=0, arg4=0, arg5=0)
...
class 지역랜덤(state.State):
    def on_tick(self) -> state.State:
        ...
        if random_condition(rate=34):
            set_mesh(triggerIds=[3203], visible=True, arg3=0, arg4=0, arg5=0)
            return C지역()
