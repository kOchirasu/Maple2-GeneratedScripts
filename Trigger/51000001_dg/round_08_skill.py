...
class 시작대기중(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[3801], visible=False, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[3802], visible=False, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[3803], visible=False, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[3804], visible=False, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[3805], visible=False, arg3=0, arg4=0, arg5=0)
...
class 지역랜덤(state.State):
    def on_tick(self) -> state.State:
        ...
        if random_condition(rate=20):
            set_mesh(triggerIds=[3801], visible=True, arg3=0, arg4=0, arg5=0)
            return A지역()
        if random_condition(rate=20):
            set_mesh(triggerIds=[3802], visible=True, arg3=0, arg4=0, arg5=0)
            return B지역()
        if random_condition(rate=20):
            set_mesh(triggerIds=[3803], visible=True, arg3=0, arg4=0, arg5=0)
            return C지역()
        if random_condition(rate=20):
            set_mesh(triggerIds=[3804], visible=True, arg3=0, arg4=0, arg5=0)
            return D지역()
        if random_condition(rate=20):
            set_mesh(triggerIds=[3805], visible=True, arg3=0, arg4=0, arg5=0)
            return E지역()
