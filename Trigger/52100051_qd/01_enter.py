...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10002078], state=0) # Lever
...
class NpcTalk01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001592, script='$52100051_QD__01_ENTER__0$', arg4=4) # 렌듀비앙
...
class NpcTalk02(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_loop(spawnId=201, sequenceName='Talk_A', duration=3000)
        self.set_conversation(type=2, spawnId=11001597, script='$52100051_QD__01_ENTER__1$', arg4=5) # 유페리아
...
class NpcMonologue01(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=101, script='$52100051_QD__01_ENTER__2$', arg4=2, arg5=0) # 렌듀비앙
        self.set_conversation(type=1, spawnId=201, script='$52100051_QD__01_ENTER__3$', arg4=2, arg5=0) # 유페리아
...
class NpcMonologue02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=102, script='$52100051_QD__01_ENTER__4$', arg4=3, arg5=0) # 렌듀비앙
        self.set_conversation(type=1, spawnId=202, script='$52100051_QD__01_ENTER__5$', arg4=2, arg5=1) # 유페리아
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.show_guide_summary(entityId=20039501, textId=20039501, duration=4000) # 가이드 : 레버 당기기
        self.set_interact_object(triggerIds=[10002078], state=1) # Lever

    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10002078], stateValue=0):
