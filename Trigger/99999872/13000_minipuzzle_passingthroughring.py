...
class Wait(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000068], state=2) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거
...
class PassingThroughRing_Success(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000068], state=1) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000068], stateValue=0):
