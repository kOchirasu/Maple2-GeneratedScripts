...
class main(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[98001], visible=False)
        self.set_effect(trigger_ids=[98002], visible=False)
        self.set_effect(trigger_ids=[98003], visible=False)
        self.set_effect(trigger_ids=[98004], visible=False)
        self.set_effect(trigger_ids=[98005], visible=False)
        self.set_effect(trigger_ids=[98006], visible=False)
        self.set_effect(trigger_ids=[90021], visible=False)
...
class DungeonStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_portal(portal_id=10, visible=False, enable=False, minimap_visible=False) # 보상으로 연결되는 포탈 제어 (끔)
        self.spawn_monster(spawn_ids=[199], auto_target=True) # 퀘스트 주는 NPC가 앞으로 걸어나옴
        self.select_camera(trigger_id=8001, enable=True) # 연출 카메라
        self.set_timer(timer_id='1', seconds=1)
        self.spawn_monster(spawn_ids=[401,402,403,404,405,406], auto_target=True) # 성벽 지키는 NPC 소환
        self.spawn_monster(spawn_ids=[801,802,803,804,805,806,807,808,809], auto_target=True) # 성벽 지키는 NPC 소환
...
class 단계_시작04_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[201,203], auto_target=True) # 성벽 지키는 NPC 리필
...
class 단계_시작2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[204,205], auto_target=True) # 성벽 지키는 NPC 리필
        self.set_dialogue(type=1, spawn_id=199, script='$02000334_BF__MAIN__8$', time=3) # 오스칼 대사
        self.set_mesh(trigger_ids=[6000,6001,6002,6003,6004,6005,6006,6007,6008,6009,6010,6011,6012,6013,6014,6015,6016], visible=False, interval=250, fade=1) # 가림막 해제
...
class 단계_타이머2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[90022], visible=True) # 점프 뛰는 소리 ON
        self.select_camera(trigger_id=8000, enable=True) # 사이드뷰 카메라
...
class 단계_시작3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[206,207], auto_target=True) # 성벽 지키는 NPC 리필
...
class 게임오버(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_timer(timer_id='3', seconds=3, interval=0)
        self.set_effect(trigger_ids=[98031], visible=False)
...
class 강퇴(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_user(map_id=0, portal_id=0, box_id=90001)
...
class 클리어_보상_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=8003, enable=True) # 연출 카메라
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
