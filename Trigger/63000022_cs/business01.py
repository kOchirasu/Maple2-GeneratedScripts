...
# 최초 입장
class TalkWeiHong01(common.Trigger):
    def on_enter(self):
...
class TalkWeiHong02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class TalkWeiHong03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class TalkWeiHong04(common.Trigger):
    def on_enter(self):
...
class TalkWeiHong05(common.Trigger):
    def on_enter(self):
...
class TalkWeiHong06(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Talk_A')
...
class TalkWeiHong07(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Idle_A')
...
class TalkWeiHong08(common.Trigger):
    def on_enter(self):
...
class TalkWeiHong09(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class TalkWeiHong10(common.Trigger):
    def on_enter(self):
...
class TalkWeiHong11(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
