...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5311], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5312], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5313], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5314], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5315], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5316], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5317], visible=False) # 경로 안내
        ...
        self.set_effect(trigger_ids=[5408], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5409], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5410], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5411], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5412], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5413], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5414], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5415], visible=False) # 경로 안내
        self.set_effect(trigger_ids=[5416], visible=False) # 경로 안내
...
class 리엔전경씬03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_caption(type='VerticalCaption', title='$52000104_QD__52000104__0$', desc='$52000104_QD__52000104__1$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=7000, scale=2.5)
...
class Quit02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000104_QD__52000104__2$', duration=6000, delay_tick=1000)
...
class 리린과대화03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='NameCaption', title='$52000104_QD__52000104__3$', desc='$52000104_QD__52000104__4$', align='center', offset_rate_x=-0.15, offset_rate_y=0.15, duration=10000, scale=2)
...
class 꽃섬멸퀘스트03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000104_QD__52000104__5$', duration=6000, delay_tick=1000)
...
class 할아버지등장씬01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_sound(trigger_id=9000, enable=False) # 코믹한 상황 브금
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
        self.set_cinematic_ui(type=1)
...
class 할아버지등장씬03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003175, illust_id='Ten_normal', msg='$52000104_QD__52000104__6$', duration=4000, align='right')
...
class 할아버지등장씬04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_caption(type='NameCaption', title='$52000104_QD__52000104__7$', desc='$52000104_QD__52000104__8$', align='center', offset_rate_x=-0.15, offset_rate_y=0.15, duration=10000, scale=2)
...
class 수련장으로이동01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000104_QD__52000104__9$', duration=6000, delay_tick=1000)
