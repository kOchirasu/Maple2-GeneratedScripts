...
class 리엔전경씬01_B(common.Trigger):
    def on_enter(self):
...
class 꽃가꾸기퀘스트01(common.Trigger):
    def on_enter(self):
...
# ########################씬4 할아버지 등장########################
class 할아버지등장씬01(common.Trigger):
    def on_enter(self):
...
class 할아버지등장씬02(common.Trigger):
    def on_enter(self):
...
class 할아버지등장씬03(common.Trigger):
    def on_enter(self):
...
class 할아버지등장씬04(common.Trigger):
    def on_enter(self):
...
class 할아버지등장씬04_1(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 할아버지등장씬05(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
        self.reset_camera(interpolationTime=1)
        self.set_cinematic_ui(type=0)
...
class 수련장으로이동01(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5400], visible=False) # 경로 안내
        self.set_effect(triggerIds=[5401], visible=False) # 경로 안내
        self.set_effect(triggerIds=[5402], visible=False) # 경로 안내
...
class 수련장으로이동02(common.Trigger):
    def on_enter(self):
