...
class 패이즈_3_시작(common.Trigger):
    def on_enter(self):
        ...
        self.side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300004_PHASE_3__0$', duration=3176)
        self.side_npc_talk(type='talk', npcId=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300004_PHASE_3__1$', duration=3176)
