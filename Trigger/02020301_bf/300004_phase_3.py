...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[200011,200012,200013,200014,200015,200016,200017,200018], visible=False)
...
class 패이즈_3_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300004_PHASE_3__0$', duration=3176)
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300004_PHASE_3__1$', duration=3176)
...
class 엘리베이터_도착(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_breakable(trigger_ids=[5171,5172,5173,5174,5175,5176,5177,5178,5179,5180,5181,5182,5183,5184], enable=False) # 좌우 이동 엘리베이터 멈춤 후, 숨기기
        self.set_breakable(trigger_ids=[5151,5152,5153,5154,5155,5156,5157,5158,5159,5160,5161,5162,5163,5164], enable=False)
        self.set_visible_breakable_object(trigger_ids=[5171,5172,5173,5174,5175,5176,5177,5178,5179,5180,5181,5182,5183,5184], visible=False)
        self.set_visible_breakable_object(trigger_ids=[5151,5152,5153,5154,5155,5156,5157,5158,5159,5160,5161,5162,5163,5164], visible=False)
...
class 포탑_생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[512], auto_target=True) # 포탑 소환
