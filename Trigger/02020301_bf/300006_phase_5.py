...
class 패이즈_5_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300006_PHASE_5__0$', duration=3176)
...
class 포탈_오픈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300006_PHASE_5__1$', duration=3176)
...
class 엘리베이터_동작_대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_ai_extra_data(key='Last_Phase', value=1, is_modify=False)
...
class 택스트_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300006_PHASE_5__2$', duration=3176)
...
class 택스트_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_normal', script='$02020301_BF__300006_PHASE_5__3$', duration=3176)
...
class 엘리베이터_도착(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_breakable(trigger_ids=[5401,5402,5403,5404,5405,5406,5407,5408,5409,5410], enable=False) # 5페이즈 상하 엘리베이터 멈춤
...
class 길막열기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[5641,5642,5643,5644], visible=False) # 4페이즈 상하좌우 엘리베이터 길막 열기
        self.set_agent(trigger_ids=[1810000,1810001,1810002,1810003,1810004,1810005,1810006,1810007,1810008,1810009,1810010,1810011], visible=False)
