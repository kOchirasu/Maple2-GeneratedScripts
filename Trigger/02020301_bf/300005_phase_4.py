...
class 패이즈_4_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[200011,200012,200013,200014,200015,200016,200017,200018], visible=False) # 페이즈3 포탑 가이드 제거
        ...
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300005_PHASE_4__0$', duration=3176)
...
class 추가대화(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Angry', script='$02020301_BF__300005_PHASE_4__1$', duration=3176)
...
class 추가대화_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300005_PHASE_4__2$', duration=3176)
...
class 엘리베이터_대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_buff(box_ids=[101], skill_id=62100108, level=1, is_player=True) # 스택버프 걸어주기
        self.side_npc_talk(type='talk', npc_id=11004205, illust='ArcaneBlader_unfair', script='$02020301_BF__300005_PHASE_4__3$', duration=3176)
        self.set_user_value(key='AI_Phase', value=0)
        # 좌우 엘리베이터 숨기기(페이즈가 바뀜으로써..)추후 파괴하는걸로 연출을 변경해보자.
        self.set_visible_breakable_object(trigger_ids=[5351,5352,5353,5354,5355,5356,5357,5358,5359,5360,5361,5362,5363,5364], visible=False)
...
class 엘리베이터_도착(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_breakable(trigger_ids=[5101,5102,5103,5104,5105,5106,5107,5108,5109,5110], enable=False) # 4페이즈 상하 엘리베이터 멈추기
...
class 길막열기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[5241,5242,5243,5244], visible=False) # 4페이즈 상하좌우 엘리베이터 길막 열기
        self.set_agent(trigger_ids=[1800000,1800001,1800002,1800003,1800004,1800005,1800006,1800007,1800008,1800009,1800010,1800011], visible=False)
