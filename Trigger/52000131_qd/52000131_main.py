...
class 카메라이동_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_loop(sequence_name='Sit_Ground_Idle_A', duration=80000)
...
class 독백_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000131_QD__52000131_MAIN__0$', time=3, arg5=0)
...
class 버튼과대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__1$', duration=3000, align='right')
...
class 버튼과대화_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000131_QD__52000131_MAIN__2$', duration=3000, align='right')
...
class 버튼과대화_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__3$', duration=4000, align='right')
...
class 버튼과대화_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000131_QD__52000131_MAIN__4$', duration=3000, align='right')
...
class 버튼과대화_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__5$', duration=3000, align='right')
...
class 버튼과대화_12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000131_QD__52000131_MAIN__6$', duration=3000, align='right')
...
class 버튼과대화_14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__7$', duration=4000, align='right')
...
class 버튼과대화_15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000131_QD__52000131_MAIN__8$', duration=3000, align='right')
...
class 버튼과대화_16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__9$', duration=4000, align='right')
        self.set_npc_emotion_sequence(spawn_id=101, sequence_name='Talk_A')
...
class 버튼과대화_17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000131_QD__52000131_MAIN__10$', duration=4000, align='right')
...
class 버튼과대화_18(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_sequence(spawn_id=101, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__11$', duration=3000, align='right')
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__12$', duration=3000, align='right')
...
class 버튼과대화_19(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_sequence(spawn_id=101, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__13$', duration=3000, align='right')
        self.add_cinematic_talk(npc_id=11001540, msg='$52000131_QD__52000131_MAIN__14$', duration=3000, align='right')
...
class 버튼과대화_21(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000131_QD__52000131_MAIN__15$', duration=3000, align='right')
