...
class 발록검마인사_01(common.Trigger):
    def on_enter(self):
...
class 발록검마인사_02(common.Trigger):
    def on_enter(self):
...
class 발록검마인사_03(common.Trigger):
    def on_enter(self):
...
class 용암건너기완료_01(common.Trigger):
    def on_enter(self):
...
class 용암건너기완료_02(common.Trigger):
    def on_enter(self):
