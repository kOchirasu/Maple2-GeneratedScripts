...
class 버프부여(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_buff(box_ids=[101], skill_id=99910280, level=1, is_player=False, is_skill_set=True) # 벨라 변신
