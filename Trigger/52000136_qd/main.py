...
class 불안한케이틀린_스킵완료(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[8010,8011], returnView=False)
        self.set_cinematic_ui(type=1)
