...
class MoveToJacey01(common.Trigger):
    def on_enter(self):
...
class MoveToJacey02(common.Trigger):
    def on_enter(self):
...
class MeetJacey01(common.Trigger):
    def on_enter(self):
...
class MeetJacey02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class MeetJacey03(common.Trigger):
    def on_enter(self):
...
class JaceyTalk01(common.Trigger):
    def on_enter(self):
...
class JaceyTalk02(common.Trigger):
    def on_enter(self):
...
class JaceyTalk03(common.Trigger):
    def on_enter(self):
...
class JaceyTalk04(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class JaceyTalk05(common.Trigger):
    def on_enter(self):
...
class JaceyTalk06(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class MinimapGuide01(common.Trigger):
    def on_enter(self):
        self.guide_event(eventId=10021010) # 트리거 To가이드 : 탭키 눌러서 미니맵 크게 보기
...
class JaceyTalk10(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class JaceyTalk11(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class JaceyTalk12(common.Trigger):
    def on_enter(self):
...
class JaceyTalk13(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
...
class PatrolWithJacey01(common.Trigger):
    def on_enter(self):
...
class PatrolWithJacey02(common.Trigger):
    def on_enter(self):
...
class PatrolWithJacey03(common.Trigger):
    def on_enter(self):
...
class PatrolWithJacey04(common.Trigger):
    def on_enter(self):
...
class CallNextRoom01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class CallNextRoom02(common.Trigger):
    def on_enter(self):
...
class CallNextRoom03(common.Trigger):
    def on_enter(self):
...
class CallNextRoom04(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
...
class JaceyQuest00(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
...
class JaceyQuest01(common.Trigger):
    def on_enter(self):
...
class JaceyQuest02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class JaceyQuest03(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class JaceyQuest04(common.Trigger):
    def on_enter(self):
...
class JaceyQuest05(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class AboutPotion01(common.Trigger):
    def on_enter(self):
...
class AboutPotion02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class AboutPotion03(common.Trigger):
    def on_enter(self):
...
class AboutPotion04(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
    ...
    def on_exit(self):
        self.guide_event(eventId=10021120) # 트리거 To가이드 : PC 컨트롤 불가


class JaceyLeve01(common.Trigger):
    def on_enter(self):
...
class JaceyLeve02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
# 트리거 To가이드
class SendSignalToGuide01(common.Trigger):
    def on_enter(self):
        self.guide_event(eventId=10021050) # 트리거 To가이드 : 약초 퀵슬롯에 장착하기
...
class PortalOpen01(common.Trigger):
    def on_enter(self):
