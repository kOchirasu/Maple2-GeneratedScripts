...
class 보스_무적페이즈_대사1(common.Trigger):
    def on_enter(self):
...
class 보스_무적페이즈_대사2(common.Trigger):
    def on_enter(self):
