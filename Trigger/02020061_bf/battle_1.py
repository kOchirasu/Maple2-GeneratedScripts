...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(group_id=[478], is_start=False)
        self.start_combine_spawn(group_id=[479], is_start=False)
        self.start_combine_spawn(group_id=[480], is_start=False)
        self.start_combine_spawn(group_id=[481], is_start=False)
...
class 스폰_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020061_BF__BATTLE_1__0$')

    def on_tick(self) -> trigger_api.Trigger:
        if self.shadow_expedition_reach_point(point=200):
...
class 스폰_1_추가대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_nomal', duration=5000, script='$02020061_BF__BATTLE_1__1$')
...
class 스폰_1_추가대사2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_surprise', duration=5000, script='$02020061_BF__BATTLE_1__2$')
...
class 스폰_2(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.shadow_expedition_reach_point(point=400):
...
class 스폰_4(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.shadow_expedition_reach_point(point=800):
