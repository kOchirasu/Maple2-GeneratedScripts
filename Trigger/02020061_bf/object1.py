...
class 레버1_안내멘트(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02020061_BF__OBJECT1__0$', arg3='5000', arg4='9011')
...
class 레버1_발동(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02020061_BF__OBJECT1__1$', arg3='5000', arg4='9011')
    ...
    def on_tick(self) -> state.State:
        ...
        if monster_dead(boxIds=[701]):
            return 종료()
        if object_interacted(interactIds=[12000084], arg2=0):
            return 레버1_몬스터등장()
