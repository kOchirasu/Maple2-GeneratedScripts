...
class 대기(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000086], state=2)
...
class 레버3_안내멘트(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02020061_BF__OBJECT3__0$', arg3='5000', arg4='9013')
...
class 레버3_발동(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000086], state=1)
        set_event_ui(type=1, arg2='$02020061_BF__OBJECT3__1$', arg3='5000', arg4='9013')
    ...
    def on_tick(self) -> state.State:
        ...
        if monster_dead(boxIds=[701]):
            return 종료()
        if object_interacted(interactIds=[12000086], arg2=0):
            return 레버3_몬스터등장()
