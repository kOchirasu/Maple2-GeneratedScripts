...
class 위치세팅(common.Trigger):
    def on_enter(self):
        self.wedding_move_user(entryType='Guest', mapId=84000025, portalIds=[22,23], boxId=701) # 하객들은 22,23번으로 랜덤이동
...
class 결혼시작체크(common.Trigger):
    ...
    def on_exit(self):
        self.wedding_move_user(entryType='Guest', mapId=84000025, portalIds=[22,23], boxId=701) # 701번 박스(버진로드)에 있는 하객들은 21,22,23번으로 랜덤이동
