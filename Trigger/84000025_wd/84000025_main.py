...
class 연출시작(state.State):
    def on_enter(self):
        ...
        wedding_move_user(entryType='Guest', mapId=84000025, portalIds=[22,23], boxId=701) # 799번 박스(입장구역)에 있는 하객들은 22,23번으로 랜덤이동
        wedding_move_user(entryType='Guest', mapId=84000025, portalIds=[22,23], boxId=703) # 701번 박스(버진로드)에 있는 하객들은 22,23번으로 랜덤이동
        wedding_move_user(entryType='Groom', mapId=84000025, portalIds=[11], boxId=702) # 신랑 11번으로
        wedding_move_user(entryType='Bride', mapId=84000025, portalIds=[12], boxId=702) # 신부는 12번으로
...
class 주례줌인02(state.State):
    def on_enter(self):
        ...
        add_cinematic_talk(npcId=11004710, msg='$84000025_WD__84000025_MAIN__0$', duration=3500)
...
class 주례사(state.State):
    def on_enter(self):
        set_cinematic_ui(type=3)
        add_cinematic_talk(npcId=11004710, msg='$84000025_WD__84000025_MAIN__1$', duration=4000)
...
class 탈주로중단(state.State):
    def on_enter(self):
        add_cinematic_talk(npcId=11004710, msg='$84000025_WD__84000025_MAIN__2$', duration=3000)
...
class 탈주로중단선언(state.State):
    def on_enter(self):
        add_cinematic_talk(npcId=11004710, msg='$84000025_WD__84000025_MAIN__3$', duration=3000)
...
class 미입력으로중단01(state.State):
    def on_enter(self):
        add_cinematic_talk(npcId=11004710, msg='$84000025_WD__84000025_MAIN__4$', duration=3000)
...
class 미입력으로중단선언(state.State):
    def on_enter(self):
        add_cinematic_talk(npcId=11004710, msg='$84000025_WD__84000025_MAIN__5$', duration=3000)
...
class 성혼발표(state.State):
    def on_enter(self):
        add_cinematic_talk(npcId=11004710, msg='$84000025_WD__84000025_MAIN__6$', duration=2500)
