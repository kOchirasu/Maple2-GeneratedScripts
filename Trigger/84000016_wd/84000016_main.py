...
class 연출시작(common.Trigger):
    def on_enter(self):
        ...
        self.wedding_move_user(entryType='Guest', mapId=84000016, portalIds=[22,23], boxId=701) # 799번 박스(입장구역)에 있는 하객들은 22,23번으로 랜덤이동
        self.wedding_move_user(entryType='Guest', mapId=84000016, portalIds=[22,23], boxId=703) # 701번 박스(버진로드)에 있는 하객들은 22,23번으로 랜덤이동
        self.wedding_move_user(entryType='Groom', mapId=84000016, portalIds=[11], boxId=702) # 신랑 11번으로
        self.wedding_move_user(entryType='Bride', mapId=84000016, portalIds=[12], boxId=702) # 신부는 12번으로
...
class 주례줌인02(common.Trigger):
    def on_enter(self):
        ...
        self.add_cinematic_talk(npcId=11004711, msg='$84000016_WD__84000016_MAIN__0$', duration=3500)
...
class 입장01(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[8004,8005,8011], returnView=False)
...
class 주례사(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=3)
        self.wedding_set_user_rotation(entryType='Groom', rotation=[0,0,0], immediate=True)
        self.wedding_set_user_rotation(entryType='Bride', rotation=[0,0,0], immediate=True)
        self.add_cinematic_talk(npcId=11004711, msg='$84000016_WD__84000016_MAIN__1$', duration=4000)
...
class 탈주로중단(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004711, msg='$84000016_WD__84000016_MAIN__2$', duration=3000)
...
class 탈주로중단선언(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004711, msg='$84000016_WD__84000016_MAIN__3$', duration=3000)
...
class 미입력으로중단01(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004711, msg='$84000016_WD__84000016_MAIN__4$', duration=3000)
...
class 미입력으로중단선언(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004711, msg='$84000016_WD__84000016_MAIN__5$', duration=3000)
...
class 성혼발표(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004711, msg='$84000016_WD__84000016_MAIN__6$', duration=2500)
