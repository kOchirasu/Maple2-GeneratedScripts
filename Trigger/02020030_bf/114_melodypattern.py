...
class MelodyPlay01_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11205], visible=True) # Bell F
        self.set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_blue') # Bell F
...
class MelodyPlay01_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11203], visible=True) # Bell D
        self.set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_yellow') # Bell D
...
class MelodyPlay02_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell D
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11205], visible=True) # Bell A
        self.set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_blue') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11203], visible=True) # Bell B
        self.set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_yellow') # Bell B
...
class MelodyPlay04_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell B
...
class MelodyPlay05_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11202], visible=True) # Bell HighC
        self.set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_orange') # Bell HighC
...
class MelodyPlay05_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell HighC
...
class CheckAnswer01_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000062], state=1) # Lever F
...
class CheckAnswer02_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000060], state=1) # Lever D
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000062], state=1) # Lever A
...
class CheckAnswer05_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000059], state=1) # Lever B
