...
class MelodyPlay01_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11205], visible=True) # Bell F
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_blue') # Bell F
...
class MelodyPlay01_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay03_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11205], visible=True) # Bell A
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_blue') # Bell A
...
class MelodyPlay03_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class CheckAnswer01_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000062], state=1) # Lever F
...
class CheckAnswer03_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000062], state=1) # Lever A
