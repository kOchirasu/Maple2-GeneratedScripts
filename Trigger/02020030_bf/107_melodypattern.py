...
class MelodyPlay02_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11204], visible=True) # Bell D
        set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_green') # Bell D
...
class MelodyPlay02_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell D
...
class MelodyPlay03_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11203], visible=True) # Bell A
        set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_yellow') # Bell A
...
class MelodyPlay03_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11204], visible=True) # Bell B
        set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_green') # Bell B
...
class MelodyPlay04_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell B
...
class MelodyPlay05_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11205], visible=True) # Bell HighC
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_blue') # Bell HighC
...
class MelodyPlay05_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11005, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell HighC
...
class CheckAnswer02_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000061], state=1) # Lever D
...
class CheckAnswer03_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000060], state=1) # Lever A
