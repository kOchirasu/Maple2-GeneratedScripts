...
class 어려움난이도보스등장(common.Trigger):
    def on_enter(self):
...
class 쉬움난이도보스등장(common.Trigger):
    def on_enter(self):
...
class 인페르녹최초이미지대사연출(common.Trigger):
    def on_enter(self):
...
class 페이지_바로가기포탈생성2(common.Trigger):
    def on_enter(self):
...
class 페이지_2PhaseWall_생성2(common.Trigger):
    def on_enter(self):
...
class 페이지_바로가기포탈생성3(common.Trigger):
    def on_enter(self):
...
class 페이지_3PhaseWall_생성3(common.Trigger):
    def on_enter(self):
