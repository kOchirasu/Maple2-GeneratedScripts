...
class 문열림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=100, script='$02000230_BF__SAVE_01__0$', time=2, arg5=0)
        self.set_actor(trigger_id=10101, visible=False, initial_sequence='Attack_Idle_A')
        self.spawn_monster(spawn_ids=[10111], auto_target=True)
        self.set_actor(trigger_id=10102, visible=False, initial_sequence='Attack_02_A')
        self.spawn_monster(spawn_ids=[10112], auto_target=True)
        self.set_actor(trigger_id=10103, visible=False, initial_sequence='Attack_02_A')
        self.spawn_monster(spawn_ids=[10113], auto_target=True)
        self.set_actor(trigger_id=10104, visible=False, initial_sequence='Attack_Idle_A')
        self.spawn_monster(spawn_ids=[10114], auto_target=True)
        self.set_actor(trigger_id=10105, visible=False, initial_sequence='Attack_02_A')
        self.spawn_monster(spawn_ids=[10115], auto_target=True)
...
class 도망과공격(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=101, visible=False, initial_sequence='Emotion_Failure_Idle_A')
        self.spawn_monster(spawn_ids=[111], auto_target=False)
        self.set_dialogue(type=1, spawn_id=111, script='$02000230_BF__SAVE_01__3$', time=2, arg5=0)
