...
class 문열림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=500, script='$02000230_BF__SAVE_05__0$', time=2, arg5=0)
        self.set_actor(trigger_id=50501, visible=False, initial_sequence='Attack_Idle_A')
        self.spawn_monster(spawn_ids=[50511], auto_target=True)
        self.set_actor(trigger_id=50502, visible=False, initial_sequence='Attack_02_A')
        self.spawn_monster(spawn_ids=[50512], auto_target=True)
        self.set_actor(trigger_id=50503, visible=False, initial_sequence='Attack_02_A')
        self.spawn_monster(spawn_ids=[50513], auto_target=True)
        self.set_actor(trigger_id=50504, visible=False, initial_sequence='Attack_Idle_A')
        self.spawn_monster(spawn_ids=[50514], auto_target=True)
        self.set_actor(trigger_id=50505, visible=False, initial_sequence='Attack_02_A')
        self.spawn_monster(spawn_ids=[50515], auto_target=True)
...
class 도망과공격(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=501, visible=False, initial_sequence='Emotion_Failure_Idle_A')
        self.spawn_monster(spawn_ids=[511], auto_target=False)
        self.set_dialogue(type=1, spawn_id=511, script='$02000230_BF__SAVE_05__3$', time=2, arg5=0)
