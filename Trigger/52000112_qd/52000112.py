...
class START(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[300,301,302,303,304,305,306,307], visible=True, start_delay=0, interval=1000, fade=1000) # 큐브하나씩부셔지는연출
...
class 재즈바1층습격_완료가능01_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=0, msg='$52000112_QD__52000112__0$', duration=6000, delay_tick=1000)
...
class 재즈바_지하습격_완료가능01_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=0, msg='$52000112_QD__52000112__2$', duration=6000, delay_tick=1000)
...
class PC_로그스거역_진행중01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=211, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=212, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=213, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=214, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=215, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=216, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=217, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=218, sequence_name='Attack_Idle_A', duration=15000)
        self.set_npc_emotion_loop(spawn_id=219, sequence_name='Attack_Idle_A', duration=15000)
...
class 쉐도우클로전투_완료연출01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=208, sequence_name='Attack_Idle_A', duration=17500)
        self.set_npc_emotion_loop(spawn_id=201, sequence_name='Sit_Down_A', duration=17500)
        self.set_npc_emotion_loop(spawn_id=202, sequence_name='Sit_Down_A', duration=17500)
        self.set_npc_emotion_loop(spawn_id=203, sequence_name='Sit_Down_A', duration=17500)
...
class 쉐도우클로전투_완료연출03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003185, illust_id='0', msg='$52000112_QD__52000112__3$', duration=5000, align='right')
...
class 쉐도우클로전투_완료연출04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, illust_id='0', msg='$52000112_QD__52000112__4$', duration=4000, align='right')
...
class 쉐도우클로전투_완료연출05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Assassin_DarkSight_A', duration=5000)
...
class 쉐도우클로전투_완료연출06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Assassin_Enterance_A', duration=5000)
...
class 쉐도우클로전투_완료연출07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003185, illust_id='0', msg='$52000112_QD__52000112__5$', duration=4000, align='right')
        self.set_npc_emotion_loop(spawn_id=208, sequence_name='Stun_A', duration=15500)
        self.set_mesh(trigger_ids=[300,301,302,303,304,305,306,307], visible=False, start_delay=0, interval=700, fade=0) # 큐브하나씩부셔지는연출
...
class 쉐도우클로전투_완료연출08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003185, illust_id='0', msg='$52000112_QD__52000112__6$', duration=4000, align='right')
