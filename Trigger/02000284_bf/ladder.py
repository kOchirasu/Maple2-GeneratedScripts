...
class 대기(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[314,315,316,317,318,319,320], visible=False, arg3=0, arg4=0, arg5=0)
...
class 사다리생성(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10000429], state=0)
        set_mesh(triggerIds=[314,315,316,317,318,319,320], visible=True, arg3=0, arg4=500, arg5=0)
