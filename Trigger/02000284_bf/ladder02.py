...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[321,322,323,324], visible=False, start_delay=0, interval=0, fade=0)
...
class 사다리생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[321,322,323,324], visible=True, start_delay=0, interval=500, fade=0)
