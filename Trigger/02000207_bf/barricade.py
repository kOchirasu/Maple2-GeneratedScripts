...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3100,3101,3102,3103,3104,3105,3106,3107,3108], visible=True, start_delay=0, interval=0, fade=0)
...
class 차단(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3100,3101,3102,3103,3104,3105,3106,3107,3108], visible=False, start_delay=0, interval=0, fade=3)
