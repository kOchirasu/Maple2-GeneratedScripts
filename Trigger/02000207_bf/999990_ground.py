...
class 시작대기중(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[5001,5002,5003,5004,5005,5006], visible=False, arg3=0, delay=0, scale=0)
...
class 층지형의숨겨진바닥생성3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[5001,5002,5003,5004,5005,5006], visible=True, arg3=1, delay=120, scale=0.5)
