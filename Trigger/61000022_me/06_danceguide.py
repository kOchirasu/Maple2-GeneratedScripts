...
class DanceGuideP12_02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26100803, textId=26100803, duration=4000)
...
class DanceGuideP22_02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26100803, textId=26100803, duration=5000)
...
class DanceGuideP62_01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26100803, textId=26100803, duration=6000)
