...
class 조건체크몬스터스폰1(common.Trigger):
    def on_enter(self):
...
class 조건체크몬스터스폰2(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=10000):
            return 조건체크몬스터스폰3(self.ctx)


class 조건체크몬스터스폰3(common.Trigger):
    def on_enter(self):
...
class 단계가기전1_2(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=2000):
            return 단계가기전2_2(self.ctx)


class 단계가기전2_2(common.Trigger):
    def on_enter(self):
...
class 단계조건체크몬스터2(common.Trigger):
    def on_enter(self):
...
class 단계시작전1_3(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=2000):
            return 단계시작전2_3(self.ctx)


class 단계시작전2_3(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
...
class 조건체크몬스터스폰(common.Trigger):
    def on_enter(self):
...
class 응접실문열기전몬스터스폰(common.Trigger):
    def on_enter(self):
...
class 응접실문열고나서처리(common.Trigger):
    def on_enter(self):
