...
class 구르는천둥대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001581, script='$52000029_QD__MAIN__0$', time=3, arg5=0)
...
class 유페리아대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001564, script='$52000029_QD__MAIN__1$', time=2, arg5=0)
...
class 이펙트연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_buff(box_ids=[2001], skill_id=71000003, level=1, is_player=True, is_skill_set=False)
        self.set_effect(trigger_ids=[601], visible=False)
...
class 이슈라대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000029_QD__MAIN__2$', time=2, arg5=0) # 음성 코드 00001296
...
class 홀슈타트대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001231, script='$52000029_QD__MAIN__3$', time=3, arg5=0)
...
class 홀슈타트도망(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=3055, enable=True)
...
class 렌듀비앙대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001230, script='$52000029_QD__MAIN__4$', time=3, arg5=0)
...
class 아노스대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000032, script='$52000029_QD__MAIN__5$', time=4, arg5=0)
...
class 제나대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001583, script='$52000029_QD__MAIN__6$', time=4, arg5=0)
...
class 유페리아대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001564, script='$52000029_QD__MAIN__7$', time=4, arg5=0)
...
class 이슈라대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000029_QD__MAIN__8$', time=2, arg5=0) # 음성 코드 00001297
...
class 이슈라대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000029_QD__MAIN__9$', time=11, arg5=0) # 음성 코드 00001298
...
class 이슈라대사04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000029_QD__MAIN__10$', time=6, arg5=0) # 음성 코드 00001299
...
class 렌듀비앙대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001230, script='$52000029_QD__MAIN__11$', time=3, arg5=0)
...
class 렌듀비앙캐스팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_buff(box_ids=[1007], skill_id=71000004, level=1, is_player=True, is_skill_set=False)
        self.move_npc(spawn_id=1003, patrol_name='MS2PatrolData_1003_C')
...
class 이슈라대사05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000029_QD__MAIN__12$', time=3, arg5=0) # 음성 코드 00001300

    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=3000):
            self.move_user(map_id=52000030, portal_id=0)
            return 종료(self.ctx)
