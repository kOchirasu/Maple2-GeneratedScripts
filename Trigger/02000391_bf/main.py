...
class 부선장대사03(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=24003011, script='$02000391_BF__MAIN__2$', arg4=3, arg5=0)
...
class 세이렌대사01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=24003010, script='$02000391_BF__MAIN__3$', arg4=3, arg5=0)
...
class 카메라310(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1099, script='$02000391_BF__MAIN__4$', arg4=3, arg5=0)
...
class 세이렌연주02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1098, script='$02000391_BF__MAIN__6$', arg4=3, arg5=0)
        play_system_sound_in_box(sound='Dungeon_Siren_Harp01')
        set_npc_emotion_sequence(spawnId=1098, sequenceName='Attack_01_D')
...
class 세이렌이동(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1098, script='$02000391_BF__MAIN__7$', arg4=3, arg5=0)
