...
class 기본셋팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[4012,4013], visible=True)
        # 마지막 보스 방으로 가기 위한 입구, 문짝과 투명벽 트리거 막기
        self.set_mesh(triggerIds=[4014,4015], visible=True)
...
class 스테이지1_완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_skill(triggerIds=[61], enable=True)
...
class 스테이지2_완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_skill(triggerIds=[62], enable=True)
...
class 스테이지3_완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_skill(triggerIds=[63], enable=True)
...
class 스테이지4_완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_skill(triggerIds=[64], enable=True)
...
class 이동하자(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[4014,4015], visible=False)
