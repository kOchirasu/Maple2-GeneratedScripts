...
class 기본셋팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[8100,8101,8102,8103,8104], visible=False)
        self.set_effect(trigger_ids=[8200,8201,8202,8203], visible=False)
        self.set_effect(trigger_ids=[8300,8301,8302,8303,8304], visible=False)
        self.set_effect(trigger_ids=[8400,8401,8402,8403,8404,8405,8406,8407,8408,8409,8410,8411,8412,8413,8414,8415,8416,8417,8418,8419,8420,8421,8422,8423,8424,8425,8426], visible=False)
        self.set_effect(trigger_ids=[8500,8501,8502,8503,8504,8505,8506,8507,8508,8509,8510,8511,8512,8513,8514,8515,8516,8517], visible=False)
        self.set_effect(trigger_ids=[8600,8601,8602], visible=False)
        self.set_effect(trigger_ids=[8801], visible=False) # 1스테이지 유리문 파괴 효과음 초기화
        self.set_effect(trigger_ids=[8802], visible=False) # 2스테이지 유리문 파괴 효과음 초기화
        self.set_effect(trigger_ids=[8803], visible=False) # 3스테이지 유리문 파괴 효과음 초기화
        self.set_effect(trigger_ids=[8804], visible=False) # 4스테이지 유리문 파괴 효과음 초기화
        self.set_effect(trigger_ids=[8805], visible=False) # 5스테이지 철문 Open 효과음 초기화
        self.set_portal(portal_id=2, visible=False, enable=False, minimap_visible=False) # 최종 보스방으로 가기 포탈 최초에는 끄기
...
class 스테이지1_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021], auto_target=True)
...
class 스테이지1_추가등장01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[1201,1202,1203,1204,1205,1206,1207,1208,1209,1210], auto_target=True)
...
class 스테이지1_추가등장02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[1301,1302,1303,1304,1305,1306,1307,1308,1309,1310,1311], auto_target=True)
...
class 스테이지1_추가등장03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[1401,1402,1403,1404,1405,1406,1407,1408,1409,1410], auto_target=True)
...
class 스테이지1문파괴대기_스테이지2몬스터등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MonsterMany변수 0으로 초기 셋팅, 소환몹이 한마리 나올때마다 1 더하고 한마리씩 죽으몬 1 빼기 함, 몬스터 등장 이전에 이 변수 0 초기화 하기
        self.set_user_value(key='MonsterMany', value=0)
        self.spawn_monster(spawn_ids=[2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021], auto_target=True)
...
class 스테이지2_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_skill(trigger_ids=[61], enable=False) # 스킬 끄기
...
class 스테이지2_추가등장01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[2201,2202,2203,2204,2205,2206,2207,2208,2209,2210,2211,2212,2213,2214,2215,2216,2217,2218,2219,2220,2221], auto_target=True)
...
class 스테이지2문파괴대기_스테이지3몬스터등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MonsterMany변수 0으로 초기 셋팅, 소환몹이 한마리 나올때마다 1 더하고 한마리씩 죽으몬 1 빼기 함, 몬스터 등장 이전에 이 변수 0 초기화 하기
        self.set_user_value(key='MonsterMany', value=0)
        self.spawn_monster(spawn_ids=[3001,3002,3003,3004,3005,3006,3007,3008,3009,3010,3011,3012,3013,3014,3015,3016,3017,3018,3019,3020,3021], auto_target=True)
...
class 스테이지2_완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4002], visible=False)
...
class 스테이지3_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_skill(trigger_ids=[62], enable=False) # 스킬 끄기
...
class 스테이지3문파괴대기_스테이지4몬스터등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[4001], auto_target=True)
...
class 스테이지3_완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4003], visible=False)
...
class 스테이지4_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_skill(trigger_ids=[63], enable=False) # 스킬 끄기
...
class 스테이지4문파괴대기_스테이지5몬스터등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # MonsterMany변수 0으로 초기 셋팅, 소환몹이 한마리 나올때마다 1 더하고 한마리씩 죽으몬 1 빼기 함, 몬스터 등장 이전에 이 변수 0 초기화 하기
        self.set_user_value(key='MonsterMany', value=0)
        self.spawn_monster(spawn_ids=[5001,5002,5003,5004,5005,5006,5007,5008,5009,5010], auto_target=True)
...
class 스테이지4_완료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4004], visible=False)
...
class 스테이지5_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_skill(trigger_ids=[64], enable=False) # 스킬 끄기
...
class 게임로직종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_loop(sequence_name='Idle_A', duration=3000)
        # 인증이 완료 되었습니다.\n금고 포탈이 활성화됩니다
...
class 실패게임로직종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$02000535_BF__MAIN__42$', duration=3500) # 에잇! 실패하다니…
        self.lock_my_pc(is_lock=False)
...
class 이동하자(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4014,4015], visible=False)
...
class 이동하자2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[8500,8501,8502,8503,8504,8505,8506,8507,8508,8509,8510,8511,8512,8513,8514,8515,8516,8517], visible=False) # 숫자입력용 진입 방향 화살표 표시 끄기
        self.set_effect(trigger_ids=[8600,8601,8602], visible=True) # 보스방 진입 방향 화살표 표시 하기
        # Pc혼잣말 : 금고로 들어가는 입구를 발견했어
        self.add_balloon_talk(spawn_id=0, msg='$02000535_BF__MAIN__45$', duration=3500)
