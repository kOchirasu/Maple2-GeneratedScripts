...
class NpcMonologue01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000481_BF__01_ENTER__2$', time=2, arg5=0) # 프레이
        self.set_dialogue(type=1, spawn_id=201, script='$02000481_BF__01_ENTER__3$', time=2, arg5=0) # 오스칼
...
class NpcMonologue02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000481_BF__01_ENTER__4$', time=3, arg5=0) # 프레이
