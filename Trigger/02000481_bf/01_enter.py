...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(triggerIds=[10002025], state=0) # Lever
...
class NpcTalk01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11000119, script='$02000481_BF__01_ENTER__0$', arg4=4) # 프레이
...
class NpcTalk02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11000015, script='$02000481_BF__01_ENTER__1$', arg4=5) # 오스칼
...
class NpcMonologue01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=101, script='$02000481_BF__01_ENTER__2$', arg4=2, arg5=0) # 프레이
        self.set_conversation(type=1, spawnId=201, script='$02000481_BF__01_ENTER__3$', arg4=2, arg5=0) # 오스칼
...
class NpcMonologue02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=102, script='$02000481_BF__01_ENTER__4$', arg4=3, arg5=0) # 프레이
        self.set_conversation(type=1, spawnId=202, script='$02000481_BF__01_ENTER__5$', arg4=2, arg5=1) # 오스칼
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.show_guide_summary(entityId=20039501, textId=20039501, duration=4000) # 가이드 : 레버 당기기
        self.set_interact_object(triggerIds=[10002025], state=1) # Lever

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10002025], stateValue=0):
