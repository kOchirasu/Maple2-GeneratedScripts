...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[13001], visible=False, start_delay=0, interval=0, fade=0) # off_01
        self.set_mesh(trigger_ids=[13011], visible=False, start_delay=0, interval=0, fade=0) # on_01
        self.set_mesh(trigger_ids=[13002], visible=False, start_delay=0, interval=0, fade=0) # off_02
        self.set_mesh(trigger_ids=[13012], visible=False, start_delay=0, interval=0, fade=0) # on_02
        self.set_mesh(trigger_ids=[13003], visible=False, start_delay=0, interval=0, fade=0) # off_03
        self.set_mesh(trigger_ids=[13013], visible=False, start_delay=0, interval=0, fade=0) # on_03
        self.set_mesh_animation(trigger_ids=[13011], visible=False, start_delay=0, interval=0) # on_01
        self.set_mesh_animation(trigger_ids=[13012], visible=False, start_delay=0, interval=0) # on_02
        self.set_mesh_animation(trigger_ids=[13013], visible=False, start_delay=0, interval=0) # on_03
        ...
        self.set_effect(trigger_ids=[13101], visible=False) # Right Sound Effect
        self.set_effect(trigger_ids=[13102], visible=False) # Right Sound Effect
        self.set_effect(trigger_ids=[13103], visible=False) # Right Sound Effect
        self.set_effect(trigger_ids=[13200], visible=False) # Success Sound Effect
        self.set_mesh(trigger_ids=[13300], visible=False, start_delay=0, interval=0, fade=0) # Final_FootHold
...
class PassingThroughRing_Play01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[13001], visible=True, start_delay=0, interval=0, fade=1) # off_01
...
class PassingThroughRing_Play01_Delay(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[13001], visible=False, start_delay=1, interval=0, fade=1) # off_01
        self.set_mesh(trigger_ids=[13011], visible=True, start_delay=0, interval=0, fade=1) # on_01
        self.set_mesh_animation(trigger_ids=[13011], visible=True, start_delay=0, interval=0) # on_01
...
class PassingThroughRing_Play02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[13002], visible=True, start_delay=0, interval=0, fade=1) # off_02
...
class PassingThroughRing_Play02_Delay(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[13002], visible=False, start_delay=1, interval=0, fade=1) # off_02
        self.set_mesh(trigger_ids=[13012], visible=True, start_delay=0, interval=0, fade=1) # on_02
        self.set_mesh_animation(trigger_ids=[13012], visible=True, start_delay=0, interval=0) # on_02
...
class PassingThroughRing_Play03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[13003], visible=True, start_delay=0, interval=0, fade=1) # off_03
...
class PassingThroughRing_Play03_Delay(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[13003], visible=False, start_delay=1, interval=0, fade=1) # off_03
        self.set_mesh(trigger_ids=[13013], visible=True, start_delay=0, interval=0, fade=1) # on_03
        self.set_mesh_animation(trigger_ids=[13013], visible=True, start_delay=0, interval=0) # on_03
...
class PassingThroughRing_Success(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[13300], visible=True, start_delay=0, interval=0, fade=0) # Final_FootHold
        # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거
