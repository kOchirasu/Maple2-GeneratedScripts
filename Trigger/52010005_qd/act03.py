...
# 3rd Quest
class Q3_미카등장01(common.Trigger):
    def on_enter(self):
...
class Q3_미카연출01(common.Trigger):
    def on_enter(self):
...
class Q3_미카연출04(common.Trigger):
    def on_enter(self):
...
class Q3_시네마틱연출01(common.Trigger):
    def on_enter(self):
...
class Q3_시네마틱연출02대기(common.Trigger):
    def on_enter(self):
...
class Q3_시네마틱연출02(common.Trigger):
    def on_enter(self):
...
class Q3_시네마틱연출03(common.Trigger):
    def on_enter(self):
...
class Q3_시네마틱연출04(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class Q3_시네마틱연출05(common.Trigger):
    def on_enter(self):
...
class Q3_미카퇴장01(common.Trigger):
    def on_enter(self):
...
class Q3_미카퇴장02(common.Trigger):
    def on_enter(self):
...
class Q3_미카퇴장03(common.Trigger):
    def on_enter(self):
...
class Q3_미카퇴장04(common.Trigger):
    def on_enter(self):
...
class Q3_유저퇴장01(common.Trigger):
    def on_enter(self):
...
class Q3_유저퇴장02(common.Trigger):
    def on_enter(self):
...
class Q3_유저퇴장03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
