...
# 2nd Quest
class Q2_미카등장01(common.Trigger):
    def on_enter(self):
...
class Q2_미카대화01(common.Trigger):
    def on_enter(self):
...
class Q2_미카대화02대기(common.Trigger):
    def on_enter(self):
...
class Q2_미카대화02(common.Trigger):
    def on_enter(self):
...
class Q2_미카대화종료(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
