...
class 전투판으로이동하면(common.Trigger):
    def on_enter(self):
...
class 전투판으로이동하면2(common.Trigger):
    def on_enter(self):
...
class 첫번째오브젝트조사(common.Trigger):
    def on_enter(self):
...
class 두번째전투판으로이동하면(common.Trigger):
    def on_enter(self):
...
class 두번째오브젝트조사(common.Trigger):
    def on_enter(self):
...
class 세번째전투판으로이동하면(common.Trigger):
    def on_enter(self):
...
class 세번째오브젝트조사(common.Trigger):
    def on_enter(self):
...
class 네번째전투판으로이동하면(common.Trigger):
    def on_enter(self):
...
class 네번째오브젝트조사(common.Trigger):
    def on_enter(self):
...
class 보스전투판완성시키기(common.Trigger):
    def on_enter(self):
