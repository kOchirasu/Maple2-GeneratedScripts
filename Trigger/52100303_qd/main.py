...
class 티마이온등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11004715, illust='Eone_serious', script='$52100303_QD__MAIN__0$', duration=3000)
...
class 종료대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11004715, illust='Eone_normal', script='$52100303_QD__MAIN__1$', duration=3000)
