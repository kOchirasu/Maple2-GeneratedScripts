...
class 대기(state.State):
    def on_enter(self):
        dungeon_variable(varId=1, value=0)
        set_user_value(triggerId=99990002, key='Team2Battle', value=0)
...
class 시작(state.State):
    def on_enter(self):
        dungeon_variable(varId=1, value=1)
        set_event_ui(type=1, arg2='경기 시작!\n당신은 B팀입니다.', arg3='3000')
        set_user_value(triggerId=99990002, key='Team2Battle', value=1)
