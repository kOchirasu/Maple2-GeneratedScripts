...
class MelodyPlay01_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11202], visible=True) # Bell F
        self.set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_orange') # Bell F
...
class MelodyPlay01_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11204], visible=True) # Bell A
        self.set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_green') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class CheckAnswer01_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000059], state=1) # Lever F
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000061], state=1) # Lever A
