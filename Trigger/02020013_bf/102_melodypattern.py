...
class MelodyPlay01_Start(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11201], visible=True) # Bell F
        self.set_actor(triggerId=11001, visible=True, initialSequence='ks_quest_musical_B01_red') # Bell F
...
class MelodyPlay01_End(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11001, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay02_Start(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11202], visible=True) # Bell D
...
class MelodyPlay04_Start(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11208], visible=True) # Bell B
        self.set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_pink') # Bell B
...
class MelodyPlay04_End(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell B
...
class MelodyPlay05_Start(common.Trigger):
    def on_enter(self):
        ...
        self.set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_yellow') # Bell HighC
...
class CheckAnswer01_Delay(common.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000058], state=1) # Lever F
...
class CheckAnswer03_Delay(common.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000060], state=1) # Lever A
...
class CheckAnswer04_Delay(common.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000065], state=1) # Lever B
