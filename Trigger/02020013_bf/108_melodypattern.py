...
class MelodyPlay05_Start(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11204], visible=True) # Bell HighC
        self.set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_green') # Bell HighC
...
class MelodyPlay05_End(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11004, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell HighC
