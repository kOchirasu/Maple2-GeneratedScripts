...
class StageEnter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[8100,8101,8102,8103,8104,8105,8106,8107,8108], visible=False) # StageEnter
...
class StageClear01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[8200,8201,8202,8203,8204,8205,8206,8207,8208,8209,8210,8211,8212], visible=False) # Stage01
...
class StageClear02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[8300,8301,8302,8303,8304,8305,8306,8307,8308,8309,8310,8311,8312], visible=False) # Stage02
...
class StageClear03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[8400,8401,8402,8403,8404,8405,8406,8407,8408,8409,8410,8411,8412], visible=False) # Stage03
...
class StageClear04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[8500,8501,8502,8503,8504,8505,8506,8507,8508,8509,8510,8511,8512], visible=False) # Stage04
...
class StageClear05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[8600,8601,8602,8603,8604,8605,8606,8607,8608,8609,8610,8611,8612], visible=False) # Stage05
