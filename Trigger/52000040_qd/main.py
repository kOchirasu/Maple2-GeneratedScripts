...
class sb_ready_01(common.Trigger):
    def on_enter(self):
...
class sb_ready_02(common.Trigger):
    def on_enter(self):
...
class sb_ready_03(common.Trigger):
    def on_enter(self):
...
class sb_ready_04(common.Trigger):
    def on_enter(self):
...
class sb_ready_05(common.Trigger):
    def on_enter(self):
...
class sb_ready_06(common.Trigger):
    def on_enter(self):
...
class sb_ready_07(common.Trigger):
    def on_enter(self):
...
class sb_ready_08(common.Trigger):
    def on_enter(self):
        self.move_user(mapId=52000017, portalId=1)


# 이도 공간에서 돌아온 소울 바인더
class sb_ready_b_02(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_03(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_04(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_06(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_07_skip(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_07(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_08_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class sb_ready_b_08(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_09_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class sb_ready_b_09(common.Trigger):
    def on_enter(self):
...
class sb_ready_b_10_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class sb_ready_b_10(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[145], animationEffect=True)
...
class sb_ready_b_11(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=4)
...
class sb_ready_b_12(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[145], animationEffect=True)
        self.create_monster(spawnIds=[221,222,223], animationEffect=True)
        self.move_npc(spawnId=221, patrolName='MS2PatrolData_2101')
...
class sb_ready_b_13(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[145], animationEffect=True)


class sb_end(common.Trigger):
    pass
...
class ready_04_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class ready_05_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class ready_06_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class ready_07_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class ready_08_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class ready_09_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class ready_10_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_01_ready(common.Trigger):
    def on_enter(self):
...
class start_02_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_03_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_04_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_05_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_06_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_07_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_08_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_09_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_10_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_11_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_12_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_13_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_14_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_15_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class start_16_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
