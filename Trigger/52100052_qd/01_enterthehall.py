...
class BlackeyeApp02(state.State):
    def on_enter(self):
        ...
        add_cinematic_talk(npcId=11001590, illustId='11001590', msg='$52100052_QD__01_ENTERTHEHALL__0$', duration=3000, align='left')
...
class BlackeyeApp03(state.State):
    def on_enter(self):
        ...
        add_cinematic_talk(npcId=11001590, illustId='11001590', msg='$52100052_QD__01_ENTERTHEHALL__1$', duration=3000, align='left')
...
class EnemyApp02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=901, script='$52100052_QD__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=902, script='$52100052_QD__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=903, script='$52100052_QD__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
...
class BlackeyeAction01(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11001590, script='$52100052_QD__01_ENTERTHEHALL__5$', arg4=5) # 이슈라
...
class BlackeyeAction02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$52100052_QD__01_ENTERTHEHALL__6$', arg4=3, arg5=1)
...
class MoveToUpstairs02(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11001590, script='$52100052_QD__01_ENTERTHEHALL__7$', arg4=5) # 이슈라
...
class Quit(state.State):
    def on_enter(self):
        play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        set_event_ui(type=1, arg2='$52100052_QD__01_ENTERTHEHALL__8$', arg3='4000', arg4='0')
...
class NpcMonologue01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100052_QD__01_ENTERTHEHALL__9$', arg4=3, arg5=0) # 이슈라
...
class NpcMonologue02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100052_QD__01_ENTERTHEHALL__10$', arg4=3, arg5=0) # 이슈라
...
class NpcMonologue03(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100052_QD__01_ENTERTHEHALL__11$', arg4=3, arg5=0) # 이슈라
...
class NpcMonologue04(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100052_QD__01_ENTERTHEHALL__12$', arg4=3, arg5=0) # 이슈라
