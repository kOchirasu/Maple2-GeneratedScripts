...
class BlackeyeApp02(common.Trigger):
    def on_enter(self):
        ...
        self.add_cinematic_talk(npcId=11001590, illustId='11001590', msg='$52100052_QD__01_ENTERTHEHALL__0$', duration=3000, align='left')
...
class EnemyApp02(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=901, script='$52100052_QD__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=902, script='$52100052_QD__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=903, script='$52100052_QD__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
