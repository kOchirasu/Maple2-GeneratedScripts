...
class 예고이펙트(state.State):
    def on_enter(self):
        set_effect(triggerIds=[8013], visible=True)
        set_effect(triggerIds=[8014], visible=True)
        set_effect(triggerIds=[8015], visible=True)
        set_effect(triggerIds=[8016], visible=True)
        set_effect(triggerIds=[8017], visible=True)
        set_effect(triggerIds=[8018], visible=True)
        set_effect(triggerIds=[8019], visible=True)
        set_effect(triggerIds=[8020], visible=True)
        set_effect(triggerIds=[8021], visible=True)
        set_effect(triggerIds=[8022], visible=True)
        set_effect(triggerIds=[8023], visible=True)
        set_effect(triggerIds=[8024], visible=True)
        set_effect(triggerIds=[8025], visible=True)
        set_effect(triggerIds=[8026], visible=True)
        set_effect(triggerIds=[8027], visible=True)
        set_effect(triggerIds=[8028], visible=True)
        set_effect(triggerIds=[8029], visible=True)
        set_effect(triggerIds=[8030], visible=True)
...
class 스킬시작대기(state.State):
    def on_enter(self):
        create_monster(spawnIds=[1063], arg2=False)
        create_monster(spawnIds=[1064], arg2=False)
        create_monster(spawnIds=[1065], arg2=False)
        create_monster(spawnIds=[1066], arg2=False)
        create_monster(spawnIds=[1067], arg2=False)
        create_monster(spawnIds=[1068], arg2=False)
        create_monster(spawnIds=[1069], arg2=False)
        create_monster(spawnIds=[1070], arg2=False)
        create_monster(spawnIds=[1071], arg2=False)
        create_monster(spawnIds=[1072], arg2=False)
        create_monster(spawnIds=[1073], arg2=False)
        create_monster(spawnIds=[1074], arg2=False)
