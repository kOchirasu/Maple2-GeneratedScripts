...
class 스킬시작대기(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[1063], animationEffect=False)
        self.create_monster(spawnIds=[1064], animationEffect=False)
        self.create_monster(spawnIds=[1065], animationEffect=False)
        self.create_monster(spawnIds=[1066], animationEffect=False)
        self.create_monster(spawnIds=[1067], animationEffect=False)
        self.create_monster(spawnIds=[1068], animationEffect=False)
        self.create_monster(spawnIds=[1069], animationEffect=False)
        self.create_monster(spawnIds=[1070], animationEffect=False)
        self.create_monster(spawnIds=[1071], animationEffect=False)
        self.create_monster(spawnIds=[1072], animationEffect=False)
        self.create_monster(spawnIds=[1073], animationEffect=False)
        self.create_monster(spawnIds=[1074], animationEffect=False)
