...
class 전투페이즈_2_대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=4000301, script='하하하!!내가 돌아왔다!', time=3, arg5=0)
...
class 끝(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='카...카트반? 어떻게?!', time=3, arg5=0)
...
class 조디등장_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=0, script='!!!!!!!??????', time=3, arg5=0)
        self.set_dialogue(type=2, spawn_id=0, script='조...조디?!', time=3, arg5=0)
        self.set_dialogue(type=2, spawn_id=0, script='조디...살아있었던거야?', time=3, arg5=0)
        ...
        self.set_dialogue(type=2, spawn_id=0, script='그...그게 아니야!!', time=3, arg5=0)
        self.set_dialogue(type=2, spawn_id=300001, script='당신을...저주해요..가만두지 않겠어요!!', time=5)
        self.set_dialogue(type=2, spawn_id=0, script='아...안돼 그만둬!! 조디!!', time=3, arg5=0)
...
class 마지막전투_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='조디!! 제발 맘춰!!', time=3, arg5=0)
...
class 긴급대화_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='이젠...더이상은...힘들어....', time=3, arg5=0)
...
class 마지막_연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=400001, sequence_name='Attack_Idle_A', duration=100000000)
        self.set_npc_emotion_loop(spawn_id=400002, sequence_name='Attack_Idle_A', duration=100000000)
        self.set_npc_emotion_loop(spawn_id=400003, sequence_name='Attack_Idle_A', duration=100000000)
    ...
    def on_exit(self) -> None:
        self.set_pc_emotion_loop(sequence_name='Emotion_Disappoint_Idle_A', duration=100000000)
...
class 마지막_연출_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=0, script='헉헉...제발 그만둬!!', time=3, arg5=0)
