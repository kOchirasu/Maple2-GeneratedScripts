...
class 인트로_3(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return 미카엘등장(self.ctx)


class 미카엘등장(common.Trigger):
    def on_enter(self):
...
class npc등장연출_1(common.Trigger):
    def on_enter(self):
...
class npc등장연출_2(common.Trigger):
    def on_enter(self):
...
class npc등장연출_3(common.Trigger):
    def on_enter(self):
...
class npc등장연출_4(common.Trigger):
    def on_enter(self):
...
class 몬스터등장_2_2(common.Trigger):
    def on_enter(self):
...
class 몬스터등장_2_3(common.Trigger):
    def on_enter(self):
...
class 몬스터등장_2_4(common.Trigger):
    def on_enter(self):
