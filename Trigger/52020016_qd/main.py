...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_portal(portal_id=95, visible=False, enable=False)
        self.set_portal(portal_id=96, visible=False, enable=False)
        self.set_effect(trigger_ids=[70001,70002,70003,70004,70005,70006,70007,70008,70009,70010,70011,70012,70013,70014,70015,70016,70017,70018,70019,70020,70021,70022,70023,70024], visible=False)
        self.set_mesh(trigger_ids=[5001,5002,5003,5004,5005], visible=False, start_delay=0, interval=0, fade=0)
        # self.set_effect(trigger_ids=[71001,71002,71003,71004,71005,71006,71007,71008,71009,71010,71011,71012,71013,71014,71015,71016], visible=False)
        self.set_effect(trigger_ids=[72001,72002,72003,72004,72005,72006,72007,72008,72009,72010,72011,72012], visible=False)
        self.set_effect(trigger_ids=[73001,73002,73003,73004,73005,73006,73007,73008,73009,73010,73011,73012], visible=False)
        self.set_mesh(trigger_ids=[5103,5104], visible=False, start_delay=0, interval=0, fade=0)
...
class 시작_2_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=0, script='이곳은 뭐하는 곳이지?!', time=3, arg5=0)
        self.set_dialogue(type=2, spawn_id=0, script='미카엘의 기운이 느껴지고 있어!\\n서둘러야 해!!', time=3, arg5=0)
...
class 시작_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[2000004], return_view=True)
...
class 시작_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='한번 가볼까?', time=3, arg5=0)
...
class 인트로(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=1)
        self.set_pc_emotion_loop(sequence_name='Stun_A', duration=1500)
...
class 인트로_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=0, script='???!!!', time=2, arg5=0)
        self.set_dialogue(type=2, spawn_id=0, script='뭐야!!\\n앞이 안보여!!', time=3, arg5=0)
...
class 대화_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[5001,5002,5003,5004,5005], visible=True, start_delay=0, interval=0, fade=0)
...
class 카메라리셋_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[2000001], return_view=True)
        self.set_cinematic_ui(type=2)
        self.set_cinematic_ui(type=0)
...
class 이동_1(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        self.set_directional_light(diffuse_color=[219,204,182], specular_color=[219,204,182])
        self.set_portal(portal_id=95, visible=True, enable=True)
        self.set_dialogue(type=1, spawn_id=0, script='갇혀 버렸어!', time=3, arg5=0)
...
class 전투페이즈_1(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        self.shadow_expedition(type='OpenBossGauge', max_gauge_point=300, title='몬스터 처치 달성')
...
class 대화_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[5103,5104], visible=True, start_delay=0, interval=0, fade=0)
        # self.set_mesh(trigger_ids=[5001,5002,5003,5004,5005], visible=True, start_delay=0, interval=0, fade=0)
...
class 카메라리셋_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[2000002], return_view=True)
...
class 대화_놀람(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='아앗! 오스칼과 레드아이, 알론... 그리고 레논?', time=3, arg5=0)
...
class 대화(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='헉헉...그만둬! 모두들!!', time=3, arg5=0)
...
class 시간종료_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_ambient_light(primary=[0,0,0])
        self.set_directional_light(diffuse_color=[193,180,137], specular_color=[100,100,100])
        self.set_dialogue(type=1, spawn_id=0, script='모두들...어디로 사라진거야?', time=3, arg5=0)
...
class 몬스터등장_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[72001,72002,72003,72004,72005,72006,72007,72008,72009,72010,72011,72012], visible=False)
        self.set_mesh(trigger_ids=[5104], visible=False, start_delay=0, interval=0, fade=0)
        self.set_dialogue(type=1, spawn_id=0, script='여기서 쓰러질 순 없어!', time=3, arg5=0)
...
class 카메라리셋_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[2000003], return_view=True)
        self.set_cinematic_ui(type=2)
        self.set_cinematic_ui(type=0)
...
class 이동_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[70001,70002,70003,70004,70005,70006,70007,70008,70009,70010,70011,70012,70013,70014,70015,70016,70017,70018,70019,70020,70021,70022,70023,70024], visible=True)
        self.set_mesh(trigger_ids=[5001,5002,5003,5004,5005], visible=True, start_delay=0, interval=0, fade=0)
        self.set_dialogue(type=1, spawn_id=0, script='아니! 이 녀석들은??!!', time=3, arg5=0)
