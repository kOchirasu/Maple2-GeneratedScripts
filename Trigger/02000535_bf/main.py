...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[801], visible=False)
        self.set_effect(trigger_ids=[802], visible=False)
...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[5522,5523,5524,5525,5526,5527,5528,5529,5530], auto_target=True)
        self.spawn_monster(spawn_ids=[9902,9903,9904,9905], auto_target=True)
        self.spawn_monster(spawn_ids=[5500,5501,5502,5503,5504,5505,5506,5507,5508,5509,5510,5511,5512,5513,5514,5515,5516,5517,5518,5519,5520,5521], auto_target=True)
...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[5531], auto_target=True)
        self.add_balloon_talk(spawn_id=5531, msg='$02000535_BF__MAIN__0$', duration=3500, delay_tick=0)
        ...
        self.set_npc_emotion_loop(spawn_id=5531, sequence_name='Attack_Idle_A', duration=7000)
...
class 첫번째전투(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[523,524,525,526,527,528,529,530,531], auto_target=True)
...
class 다음으로이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$02000535_BF__MAIN__4$', duration=3500)
...
class 머리를쓰자(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=0, msg='$02000535_BF__MAIN__5$', duration=3500)
...
class 통로이동1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[5000,5001,5002,5003,5004], auto_target=True)
...
class 메이드대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=670, sequence_name='Attack_Idle_A', duration=5000)
        self.set_npc_emotion_loop(spawn_id=671, sequence_name='Attack_Idle_A', duration=5000)
...
class 흑성회스폰(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[601,602,603,604,605], auto_target=True)
        self.spawn_monster(spawn_ids=[680,681], auto_target=True)
...
class 간부들엿보기2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=0, msg='$02000535_BF__MAIN__24$', duration=3500)
...
class 카메라리셋시키기2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$02000535_BF__MAIN__28$', duration=3500)
...
class 테라스몬스터생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[606,6606,608,6608], auto_target=True)
...
class 테라스몬스터생성3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[607,6607,609,610], auto_target=True)
...
class 포탈생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4019], visible=False)
...
class 실패게임로직종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$02000535_BF__MAIN__42$', duration=3500)
        self.lock_my_pc(is_lock=False)
