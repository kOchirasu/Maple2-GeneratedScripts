...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5305], visible=False)
        self.set_effect(trigger_ids=[5306], visible=False)
        self.set_effect(trigger_ids=[5307], visible=False)
        self.set_effect(trigger_ids=[5308], visible=False)
        self.set_effect(trigger_ids=[5309], visible=False)
        self.set_effect(trigger_ids=[5310], visible=False)
        self.set_effect(trigger_ids=[5311], visible=False)
        self.set_effect(trigger_ids=[5312], visible=False)
        self.set_effect(trigger_ids=[5313], visible=False)
        self.set_effect(trigger_ids=[5314], visible=False)
        self.set_effect(trigger_ids=[5315], visible=False)
...
class 커닝시티전경씬03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_caption(type='VerticalCaption', title='$52000111_QD__52000111__0$', desc='$52000111_QD__52000111__1$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=7000, scale=2.5)
...
class Quit02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000111_QD__52000111__2$', duration=6000, delay_tick=1000)
...
class 쉐도우클로등장씬02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000111_QD__52000111__3$', duration=6000, delay_tick=1000)
        self.set_pc_emotion_loop(sequence_name='Assassin_Bore_A', duration=25000)
...
class 쉐도우클로등장씬04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000111_QD__52000111__4$', duration=6000, delay_tick=1000)
...
class 쉐도우클로등장씬05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_npc_range(range_ids=[202,203,204,205,206,207,208,209,210,211], is_auto_targeting=False)
...
class 쉐도우클로등장씬07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=200, sequence_name='Sit_Down_A', duration=4000)
...
class 쉐도우클로등장씬11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='NameCaption', title='$52000111_QD__52000111__5$', desc='$52000111_QD__52000111__6$', align='center', offset_rate_x=-0.15, offset_rate_y=0.15, duration=10000, scale=2)
...
class PC대탈출02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Push_A', duration=8000)
        self.face_emotion(spawn_id=0, emotion_name='PC_Pain_86000')
        self.set_npc_emotion_loop(spawn_id=300, sequence_name='Sit_Down_A', duration=17500)
        self.set_npc_emotion_loop(spawn_id=301, sequence_name='Sit_Down_A', duration=17500)
        self.set_npc_emotion_loop(spawn_id=302, sequence_name='Sit_Down_A', duration=17500)
...
class PC대탈출04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=2)
        self.reset_camera(interpolation_time=0)
        self.add_balloon_talk(spawn_id=0, msg='$52000111_QD__52000111__7$', duration=6000, delay_tick=1000)
...
class 어쌔신탈출02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_user(map_id=52000113, portal_id=0)
