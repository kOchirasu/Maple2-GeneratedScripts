...
class 도망쳐_01_02(common.Trigger):
    def on_enter(self):
...
class 도망쳐_10_01(common.Trigger):
    def on_enter(self):
...
class 도망쳐_10_02(common.Trigger):
    def on_enter(self):
...
class 도망쳐_15_01(common.Trigger):
    def on_enter(self):
        self.set_pc_emotion_loop(sequenceName='Talk_A', duration=4000)
