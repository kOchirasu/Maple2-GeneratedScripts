...
class start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_portal(portal_id=5002, visible=False, enable=False)
        self.set_portal(portal_id=2, visible=False, enable=False)
        self.set_portal(portal_id=4, visible=False, enable=False)
        self.set_mesh(trigger_ids=[8002], visible=False)
...
class 도망쳐_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11001302, msg='$52000198_QD__52000198__1$', align='left', illust_id='Ereb_serious', duration=4500)
        self.add_cinematic_talk(npc_id=0, msg='$52000198_QD__52000198__2$', duration=4000)
        self.add_cinematic_talk(npc_id=11001302, msg='$52000198_QD__52000198__3$', align='left', illust_id='Ereb_serious', duration=4500)
...
class 도망쳐_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=3)
        self.add_cinematic_talk(npc_id=11001302, msg='$52000198_QD__52000198__8$', align='right', illust_id='Ereb_serious', duration=4500)
...
class 도망쳐_10_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11001302, msg='$52000198_QD__52000198__10$', align='right', illust_id='Ereb_serious', duration=4500)
...
class 도망쳐_10_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_loop(sequence_name='Talk_A', duration=4500)
...
class 도망쳐_15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004787, msg='$52000198_QD__52000198__16$', align='left', illust_id='Baron_normal', duration=4500)
...
class 도망쳐_15_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004787, msg='$52000198_QD__52000198__18$', align='left', illust_id='Baron_normal', duration=4000)
        self.add_cinematic_talk(npc_id=11004787, msg='$52000198_QD__52000198__19$', align='left', illust_id='Baron_normal', duration=4000)
...
class 도망쳐_20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.add_cinematic_talk(npc_id=11001302, msg='$52000198_QD__52000198__20$', align='right', illust_id='Ereb_surprise', duration=4000)
        self.add_cinematic_talk(npc_id=11004787, msg='$52000198_QD__52000198__21$', align='left', illust_id='Baron_normal', duration=4000)
        self.add_cinematic_talk(npc_id=11001302, msg='$52000198_QD__52000198__22$', align='right', illust_id='Ereb_serious', duration=4500)
...
class 도망쳐_22(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_loop(sequence_name='Object_React_A', duration=3000)
