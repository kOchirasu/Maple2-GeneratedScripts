...
class 시작대기중(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10000681], state=1)
...
class 오브젝트반응(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10000681], stateValue=0):
            return 시간텀(self.ctx)
...
class NPC이동(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=1106, script='$02000269_BF__IM_106__0$', arg4=2)
