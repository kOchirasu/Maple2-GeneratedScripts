...
class 투르카_클라디아_02(common.Trigger):
    def on_enter(self):
...
class 투르카_클라디아_03(common.Trigger):
    def on_enter(self):
...
class 투르카_클라디아_04(common.Trigger):
    def on_enter(self):
...
class 투르카_클라디아_05(common.Trigger):
    def on_enter(self):
...
class 장치가동_01_02(common.Trigger):
    def on_enter(self):
...
class 장치가동_01_03(common.Trigger):
    def on_enter(self):
...
class 장치가동_02_01(common.Trigger):
    def on_enter(self):
