...
class 종료연출대기(state.State):
    def on_enter(self):
        ...
        move_user(mapId=2000392, portalId=2)
...
class 종료연출(state.State):
    def on_enter(self):
        set_skip(state=연출종료)
        set_conversation(type=1, spawnId=1098, script='$02000392_BF__MAIN__0$', arg4=3, arg5=0)
        set_conversation(type=1, spawnId=1099, script='$02000392_BF__MAIN__1$', arg4=3, arg5=0)
...
class 자매대화01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1096, script='$02000392_BF__MAIN__3$', arg4=3, arg5=0)
        set_conversation(type=1, spawnId=1097, script='$02000392_BF__MAIN__4$', arg4=3, arg5=1)
...
class 자매대화02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1096, script='$02000392_BF__MAIN__5$', arg4=3, arg5=0)
...
class 자매대화03(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1097, script='$02000392_BF__MAIN__11$', arg4=2, arg5=0)
...
class 자매대화04(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1097, script='$02000392_BF__MAIN__7$', arg4=3, arg5=0)
...
class 자매대화05(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1097, script='$02000392_BF__MAIN__8$', arg4=3, arg5=0)
...
class 자매대화06(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1097, script='$02000392_BF__MAIN__9$', arg4=3, arg5=0)
