...
class StandAside10(common.Trigger):
    def on_enter(self):
...
class StandAside11(common.Trigger):
    def on_enter(self):
...
# 퀘스트 진행 완료 상태
class StandAside20(common.Trigger):
    def on_enter(self):
        self.set_sound(triggerId=10000, enable=True)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class StandAside21(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=203, patrolName='MS2PatrolData_203')
        self.move_npc(spawnId=205, patrolName='MS2PatrolData_205')
        self.move_npc(spawnId=206, patrolName='MS2PatrolData_206')
...
# 최초 입장
class PlayOpeningMovie01(common.Trigger):
    def on_enter(self):
...
class PlayOpeningMovie02(common.Trigger):
    def on_enter(self):
...
class PlayMovie01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=2000):
            return PlayMovie02(self.ctx)


class PlayMovie02(common.Trigger):
    def on_enter(self):
        self.create_widget(type='SceneMovie')
        self.widget_action(type='SceneMovie', func='Clear')
...
class WeiHongTalk03(common.Trigger):
    def on_enter(self):
...
class WeiHongTalk04(common.Trigger):
    def on_enter(self):
...
class WeiHongTalk05(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_effect(triggerIds=[8001], visible=False) # WeiHong 00001391
...
class WeiHongTalk06(common.Trigger):
    def on_enter(self):
...
class WeiHongTalk07(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_effect(triggerIds=[8002], visible=False) # WeiHong 00001392
...
class StandAside01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=201, patrolName='MS2PatrolData_201')
        self.move_npc(spawnId=202, patrolName='MS2PatrolData_202')
        self.move_npc(spawnId=204, patrolName='MS2PatrolData_204')
...
class StandAside02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=203, patrolName='MS2PatrolData_203')
        self.move_npc(spawnId=205, patrolName='MS2PatrolData_205')
        self.move_npc(spawnId=206, patrolName='MS2PatrolData_206')
...
class StandAside03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class KeytypeSelect01(common.Trigger):
    def on_enter(self):
...
class MeetWeiHong01(common.Trigger):
    def on_enter(self):
        ...
        self.show_guide_summary(entityId=10020010, textId=10020010) # 가이드 : 방향키를 이용해 화살표가 가리키는 곳으로 이동하기
...
class MeetWeiHong02(common.Trigger):
    def on_enter(self):
...
class WeiHongTalk10(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class WeiHongTalk11(common.Trigger):
    def on_enter(self):
...
class WeiHongTalk12(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_effect(triggerIds=[8005], visible=False) # WeiHong 00000480
...
class WeiHongTalk13(common.Trigger):
    def on_enter(self):
...
class WeiHongTalk14(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_effect(triggerIds=[8003], visible=False) # WeiHong 00001393
...
class MafiaTalk10(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[6000], visible=True) # VoiceGangster
...
class MafiaTalk11(common.Trigger):
    def on_enter(self):
...
class MafiaTalk12(common.Trigger):
    def on_enter(self):
...
class WeiHongTalk20(common.Trigger):
    def on_enter(self):
...
class WeiHongQuest01(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_effect(triggerIds=[8004], visible=False) # WeiHong 00001394
...
class WeiHongQuest02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
...
class WeiHongQuest03(common.Trigger):
    def on_enter(self):
