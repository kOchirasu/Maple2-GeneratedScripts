...
class 다음몬스터생성조건체크(common.Trigger):
    def on_enter(self):
...
class 다음몬스터생성조건체크2(common.Trigger):
    def on_enter(self):
...
class 다음몬스터생성조건체크3(common.Trigger):
    def on_enter(self):
...
class 두번째다리만들기1(common.Trigger):
    def on_enter(self):
...
class 두번째다리만들기2(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=2000):
            return 두번째사다리생성하기1(self.ctx)


class 두번째사다리생성하기1(common.Trigger):
    def on_enter(self):
