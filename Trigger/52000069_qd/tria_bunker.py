...
class 카메라이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11000064, illust_id='Lennon_normal', msg='$52000069_QD__TRIA_BUNKER__0$', duration=9195, align='left')
...
class 연출종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1003, script='$52000069_QD__TRIA_BUNKER__1$', time=4, arg5=0)
...
class 프레이대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11000119, illust_id='Fray_serious', msg='$52000069_QD__TRIA_BUNKER__2$', duration=4000, align='center')
...
class 지원군연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1004, script='$52000069_QD__TRIA_BUNKER__3$', time=4, arg5=0)
        self.set_dialogue(type=1, spawn_id=1005, script='$52000069_QD__TRIA_BUNKER__4$', time=4, arg5=0)
...
class 에레브대사04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_sound(trigger_id=90000, enable=False) # TriaAttack
        self.add_cinematic_talk(npc_id=11000075, illust_id='Ereb_surprise', msg='$52000069_QD__TRIA_BUNKER__8$', duration=4000, align='center')
...
class 쓰러짐(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=1006, sequence_name='Down_Idle_A', duration=1E+09)
        self.set_npc_emotion_loop(spawn_id=1007, sequence_name='Down_Idle_A', duration=1E+09)
        # self.set_npc_emotion_loop(spawn_id=1008, sequence_name='Down_Idle', duration=1E+09)
        self.set_npc_emotion_loop(spawn_id=1009, sequence_name='Dead_Idle_A', duration=1E+09)
...
class 마드리아공격(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11000075, illust_id='Ereb_serious', msg='$52000069_QD__TRIA_BUNKER__10$', duration=3000, align='center')
...
class 에레브각성2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=1000, sequence_name='Damg_Idle_B', duration=1E+09)
