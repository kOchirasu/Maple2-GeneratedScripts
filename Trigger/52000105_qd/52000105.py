...
# ########################씬2 몬스터 소환 교육01~02########################
class 몬스터처치훈련01(common.Trigger):
    def on_enter(self):
...
class 몬스터처치훈련02(common.Trigger):
    def on_enter(self):
...
class 할아버지대련02_b(common.Trigger):
    def on_enter(self):
...
class 할아버지대련05_B(common.Trigger):
    def on_enter(self):
...
class 대련종료씬시작02_01(common.Trigger):
    def on_enter(self):
...
class 대련종료씬시작07_b(common.Trigger):
    def on_enter(self):
...
# ########################씬4 떠나는할아버지01########################
class 떠나는할아버지01(common.Trigger):
    def on_enter(self):
...
class 떠나는할아버지02(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
...
class 떠나는할아버지03(common.Trigger):
    def on_enter(self):
...
class 떠나는할아버지04(common.Trigger):
    def on_enter(self):
...
class 떠나는할아버지05(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
...
class 떠나는할아버지06(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 떠나는할아버지07(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
