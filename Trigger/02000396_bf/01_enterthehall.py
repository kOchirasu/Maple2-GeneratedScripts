...
class BlackeyeApp01(common.Trigger):
    def on_enter(self):
...
class BlackeyeApp02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera(triggerId=600, enable=True)
        self.move_npc(spawnId=101, patrolName='MS2PatrolData_101')
        self.set_conversation(type=1, spawnId=101, script='$02000396_BF__01_ENTERTHEHALL__0$', arg4=3, arg5=1)
...
class BlackeyeApp02Skip(common.Trigger):
    def on_enter(self):
...
class BlackeyeApp03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=101, script='$02000396_BF__01_ENTERTHEHALL__1$', arg4=3, arg5=0)
...
class BlackeyeApp03Skip(common.Trigger):
    def on_enter(self):
        self.remove_balloon_talk(spawnId=101)
        self.set_skip()
...
class EnemyApp01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class EnemyApp02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.create_monster(spawnIds=[901,902,903], animationEffect=False) # Mob_Actor
        self.set_conversation(type=1, spawnId=901, script='$02000396_BF__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=902, script='$02000396_BF__01_ENTERTHEHALL__3$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=903, script='$02000396_BF__01_ENTERTHEHALL__4$', arg4=2, arg5=1)
...
class EnemyApp03Skip(common.Trigger):
    def on_enter(self):
...
class EnemyApp03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera(triggerId=600, enable=True)
...
class BlackeyeAction01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_conversation(type=2, spawnId=11000006, script='$02000396_BF__01_ENTERTHEHALL__5$', arg4=5) # 블랙아이
...
class BlackeyeAction01Skip(common.Trigger):
    def on_enter(self):
...
class BlackeyeAction02(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101]) # Npc_Actor
        self.create_monster(spawnIds=[102], animationEffect=False) # Npc_Battle
        self.set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__6$', arg4=3, arg5=1)
...
class BlackeyeAction03(common.Trigger):
    def on_enter(self):
...
class MoveToUpstairs01(common.Trigger):
    def on_enter(self):
...
class MoveToUpstairs02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_conversation(type=2, spawnId=11000006, script='$02000396_BF__01_ENTERTHEHALL__7$', arg4=5) # 블랙아이
...
class MoveToUpstairs02Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
...
class FindWayOut01(common.Trigger):
    def on_enter(self):
...
class NpcMonologueRandom(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class NpcMonologue01(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__9$', arg4=3, arg5=0)
...
class NpcMonologue02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__10$', arg4=3, arg5=0)
...
class NpcMonologue03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__11$', arg4=3, arg5=0)
...
class NpcMonologue04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__12$', arg4=3, arg5=0)
