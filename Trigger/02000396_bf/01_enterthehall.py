...
class BlackeyeApp02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=101, script='$02000396_BF__01_ENTERTHEHALL__0$', arg4=3, arg5=1)
...
class BlackeyeApp03(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=101, script='$02000396_BF__01_ENTERTHEHALL__1$', arg4=3, arg5=0)
...
class EnemyApp02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=901, script='$02000396_BF__01_ENTERTHEHALL__2$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=902, script='$02000396_BF__01_ENTERTHEHALL__3$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=903, script='$02000396_BF__01_ENTERTHEHALL__4$', arg4=2, arg5=1)
...
class BlackeyeAction01(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11000006, script='$02000396_BF__01_ENTERTHEHALL__5$', arg4=5) # 블랙아이
...
class BlackeyeAction02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__6$', arg4=3, arg5=1)
...
class MoveToUpstairs02(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11000006, script='$02000396_BF__01_ENTERTHEHALL__7$', arg4=5) # 블랙아이
...
class Quit(state.State):
    def on_enter(self):
        play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        set_event_ui(type=1, arg2='$02000396_BF__01_ENTERTHEHALL__8$', arg3='4000', arg4='0')
...
class NpcMonologue01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__9$', arg4=3, arg5=0)
...
class NpcMonologue02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__10$', arg4=3, arg5=0)
...
class NpcMonologue03(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__11$', arg4=3, arg5=0)
...
class NpcMonologue04(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000396_BF__01_ENTERTHEHALL__12$', arg4=3, arg5=0)
