...
class Wait(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10001137], state=0) # ToWall_True
        set_interact_object(triggerIds=[10001138], state=0) # ToRoom_True
        set_interact_object(triggerIds=[10001139], state=0) # ToTower_True
...
class ToWall01(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10001137], state=1) # ToWall_True
    ...
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001137], arg2=0):
            return ToWall02()
...
class ToWallGuide01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000006, script='$02000396_BF__04_RANDOMPORTAL__1$', arg4=5) # 블랙아이
...
class ToRoom01(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10001138], state=1) # ToRoom_True
        set_user_value(triggerId=5, key='ToWallFalse', value=1) # ToWall_False
        set_user_value(triggerId=7, key='ToTowerFalse', value=1) # ToTowerFalse

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001138], arg2=0):
            return ToRoom02()


class ToRoom02(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000396_BF__04_RANDOMPORTAL__2$', arg3='2000', arg4='0')
...
class ToRoomGuide01(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11000006, script='$02000396_BF__04_RANDOMPORTAL__3$', arg4=5) # 블랙아이
...
class ToTower01(state.State):
    def on_enter(self):
        set_user_value(triggerId=5, key='ToWallFalse', value=1) # ToWall_False
        set_user_value(triggerId=6, key='ToRoomFalse', value=1) # ToRoom_False
        set_interact_object(triggerIds=[10001139], state=1) # ToTower_True

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001139], arg2=0):
            return ToTower02()


class ToTower02(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000396_BF__04_RANDOMPORTAL__4$', arg3='2000', arg4='0')
...
class ToTowerGuide01(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11000006, script='$02000396_BF__04_RANDOMPORTAL__5$', arg4=5) # 블랙아이
