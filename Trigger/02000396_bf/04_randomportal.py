...
class Wait(trigger_api.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10001137], state=0) # ToWall_True
        self.set_interact_object(triggerIds=[10001138], state=0) # ToRoom_True
        self.set_interact_object(triggerIds=[10001139], state=0) # ToTower_True
...
class ToWall01(trigger_api.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10001137], state=1) # ToWall_True
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10001137], stateValue=0):
...
class ToWallGuide01(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000006, script='$02000396_BF__04_RANDOMPORTAL__1$', arg4=5) # 블랙아이
...
class ToRoom01(trigger_api.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10001138], state=1) # ToRoom_True
        self.set_user_value(triggerId=5, key='ToWallFalse', value=1) # ToWall_False
        self.set_user_value(triggerId=7, key='ToTowerFalse', value=1) # ToTowerFalse

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10001138], stateValue=0):
...
class ToRoomGuide01(trigger_api.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_conversation(type=2, spawnId=11000006, script='$02000396_BF__04_RANDOMPORTAL__3$', arg4=5) # 블랙아이
...
class ToTower01(trigger_api.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=5, key='ToWallFalse', value=1) # ToWall_False
        self.set_user_value(triggerId=6, key='ToRoomFalse', value=1) # ToRoom_False
        self.set_interact_object(triggerIds=[10001139], state=1) # ToTower_True

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10001139], stateValue=0):
...
class ToTowerGuide01(trigger_api.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_conversation(type=2, spawnId=11000006, script='$02000396_BF__04_RANDOMPORTAL__5$', arg4=5) # 블랙아이
