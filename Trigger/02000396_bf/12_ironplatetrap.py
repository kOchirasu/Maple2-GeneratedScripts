...
class Setting(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10001131], state=0, arg4=False) # LeverForTrap
...
class LeverOn(trigger_api.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10001131], state=1) # LeverForTrap
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10001131], stateValue=0):
