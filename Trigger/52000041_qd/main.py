...
class 완료조건체크50001392(common.Trigger):
    def on_enter(self):
...
class 진행조건체크50001402(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 진행조건체크50001400(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 상태07(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=100):
            return 종료(self.ctx)


class 상태08(common.Trigger):
    def on_enter(self):
...
class 어흥이대사01스킵(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[601], visible=False)
...
class 어흥이대사02스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 준타대사02_2스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 어흥이대사03스킵(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[604], visible=False)
        self.remove_cinematic_talk()
        self.set_skip()
...
class 어흥이대사05스킵(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[606], visible=False)
        self.remove_cinematic_talk()
        self.set_skip()
...
class 어흥이대사06스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
