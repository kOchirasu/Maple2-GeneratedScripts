...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000233], state=2) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거
...
class PassingThroughRing_Success(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000233], state=1) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001131 걸어서 71001031 제거

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[12000233], arg2=0):
