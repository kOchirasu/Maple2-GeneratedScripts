...
class Step_03(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_achievement(triggerId=701, type='trigger', achieve='boomocean_1min')
        # 붐붐오션 1분 버티기 트로피
...
class Step_09(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_achievement(triggerId=701, type='trigger', achieve='boomocean_3min')
        # 붐붐오션 3분 버티기 트로피
...
class Step_15(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_achievement(triggerId=701, type='trigger', achieve='boomocean_5min')
        # 붐붐오션 5분 버티기 트로피
