...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_effect(triggerIds=[7006], visible=False) # RockDrop
        self.set_effect(triggerIds=[7007], visible=False) # RockDrop
...
class RockDrop01(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7006], visible=True) # RockDrop
...
class RockDrop11(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7007], visible=True) # RockDrop
