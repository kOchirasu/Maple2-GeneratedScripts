...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003163, illust_id='Nelf_normal', msg='$52000116_QD__MAIN__0$', duration=4000, align='Right') # 11003163: 넬프
...
class jordyspawn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[102], auto_target=True) # 102:조디
...
class jordyhelp(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/Sound/Eff_Object_Castle_Door_Open_01.xml')
        self.set_dialogue(type=2, spawn_id=11001838, script='$52000116_QD__MAIN__1$', time=1, arg5=0) # 조디 계단 올라가며 하는 대사
...
class wowspawn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[103], auto_target=True) # 103:연출용 강아지
        self.set_dialogue(type=1, spawn_id=102, script='$52000116_QD__MAIN__2$', time=2, arg5=0) # 조디 뒤로 돌아서 하는 대사
...
class wow(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11003179, script='$52000116_QD__MAIN__3$', time=2, arg5=0) # 강아지 짖는 대사
...
class save(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Sit_Down_A', duration=400000)
...
class battleready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[104], auto_target=True, delay=500) # 멍멍이 몬스터
...
class battle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_npc_emotion_loop(spawn_id=104, sequence_name='Attack_Idle_A', duration=10000)
        self.reset_camera(interpolation_time=0.5)
        self.move_user_path(patrol_name='MS2PatrolData_3003')
        self.set_dialogue(type=1, spawn_id=102, script='$52000116_QD__MAIN__4$', time=2, arg5=0) # 조디 말풍선
        self.set_dialogue(type=1, spawn_id=101, script='$52000116_QD__MAIN__5$', time=2, arg5=0) # 넬프 말풍선
...
class fadeout(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
        self.spawn_monster(spawn_ids=[105], auto_target=True) # 조디
