...
class 퀘스트분기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=11010, visible=False, initial_sequence='Dead_A')
        self.set_actor(trigger_id=16000, visible=False, initial_sequence='Stun_A')
        self.set_actor(trigger_id=16001, visible=False, initial_sequence='Stun_A')
        self.set_actor(trigger_id=16002, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16003, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16004, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16005, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16006, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16007, visible=False, initial_sequence='Stun_A')
        self.set_actor(trigger_id=16008, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16009, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16010, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16011, visible=False, initial_sequence='Idle_A')
        self.set_actor(trigger_id=16012, visible=False, initial_sequence='Stun_A')
        ...
        self.set_breakable(trigger_ids=[5000,5001,5002,5003,5004,5005,5006,5007,5008,5009,5010,5011,5012,5013,5014,5015,5016], enable=False)
...
class 마드리아백샷(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2002, script='$52000068_QD__TRIA_SEIGE__0$', time=3, arg5=0)
...
class 연출종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_agent(trigger_ids=[8003], visible=False)
        self.set_agent(trigger_ids=[8004], visible=False)
        self.set_dialogue(type=1, spawn_id=1001, script='$52000068_QD__TRIA_SEIGE__4$', time=4, arg5=0)
...
class 임무01반응대기(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10001074,10001075,10001076], state=2):
            self.set_dialogue(type=1, spawn_id=1001, script='$52000068_QD__TRIA_SEIGE__6$', time=4, arg5=0)
