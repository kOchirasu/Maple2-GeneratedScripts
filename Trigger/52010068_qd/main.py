...
class 틴차이_준타_스폰01(common.Trigger):
    def on_enter(self):
...
class Orde_In_Effect(common.Trigger):
    def on_enter(self):
...
class Orde_In_Turn(common.Trigger):
    def on_enter(self):
...
class Orde_In_Talk(common.Trigger):
    def on_enter(self):
...
class Orde_In_Talk_End(common.Trigger):
    def on_enter(self):
        self.reset_camera()
...
class Orde_In_ReTurn(common.Trigger):
    def on_enter(self):
...
class Orde_Out_Effect(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출02스킵(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출03스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출05스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출9스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출12스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출13스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출18스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출18b스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출19스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출20스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
