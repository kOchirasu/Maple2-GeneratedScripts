...
class 큐브9(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[4014,4015,4016,4017], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[5014,5015,5016,5017], visible=True, start_delay=0, interval=0, fade=0)
...
class 큐브제거(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[4014,4015,4016,4017], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[5014,5015,5016,5017], visible=False, start_delay=0, interval=0, fade=0)
