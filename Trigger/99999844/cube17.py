...
class 큐브17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[4029,4030,4031,4032], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[5029,5030,5031,5032], visible=True, start_delay=0, interval=0, fade=0)
...
class 큐브제거(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[4029,4030,4031,4032], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[5029,5030,5031,5032], visible=False, start_delay=0, interval=0, fade=0)
