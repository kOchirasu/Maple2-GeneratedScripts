...
class 기믹끝(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[905]):
            self.set_conversation(type=1, spawnId=105, script='웃기는군! 이동 할 수 있게 해줄게', arg4=4000)
