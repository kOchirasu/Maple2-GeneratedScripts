...
class 큐브4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[4006,4007], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[5006,5007], visible=True, start_delay=0, interval=0, fade=0)
...
class 큐브제거(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[4006,4007], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[5006,5007], visible=False, start_delay=0, interval=0, fade=0)
