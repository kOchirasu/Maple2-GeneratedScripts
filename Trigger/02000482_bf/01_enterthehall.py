...
class BlackeyeApp03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$02000482_BF__01_ENTERTHEHALL__1$', time=3, arg5=0)
...
class NpcMonologue01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__9$', time=3, arg5=0)
...
class NpcMonologue02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__10$', time=3, arg5=0)
...
class NpcMonologue03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__11$', time=3, arg5=0)
...
class NpcMonologue04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000482_BF__01_ENTERTHEHALL__12$', time=3, arg5=0)
