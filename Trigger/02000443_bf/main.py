...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1001,1002,1003], visible=False)
        self.set_mesh(trigger_ids=[1004,1005,1006], visible=False)
        self.set_mesh(trigger_ids=[1003], visible=False)
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$02000443_BF__MAIN__3$', time=2, arg5=0)
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000443_BF__MAIN__1$', time=2, arg5=0)
        self.set_dialogue(type=1, spawn_id=101, script='$02000443_BF__MAIN__2$', time=2, arg5=0)
