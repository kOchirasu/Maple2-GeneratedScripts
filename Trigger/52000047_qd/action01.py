...
class NPCNotice01(common.Trigger):
    def on_enter(self):
...
class NPCNotice02(common.Trigger):
    def on_enter(self):
...
class NPCNotice03(common.Trigger):
    def on_enter(self):
...
class NPCNotice04(common.Trigger):
    def on_enter(self):
...
class NPCNotice05(common.Trigger):
    def on_enter(self):
...
class NPCNotice06(common.Trigger):
    def on_enter(self):
...
class NPCNotice07(common.Trigger):
    def on_enter(self):
...
class MafiaReadyToFight01(common.Trigger):
    def on_enter(self):
...
class MafiaReadyToFight02(common.Trigger):
    def on_enter(self):
...
class MafiaReadyToFight03(common.Trigger):
    def on_enter(self):
...
class MafiaReadyToFight04(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class MafiaFightStart01(common.Trigger):
    def on_enter(self):
...
class MafiaFightEnd01(common.Trigger):
    def on_enter(self):
...
# 웨이홍 바사라첸 입장
class WeihongWalkIn01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class WeihongWalkIn02(common.Trigger):
    def on_enter(self):
...
class WeihongWalkIn03(common.Trigger):
    def on_enter(self):
...
class WeihongTalk01(common.Trigger):
    def on_enter(self):
...
class WeihongTalk01Skip(common.Trigger):
    def on_enter(self):
...
class WeihongTalk02(common.Trigger):
    def on_enter(self):
...
class WeihongTalk02Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=1)
...
class MeetAgainWeihong01(common.Trigger):
    def on_enter(self):
...
class MeetAgainWeihong02(common.Trigger):
    def on_enter(self):
...
class MeetAgainWeihong03(common.Trigger):
    def on_enter(self):
...
class MeetAgainWeihong04(common.Trigger):
    def on_enter(self):
...
class MeetAgainWeihong05(common.Trigger):
    def on_enter(self):
...
class MeetAgainWeihong06(common.Trigger):
    def on_enter(self):
...
# 다음 퀘스트 시작
class NextQuestStart01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[9900], questIds=[10003044], questStates=[1]):
...
class PositionArrange03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class WeihongStepBack01(common.Trigger):
    def on_enter(self):
...
class WeihongStepBack02(common.Trigger):
    def on_enter(self):
...
class PCTryToAttackWeihong01(common.Trigger):
    def on_enter(self):
...
class PCTryToAttackWeihong02(common.Trigger):
    def on_enter(self):
...
class PCTryToAttackWeihong03(common.Trigger):
    def on_enter(self):
...
class VasaraPush01(common.Trigger):
    def on_enter(self):
...
class VasaraPush02(common.Trigger):
    def on_enter(self):
...
class VasaraPush03(common.Trigger):
    def on_enter(self):
...
class VasaraPush04(common.Trigger):
    def on_enter(self):
...
class SceneChange01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class SceneChange02(common.Trigger):
    def on_enter(self):
...
class SceneChange03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class VasaraTalk01(common.Trigger):
    def on_enter(self):
...
class VasaraTalk02(common.Trigger):
    def on_enter(self):
...
class VasaraTalk03(common.Trigger):
    def on_enter(self):
...
class VasaraBattle01(common.Trigger):
    def on_enter(self):
...
class VasaraBattle02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
...
class VasaraBattle03(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5001], visible=True) # 미션 성공 사운드 이펙트
...
class VasaraTired01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class VasaraTired02(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=720, enable=True)
...
class VasaraTired03(common.Trigger):
    def on_enter(self):
...
class VasaraTired04(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class VasaraTired05(common.Trigger):
    def on_enter(self):
...
class WeihongOrder01(common.Trigger):
    def on_enter(self):
...
class WeihongOrder02(common.Trigger):
    def on_enter(self):
...
class WeihongOrder02Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=1)
...
class MafiaMove01(common.Trigger):
    def on_enter(self):
...
class MafiaMove02(common.Trigger):
    def on_enter(self):
...
class VasaraTalk10(common.Trigger):
    def on_enter(self):
...
class VasaraTalk10Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class VasaraPushAgain01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=300):
            return VasaraPushAgain02(self.ctx)


class VasaraPushAgain02(common.Trigger):
    def on_enter(self):
...
class VasaraPushAgain03(common.Trigger):
    def on_enter(self):
...
class VasaraPushAgain04(common.Trigger):
    def on_enter(self):
...
class VasaraLastAttack01(common.Trigger):
    def on_enter(self):
...
class VasaraLastAttack02(common.Trigger):
    def on_enter(self):
...
class VasaraLastAttack03(common.Trigger):
    def on_enter(self):
...
class VasaraTalk20(common.Trigger):
    def on_enter(self):
...
class VasaraTalk20Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class VasaraTalk21(common.Trigger):
    def on_enter(self):
...
class VasaraTalk21Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
...
class FriendOfVasara01(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5220], visible=True) # SandFlow
