...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[101,102,103,104,105], auto_target=True) # 몬스터 등장
        self.set_ladder(trigger_ids=[1011], visible=False, enable=True)
        self.set_ladder(trigger_ids=[1012], visible=False, enable=True)
        self.set_ladder(trigger_ids=[1013], visible=False, enable=True)
        self.spawn_monster(spawn_ids=[201,202,203,204,205,206,207,208,209], auto_target=True) # 마지막 섹터 몬스터 등장
        self.set_mesh(trigger_ids=[29991,29992,29993,29994,29995,29996,29997,29998,29999], visible=False) # 안보이는 상태
...
class 시작_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1002], visible=False, interval=0, fade=10) # 벽 해제
...
class 전투_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[999], auto_target=True) # 몬스터 등장
...
class 관문_01_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1004], visible=False, interval=0, fade=10) # 벽 해제
...
class 전투_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=110, text_id=40010) # 적을 모두 처치하세요
        self.spawn_monster(spawn_ids=[111,112,113,114,115,116,117,118,119], auto_target=True) # 몬스터 등장
...
class 관문_02_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.set_effect(trigger_ids=[7021], visible=False) # 알람 소리
        self.show_guide_summary(entity_id=106, text_id=20003362, duration=3000) # 다음 구역으로 이동할 수 있습니다.
...
class 전투_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=110, text_id=40010) # 적을 모두 처치하세요
        self.spawn_monster(spawn_ids=[121,122,123,124,125,126,127,128,129], auto_target=True) # 몬스터 등장
        self.spawn_monster(spawn_ids=[994], auto_target=True) # 새틀라이트 등장
...
class 전투_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=110, text_id=40010) # 적을 모두 처치하세요
        self.spawn_monster(spawn_ids=[131,132,133,134,135,136,137,138,139], auto_target=True) # 몬스터 등장
...
class 관문_04_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1007], visible=False, interval=0, fade=10) # 벽 해제
        self.set_effect(trigger_ids=[7022], visible=False) # 알람 소리
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=106, text_id=20003362, duration=3000) # 다음 구역으로 이동할 수 있습니다.
...
class 전투_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=110, text_id=40010) # 적을 모두 처치하세요
        self.spawn_monster(spawn_ids=[141,142,143,144,145,146,147,148,149], auto_target=True) # 몬스터 등장
...
class 전투_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=110, text_id=40010) # 적을 모두 처치하세요
        self.spawn_monster(spawn_ids=[151,152,153,154,155,156,157,158,159], auto_target=True) # 몬스터 등장
...
class 관문_06_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[2001,2002,2003], visible=False, interval=300, fade=10) # 빨간 선이
        self.set_mesh(trigger_ids=[2011,2012,2013], visible=True, interval=300, fade=10) # 파란 선으로
...
class 관문_06_개방_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[161,162,163,164,165,166,167,168,169], auto_target=True) # 몬스터 등장
        self.set_mesh(trigger_ids=[2014,2015,2016], visible=False, interval=30, fade=0) # 문 폭발
        self.set_mesh(trigger_ids=[2011,2012,2013], visible=False, interval=0, fade=10) # 파란 선도 마저 삭제
        self.show_guide_summary(entity_id=106, text_id=20003362, duration=3000) # 다음 구역으로 이동할 수 있습니다.
...
class 전투_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=110, text_id=40010) # 적을 모두 처치하세요
        self.spawn_monster(spawn_ids=[171,172,173,174,175,176,177,178,179], auto_target=True) # 몬스터 등장
...
class 관문_07_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2021,2022,2023], visible=False, interval=0, fade=0) # 관문 개방
        self.show_guide_summary(entity_id=106, text_id=20003362, duration=3000) # 다음 구역으로 이동할 수 있습니다.
