...
class 연출시작_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$52100300_QD__MAIN__12$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2.5)
...
class 연출시작_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004682, illust_id='11004022', align='right', msg='$52100300_QD__MAIN__14$', duration=3500)
...
class 연출시작_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004682, illust_id='11004022', align='right', msg='$52100300_QD__MAIN__15$', duration=3500)
...
class 추가대사_01(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            ...
            self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Normal', script='$52100300_QD__MAIN__1$', duration=5000)
...
class 추가대사_02(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[101,102,103]):
            self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$52100300_QD__MAIN__2$', duration=5000)
...
class 추가대사_03(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_normal', script='$52100300_QD__MAIN__3$', duration=5000)
...
class 엘리베이터_체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$52100300_QD__MAIN__4$', duration=5000)
...
class 웨이브_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_unfair', script='$52100300_QD__MAIN__6$', duration=5000)
...
class 추가대사_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2001,2002,2003,2004], visible=False)
        self.set_mesh(trigger_ids=[30000,30010,30020,30030], visible=False)
        self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Normal', script='$52100300_QD__MAIN__7$', duration=5000)
...
class 지뢰방_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[5001], visible=False)
        self.set_mesh(trigger_ids=[3001,3002,3003], visible=True)
        self.set_user_value(trigger_id=99990003, key='RandomBomb', value=1)
        self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Normal', script='$52100300_QD__MAIN__8$', duration=5000)
...
class 추가대사_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$52100300_QD__MAIN__9$', duration=5000)
...
class 추가대사_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_normal', script='$52100300_QD__MAIN__10$', duration=5000)
...
class 보스전(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$52100300_QD__MAIN__11$', duration=5000)
        self.set_actor(trigger_id=9002, visible=True, initial_sequence='sf_fi_funct_darkdoor_A01_start')
        self.set_mesh(trigger_ids=[3001], visible=False)
