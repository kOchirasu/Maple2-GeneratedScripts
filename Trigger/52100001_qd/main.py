...
class 부선장대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=24003011, script='$02000391_BF__MAIN__0$', time=3, arg5=0)
...
class 해적이동01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2099, script='$02000391_BF__MAIN__1$', time=3, arg5=0)
...
class 부선장대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=24003011, script='$02000391_BF__MAIN__2$', time=4, align='left')
...
class 세이렌대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$02000391_BF__MAIN__3$', align='left', duration=4000)
...
class 카메라310(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$02000391_BF__MAIN__4$', align='left', duration=3000)
        ...
        self.add_buff(box_ids=[2094], skill_id=70000055, level=1, is_player=True)
        self.add_buff(box_ids=[2095], skill_id=70000055, level=1, is_player=True)
        self.add_buff(box_ids=[2096], skill_id=70000055, level=1, is_player=True)
        self.add_buff(box_ids=[2097], skill_id=70000055, level=1, is_player=True)
        self.add_buff(box_ids=[2098], skill_id=70000055, level=1, is_player=True)
        self.add_buff(box_ids=[2099], skill_id=70000055, level=1, is_player=True)
...
class 카메라304(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2099, script='$02000391_BF__MAIN__5$', time=3, arg5=0)
...
class 세이렌연주02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$02000391_BF__MAIN__6$', align='left', duration=5000)
        self.play_system_sound_in_box(sound='Dungeon_Siren_Harp01')
        self.set_npc_emotion_sequence(spawn_id=1098, sequence_name='Attack_01_D')
...
class 물큐브제거(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3001,3002,3003,3004,3005,3006,3007,3008,3009,3010,3011,3012,3013,3014,3015,3016,3017,3018,3019,3020,3021,3022,3023,3024,3025,3026,3027,3028,3029,3030,3031,3032,3033,3034,3035,3036,3037,3038,3039,3040,3041,3042,3043,3044,3045,3046,3047,3048,3049,3050,3051,3052,3053,3054,3055,3056,3057,3058,3059,3060,3061,3062,3063,3064,3065,3066,3067,3068,3069,3070,3071,3072,3073,3074,3075,3076,3077,3078,3079,3080,3081,3082,3083,3084,3085,3086,3087,3088,3089,3090,3091,3092,3093,3094,3095,3096,3097,3098,3099,3100,3101,3102,3103,3104,3105,3106,3107,3108,3109,3110,3111,3112,3113,3114,3115,3116,3117,3118,3119,3120,3121,3122,3123,3124,3125,3126,3127,3128,3129,3130,3131,3132,3133,3134,3135,3136,3137,3138,3139,3140,3141,3142,3143,3144,3145,3146,3147,3148,3149,3150,3151,3152,3153,3154,3155,3156,3157,3158,3159,3160,3161,3162,3163,3164,3165,3166,3167,3168,3169,3170,3171,3172,3173,3174,3175,3176,3177,3178,3179,3180,3181,3182,3183,3184,3185,3186,3187,3188,3189,3190,3191,3192,3193,3194,3195,3196,3197,3198,3199,3200,3201], visible=False, start_delay=0, interval=0, fade=0)
...
class 세이렌이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$02000391_BF__MAIN__7$', align='left', duration=3500)
...
class 카메라307(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=24003011, script='$02000391_BF__MAIN__8$', time=3, arg5=0)
...
class 카메라308(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011], is_auto_targeting=False)
        self.select_camera(trigger_id=308, enable=True)
        self.set_npc_emotion_sequence(spawn_id=2100, sequence_name='Attack_01_A')
        self.set_dialogue(type=1, spawn_id=2100, script='$02000391_BF__MAIN__9$', time=3, arg5=0)
...
class 연출종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[603], visible=False)
        self.set_mesh(trigger_ids=[3001,3002,3003,3004,3005,3006,3007,3008,3009,3010,3011,3012,3013,3014,3015,3016,3017,3018,3019,3020,3021,3022,3023,3024,3025,3026,3027,3028,3029,3030,3031,3032,3033,3034,3035,3036,3037,3038,3039,3040,3041,3042,3043,3044,3045,3046,3047,3048,3049,3050,3051,3052,3053,3054,3055,3056,3057,3058,3059,3060,3061,3062,3063,3064,3065,3066,3067,3068,3069,3070,3071,3072,3073,3074,3075,3076,3077,3078,3079,3080,3081,3082,3083,3084,3085,3086,3087,3088,3089,3090,3091,3092,3093,3094,3095,3096,3097,3098,3099,3100,3101,3102,3103,3104,3105,3106,3107,3108,3109,3110,3111,3112,3113,3114,3115,3116,3117,3118,3119,3120,3121,3122,3123,3124,3125,3126,3127,3128,3129,3130,3131,3132,3133,3134,3135,3136,3137,3138,3139,3140,3141,3142,3143,3144,3145,3146,3147,3148,3149,3150,3151,3152,3153,3154,3155,3156,3157,3158,3159,3160,3161,3162,3163,3164,3165,3166,3167,3168,3169,3170,3171,3172,3173,3174,3175,3176,3177,3178,3179,3180,3181,3182,3183,3184,3185,3186,3187,3188,3189,3190,3191,3192,3193,3194,3195,3196,3197,3198,3199,3200,3201], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3901,3902,3903,3904], visible=False, start_delay=0, interval=0, fade=0)
...
class 던전시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_npc_range(range_ids=[2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011], is_auto_targeting=False)
        self.spawn_npc_range(range_ids=[1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016], is_auto_targeting=False)
