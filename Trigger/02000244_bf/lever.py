...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[899], visible=False)
        ...
        self.set_mesh(trigger_ids=[801,802,803,804], visible=False)
...
class 오픈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[805,806,807,808], visible=False)
        self.set_mesh(trigger_ids=[809,810,811,812], visible=False)
