...
class 잡담_01_703(common.Trigger):
    def on_enter(self):
...
class 잡담_02_703(common.Trigger):
    def on_enter(self):
...
class 잡담_03_703(common.Trigger):
    def on_enter(self):
...
class 잡담_04_703(common.Trigger):
    def on_enter(self):
...
class 잡담_05_703(common.Trigger):
    def on_enter(self):
...
class 잡담_06_703(common.Trigger):
    def on_enter(self):
