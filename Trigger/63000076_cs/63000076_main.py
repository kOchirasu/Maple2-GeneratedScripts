...
class 준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4005], visible=False)
        self.set_mesh(trigger_ids=[4006], visible=False)
        self.set_mesh(trigger_ids=[4007], visible=False)
        self.set_mesh(trigger_ids=[4008], visible=False)
...
class 보보스발소리_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004375, msg='$63000076_CS__63000076_MAIN__7$', duration=2000, align='right') # 오잉? 소리가 들린다!
...
class 보보스발소리_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004375, msg='$63000076_CS__63000076_MAIN__8$', duration=3000, align='right')
...
class 보보스등장_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004372, msg='$63000076_CS__63000076_MAIN__11$', duration=3000, align='right') # 맛있게 먹어! 크리스마스 케이크야!
...
class 보보스등장_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$63000076_CS__63000076_MAIN__13$', duration=2500, align='right') # 뭐지? 사람 소리 같은데?
...
class 사라진케이크_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004375, msg='$63000076_CS__63000076_MAIN__15$', duration=2500, align='right')
        self.set_mesh(trigger_ids=[4005], visible=False)
        self.set_mesh(trigger_ids=[4006], visible=False)
        self.set_mesh(trigger_ids=[4007], visible=False)
...
class 사라진케이크_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004375, msg='$63000076_CS__63000076_MAIN__16$', duration=3000, align='right')
...
class 사라진케이크_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.add_cinematic_talk(npc_id=0, msg='$63000076_CS__63000076_MAIN__17$', duration=3500, align='right')
...
class 미아등장_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004372, msg='$63000076_CS__63000076_MAIN__18$', duration=3000, align='right') # 다 먹어 버렸네… 미안…
...
class 미아등장_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004372, msg='$63000076_CS__63000076_MAIN__19$', duration=3000, align='right')
...
class 미아등장_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004372, msg='$63000076_CS__63000076_MAIN__20$', duration=3000, align='right') # 난 또 소원 들어주러 가야 해서 이만
...
class 미아등장_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004364, msg='$63000076_CS__63000076_MAIN__21$', duration=3000, illust_id='Mia_annoyed', align='right')
...
class 미아등장_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$63000076_CS__63000076_MAIN__22$', duration=2500, align='right') # 괜찮으세요?
...
class 미아등장_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004364, msg='$63000076_CS__63000076_MAIN__23$', duration=2500, illust_id='Mia_annoyed', align='right') # 누구시죠?
...
class 미아등장_12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$63000076_CS__63000076_MAIN__24$', duration=3500, align='right')
...
class 미아등장_13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004364, msg='$63000076_CS__63000076_MAIN__25$', duration=3000, illust_id='Mia_normal', align='right')
...
class 미아등장_14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$63000076_CS__63000076_MAIN__26$', duration=2500, align='right') # 거실에 있어요. (그것도 아주 잘…)
...
class 미아등장_15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 다행이네요. 어서 만나봐야겠어요.\n거실에서 만나요.
        self.add_cinematic_talk(npc_id=11004364, msg='$63000076_CS__63000076_MAIN__27$', duration=3000, illust_id='Mia_annoyed', align='right')
