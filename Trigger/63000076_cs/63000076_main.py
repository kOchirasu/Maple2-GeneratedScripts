...
class 요정잡담종료_01(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 요정잡담종료_02(common.Trigger):
    def on_enter(self):
...
class 보보스발소리_01(common.Trigger):
    def on_enter(self):
...
class 보보스발소리_02(common.Trigger):
    def on_enter(self):
...
class 보보스발소리_03(common.Trigger):
    def on_enter(self):
...
class 보보스발소리_04(common.Trigger):
    def on_enter(self):
...
class 사라진케이크_01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 사라진케이크_02(common.Trigger):
    def on_enter(self):
...
class 사라진케이크_03(common.Trigger):
    def on_enter(self):
...
class 사라진케이크_04(common.Trigger):
    def on_enter(self):
...
class 사라진케이크_05(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[8004], returnView=False)
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
