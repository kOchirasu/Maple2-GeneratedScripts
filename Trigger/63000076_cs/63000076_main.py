...
class 요정잡담_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=103, msg='$63000076_CS__63000076_MAIN__0$', duration=2500)
...
class 요정잡담_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 착한 $npcName:11004372$!\n달콤한 걸 먹는 게 내 소원이었어!
        self.add_balloon_talk(spawnId=101, msg='$63000076_CS__63000076_MAIN__1$', duration=2500)
...
class 요정잡담_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=105, msg='$63000076_CS__63000076_MAIN__2$', duration=2500)
...
class 요정잡담_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=113, msg='$63000076_CS__63000076_MAIN__5$', duration=2500)
...
class 보보스발소리_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004375, msg='$63000076_CS__63000076_MAIN__8$', duration=3000, align='right')
...
class 보보스등장_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=106, msg='$63000076_CS__63000076_MAIN__9$', duration=2500)
...
class 사라진케이크_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004375, msg='$63000076_CS__63000076_MAIN__15$', duration=2500, align='right')
        self.set_mesh(triggerIds=[4005], visible=False)
        self.set_mesh(triggerIds=[4006], visible=False)
        self.set_mesh(triggerIds=[4007], visible=False)
...
class 사라진케이크_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004375, msg='$63000076_CS__63000076_MAIN__16$', duration=3000, align='right')
...
class 사라진케이크_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.add_cinematic_talk(npcId=0, msg='$63000076_CS__63000076_MAIN__17$', duration=3500, align='right')
...
class 미아등장_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004372, msg='$63000076_CS__63000076_MAIN__19$', duration=3000, align='right')
...
class 미아등장_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004364, msg='$63000076_CS__63000076_MAIN__21$', duration=3000, illustId='Mia_annoyed', align='right')
...
class 미아등장_12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=0, msg='$63000076_CS__63000076_MAIN__24$', duration=3500, align='right')
...
class 미아등장_13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004364, msg='$63000076_CS__63000076_MAIN__25$', duration=3000, illustId='Mia_normal', align='right')
...
class 미아등장_15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 다행이네요. 어서 만나봐야겠어요.\n거실에서 만나요.
        self.add_cinematic_talk(npcId=11004364, msg='$63000076_CS__63000076_MAIN__27$', duration=3000, illustId='Mia_annoyed', align='right')
