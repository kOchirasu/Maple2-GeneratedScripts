...
class 잡담_01_702(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=103, msg='$63000076_CS__63000076_CHAT_702__0$', duration=2000, delay_tick=0) # 사람이다! 사람!
...
class 잡담_02_702(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=101, msg='$63000076_CS__63000076_CHAT_702__1$', duration=2500, delay_tick=0)
...
class 잡담_03_702(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=102, msg='$63000076_CS__63000076_CHAT_702__2$', duration=3000, delay_tick=0)
