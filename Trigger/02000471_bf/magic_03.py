...
class Ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_buff(box_ids=[203], skill_id=70002021, level=1, is_player=True, is_skill_set=False)
...
class Event_03_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=165, sequence_name='Down_Idle_A', duration=600000)
        self.set_dialogue(type=1, spawn_id=165, script='$02000471_BF__MAGIC_03__0$', time=3, arg5=0)
