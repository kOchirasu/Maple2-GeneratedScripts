...
class idle(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002018], arg2=0):
            return Ready()
...
class scene_02(state.State):
    def on_enter(self):
        set_scene_skip(state=scene_06_ready, arg2='exit')
        set_conversation(type=2, spawnId=11001956, script='$02000471_BF__EVENT_02__0$', arg4=5)
...
class scene_03(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001956, script='$02000471_BF__EVENT_02__1$', arg4=5)
...
class scene_04(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001956, script='$02000471_BF__EVENT_02__2$', arg4=5)
...
class scene_05(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001956, script='$02000471_BF__EVENT_02__3$', arg4=5)
...
class scene_07(state.State):
    def on_enter(self):
        set_user_value(triggerId=2040314, key='TimerStart', value=1)
        destroy_monster(spawnIds=[199])
...
class scene_08(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000471_BF__EVENT_02__9$', arg3='5000')
...
class scene_10(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=181, script='$02000471_BF__EVENT_02__5$', arg4=3, arg5=2)
        set_conversation(type=1, spawnId=182, script='$02000471_BF__EVENT_02__6$', arg4=3, arg5=4)
        set_conversation(type=1, spawnId=183, script='$02000471_BF__EVENT_02__7$', arg4=3, arg5=8)
        set_conversation(type=1, spawnId=184, script='$02000471_BF__EVENT_02__8$', arg4=3, arg5=0)
