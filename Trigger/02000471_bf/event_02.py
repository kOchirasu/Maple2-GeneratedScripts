...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10002018], stateValue=0):
...
class scene_04(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001956, script='$02000471_BF__EVENT_02__2$', arg4=5)
...
class scene_10(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=184, script='$02000471_BF__EVENT_02__8$', arg4=3, arg5=0)
