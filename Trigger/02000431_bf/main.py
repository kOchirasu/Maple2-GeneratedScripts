...
class 부선장대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=24003011, script='$02000431_BF__MAIN__0$', arg4=3, arg5=0)
...
class 해적이동01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=2099, script='$02000431_BF__MAIN__1$', arg4=3, arg5=0)
...
class 부선장대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=24003011, script='$02000431_BF__MAIN__2$', arg4=3, arg5=0)
...
class 세이렌대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=24003010, script='$02000431_BF__MAIN__3$', arg4=3, arg5=0)
...
class 카메라310(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=1, spawnId=1099, script='$02000431_BF__MAIN__4$', arg4=3, arg5=0)
...
class 카메라304(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=2099, script='$02000431_BF__MAIN__5$', arg4=3, arg5=0)
...
class 세이렌연주02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=1098, script='$02000431_BF__MAIN__6$', arg4=3, arg5=0)
        self.play_system_sound_in_box(sound='Dungeon_Siren_Harp01')
        self.set_npc_emotion_sequence(spawnId=1098, sequenceName='Attack_01_D')
...
class 세이렌이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=1098, script='$02000431_BF__MAIN__7$', arg4=3, arg5=0)
...
class 카메라307(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=24003011, script='$02000431_BF__MAIN__8$', arg4=3, arg5=0)
...
class 카메라308(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=1, spawnId=2100, script='$02000431_BF__MAIN__9$', arg4=3, arg5=0)
