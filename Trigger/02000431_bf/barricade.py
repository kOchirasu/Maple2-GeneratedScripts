...
class Wait(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[80002], visible=True, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[80003], visible=True, arg3=0, arg4=0, arg5=0)
...
class 대기(state.State):
    def on_enter(self):
        set_user_value(triggerId=99999101, key='start', value=1)
        ...
        set_mesh(triggerIds=[80002], visible=False, arg3=0, arg4=0, arg5=0)
        set_mesh(triggerIds=[80003], visible=False, arg3=0, arg4=0, arg5=0)
...
class 카운트(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000431_BF__BARRICADE__0$', arg3='3000')
