...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[80003], visible=True, arg3=0, delay=0, scale=0)
...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[80002], visible=False, arg3=0, delay=0, scale=0)
        self.set_mesh(triggerIds=[80003], visible=False, arg3=0, delay=0, scale=0)
