...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$02000390_BF__MAIN__1$', time=2, arg5=0)
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000390_BF__MAIN__2$', time=2, arg5=0)
        self.set_dialogue(type=1, spawn_id=101, script='$02000390_BF__MAIN__3$', time=2, arg5=0)
