...
class scene_01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000390_BF__MAIN__0$', arg4=2, arg5=2)
        set_conversation(type=1, spawnId=101, script='$02000390_BF__MAIN__1$', arg4=2, arg5=0)
...
class scene_02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$02000390_BF__MAIN__2$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$02000390_BF__MAIN__3$', arg4=2, arg5=0)
