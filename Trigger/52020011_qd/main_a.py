...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$map:52020011$', desc='$NpcName:11003599$의 임시 거처', align='centerLeft', offset_rate_x=0.05, offset_rate_y=0.15, duration=3000, scale=1.5)
