...
class 준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=3001, visible=False, initial_sequence='0', arg4=False, arg5=False) # 아빠끄기
...
class 보보스의오해_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 미안해… 소원… 들어줘야 하니까.\n내가 루돌프 되면 꼭 내려줄게.
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__0$', duration=3500, align='right')
...
class 보보스의오해_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=8004, enable=True)
...
class 보보스의오해_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$63000077_CS__63000077_MAIN__2$', duration=2800, align='right') # 이봐, 무슨 짓이야! 당장 그만둬!
...
class 보보스의오해_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=8005, enable=True)
...
class 보보스의오해_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__3$', duration=3500, align='right')
...
class 보보스의오해_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.face_emotion(spawn_id=0, emotion_name='Angry')
...
class 보보스의오해_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$63000077_CS__63000077_MAIN__4$', duration=4000, align='right')
...
class 보보스의오해_13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__5$', duration=2500, align='right')
...
class 보보스의오해_14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__6$', duration=3500, align='right')
...
class 보보스의오해_16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.face_emotion(spawn_id=0, emotion_name='Trigger_disappoint')
        self.add_cinematic_talk(npc_id=0, msg='$63000077_CS__63000077_MAIN__7$', duration=2500, align='right') # 정말 말이 안 통하는 녀석이잖아.
...
class 보보스의오해_17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.face_emotion(spawn_id=0, emotion_name='Trigger_panic')
        self.add_cinematic_talk(npc_id=0, msg='$63000077_CS__63000077_MAIN__8$', duration=2500, align='right') # 도대체 무슨 소릴 하는 거야?
...
class 보보스의오해_19(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__9$', duration=2500, align='right')
...
class 보보스의오해_20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__10$', duration=3000, align='right')
...
class 보보스의오해_22(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__11$', duration=2000, align='right') # 날 방해하면…
...
class 보보스의오해_23(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__12$', duration=2000, align='right')
...
class 일반사냥(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=3001, visible=False, initial_sequence='0', arg4=False, arg5=False) # 아빠액터끄기
        self.destroy_monster(spawn_ids=[101,102])
...
class 패배한보보스_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=106, sequence_name='Cry_A', duration=35000)
        self.set_actor(trigger_id=3001, visible=False, initial_sequence='Talk_A')
        self.move_user(map_id=63000077, portal_id=4)
        self.select_camera(trigger_id=8008, enable=True)
...
class 클라우스대화_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004368, msg='$63000077_CS__63000077_MAIN__13$', duration=2500, align='left') # 도와주셔서 감사합니다!
...
class 클라우스대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004368, msg='$63000077_CS__63000077_MAIN__14$', duration=2500, align='left') # 그런데 누구……?
...
class 다시만난가족_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004368, msg='$63000077_CS__63000077_MAIN__16$', duration=3500, illust_id='June_normal', align='left')
...
class 다시만난가족_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004368, msg='$63000077_CS__63000077_MAIN__17$', duration=3000, illust_id='June_normal', align='left')
...
class 다시만난가족_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004356, msg='$63000077_CS__63000077_MAIN__18$', duration=2000, align='left')
...
class 다시만난가족_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 그건 그냥 투정이었어.\n내 소원은 그런 게 아니란 말이에요!
        self.add_cinematic_talk(npc_id=11004356, msg='$63000077_CS__63000077_MAIN__19$', duration=3500, align='right')
...
class 다시만난가족_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=8012, enable=True)
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__20$', duration=2000, align='left') # 으응???
...
class 다시만난가족_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__21$', duration=3500, align='left')
...
class 다시만난가족_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=8011, enable=True)
...
class 다시만난가족_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004356, msg='$63000077_CS__63000077_MAIN__22$', duration=3500, illust_id='Evelyn_glad', align='right')
...
class 다시만난가족_12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__23$', duration=4000, align='left')
...
class 다시만난가족_13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004373, msg='$63000077_CS__63000077_MAIN__24$', duration=3000, align='left')
...
class 다시만난가족_14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004361, msg='$63000077_CS__63000077_MAIN__25$', duration=4000, illust_id='Aiden_smile', align='right')
...
class 다시만난가족_15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004365, msg='$63000077_CS__63000077_MAIN__26$', duration=3500, illust_id='Mia_happy', align='right')
...
class 다시만난가족_16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004356, msg='$63000077_CS__63000077_MAIN__27$', duration=2000, illust_id='Evelyn_normal', align='right') # ……
...
class 다시만난가족_17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004356, msg='$63000077_CS__63000077_MAIN__28$', duration=3500, illust_id='Evelyn_sad', align='right')
...
class 다시만난가족_18(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004368, msg='$63000077_CS__63000077_MAIN__29$', duration=3000, illust_id='June_smile', align='right')
...
class 다시만난가족_19(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004356, msg='$63000077_CS__63000077_MAIN__30$', duration=3500, illust_id='Evelyn_glad', align='right')
