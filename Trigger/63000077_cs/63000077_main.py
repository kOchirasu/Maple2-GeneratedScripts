...
class 수락_01_30000378(common.Trigger):
    def on_enter(self):
...
class 수락_02_30000378(common.Trigger):
    def on_enter(self):
...
class 완료_01_30000377(common.Trigger):
    def on_enter(self):
...
class 완료_02_30000377(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101])
        self.create_monster(spawnIds=[106,108], animationEffect=False)
...
class 보보스의오해_01(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_02(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_03(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__0$', duration=3500, align='right') # 미안해… 소원… 들어줘야 하니까.\n내가 루돌프 되면 꼭 내려줄게.
...
class 보보스의오해_04(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_05(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_06(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_07(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_08(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_09(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__3$', duration=3500, align='right') # 응…? 나…는 소원 들어주고 있어.\n$npcName:11004356$의 크리스마스 소원.
...
class 보보스의오해_10(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_11(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=0, msg='$63000077_CS__63000077_MAIN__4$', duration=4000, align='right') # $npcName:11004356$의 소원은 그런 게 아냐!\n$npcName:11004368$$pp:는,은$ $npcName:11004356$의 소중한 가족이라고! 당장 내려줘!
...
class 보보스의오해_12(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=8005, enable=True)
...
class 보보스의오해_13(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_14(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__6$', duration=3500, align='right') # $npcName:11004356$ 아빠, 여기 있어야 된다.\n$npcName:11004373$$pp:는,은$ 착한 일을 하는 거다.
...
class 보보스의오해_15(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=8006, enable=True)
...
class 보보스의오해_16(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_17(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_18(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=8005, enable=True)
...
class 보보스의오해_19(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__9$', duration=2500, align='right') # $npcName:11004373$, 착한 일 하고 산타 할아버지한테 인정 받을 거다.
...
class 보보스의오해_20(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__10$', duration=3000, align='right') # 루돌프 돼서, 행복해지고…\n$npcName:11004356$이랑도 같이 놀 거야.
...
class 보보스의오해_21(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_22(common.Trigger):
    def on_enter(self):
...
class 보보스의오해_23(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__12$', duration=2000, align='right') # &lt;font size='40'&gt;때릴 거다!&lt;/font&gt;
...
class 패배한보보스_01(common.Trigger):
    def on_enter(self):
...
class 패배한보보스_02(common.Trigger):
    def on_enter(self):
...
class 패배한보보스_03(common.Trigger):
    def on_enter(self):
...
class 클라우스대화_01(common.Trigger):
    def on_enter(self):
...
class 클라우스대화_02(common.Trigger):
    def on_enter(self):
...
class 클라우스대화_03(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=4, enable=True, path='BG/Common/ScreenMask/Eff_fadein_halfsec.xml')
        self.set_scene_skip()
...
class 클라우스대화_04(common.Trigger):
    def on_enter(self):
...
class 클라우스대화_05(common.Trigger):
    def on_enter(self):
...
class 에블린일기_02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=9, script='$63000077_CS__63000077_MAIN__15$') # &lt;FONT color='#ffd200'&gt;누군가의 일기장 52페이지&lt;/FONT&gt;\n아빠 미워. 그깟 꽃이 뭐라고 나를 그렇게 혼낸 거야? \n화단 하나 관리 못 했다고 세상이 뒤집히는 것도 아닌데.\n꽃이 나보다 소중하면, 내 눈에 띄지 말고 쭉 정원에서 살아! $npcName:11004368$씨!
        self.move_user(mapId=63000077, portalId=4)
        self.select_camera(triggerId=8008, enable=True)
...
class 다시만난가족_01(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004368, msg='$63000077_CS__63000077_MAIN__16$', duration=3500, illustId='June_normal', align='left') # 제가 $npcName:11004356$의 마음을 아프게 한 것도 사실이고,\n제 딸 $npcName:11004356$의 마음을 달래주려는 순진한 $npcName:11004373$의 부탁이니…
...
class 다시만난가족_02(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004368, msg='$63000077_CS__63000077_MAIN__17$', duration=3000, illustId='June_normal', align='left') # 잠깐 나무 위에 올라가 있는 것도 나쁘지 않겠다 싶었답니다
...
class 다시만난가족_03(common.Trigger):
    def on_enter(self):
...
class 다시만난가족_04(common.Trigger):
    def on_enter(self):
...
class 다시만난가족_05(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004356, msg='$63000077_CS__63000077_MAIN__19$', duration=3500, align='right') # 그건 그냥 투정이었어.\n내 소원은 그런 게 아니란 말이에요!
...
class 다시만난가족_06(common.Trigger):
    def on_enter(self):
...
class 다시만난가족_07(common.Trigger):
    def on_enter(self):
...
class 다시만난가족_08(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__21$', duration=3500, align='left') # $npcName:11004356$…소원 아니야?\n내가 잘못한거야…?
...
class 다시만난가족_09(common.Trigger):
    def on_enter(self):
...
class 다시만난가족_10(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004356, msg='$63000077_CS__63000077_MAIN__22$', duration=3500, illustId='Evelyn_glad', align='right') # 보…?\n그날 밤 내 얘길 듣고 간 게 역시 너였구나.
...
class 다시만난가족_11(common.Trigger):
    def on_enter(self):
...
class 다시만난가족_12(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__23$', duration=4000, align='left') # 미안…미안해…!\n소원을 들어주고… 행복하게 해주고 싶었는데…!
...
class 다시만난가족_13(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004373, msg='$63000077_CS__63000077_MAIN__24$', duration=3000, align='left') # $npcName:11004373$$pp:가,이$… 너무 미안해…!
...
class 다시만난가족_14(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=8011, enable=True)
        self.add_cinematic_talk(npcId=11004361, msg='$63000077_CS__63000077_MAIN__25$', duration=4000, illustId='Aiden_smile', align='right') # 아니야, 털북숭이. 미안해 할 필요 없어.\n$npcName:11004356$의 소원은 따로 있으니까
...
class 다시만난가족_15(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004365, msg='$63000077_CS__63000077_MAIN__26$', duration=3500, illustId='Mia_happy', align='right') # 그래. 진짜 소원을 말하면, 그걸 들어주렴.
...
class 다시만난가족_16(common.Trigger):
    def on_enter(self):
...
class 다시만난가족_17(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004356, msg='$63000077_CS__63000077_MAIN__28$', duration=3500, illustId='Evelyn_sad', align='right') # 미안해요, 모두.\n내가 부린 투정 때문에… 모두 너무 고생했어요.
...
class 다시만난가족_18(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004368, msg='$63000077_CS__63000077_MAIN__29$', duration=3000, illustId='June_smile', align='right') # 그래서, 우리 $npcName:11004356$의 진짜 크리스마스 소원은 뭐지?
...
class 다시만난가족_19(common.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004356, msg='$63000077_CS__63000077_MAIN__30$', duration=3500, illustId='Evelyn_glad', align='right') # 우리 가족 모두 함께 모여서…\n행복한 크리스마스 파티를 하는 거예요
...
class 다시만난가족_20(common.Trigger):
    def on_enter(self):
