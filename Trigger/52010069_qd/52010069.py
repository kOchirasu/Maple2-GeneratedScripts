...
class 전경씬_03_01(common.Trigger):
    def on_enter(self):
...
class 전경씬_03_02(common.Trigger):
    def on_enter(self):
...
class 전경씬_04_01(common.Trigger):
    def on_enter(self):
...
class 아이오브라펜타로_01(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101], arg2=False)
        self.destroy_monster(spawnIds=[102], arg2=False)
        self.destroy_monster(spawnIds=[103], arg2=False)
...
class 아이오브라펜타로_02(common.Trigger):
    def on_enter(self):
