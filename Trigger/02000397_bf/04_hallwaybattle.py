...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10001147], state=0) # Key
...
class MobTrapOn01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=901, script='$02000397_BF__04_HALLWAYBATTLE__0$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=902, script='$02000397_BF__04_HALLWAYBATTLE__1$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=903, script='$02000397_BF__04_HALLWAYBATTLE__2$', arg4=2, arg5=0)
...
class GuideUseKey(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10001147], state=1) # Key

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001147], arg2=0):
            return PortalOn()
