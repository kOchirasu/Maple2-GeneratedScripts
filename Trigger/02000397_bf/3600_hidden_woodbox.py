...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10001145], state=0) # WoodBox
...
class Opened(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10001145], state=1) # WoodBox

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001145], arg2=0):
            return LadderOn()
