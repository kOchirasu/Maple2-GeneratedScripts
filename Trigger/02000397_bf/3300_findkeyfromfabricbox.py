...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10001142], state=0) # Fabricbox
...
class True(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10001142], state=1) # Fabricbox

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001142], arg2=0):
            return KeyFound()
