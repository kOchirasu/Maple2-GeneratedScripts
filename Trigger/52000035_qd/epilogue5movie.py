...
class start01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_value(key='50001625', value=1):
...
class LoadingDelayB0(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk1(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk2(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk3(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk4(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk5(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk6(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk7(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk8(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk9(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk10(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk11(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk12(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk13(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk14(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk16(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk17(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_onetime_effect(id=2100275, enable=False, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
        self.set_skip()
...
class Epilogue5Talk18(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk19(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class Epilogue5Talk20(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk21(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_onetime_effect(id=2100275, enable=False, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
        self.set_skip()
...
class Epilogue5Talk22(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk23(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk24(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk25(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk27(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2100275, enable=True, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
...
class Epilogue5Talk28(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2100275, enable=False, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk29(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk30(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk31(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk32(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk33(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk34(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk35(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk36(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk37(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2100275, enable=True, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
...
class Epilogue5Talk38(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk39(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=102, patrolName='MS2PatrolData_EP4_DarkToTurka') # 11001957,투르카 노려봄!
...
class Epilogue5Talk40(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2100275, enable=False, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk41(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk42(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk43(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=102, patrolName='MS2PatrolData_darkReturn') # 11001957,투르카 원복
...
class Epilogue5Talk44(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk45(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[1300], returnView=False)
...
class Epilogue5Talk46(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk47(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk48(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk49(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk50(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk51(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk52(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk53(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk54(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk55(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2100275, enable=True, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
...
class Epilogue5Talk56(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2100275, enable=False, path='BG/Common/Sound/Eff_System_DarkLord_Breathing.xml') # 11001957 호흡기
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk57(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[1400], returnView=False)
...
class Epilogue5Talk58(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class Epilogue5Talk59(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk60(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk61(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk62(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class Epilogue5Talk63(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk64(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk65(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk66(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue5Talk67(common.Trigger):
    def on_enter(self):
...
class Epilogue5Talk68(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
