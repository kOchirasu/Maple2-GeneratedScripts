...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3061,3062,3063,3064,3065,3066], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[4601,4602,4603,4604,4605,4606,4607,4608,4609,4610,4611,4612,4613,4614], visible=True, start_delay=0, interval=0, fade=0)
...
class 경보(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3061,3062,3063,3064,3065,3066], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[4601,4602,4603,4604,4605,4606,4607,4608,4609,4610,4611,4612,4613,4614], visible=False, start_delay=0, interval=0, fade=0)
...
class 해제(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3061,3062,3063,3064,3065,3066], visible=False, start_delay=0, interval=0, fade=5)
        self.set_mesh(trigger_ids=[4601,4602,4603,4604,4605,4606,4607,4608,4609,4610,4611,4612,4613,4614], visible=False, start_delay=0, interval=0, fade=5)
