...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3011,3012,3013,3014,3015,3016], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[4101,4102,4103,4104], visible=True, start_delay=0, interval=0, fade=0)
...
class 경보(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3011,3012,3013,3014,3015,3016], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[4101,4102,4103,4104], visible=False, start_delay=0, interval=0, fade=0)
...
class 해제(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3011,3012,3013,3014,3015,3016], visible=False, start_delay=0, interval=0, fade=5)
        self.set_mesh(trigger_ids=[4101,4102,4103,4104], visible=False, start_delay=0, interval=0, fade=5)
