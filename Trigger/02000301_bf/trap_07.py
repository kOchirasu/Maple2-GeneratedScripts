...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3071,3072,3073,3074,3075,3076], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[4701,4702,4703,4704,4705,4706,4707,4708,4709,4710,4711,4712,4713], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3077,3078], visible=True, start_delay=0, interval=0, fade=0)
...
class 경보(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4701,4702,4703,4704,4705,4706,4707,4708,4709,4710,4711,4712,4713], visible=False, start_delay=0, interval=0, fade=5)
        self.set_mesh(trigger_ids=[3077,3078], visible=False, start_delay=0, interval=0, fade=5)
...
class 해제(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2008]):
            self.set_mesh(trigger_ids=[3071,3072,3073,3074,3075,3076], visible=False, start_delay=0, interval=0, fade=5)
            self.set_mesh(trigger_ids=[4701,4702,4703,4704,4705,4706,4707,4708,4709,4710,4711,4712,4713], visible=False, start_delay=0, interval=0, fade=5)
            return 해제(self.ctx)
