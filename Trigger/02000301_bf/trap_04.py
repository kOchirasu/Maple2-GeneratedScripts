...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3041,3042,3043,3044,3045,3046], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[4401,4402,4403,4404,4405,4406,4407,4408,4409,4410,4411,4412,4413,4414], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3047,3048], visible=True, start_delay=0, interval=0, fade=0)
...
class 경보(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4401,4402,4403,4404,4405,4406,4407,4408,4409,4410,4411,4412,4413,4414], visible=False, start_delay=0, interval=0, fade=5)
        self.set_mesh(trigger_ids=[3047,3048], visible=False, start_delay=0, interval=0, fade=5)
...
class 해제(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2005]):
            self.set_mesh(trigger_ids=[3041,3042,3043,3044,3045,3046], visible=False, start_delay=0, interval=0, fade=5)
            self.set_mesh(trigger_ids=[4401,4402,4403,4404,4405,4406,4407,4408,4409,4410,4411,4412,4413,4414], visible=False, start_delay=0, interval=0, fade=5)
            return 해제(self.ctx)
