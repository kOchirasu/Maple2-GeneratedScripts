...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4001,4002,4003], visible=True, start_delay=0, interval=0, fade=0)
...
class 경보(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4001,4002,4003], visible=False, start_delay=0, interval=0, fade=0)
...
class 해제(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3001,3002,3003,3004,3005,3006], visible=False, start_delay=0, interval=0, fade=5)
        self.set_mesh(trigger_ids=[4001,4002,4003], visible=False, start_delay=0, interval=0, fade=5)
