...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3021,3022,3023,3024,3025,3026], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[4201,4202,4203,4204,4205,4206,4207,4208,4209,4210,4211,4212], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3027,3028], visible=True, start_delay=0, interval=0, fade=0)
...
class 경보(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4201,4202,4203,4204,4205,4206,4207,4208,4209,4210,4211,4212], visible=False, start_delay=0, interval=0, fade=5)
        self.set_mesh(trigger_ids=[3027,3028], visible=False, start_delay=0, interval=0, fade=5)
...
class 해제(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2003]):
            self.set_mesh(trigger_ids=[3021,3022,3023,3024,3025,3026], visible=False, start_delay=0, interval=0, fade=5)
            self.set_mesh(trigger_ids=[4201,4202,4203,4204,4205,4206,4207,4208,4209,4210,4211,4212], visible=False, start_delay=0, interval=0, fade=5)
            return 해제(self.ctx)
