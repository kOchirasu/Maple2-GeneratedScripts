...
# 레논 전투 중
class MeetLennon01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class MeetLennon02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.destroy_monster(spawnIds=[5005]) # Blackeye_Actor01
...
class MeetLennon03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class LennonLeave01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class LennonLeave02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class LennonLeave03(common.Trigger):
    def on_enter(self):
...
class ReactSoulBead01(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[1300], visible=True)
        self.set_agent(triggerIds=[1301], visible=True)
...
class ReactSoulBead02(common.Trigger):
    def on_enter(self):
...
class ReadyToMove03(common.Trigger):
    def on_enter(self):
