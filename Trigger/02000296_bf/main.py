...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_ladder(trigger_ids=[110], visible=False, enable=False) # Enter
        self.set_ladder(trigger_ids=[111], visible=False, enable=False) # Enter
        self.set_ladder(trigger_ids=[112], visible=False, enable=False) # Enter
        self.set_ladder(trigger_ids=[113], visible=False, enable=False) # Enter
        ...
        self.set_effect(trigger_ids=[4000], visible=False) # Intro_Chord
        self.set_mesh(trigger_ids=[1001], visible=False, start_delay=0, interval=0, fade=0) # SoulBead
        self.set_mesh(trigger_ids=[1100], visible=True, start_delay=0, interval=0, fade=0) # SoulBeadBarrier_AlwaysOn
        self.set_mesh(trigger_ids=[1101], visible=True, start_delay=0, interval=0, fade=0) # EnterBarrier
        self.set_mesh(trigger_ids=[1200,1201,1202,1203,1204,1205,1206,1207,1208,1209], visible=True, start_delay=0, interval=100, fade=5) # ExitBridge
...
class LoadingDelay02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=5005, script='$02000296_BF__MAIN__0$', time=3, arg5=0)
...
class MeetLennon02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=5007, script='$02000296_BF__MAIN__2$', time=3, arg5=0) # Lennon_Battle
...
class LennonLeave02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_agent(trigger_ids=[1300], visible=False)
        self.set_agent(trigger_ids=[1301], visible=False)
...
class LennonLeave03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.destroy_monster(spawn_ids=[5013]) # Lennon_Actor
        self.set_mesh(trigger_ids=[1200,1201,1202,1203,1204,1205,1206,1207,1208,1209], visible=False, start_delay=500, interval=100, fade=5) # ExitBridge
        self.set_mesh(trigger_ids=[1101], visible=False, start_delay=0, interval=0, fade=0) # EnterBarrier
        self.set_ladder(trigger_ids=[110], visible=True, enable=True, fade=0) # Enter
        self.set_ladder(trigger_ids=[111], visible=True, enable=True, fade=0) # Enter
        self.set_ladder(trigger_ids=[112], visible=True, enable=True, fade=0) # Enter
        self.set_ladder(trigger_ids=[113], visible=True, enable=True, fade=0) # Enter
...
class ReactSoulBead01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=5006, script='$02000296_BF__MAIN__6$', time=4, arg5=0) # Blackeye_Battle
...
class ReactSoulBead02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=5006, script='$02000296_BF__MAIN__7$', time=4, arg5=0) # Blackeye_Battle
...
class BossBattle01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1001], visible=True, start_delay=0, interval=0, fade=2)
        self.set_effect(trigger_ids=[1000], visible=False)
        self.set_dialogue(type=1, spawn_id=5006, script='$02000296_BF__MAIN__8$', time=3, arg5=0) # Blackeye_Battle
...
class BossBattle02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[5100], auto_target=True) # Boss
...
class ReadyToMove02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=5006, script='$02000296_BF__MAIN__9$', time=4, arg5=0) # Blackeye_Battle
