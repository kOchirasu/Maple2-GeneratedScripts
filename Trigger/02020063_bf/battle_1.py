...
class 대기(state.State):
    def on_enter(self):
        ...
        start_combine_spawn(groupId=[500], isStart=False)
...
class 스폰_1(state.State):
    def on_enter(self):
        ...
        side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020063_BF__BATTLE_1__0$')
...
class 스폰_1_추가대사1(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__BATTLE_1__1$')
...
class 스폰_1_추가대사2(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_1__2$')
