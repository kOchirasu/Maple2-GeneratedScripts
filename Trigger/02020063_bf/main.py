...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=99990002, key='Battle_1_SpawnStart', value=1)
        # <웨이브 시작>
...
class 포탑페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=99990003, key='Battle_2_Start', value=1)
        # <포탑 생성>
...
class 보스페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__MAIN__4$')
        self.set_user_value(triggerId=99990004, key='Battle_3_Start', value=1)
        self.set_timer(timerId='1', seconds=180, startDelay=1, interval=1, vOffset=60)
        # <3라운드 게임 플레이 타임 설정>
...
class 성공_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__MAIN__5$')
        self.set_user_value(triggerId=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(triggerId=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(triggerId=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(triggerId=99990005, key='Battle_2_SpawnStart', value=0)
...
class 성공_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npcId=11003533, illust='Bliche_smile', duration=5000, script='$02020063_BF__MAIN__6$')
...
class 실패_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__MAIN__7$')
        self.set_user_value(triggerId=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(triggerId=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(triggerId=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(triggerId=99990005, key='Battle_2_SpawnStart', value=0)
...
class 실패_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020063_BF__MAIN__8$')
