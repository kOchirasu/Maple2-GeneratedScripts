...
class 보스페이즈(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__MAIN__4$')
...
class 성공_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__MAIN__5$')
        self.set_user_value(trigger_id=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(trigger_id=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(trigger_id=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(trigger_id=99990005, key='Battle_2_SpawnStart', value=0)
...
class 성공_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_smile', duration=5000, script='$02020063_BF__MAIN__6$')
...
class 실패_세팅(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__MAIN__7$')
        self.set_user_value(trigger_id=99990002, key='Battle_1_SpawnStart', value=0)
        self.set_user_value(trigger_id=99990003, key='Battle_2_Start', value=0)
        self.set_user_value(trigger_id=99990004, key='Battle_3_Start', value=0)
        self.set_user_value(trigger_id=99990005, key='Battle_2_SpawnStart', value=0)
...
class 실패_추가대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_normal', duration=5000, script='$02020063_BF__MAIN__8$')
