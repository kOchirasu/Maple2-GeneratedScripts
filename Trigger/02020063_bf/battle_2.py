...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(group_id=[10000600], is_start=False) # 거대화 보급 상자
        self.start_combine_spawn(group_id=[10000601], is_start=False)
        self.start_combine_spawn(group_id=[10000602], is_start=False)
...
class 추가대사_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__BATTLE_2__0$')
...
class 추가대사_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_2__1$')
...
class 추가대사_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003533, illust='Bliche_normal', duration=5000, script='$02020063_BF__BATTLE_2__2$')
...
class 포탑소환_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_2__4$')
...
class 포탑소환_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_2__5$')
...
class 종료대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_smile', duration=5000, script='$02020063_BF__BATTLE_2__6$')
...
class 포탑소환_클리어(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(group_id=[10000600], is_start=False)
        self.set_user_value(trigger_id=99990007, key='TurretSpawn_1', value=0)
        self.set_user_value(trigger_id=99990008, key='TurretSpawn_2', value=0)
        self.set_user_value(trigger_id=99990009, key='TurretSpawn_3', value=0)
        self.set_user_value(trigger_id=99990010, key='TurretSpawn_4', value=0)
