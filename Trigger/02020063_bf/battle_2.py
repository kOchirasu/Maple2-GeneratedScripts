...
class 대기(common.Trigger):
    def on_enter(self):
        ...
        self.start_combine_spawn(groupId=[10000600], isStart=False) # 거대화 보급 상자
        self.start_combine_spawn(groupId=[10000601], isStart=False)
        self.start_combine_spawn(groupId=[10000602], isStart=False)
...
class 포탑소환_1(common.Trigger):
    def on_enter(self):
        self.start_combine_spawn(groupId=[10000600], isStart=True) # 상자 소환 1
...
class 추가대사_1(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11001813, illust='Turka_normal', duration=5000, script='$02020063_BF__BATTLE_2__0$')
...
class 추가대사_2(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_2__1$')
...
class 추가대사_3(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020063_BF__BATTLE_2__2$')
...
class 포탑소환_2(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_2__4$')
...
class 포탑소환_3(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_2__5$')
...
class 종료대기(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=11003536, illust='Neirin_smile', duration=5000, script='$02020063_BF__BATTLE_2__6$')
