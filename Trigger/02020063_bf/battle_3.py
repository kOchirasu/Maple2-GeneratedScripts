...
class 보스_추가대사(state.State):
    def on_tick(self) -> state.State:
        if wait_tick(waitTick=5000):
            set_event_ui(type=1, arg2='$02020063_BF__BATTLE_3__0$', arg3='5000')
            return 보스소환()
...
class 보스_무적페이즈(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02020063_BF__BATTLE_3__1$', arg3='5000')
        ...
        start_combine_spawn(groupId=[10000600], isStart=True)
        start_combine_spawn(groupId=[10000604], isStart=True)
...
class 보스_추가대사1(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003536, illust='Neirin_surprise', duration=5000, script='$02020063_BF__BATTLE_3__2$')
...
class 보스_추가대사2(state.State):
    def on_enter(self):
        side_npc_talk(type='talk', npcId=11003533, illust='Bliche_normal', duration=5000, script='$02020063_BF__BATTLE_3__3$')
