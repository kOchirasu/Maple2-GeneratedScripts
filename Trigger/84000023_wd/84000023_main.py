...
class 연출시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.wedding_move_user(entryType='Guest', mapId=84000023, portalIds=[22,23], boxId=701)
        # 701번 박스(버진로드)에 있는 하객들은 22,23번으로 랜덤이동
        self.wedding_move_user(entryType='Guest', mapId=84000023, portalIds=[22,23], boxId=703)
