...
class 연출시작(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.wedding_move_user(entryType='Guest', mapId=84000023, portalIds=[22,23], boxId=701) # 799번 박스(입장구역)에 있는 하객들은 22,23번으로 랜덤이동
        self.wedding_move_user(entryType='Guest', mapId=84000023, portalIds=[22,23], boxId=703) # 701번 박스(버진로드)에 있는 하객들은 22,23번으로 랜덤이동
        self.wedding_move_user(entryType='Groom', mapId=84000023, portalIds=[11], boxId=702) # 신랑 11번으로
        self.wedding_move_user(entryType='Bride', mapId=84000023, portalIds=[12], boxId=702) # 신부는 12번으로
...
class 주례줌인02(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.add_cinematic_talk(npcId=11004724, msg='$84000023_WD__84000023_MAIN__0$', duration=3500)
...
class 주례사(trigger_api.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=3)
        self.add_cinematic_talk(npcId=11004724, msg='$84000023_WD__84000023_MAIN__1$', duration=4000)
...
class 탈주로중단(trigger_api.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004724, msg='$84000023_WD__84000023_MAIN__2$', duration=3000)
...
class 탈주로중단선언(trigger_api.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004724, msg='$84000023_WD__84000023_MAIN__3$', duration=3000)
...
class 미입력으로중단01(trigger_api.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004724, msg='$84000023_WD__84000023_MAIN__4$', duration=3000)
...
class 미입력으로중단선언(trigger_api.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004724, msg='$84000023_WD__84000023_MAIN__5$', duration=3000)
...
class 성혼발표(trigger_api.Trigger):
    def on_enter(self):
        self.add_cinematic_talk(npcId=11004724, msg='$84000023_WD__84000023_MAIN__6$', duration=2500)
