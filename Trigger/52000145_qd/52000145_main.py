...
class 퀘스트1수락_01(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 퀘스트1수락_02(common.Trigger):
    def on_enter(self):
...
class 퀘스트1진행_00(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return 퀘스트1진행_01(self.ctx)
...
class 퀘스트1완료가능_00(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return 퀘스트1완료가능_01(self.ctx)
...
class 퀘스트2시작_01(common.Trigger):
    def on_enter(self):
...
class 퀘스트2진행_00(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return 퀘스트2진행_01(self.ctx)


class 퀘스트2진행_01(common.Trigger):
    def on_enter(self):
...
class 퀘스트2완료가능_00(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
...
class 오스칼등장_08_1(common.Trigger):
    def on_enter(self):
