...
class 몬스터웨이브안내토끼1(common.Trigger):
    def on_enter(self):
...
class 몬스터웨이브2시작안내(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 거미여왕기어올라오기(common.Trigger):
    def on_enter(self):
