...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2150,2151], visible=False)
        self.set_mesh(trigger_ids=[2999], visible=False)
        ...
        self.set_skill(trigger_ids=[3000], enable=False)
...
class 물가보여주기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004687, msg='$02000545_BF__MAIN__6$', align='left', duration=4000)
...
class 몬스터웨이브1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[401,402,403,404,405], auto_target=True)
...
class 거미여왕스폰2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.spawn_monster(spawn_ids=[608], auto_target=True)
        self.add_cinematic_talk(npc_id=11004687, msg='$02000545_BF__MAIN__14$', align='left', duration=3000)
...
class 거미여왕스폰3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023,2024,2025,2026,2027,2028,2029,2030,2031,2032,2033,2034,2035,2036,2037,2038,2039,2040,2041,2042,2043,2044,2045,2046,2047,2048,2049,2050], visible=False)
        self.set_mesh(trigger_ids=[2141,2142], visible=False)
        self.set_effect(trigger_ids=[5001], visible=True)
        ...
        self.add_cinematic_talk(npc_id=11004687, msg='$02000545_BF__MAIN__15$', align='left', duration=3000)
        ...
        self.set_npc_emotion_loop(spawn_id=608, sequence_name='Stun_A', duration=10000000)
...
class 거미여왕기어올라오기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=23300010, msg='$02000545_BF__MAIN__16$', align='left', duration=4000)
