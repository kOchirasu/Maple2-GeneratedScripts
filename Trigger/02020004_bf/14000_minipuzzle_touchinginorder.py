...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000241], state=2) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001141 걸어서 71001041 제거
...
class TouchingInNumericalOrder_Success(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[12000241], state=1) # RareBox / 기믹 종료 오브젝트 / Additional Effect 71001141 걸어서 71001041 제거

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[12000241], arg2=0):
