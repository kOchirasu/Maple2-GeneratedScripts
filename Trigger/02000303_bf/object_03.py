...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[60596], visible=False)
        self.set_effect(trigger_ids=[60597], visible=False)
        self.set_effect(trigger_ids=[60598], visible=False)
        self.set_effect(trigger_ids=[60599], visible=False)
        self.set_effect(trigger_ids=[60600], visible=False)
