...
class 검마걸어나오는연출01(common.Trigger):
    def on_enter(self):
...
class 검마걸어나오는연출02(common.Trigger):
    def on_enter(self):
...
class 검마걸어나오는연출03(common.Trigger):
    def on_enter(self):
...
class 검마걸어나오는연출04(common.Trigger):
    def on_enter(self):
...
class 검마걸어나오는연출05(common.Trigger):
    def on_enter(self):
