...
class 투르카의등장02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Quest_Frustration_A', duration=9500)
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Talk_A', duration=12000)
...
class 공명준비이오네04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Quest_Resonance_A', duration=1.2E+09)
...
class 투르카공격준비03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=104, sequence_name='Bore_A', duration=100000)
        self.spawn_monster(spawn_ids=[501], auto_target=True)
        self.spawn_monster(spawn_ids=[502], auto_target=True)
        self.spawn_monster(spawn_ids=[503], auto_target=True)
        self.spawn_monster(spawn_ids=[504], auto_target=True)
        self.spawn_monster(spawn_ids=[505], auto_target=True)
        self.spawn_monster(spawn_ids=[506], auto_target=True)
        self.spawn_monster(spawn_ids=[507], auto_target=True)
        self.spawn_monster(spawn_ids=[508], auto_target=True)
        self.spawn_monster(spawn_ids=[509], auto_target=True)
        self.spawn_monster(spawn_ids=[510], auto_target=True)
        self.spawn_monster(spawn_ids=[511], auto_target=True)
        self.spawn_monster(spawn_ids=[512], auto_target=True)
        self.spawn_monster(spawn_ids=[513], auto_target=True)
        self.spawn_monster(spawn_ids=[514], auto_target=True)
...
class 공명완료02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Bore_A', duration=100000)
...
class 공명완료02_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[4011], return_view=False)
        self.set_npc_emotion_loop(spawn_id=103, sequence_name='Bore_A', duration=100000)
...
class 공명완료03_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.face_emotion(spawn_id=0, emotion_name='defaultBattle')
        self.set_pc_emotion_loop(sequence_name='Idle_A', duration=8000)
