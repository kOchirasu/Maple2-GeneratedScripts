...
class 바라보는크란츠_01(common.Trigger):
    def on_enter(self):
...
class 바라보는크란츠_02(common.Trigger):
    def on_enter(self):
...
class 바라보는크란츠_03(common.Trigger):
    def on_enter(self):
...
class 크란츠습격03_01(common.Trigger):
    def on_enter(self):
...
class 크란츠습격03_01_01(common.Trigger):
    def on_enter(self):
...
class 크란츠습격03_02(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4025], returnView=False)
...
class 크란츠습격03_03(common.Trigger):
    def on_enter(self):
...
class 크란츠습격04_01(common.Trigger):
    def on_enter(self):
