...
class 말풍선연출01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__0$', time=4, arg5=0)
...
class 말풍선연출02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=201, script='$52000022_QD__PATROL01__1$', time=3, arg5=0)
...
class 말풍선연출03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='5', seconds=5)
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__2$', time=4, arg5=0)
...
class 추격대원이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='3', seconds=3)
        self.set_dialogue(type=1, spawn_id=201, script='$52000022_QD__PATROL01__3$', time=3, arg5=0)
...
class 말풍선연출04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='5', seconds=5)
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__4$', time=4, arg5=0)
...
class 말풍선연출05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='2', seconds=2)
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__5$', time=2, arg5=0)
...
class 말풍선연출06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='2', seconds=2)
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__6$', time=2, arg5=0)
...
class 말풍선연출07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='2', seconds=2)
        self.set_dialogue(type=1, spawn_id=201, script='$52000022_QD__PATROL01__7$', time=2, arg5=0)
...
class 말풍선연출08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='2', seconds=2)
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__8$', time=2, arg5=0)
...
class 몹소환(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__9$', time=2, arg5=0)
        self.set_dialogue(type=1, spawn_id=101, script='$52000022_QD__PATROL01__10$', time=3, arg5=0)
