...
class Tower01to10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000342,10000343,10000344,10000345,10000346,10000347,10000348,10000349,10000350,10000351], isStart=True)
...
class Tower11to20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000352,10000353,10000354,10000355,10000356,10000357,10000358,10000359,10000360,10000361], isStart=True)
...
class Tower21to30(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000362,10000363,10000364,10000365,10000366,10000367,10000368,10000369,10000370,10000371], isStart=True)
...
class Tower31to40(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000372,10000373,10000374,10000375,10000376,10000377,10000378,10000379,10000380,10000381], isStart=True)
