...
class Wait_Talk01(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__0$')
...
class Wait_Talk02(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__1$')
...
class Wait_Talk03(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__2$')
...
class StartGameExplain(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__3$')
...
class GameExplain01(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=6000, script='$82000002_survival__01_SURVIVAL__4$')
...
class GameExplain02(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=3000, script='$82000002_survival__01_SURVIVAL__5$')
...
class GameExplain03(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=3000, script='$82000002_survival__01_SURVIVAL__6$')
...
class GameExplain04(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__7$')
...
class GameExplain05(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__14$')
...
class PVPReady(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__8$') # 누가 우승할지 보자
...
class MatchingSuccess(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__9$') # 충분히 모였군!
...
class Countdown(state.State):
    def on_enter(self):
        create_field_game(type='MapleSurvivalTeam')
        show_count_ui(text='$82000002_survival__01_SURVIVAL__10$', stage=0, count=3)
...
class AreaOpen(state.State):
    def on_enter(self):
        ...
        set_user_value(triggerId=16, key='ExtraEventCheck', value=1)
...
class MatchingFail(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__11$') # 인원 부족
...
class GameCancel(state.State):
    def on_enter(self):
        side_npc_talk(npcId=23500110, illust='Mushking_normal', duration=4000, script='$82000002_survival__01_SURVIVAL__12$') # 경기 취소
...
class ReadyToKickOut(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$82000002_survival__01_SURVIVAL__13$', arg3='4000', arg4='0') # 잠시 후 원래 있던 곳으로 돌아갑니다.
...
class GameEnd(state.State):
    def on_enter(self):
        ...
        sight_range(enable=False, range=3) # 우승자 카메라 (LocalTargetCamera 호출) 연출 시, 워포그 해제
...
class Quit(state.State):
    def on_enter(self):
        ...
        set_user_value(triggerId=16, key='ExtraEventOff', value=1)
