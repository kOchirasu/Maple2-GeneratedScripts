...
class ExtraEventRandomDelay02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npc_id=21001019, type='talkbottom', illust='MushroomRichPorter_normal', duration=8000, script='$82000002_survival__16_ExtraEvent__5$')
...
class ExtraEvent01_Fast(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(npc_id=21001019, type='talkbottom', illust='MushroomRichPorter_normal', duration=8000, script='$82000002_survival__16_ExtraEvent__6$')
...
class ExtraEvent02_MapHack(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_buff(box_id=9000, skill_id=71000052)
        self.play_system_sound_in_box(sound='System_Mokum_Completion_01')
        self.side_npc_talk(npc_id=21001019, type='talkbottom', illust='MushroomRichPorter_normal', duration=8000, script='$82000002_survival__16_ExtraEvent__7$')
...
class ExtraEvent03_RobotSpawn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.play_system_sound_in_box(sound='System_Mokum_Completion_01')
        self.side_npc_talk(npc_id=21001019, type='talkbottom', illust='MushroomRichPorter_normal', duration=8000, script='$82000002_survival__16_ExtraEvent__8$')
...
class ExtraEvent04_SkillCoolDownTimeReduce(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.play_system_sound_in_box(sound='System_Mokum_Completion_01')
        self.side_npc_talk(npc_id=21001019, type='talkbottom', illust='MushroomRichPorter_normal', duration=8000, script='$82000002_survival__16_ExtraEvent__9$')
