...
class Round_Talk1(common.Trigger):
    def on_enter(self):
...
class Round_Talk_01_1(common.Trigger):
    def on_enter(self):
...
class Round_Talk_02_1(common.Trigger):
    def on_enter(self):
...
class Round_Talk_03_1(common.Trigger):
    def on_enter(self):
...
class Round_Talk_04_1(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.monster_dead(boxIds=[101]):
            return Round2(self.ctx)


class Round2(common.Trigger):
    def on_enter(self):
...
class Round_Talk_00_2(common.Trigger):
    def on_enter(self):
...
class Round_Talk_01_2(common.Trigger):
    def on_enter(self):
...
class Round_Talk_02_2(common.Trigger):
    def on_enter(self):
...
class Round_Talk_03_2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_Random2(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class Round_Spawn_A2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_B2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_C2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_A_02_Ready2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_B_02_Ready2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_C_02_Ready2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_A_02_2(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class Round_Spawn_A_B_02_2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_A_C_02_2(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=2037404, key='2Round_C', value=1) # 데블린 치프  소환 장치
...
class Round_Spawn_A_B_C2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_A_C_B2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_B_02_2(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=50):
...
class Round_Spawn_B_A_02_2(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=2037402, key='2Round_A', value=1) # 파모칸 소환 장치
...
class Round_Spawn_B_C_02_2(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=2037404, key='2Round_C', value=1) # 데블린 치프  소환 장치
...
class Round_Spawn_B_A_C2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_B_C_A2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_C_02_2(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=50):
...
class Round_Spawn_C_A_02_2(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=2037402, key='2Round_A', value=1) # 파모칸 소환 장치
...
class Round_Spawn_C_B_02_2(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=2037403, key='2Round_B', value=1) # 캡틴 모크  소환 장치
...
class Round_Spawn_C_A_B2(common.Trigger):
    def on_enter(self):
...
class Round_Spawn_C_B_A2(common.Trigger):
    def on_enter(self):
...
class Round_End_Condition2(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.monster_dead(boxIds=[102,103,104]):
            return Round_Ready3(self.ctx)


class Round_Ready3(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=3000):
            return Round_Talk01_3(self.ctx)


class Round_Talk01_3(common.Trigger):
    def on_enter(self):
...
class Round_Talk02_3(common.Trigger):
    def on_enter(self):
...
class Round_Talk03_3(common.Trigger):
    def on_enter(self):
...
class Round_Talk04_3(common.Trigger):
    def on_enter(self):
...
class Round_Talk05_3(common.Trigger):
    def on_enter(self):
...
class Round_Talk06_3(common.Trigger):
    def on_enter(self):
...
class Round_Talk07_3(common.Trigger):
    def on_enter(self):
...
class Clear(common.Trigger):
    def on_enter(self):
        self.move_user(mapId=2000374, portalId=6)
