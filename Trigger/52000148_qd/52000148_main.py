...
class 잠시대기_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_loop(sequence_name='Sit_Ground_Idle_A', duration=130000)
...
class 오스카와대화_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__1$', duration=2500, align='right')
...
class 오스카와대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__2$', duration=3000, align='left')
...
class 오스카와대화_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__3$', duration=3000, align='right')
...
class 오스카와대화_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__4$', duration=3000, align='left')
...
class 오스카와대화_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__5$', duration=4000, align='left')
        self.set_npc_emotion_sequence(spawn_id=101, sequence_name='Talk_A')
...
class 오스카와대화_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__6$', duration=3000, align='right')
...
class 오스카와대화_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__7$', duration=3000, align='left')
        self.set_npc_emotion_sequence(spawn_id=101, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__8$', duration=4000, align='left')
...
class 오스카와대화_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__9$', duration=3000, align='right')
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__10$', duration=3000, align='right')
...
class 오스카와대화_11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__11$', duration=2500, illust_id='Oskhal_normal', align='left')
...
class 오스카와대화_12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__12$', duration=3000, align='right')
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__13$', duration=3000, align='right')
...
class 오스카와대화_13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__14$', duration=3500, illust_id='Oskhal_normal', align='left')
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__15$', duration=3500, illust_id='Oskhal_normal', align='left')
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__16$', duration=2500, illust_id='Oskhal_normal', align='left')
...
class 오스카와대화_14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__17$', duration=2500, align='right')
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__18$', duration=4000, align='right')
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__19$', duration=3000, align='right')
...
class 오스카와대화_15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__20$', duration=3000, illust_id='Oskhal_normal', align='left')
...
class 오스카와대화_16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__21$', duration=4000, align='right')
...
class 오스카와대화_17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__22$', duration=3000, illust_id='Oskhal_normal', align='left')
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__23$', duration=3000, illust_id='Oskhal_normal', align='left')
...
class 오스카와대화_18(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__24$', duration=2500, align='right')
...
class 오스카와대화_19(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003380, msg='$52000148_QD__52000148_MAIN__25$', duration=3000, illust_id='Oskhal_normal', align='left')
...
class 독백_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__26$', duration=2500, align='right')
...
class 독백_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__27$', duration=3000, align='right')
...
class 독백_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=0, msg='$52000148_QD__52000148_MAIN__28$', duration=3500, align='right')
