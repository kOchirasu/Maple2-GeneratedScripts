...
class 경기장입장(state.State):
    def on_tick(self) -> state.State:
        if true():
            move_user(mapId=66000002, portalId=902, boxId=302)
            return 잠시대기()
...
class 시작멘트1(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__2$', arg3='4000') # 로그에서 해당 이벤트에 참여한 사람을 체크하기 위한 명령어 / 1=미니게임 이름, 2=타겟박스 id
...
class 시작멘트2(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__3$', arg3='4000')
...
class 시작멘트3(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__4$', arg3='4000')
...
class 한숨돌리기05(state.State):
    def on_enter(self):
        set_timer(timerId='36', seconds=2)
...
class 보상단계(state.State):
    def on_enter(self):
        set_timer(timerId='37', seconds=7)
        set_event_ui(type=3, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__15$', arg3='5000', arg4='301')
        set_event_ui(type=6, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__16$', arg3='5000', arg4='303,304,305,306') # 로그에서 해당 이벤트에서 우승한 사람을 체크하기 위한 명령어 / 1=미니게임 이름, 2=타겟박스 id
...
class 버프걸기(state.State):
    def on_enter(self):
        set_timer(timerId='38', seconds=6) # action name="이벤트UI를설정한다" arg1="3" arg2="$61000007_ME__MAINPROCESS_SPRINGBEACH__17$" arg3="5000" arg4="301"/>
