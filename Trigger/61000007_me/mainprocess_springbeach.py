...
class 경기장입장(state.State):
    def on_tick(self) -> state.State:
        if true():
            move_user(mapId=61000007, portalId=902, boxId=302)
            return 잠시대기()
...
class 시작멘트1(state.State):
    def on_enter(self):
        start_mini_game(boxId=301, round=5, gameName='springbeach')
        ...
        set_achievement(triggerId=301, type='trigger', achieve='springbeach_start')
...
class 시작멘트3(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__4$', arg3='7000')
...
class 우승자카메라연출(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=6, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__16$', arg3='5000', arg4='303,304,305,306')
...
class 보상단계(state.State):
    def on_enter(self):
        set_event_ui(type=3, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__17$', arg3='5000', arg4='301')
        set_event_ui(type=6, arg2='$61000007_ME__MAINPROCESS_SPRINGBEACH__18$', arg3='5000', arg4='303,304,305,306')
        add_buff(boxIds=[301], skillId=70000019, level=1) # 로그에서 해당 이벤트에서 우승한 사람을 체크하기 위한 명령어 / 1=미니게임 이름, 2=타겟박스 id
        set_achievement(triggerId=301, type='trigger', achieve='springbeach_win')
        mini_game_give_reward(winnerBoxId=301, contentType='miniGame')
        end_mini_game(winnerBoxId=301, gameName='springbeach')
