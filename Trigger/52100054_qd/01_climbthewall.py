...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002083], state=1) # Lever
        set_interact_object(triggerIds=[10002084], state=1) # Lever
...
class TerraceMobAttack01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=901, script='$52100054_QD__01_CLIMBTHEWALL__0$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=902, script='$52100054_QD__01_CLIMBTHEWALL__0$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=903, script='$52100054_QD__01_CLIMBTHEWALL__0$', arg4=2, arg5=1)
...
class TowerUnderMobAttack01(state.State):
    def on_enter(self):
        play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        show_guide_summary(entityId=20039803, textId=20039803, duration=3000) # 가이드 : 레버를 당기기
        create_monster(spawnIds=[920,921,922,923], arg2=False)

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002083], arg2=0):
...
class GuidePullTheLever01(state.State):
    ...
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002084], arg2=0):
