...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10002083], state=1) # Lever
        self.set_interact_object(triggerIds=[10002084], state=1) # Lever
...
class TerraceMobAttack01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=901, script='$52100054_QD__01_CLIMBTHEWALL__0$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=902, script='$52100054_QD__01_CLIMBTHEWALL__0$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=903, script='$52100054_QD__01_CLIMBTHEWALL__0$', arg4=2, arg5=1)
...
class TowerUnderMobAttack01(common.Trigger):
    ...
    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10002083], stateValue=0):
...
class GuidePullTheLever01(common.Trigger):
    ...
    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10002084], stateValue=0):
