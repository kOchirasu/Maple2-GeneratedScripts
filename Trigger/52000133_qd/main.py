...
class 케이틀린첫만남_연출시작(common.Trigger):
    def on_enter(self):
...
class 케이틀린첫만남_스킵완료(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
...
class 예민한아노스_연출준비(common.Trigger):
    def on_enter(self):
...
class 예민한아노스_연출시작(common.Trigger):
    def on_enter(self):
...
class 예민한아노스_스킵완료(common.Trigger):
    def on_enter(self):
