...
class 대기(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.dungeon_variable(var_id=210, value=1):
...
class 메시지1(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.dungeon_variable(var_id=220, value=1):
...
class 메시지2(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.dungeon_variable(var_id=230, value=1):
...
class 메시지3(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.dungeon_variable(var_id=240, value=1):
