...
class 보스전유저감지(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[1002]):
            return 보스체력체크1(self.ctx)


class 보스체력체크1(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 씨앗패턴1_확률체크(common.Trigger):
    def on_enter(self):
...
class 씨앗패턴1_1_심기(common.Trigger):
    def on_enter(self):
...
class 씨앗패턴1_2_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴1_3_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴1_4_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴2_확률체크(common.Trigger):
    def on_enter(self):
...
class 씨앗패턴2_1_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴2_2_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴2_3_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴2_4_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴3_확률체크(common.Trigger):
    def on_enter(self):
...
class 씨앗패턴3_1_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴3_2_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴3_3_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
...
class 씨앗패턴3_4_심기(common.Trigger):
    def on_enter(self):
        self.set_interact_object(triggerIds=[10002128], state=1)
        self.set_interact_object(triggerIds=[10002129], state=1)
