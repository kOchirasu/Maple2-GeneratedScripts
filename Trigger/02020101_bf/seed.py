...
class 씨앗패턴1_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[9001], visible=True, start_delay=0, interval=0, fade=2)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.object_interacted(interact_ids=[10002124], state=0):
            self.set_mesh(trigger_ids=[9001], visible=False, start_delay=0, interval=0, fade=0)
            return 씨앗패턴1_1_심기(self.ctx)


class 씨앗패턴1_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[9002], visible=True, start_delay=0, interval=0, fade=2)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.object_interacted(interact_ids=[10002125], state=0):
            self.set_mesh(trigger_ids=[9002], visible=False, start_delay=0, interval=0, fade=0)
            return 씨앗패턴1_2_심기(self.ctx)


class 씨앗패턴1_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[9003], visible=True, start_delay=0, interval=0, fade=2)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.object_interacted(interact_ids=[10002126], state=0):
            self.set_mesh(trigger_ids=[9003], visible=False, start_delay=0, interval=0, fade=0)
            return 씨앗패턴1_3_심기(self.ctx)


class 씨앗패턴1_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[9004], visible=True, start_delay=0, interval=0, fade=2)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.object_interacted(interact_ids=[10002127], state=0):
            self.set_mesh(trigger_ids=[9004], visible=False, start_delay=0, interval=0, fade=0)
...
class 보스체력체크2(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[101]):
            return 종료(self.ctx)
        if self.check_npc_hp(compare='lowerEqual', value=40, spawn_id=101, is_relative=True):
...
class 보스체력체크3(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[101]):
            return 종료(self.ctx)
        if self.check_npc_hp(compare='lowerEqual', value=15, spawn_id=101, is_relative=True):
