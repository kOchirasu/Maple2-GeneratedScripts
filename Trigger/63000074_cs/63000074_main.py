...
class Diary_ready(common.Trigger):
    def on_enter(self):
...
class Diary_set(common.Trigger):
    def on_enter(self):
...
class Diary_start(common.Trigger):
    def on_enter(self):
...
class Evelyn_monologue_00(common.Trigger):
    def on_enter(self):
...
class Evelyn_monologue_01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class Evelyn_monologue_02(common.Trigger):
    def on_enter(self):
...
class Evelyn_monologue_03(common.Trigger):
    def on_enter(self):
...
class Evelyn_monologue_04(common.Trigger):
    def on_enter(self):
...
class bobos_ready(common.Trigger):
    def on_enter(self):
...
class rednose_01(common.Trigger):
    def on_enter(self):
...
class rednose_02(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml') # 불끄기
...
class rednose_03(common.Trigger):
    def on_enter(self):
...
class moveto63000072(common.Trigger):
    def on_enter(self):
        self.move_user(mapId=63000072, portalId=11)


class moveto63000072_2(common.Trigger):
    def on_enter(self):
        self.move_user(mapId=63000072, portalId=11)
