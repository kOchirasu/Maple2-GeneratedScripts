...
class 전투_2라운드(common.Trigger):
    def on_enter(self):
        ...
        self.create_monster(spawnIds=[301], animationEffect=False) # <독바닥 깔기 몬스터 생성>
...
class 전투_3라운드_시작(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[301])
        self.create_monster(spawnIds=[302], animationEffect=False) # <독바닥 깔기 제어>
...
class 전투_4라운드_시작(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[302])
        self.create_monster(spawnIds=[303], animationEffect=False) # <독바닥 깔기 제어>
