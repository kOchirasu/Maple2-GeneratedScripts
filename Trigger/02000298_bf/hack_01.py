...
class 대기(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10000369], state=0)
...
class 스폰(state.State):
    def on_enter(self):
        create_monster(spawnIds=[1030], arg2=False)
        set_interact_object(triggerIds=[10000369], state=1)

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10000369], arg2=0):
            return 코드체크()
...
class 코드_1279(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__0$', arg3='2000')
...
class 코드_1238(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__1$', arg3='2000')
...
class 코드_1358(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__2$', arg3='2000')
...
class 코드_1489(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__3$', arg3='2000')
...
class 코드_1567(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__4$', arg3='2000')
...
class 코드_1679(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__5$', arg3='2000')
...
class 코드_2389(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__6$', arg3='2000')
...
class 코드_2347(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__7$', arg3='2000')
...
class 코드_2478(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__8$', arg3='2000')
...
class 코드_2456(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__9$', arg3='2000')
...
class 코드_2569(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__10$', arg3='2000')
...
class 코드_2678(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__11$', arg3='2000')
...
class 코드_3458(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__12$', arg3='2000')
...
class 코드_3589(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__13$', arg3='2000')
...
class 코드_3679(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__14$', arg3='2000')
...
class 코드_3789(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__15$', arg3='2000')
...
class 코드_4567(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__16$', arg3='2000')
...
class 코드_4578(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__17$', arg3='2000')
...
class 코드_4689(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__18$', arg3='2000')
...
class 코드_4789(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_01__19$', arg3='2000')
