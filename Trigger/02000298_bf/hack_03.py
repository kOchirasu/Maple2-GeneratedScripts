...
class 대기(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10000371], state=0)
...
class 스폰(state.State):
    def on_enter(self):
        create_monster(spawnIds=[1031], arg2=False)
        set_interact_object(triggerIds=[10000371], state=1)

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10000371], arg2=0):
            return 코드체크()
...
class 코드_1279(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__0$', arg3='2000')
...
class 코드_1238(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__1$', arg3='2000')
...
class 코드_1358(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__2$', arg3='2000')
...
class 코드_1489(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__3$', arg3='2000')
...
class 코드_1567(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__4$', arg3='2000')
...
class 코드_1679(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__5$', arg3='2000')
...
class 코드_2389(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__6$', arg3='2000')
...
class 코드_2347(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__7$', arg3='2000')
...
class 코드_2478(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__8$', arg3='2000')
...
class 코드_2456(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__9$', arg3='2000')
...
class 코드_2569(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__10$', arg3='2000')
...
class 코드_2678(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__11$', arg3='2000')
...
class 코드_3458(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__12$', arg3='2000')
...
class 코드_3589(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__13$', arg3='2000')
...
class 코드_3679(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__14$', arg3='2000')
...
class 코드_3789(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__15$', arg3='2000')
...
class 코드_4567(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__16$', arg3='2000')
...
class 코드_4578(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__17$', arg3='2000')
...
class 코드_4689(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__18$', arg3='2000')
...
class 코드_4789(state.State):
    def on_enter(self):
        set_timer(timerId='5', seconds=5)
        set_event_ui(type=1, arg2='$02000298_BF__HACK_03__19$', arg3='2000')
