...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3012], visible=True, start_delay=0, interval=0, fade=0)
...
class 문열림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3011], visible=False, start_delay=0, interval=0, fade=5)
        self.set_mesh(trigger_ids=[3012], visible=False, start_delay=0, interval=0, fade=5)
