...
class Collapse00(common.Trigger):
    def on_enter(self):
...
class Collapse03(common.Trigger):
    def on_enter(self):
...
class Collapse04(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5910], visible=True) # RumbleSound
...
class Collapse05(common.Trigger):
    def on_enter(self):
...
class Collapse06(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5818], visible=True) # SandFlowdown
...
class Collapse07(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5910], visible=True) # RumbleSound
...
class Collapse08(common.Trigger):
    def on_tick(self) -> common.Trigger:
