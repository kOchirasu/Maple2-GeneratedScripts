...
class 자대화_10_1_3(common.Trigger):
    def on_enter(self):
...
class 자대화_10_2_3(common.Trigger):
    def on_enter(self):
...
class 자대화_11_1_3(common.Trigger):
    def on_enter(self):
