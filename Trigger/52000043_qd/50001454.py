...
class 틴차이대사01스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 틴차이대사02스킵(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[607], visible=False)
        self.remove_cinematic_talk()
        self.set_skip()
...
class 틴차이대사03스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 틴차이대사04스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 틴차이대사05스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 틴차이대사06스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
