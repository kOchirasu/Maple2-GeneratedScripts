...
class 준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_ladder(trigger_ids=[6001], visible=False, enable=False)
        self.set_ladder(trigger_ids=[6002], visible=False, enable=False)
        self.set_ladder(trigger_ids=[6003], visible=False, enable=False)
        self.set_ladder(trigger_ids=[6004], visible=False, enable=False)
...
class 보보스퇴장_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.add_cinematic_talk(npc_id=11004371, msg='책 틈에서 지내게 했으니, 소원 들어준 거야…', duration=2000, align='right')
...
class 에이든대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11004359, msg='$63000073_CS__63000073_MAIN__1$', duration=2500, align='right', illust_id='0') # 아… 머리야.\n이게 어떻게 된 일이지
...
class 에이든대화_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_pc_emotion_loop(sequence_name='Talk_A', duration=2500)
        self.add_cinematic_talk(npc_id=0, msg='$63000073_CS__63000073_MAIN__2$', duration=2500, align='right') # $npcName:11004359$이지?
...
class 에이든대화_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$63000073_CS__63000073_MAIN__3$', duration=4500, align='right')
...
class 에이든대화_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=122, sequence_name='Talk_A', duration=3500)
        # …뭐라고?\n그럼… 나만 당한 게 아닌 건가?
        self.add_cinematic_talk(npc_id=11004359, msg='$63000073_CS__63000073_MAIN__4$', duration=3500, align='right', illust_id='0')
...
class 에이든대화_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=122, sequence_name='Talk_A', duration=4500)
        # 어서 $npcName:11004354$$pp:를,을$ 만나봐야겠군.\n먼저 출발할게, 마을에서 보자.
        self.add_cinematic_talk(npc_id=11004359, msg='$63000073_CS__63000073_MAIN__5$', duration=4500, align='right', illust_id='0')
