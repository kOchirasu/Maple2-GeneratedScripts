...
class 보보스퇴장_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawnId=121, msg='$63000073_CS__63000073_MAIN__0$', duration=2500, delayTick=1000)
        # self.add_cinematic_talk(npcId=11004371, msg='책 틈에서 지내게 했으니, 소원 들어준 거야…', duration=2000, align='right')
...
class 에이든대화_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=0, msg='$63000073_CS__63000073_MAIN__3$', duration=4500, align='right')
...
class 에이든대화_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # …뭐라고?\n그럼… 나만 당한 게 아닌 건가?
        self.add_cinematic_talk(npcId=11004359, msg='$63000073_CS__63000073_MAIN__4$', duration=3500, align='right', illustId='0')
...
class 에이든대화_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004359, msg='$63000073_CS__63000073_MAIN__5$', duration=4500, align='right', illustId='0')
