...
class 깨어남1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=2004, visible=False, initial_sequence='Bore_A')
        self.set_actor(trigger_id=2005, visible=False, initial_sequence='Stun_A')
        self.set_actor(trigger_id=2006, visible=False, initial_sequence='Stun_A')
        self.spawn_monster(spawn_ids=[20004], auto_target=True)
        self.set_dialogue(type=1, spawn_id=20004, script='$02000320_BF__WAKEUP_02__0$', time=2, arg5=0)
        self.spawn_monster(spawn_ids=[20005], auto_target=True)
        self.set_dialogue(type=1, spawn_id=20005, script='$02000320_BF__WAKEUP_02__1$', time=2, arg5=1)
        self.spawn_monster(spawn_ids=[20006], auto_target=True)
...
class 깨어남2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=20002, script='$02000320_BF__WAKEUP_02__5$', time=2, arg5=0)
...
class 다시자러감(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=20004, script='$02000320_BF__WAKEUP_02__8$', time=2, arg5=0)
