...
class 깨어남1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=8004, visible=False, initial_sequence='Bore_A')
        self.set_actor(trigger_id=8005, visible=False, initial_sequence='Stun_A')
        self.set_actor(trigger_id=8006, visible=False, initial_sequence='Stun_A')
        self.spawn_monster(spawn_ids=[80004], auto_target=True)
        self.set_dialogue(type=1, spawn_id=80004, script='$02000320_BF__WAKEUP_08__0$', time=2, arg5=0)
        self.spawn_monster(spawn_ids=[80005], auto_target=True)
        self.set_dialogue(type=1, spawn_id=80005, script='$02000320_BF__WAKEUP_08__1$', time=2, arg5=1)
        self.spawn_monster(spawn_ids=[80006], auto_target=True)
...
class 깨어남2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=80002, script='$02000320_BF__WAKEUP_08__5$', time=2, arg5=0)
...
class 다시자러감(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=80004, script='$02000320_BF__WAKEUP_08__8$', time=2, arg5=0)
