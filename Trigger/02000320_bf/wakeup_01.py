...
class 깨어남1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=1004, visible=False, initial_sequence='Bore_A')
        self.set_actor(trigger_id=1005, visible=False, initial_sequence='Stun_A')
        self.set_actor(trigger_id=1006, visible=False, initial_sequence='Stun_A')
        self.spawn_monster(spawn_ids=[10004], auto_target=True)
        self.set_dialogue(type=1, spawn_id=10004, script='$02000320_BF__WAKEUP_01__0$', time=2, arg5=0)
...
class 깨어남2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=10002, script='$02000320_BF__WAKEUP_01__5$', time=2, arg5=0)
...
class 다시자러감(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=10004, script='$02000320_BF__WAKEUP_01__8$', time=2, arg5=0)
