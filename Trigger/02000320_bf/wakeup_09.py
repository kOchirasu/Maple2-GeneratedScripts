...
class 깨어남1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(trigger_id=9004, visible=False, initial_sequence='Bore_A')
        self.set_actor(trigger_id=9005, visible=False, initial_sequence='Stun_A')
        self.set_actor(trigger_id=9006, visible=False, initial_sequence='Stun_A')
        self.spawn_monster(spawn_ids=[90004], auto_target=True)
        self.set_dialogue(type=1, spawn_id=90004, script='$02000320_BF__WAKEUP_09__0$', time=2, arg5=0)
        self.spawn_monster(spawn_ids=[90005], auto_target=True)
        self.set_dialogue(type=1, spawn_id=90005, script='$02000320_BF__WAKEUP_09__1$', time=2, arg5=1)
        self.spawn_monster(spawn_ids=[90006], auto_target=True)
...
class 깨어남2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=90002, script='$02000320_BF__WAKEUP_09__5$', time=2, arg5=0)
...
class 다시자러감(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=90004, script='$02000320_BF__WAKEUP_09__8$', time=2, arg5=0)
