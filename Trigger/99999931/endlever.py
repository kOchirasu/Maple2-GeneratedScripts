...
class 문닫기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portalId=101, visible=False, enable=True)
        # 순간 이동 포털을 안 보이게(arg2=0) 하고 동작하게(arg3=1) 한다
        self.set_portal(portalId=102, visible=False, enable=True)
        # 순간 이동 포털을 안 보이게(arg2=0) 하고 동작하게(arg3=1) 한다
        self.set_portal(portalId=103, visible=False, enable=True)
        # 순간 이동 포털을 안 보이게(arg2=0) 하고 동작하게(arg3=1) 한다
        self.set_portal(portalId=104, visible=False, enable=True)
        # 순간 이동 포털을 안 보이게(arg2=0) 하고 동작하게(arg3=1) 한다
        self.set_portal(portalId=115, visible=False, enable=True)
        # 순간 이동 포털을 안 보이게(arg2=0) 하고 동작하게(arg3=1) 한다
        self.set_portal(portalId=116, visible=False, enable=True)
        # 순간 이동 포털을 안 보이게(arg2=0) 하고 동작하게(arg3=1) 한다
        self.set_portal(portalId=117, visible=False, enable=True)
        # 순간 이동 포털을 안 보이게(arg2=0) 하고 동작하게(arg3=1) 한다
        self.set_portal(portalId=118, visible=False, enable=True)
