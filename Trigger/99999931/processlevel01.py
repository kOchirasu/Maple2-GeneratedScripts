...
class 게임진행1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_breakable(trigger_ids=[101,102,103,104,105,106,107,114,115,116,118,119,121,123,126,130,131,132,133,134,135], enable=False) # 움직이는 발판을 멈춘다 (arg2=0)
        self.set_skill(trigger_ids=[801,802,803,804,805,806,807], is_enable='1')
...
class 게임진행2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_skill(trigger_ids=[801], enable=False)
        self.set_skill(trigger_ids=[802], enable=False)
        self.set_skill(trigger_ids=[803], enable=False)
        self.set_skill(trigger_ids=[804], enable=False)
        self.set_skill(trigger_ids=[805], enable=False)
        self.set_skill(trigger_ids=[806], enable=False)
        self.set_skill(trigger_ids=[807], enable=False)
        ...
        self.set_skill(trigger_ids=[830], enable=False)
        self.set_skill(trigger_ids=[831], enable=False)
        self.set_skill(trigger_ids=[832], enable=False)
        self.set_skill(trigger_ids=[833], enable=False)
        self.set_skill(trigger_ids=[834], enable=False)
        self.set_skill(trigger_ids=[835], enable=False)
