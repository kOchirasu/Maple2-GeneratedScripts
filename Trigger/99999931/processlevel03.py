...
class 게임진행1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_breakable(trigger_ids=[101,102,103,104,105,106,107,112,113,115,116,118,119,121,122,124,125,130,131,132,133,134,135,136], enable=False) # 움직이는 발판을 멈춘다 (arg2=0)
...
class 게임진행2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_skill(trigger_ids=[836], enable=False)
