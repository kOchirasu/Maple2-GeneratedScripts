...
class QuestOnGoing23(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
# 최초 입장
class PCWakeUp01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class PCWakeUp02(common.Trigger):
    def on_enter(self):
...
class PCWakeUp03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class PCWakeUp04(common.Trigger):
    def on_enter(self):
...
class PCWakeUp05(common.Trigger):
    def on_enter(self):
...
class BattleING01(common.Trigger):
    def on_enter(self):
...
class BattleING02(common.Trigger):
    def on_enter(self):
...
class TinChaiTalk02_CSkip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class BattleStart01(common.Trigger):
    def on_enter(self):
        ...
        self.show_guide_summary(entityId=10035010, textId=10035010) # 가이드 : 틴차이를 도와 검은 그림자 처치하기
...
class BattleStart02(common.Trigger):
    def on_enter(self):
        self.guide_event(eventId=10035020) # 트리거 To가이드 : HP가 0이 되면 비석에 깔리니 조심
...
class BattleEnd05(common.Trigger):
    def on_enter(self):
...
class ShadowWave01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class ShadowWave02(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=600, enable=True)
...
class ShadowWave03(common.Trigger):
    def on_enter(self):
...
class ShadowWave04(common.Trigger):
    def on_enter(self):
...
# 카메라 워크
class ShadowWave05(common.Trigger):
    def on_enter(self):
...
class ShadowWave06(common.Trigger):
    def on_enter(self):
...
# 양측 2차 스폰
class ShadowWave07(common.Trigger):
    def on_enter(self):
...
class TinChaiDesperate01(common.Trigger):
    def on_enter(self):
...
class TinChaiDesperate02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class JuntaApp01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class JuntaApp02(common.Trigger):
    def on_enter(self):
...
class JuntaApp03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_agent(triggerIds=[8100], visible=False)
...
class JuntaApp04(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[201], animationEffect=False) # 11001742_M_Junta 준타 Regen_A
    ...
    def on_exit(self):
        self.set_skill(triggerIds=[7000], enable=True) # 올킬
...
class MeetJunta01(common.Trigger):
    def on_enter(self):
...
class MeetJunta02(common.Trigger):
    def on_enter(self):
...
class MeetJunta03(common.Trigger):
    def on_enter(self):
...
class MeetJunta04(common.Trigger):
    def on_enter(self):
...
class MeetJunta05_Cskip(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=701, enable=True)
        self.set_effect(triggerIds=[5100], visible=False) # Sound_ShadowApp_Loop
        self.destroy_monster(spawnIds=[910,911,912,913,920,921,922,923,924,930,931,932,933,940,941,942,943,944,945,950,951,952,953,960,961,962,963,964,965])
...
class MeetJunta05_Cskip2(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[970,971,972,973,974,975,976,977,978,979,980,981,982,983,984,985,986,987,988,989,990,991,992,993,994,995,996,997,998])
...
class MeetJunta05(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.destroy_monster(spawnIds=[102,201])
        self.create_monster(spawnIds=[103,202], animationEffect=False)
...
class MeetJunta06(common.Trigger):
    def on_enter(self):
...
class ShadowWaveAgain01(common.Trigger):
    def on_enter(self):
...
# 정면 1차 스폰 후 다리 패트롤 바로 시작
class ShadowWaveAgain02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_agent(triggerIds=[8100], visible=True)
...
# 정면 2차 스폰 후 다리 패트롤 바로 시작
class ShadowWaveAgain03(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=601, enable=True)
        self.set_effect(triggerIds=[5100], visible=True) # Sound_ShadowApp_Loop
...
# 카메라 워크
class ShadowWaveAgain04(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=920, patrolName='MS2PatrolData_920')
        self.move_npc(spawnId=921, patrolName='MS2PatrolData_921')
        self.move_npc(spawnId=922, patrolName='MS2PatrolData_922')
...
class ShadowWaveAgain05(common.Trigger):
    def on_enter(self):
...
# 양측 2차 스폰
class ShadowWaveAgain06(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[940,941,942,943,944,945,960,961,962,963,964,965])
        self.move_npc(spawnId=940, patrolName='MS2PatrolData_940')
        self.move_npc(spawnId=941, patrolName='MS2PatrolData_941')
...
class TimeToLeave04(common.Trigger):
    def on_enter(self):
...
class TimeToLeave05(common.Trigger):
    def on_enter(self):
