...
class 생성(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10000339], state=0)
...
class 게이트열림(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10000339], state=1)
...
class 게이트닫힘(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10000339], stateValue=0):
            return 생성(self.ctx)
