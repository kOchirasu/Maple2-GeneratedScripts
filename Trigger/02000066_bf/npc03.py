...
class 시작(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10000343], state=0)
...
class 오브젝트반응(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10000343], state=1)

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10000343], stateValue=0):
            return 부활(self.ctx)
...
class NPC대사(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=203, visible=False, initialSequence='Dead_A')
        self.set_conversation(type=1, spawnId=2003, script='$02000066_BF__NPC03__1$', arg4=2)
