...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 초기화
        self.set_effect(trigger_ids=[602], visible=False) # 아노스 던전 시작01
        self.set_effect(trigger_ids=[603], visible=False) # 아노스  소환
        self.set_effect(trigger_ids=[604], visible=False) # 아노스 게이트 파괴
        self.set_effect(trigger_ids=[605], visible=False) # 아노스 경비병 사망
        self.set_effect(trigger_ids=[606], visible=False) # 파토스 성공01
        self.set_effect(trigger_ids=[607], visible=False) # 파토스 성공02
        self.set_effect(trigger_ids=[608], visible=False) # 파토스 성공03
        self.set_effect(trigger_ids=[609], visible=False) # 파토스 성공04
        self.set_effect(trigger_ids=[610], visible=False) # 파토스 성공05
        self.set_effect(trigger_ids=[611], visible=False) # 파토스 리젠
        self.set_effect(trigger_ids=[612], visible=False) # 아노스 성공
        self.set_effect(trigger_ids=[613], visible=False) # 파토스 실패01
        self.set_effect(trigger_ids=[614], visible=False) # 파토스 실패02
        self.set_effect(trigger_ids=[615], visible=False) # 파토스 실패03
        self.set_effect(trigger_ids=[616], visible=False) # 파토스 실패04
        self.set_effect(trigger_ids=[617], visible=False) # 파토스 실패05
        self.set_effect(trigger_ids=[618], visible=False) # 파토스 실패06
        self.set_effect(trigger_ids=[619], visible=False) # 파토스 실패07
        self.set_effect(trigger_ids=[620], visible=False)
        self.set_effect(trigger_ids=[6003], visible=False) # 미션 성공
...
class 차어나운스01_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11000032, illust_id='Anos_serious', msg='$02000066_BF__MAIN__4$', duration=5000, align='center')
        self.set_skip(state=차어나운스03_1)
...
class 차어나운스02_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11000032, illust_id='Anos_serious', msg='$02000066_BF__MAIN__5$', duration=5000, align='center')
        self.set_skip(state=차어나운스03_1)
...
class 차웨이브1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='120', seconds=120, start_delay=0, interval=1, v_offset=0)
...
class 차웨이브2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_timer(timer_id='120', seconds=120, start_delay=0, interval=1)
...
class 차웨이브성공3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.destroy_monster(spawn_ids=[902])
        self.set_mesh(trigger_ids=[9001], visible=False)
        self.destroy_monster(spawn_ids=[99])
        self.set_npc_emotion_loop(spawn_id=99, sequence_name='Attack_Idle_A', duration=1E+12)
