...
class 시작(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10000373], state=0)
...
class 오브젝트반응(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10000373], state=1)

    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10000373], stateValue=0):
            return 부활(self.ctx)
...
class NPC대사(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=205, visible=False, initialSequence='Dead_A')
        self.set_conversation(type=1, spawnId=2005, script='$02000066_BF__NPC05__1$', arg4=2)
