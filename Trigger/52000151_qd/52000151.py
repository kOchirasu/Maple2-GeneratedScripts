...
class 생틈퀘수령전대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=200, sequence_name='Event_01_A', duration=999999)
...
class 파토스등장연출01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=202, sequence_name='Stun_A', duration=999999)
...
class 파토스등장연출02_B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[1100,1101,1102,1103,1104,1105,1106,1107], visible=True, start_delay=0, interval=100)
        self.set_effect(trigger_ids=[1200,1201,1202,1203,1204,1205,1206], visible=True, start_delay=0, interval=100)
        self.set_effect(trigger_ids=[1300,1301,1302,1303,1304,1305,1306,1307,1308,1309,1310,1311], visible=True, start_delay=0, interval=100)
        self.set_effect(trigger_ids=[1400,1401,1402,1403,1404,1405,1406,1407,1408,1409], visible=True, start_delay=0, interval=100)
        self.set_effect(trigger_ids=[1500,1501,1502,1503,1504,1505,1506,1507,1508], visible=True, start_delay=0, interval=100)
        self.set_effect(trigger_ids=[1600,1601,1602,1603,1604,1605,1606,1607,1608], visible=True, start_delay=0, interval=100)
        self.set_effect(trigger_ids=[1700,1701,1702,1703,1704], visible=True, start_delay=0, interval=100)
...
class 파토스등장연출03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003439, illust_id='0', msg='$52000151_QD__52000151__0$', duration=4000, align='right') # 호르헤 대사
...
class 파토스등장연출04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003442, illust_id='0', msg='$52000151_QD__52000151__1$', duration=4000, align='right') # 케이틀린 대사
...
class 파토스등장연출05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__2$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__3$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__4$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003442, illust_id='0', msg='$52000151_QD__52000151__5$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003439, illust_id='0', msg='$52000151_QD__52000151__6$', duration=4000, align='right') # 호르헤 대사
        self.select_camera_path(path_ids=[7000,7001], return_view=False)
...
class 파토스등장연출12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003439, illust_id='0', msg='$52000151_QD__52000151__7$', duration=4000, align='right') # 호르헤 대사
...
class 파토스등장연출13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__8$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__9$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__10$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__11$', duration=4000, align='right') # 파토스 대사
        # 저 녀석은 저 녀석.
...
class 파토스등장연출17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__12$', duration=4000, align='right') # 파토스 대사
        # 나 파토스는 파토스일 뿐.
...
class 파토스등장연출18(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__13$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출19(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__14$', duration=4000, align='right') # 파토스 대사
...
class 파토스등장연출20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003441, illust_id='0', msg='$52000151_QD__52000151__15$', duration=4000, align='right') # 케이틀린 대사
