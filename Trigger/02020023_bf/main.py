...
class 카메라_캡션(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[501,502], return_view=True)
        self.show_caption(type='VerticalCaption', title='$02020023_BF__main__3$', desc='$02020023_BF__main__4$', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=4000, scale=2)
...
class 카메라_줌인(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[503,504], return_view=True)
...
class 카메라_블리체뒤돌기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=102, rotation=180)
        self.add_cinematic_talk(npc_id=23200083, illust_id='Bliche_normal', msg='$02020023_BF__main__1$', duration=4000, align='left')
...
class 카메라_블리체대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=23200083, illust_id='Bliche_normal', msg='$02020023_BF__main__0$', duration=4000, align='left')
