...
class 카메라_블리체등장(common.Trigger):
    def on_enter(self):
...
class 카메라_블리체뒤돌기(common.Trigger):
    def on_enter(self):
...
class 카메라_블리체대사1(common.Trigger):
    def on_enter(self):
...
class 블리체_전투시작대사(common.Trigger):
    def on_enter(self):
