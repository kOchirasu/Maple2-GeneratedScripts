...
class FirstWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90980,90986], arg2=False)
...
class FirstWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90983,90987], arg2=False)
...
class SecondWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90994,90996], arg2=False)
...
class SecondWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90993,90999], arg2=False)
