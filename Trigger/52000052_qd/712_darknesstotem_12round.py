...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3800,3801,3802,3803,3804,3805,3806,3807,3808,3809,3810,3811,3812,3813], visible=False, start_delay=0, interval=0, fade=0) # TotemGround
...
class TotemApp01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3800,3801,3802,3803,3804,3805,3806,3807,3808,3809,3810,3811,3812,3813], visible=True, start_delay=0, interval=0, fade=5) # TotemGround
...
class JuntaReady01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=2312, script='$52000052_QD__702_DARKNESSTOTEM_02ROUND__0$', time=3, arg5=0) # 전투중인 준타
...
class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3800,3801,3802,3803,3804,3805,3806,3807,3808,3809,3810,3811,3812,3813], visible=False, start_delay=0, interval=0, fade=5) # TotemGround
