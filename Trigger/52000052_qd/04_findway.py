...
class Round04_Start(common.Trigger):
    def on_enter(self):
...
class Round04_Sucess02(common.Trigger):
    def on_enter(self):
...
class Round04_RouteSelect(common.Trigger):
    def on_enter(self):
...
class Round04_PickRoute_Left(common.Trigger):
    def on_enter(self):
...
class Round04_PickRoute_Right(common.Trigger):
    def on_enter(self):
