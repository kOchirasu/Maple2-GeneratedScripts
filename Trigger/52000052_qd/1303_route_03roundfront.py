...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5003], visible=False) # 03Round_BridgeApp
        self.set_mesh(trigger_ids=[130300,130301,130302,130303,130304,130305,130306,130307,130308,130309,130310,130311,130312,130313,130314,130315,130316,130317,130318,130319,130320,130321], visible=False, start_delay=0, interval=0, fade=0) # Fake
        self.set_mesh(trigger_ids=[330300,330301,330302,330303,330304,330305,330306,330307,330308,330309,330310,330311,330312,330313,330314,330315,330316,330317,330318,330319,330320,330321], visible=False, start_delay=0, interval=0, fade=0) # Real
...
class StartDazzlingRandom01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_random_mesh(trigger_ids=[130300,130301,130302,130303,130304,130305,130306,130307,130308,130309,130310,130311,130312,130313,130314,130315,130316,130317,130318,130319,130320,130321], visible=False, start_delay=22, interval=0, fade=0) # Fake
...
class MakeTrue(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[130300,130301,130302,130303,130304,130305,130306,130307,130308,130309,130310,130311,130312,130313,130314,130315,130316,130317,130318,130319,130320,130321], visible=False, start_delay=0, interval=0, fade=5) # Fake
        ...
        self.set_agent(trigger_ids=[18031], visible=False)
        self.set_agent(trigger_ids=[18032], visible=False)
        self.set_agent(trigger_ids=[18033], visible=False)
        self.set_agent(trigger_ids=[18034], visible=False)
