...
class FirstWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91080,91084], arg2=False)
...
class FirstWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91087,91089], arg2=False)
...
class SecondWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91090,91096], arg2=False)
...
class SecondWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91091,91099], arg2=False)
