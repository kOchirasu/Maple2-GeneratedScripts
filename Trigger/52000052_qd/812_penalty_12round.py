...
class FirstWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91280,91284], arg2=False)
...
class FirstWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91285,91287], arg2=False)
...
class SecondWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91290,91298], arg2=False)
...
class SecondWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91293,91295], arg2=False)
