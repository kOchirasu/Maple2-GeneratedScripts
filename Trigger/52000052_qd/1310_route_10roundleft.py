...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_portal(portal_id=17, visible=False, enable=False, minimap_visible=False)
        self.set_mesh(trigger_ids=[4017], visible=True, start_delay=0, interval=0, fade=0) # PortalBarrier
        self.set_agent(trigger_ids=[18101], visible=True)
        self.set_agent(trigger_ids=[18102], visible=True)
        self.set_effect(trigger_ids=[5010], visible=False) # 10Round_BridgeApp
        self.set_mesh(trigger_ids=[131000,131001,131002,131003,131004,131005,131006,131007,131008,131009,131010,131011], visible=False, start_delay=0, interval=0, fade=0) # Fake
        self.set_mesh(trigger_ids=[331000,331001,331002,331003,331004,331005,331006,331007,331008,331009,331010,331011], visible=False, start_delay=0, interval=0, fade=0) # Real
...
class StartDazzlingRandom01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_random_mesh(trigger_ids=[131000,131001,131002,131003,131004,131005,131006,131007,131008,131009,131010,131011], visible=False, start_delay=12, interval=0, fade=0) # Fake
...
class MakeTrue(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[131000,131001,131002,131003,131004,131005,131006,131007,131008,131009,131010,131011], visible=False, start_delay=0, interval=0, fade=5) # Fake
        ...
        self.set_agent(trigger_ids=[18101], visible=False)
        self.set_agent(trigger_ids=[18102], visible=False)
        self.set_portal(portal_id=17, visible=True, enable=True, minimap_visible=False)
        self.set_mesh(trigger_ids=[4017], visible=False, start_delay=0, interval=0, fade=0) # PortalBarrier
