...
class StartDazzlingRandom01(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_random_mesh(triggerIds=[131000,131001,131002,131003,131004,131005,131006,131007,131008,131009,131010,131011], visible=False, meshCount=12, arg4=0, delay=0) # Fake
