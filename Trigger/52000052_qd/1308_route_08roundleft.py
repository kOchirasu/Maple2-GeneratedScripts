...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5008], visible=False) # 08Round_BridgeApp
        self.set_mesh(trigger_ids=[130800,130801,130802,130803,130804,130805,130806,130807,130808,130809,130810,130811,130812,130813,130814,130815,130816,130817,130818,130819], visible=False, start_delay=0, interval=0, fade=0) # Fake
        self.set_mesh(trigger_ids=[330800,330801,330802,330803,330804,330805,330806,330807,330808,330809,330810,330811,330812,330813,330814,330815,330816,330817,330818,330819], visible=False, start_delay=0, interval=0, fade=0) # Real
...
class StartDazzlingRandom01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_random_mesh(trigger_ids=[130800,130801,130802,130803,130804,130805,130806,130807,130808,130809,130810,130811,130812,130813,130814,130815,130816,130817,130818,130819], visible=False, start_delay=20, interval=0, fade=0) # Fake
...
class MakeTrue(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[130800,130801,130802,130803,130804,130805,130806,130807,130808,130809,130810,130811,130812,130813,130814,130815,130816,130817,130818,130819], visible=False, start_delay=0, interval=0, fade=5) # Fake
        ...
        self.set_agent(trigger_ids=[18081], visible=False)
        self.set_agent(trigger_ids=[18082], visible=False)
        self.set_agent(trigger_ids=[18083], visible=False)
        self.set_agent(trigger_ids=[18084], visible=False)
