...
class StartDazzlingRandom01(common.Trigger):
    ...
    def on_exit(self):
        self.set_random_mesh(triggerIds=[130800,130801,130802,130803,130804,130805,130806,130807,130808,130809,130810,130811,130812,130813,130814,130815,130816,130817,130818,130819], visible=False, meshCount=20, arg4=0, delay=0) # Fake
