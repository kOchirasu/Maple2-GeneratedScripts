...
class FirstWaveStart01(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90482,90486], animationEffect=False)
...
class FirstWaveStart02(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90481,90489], animationEffect=False)
...
class SecondWaveStart01(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90494,90496], animationEffect=False)
...
class SecondWaveStart02(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90491,90495], animationEffect=False)
