...
class MovingDelay01(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class ReadyToWalkIn01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=212, script='$52000052_QD__12_FINDWAY__0$', arg4=3, arg5=1) # 준타
...
class ReadyToWalkIn02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=112, script='$52000052_QD__12_FINDWAY__1$', arg4=3, arg5=1) # 틴차이
...
class Round12_Start(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=1012, script='$52000052_QD__12_FINDWAY__2$', arg4=3, arg5=2) # 틴차이
...
class Round12_RouteSelect(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[2213,2212])
        self.create_monster(spawnIds=[213], animationEffect=False) # 연출용 준타
        self.set_conversation(type=1, spawnId=113, script='$52000052_QD__12_FINDWAY__3$', arg4=3, arg5=0) # 틴차이
...
class Round12_RouteApp01(common.Trigger):
    def on_enter(self):
...
class Round12_RouteApp02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5013], visible=False) # Sound_StoneGate
...
class Round12_RouteApp03(common.Trigger):
    def on_enter(self):
...
class GoToNextMap01(common.Trigger):
    def on_enter(self):
...
class GoToNextMap02(common.Trigger):
    def on_enter(self):
