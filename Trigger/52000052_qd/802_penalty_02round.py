...
class FirstWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90282,90288], arg2=False)
...
class FirstWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90285,90289], arg2=False)
...
class SecondWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90294,90296], arg2=False)
...
class SecondWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90291,90297], arg2=False)
