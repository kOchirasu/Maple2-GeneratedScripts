...
class FirstWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90180,90188], arg2=False)
...
class FirstWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90185,90189], arg2=False)
...
class SecondWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90190,90192], arg2=False)
...
class SecondWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90195,90197], arg2=False)
