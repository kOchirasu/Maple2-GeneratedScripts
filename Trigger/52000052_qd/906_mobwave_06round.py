...
class FirstWaveDirection10(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90600,90602,90604,90606,90608], arg2=False)
...
class FirstWaveDirection11(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90601,90603,90605,90607,90609], arg2=False)
...
class FirstWaveDirection20(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90610,90612,90614,90616,90618], arg2=False)
...
class FirstWaveDirection21(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90611,90613,90615,90617,90619], arg2=False)
...
class FirstWaveDirection30(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90620,90622,90624,90626,90628], arg2=False)
...
class FirstWaveDirection31(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90621,90623,90625,90627,90629], arg2=False)
...
class FirstWaveDirection40(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90630,90632,90634,90636,90638], arg2=False)
...
class FirstWaveDirection41(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90631,90633,90635,90637,90639], arg2=False)
...
class FirstWaveDirection50(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90640,90642,90644,90646,90648], arg2=False)
...
class FirstWaveDirection51(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90641,90643,90645,90647,90649], arg2=False)
...
class NpcDownPenaltyStart(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1106, script='$52000052_QD__901_MOBWAVE_01ROUND__2$', arg4=4, arg5=4) # 틴차이
