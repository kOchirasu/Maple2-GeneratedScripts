...
# 왼쪽에서 진입
class ReadyToWalkIn_FromLeft01(common.Trigger):
    def on_enter(self):
...
class ReadyToWalkIn_FromLeft02(common.Trigger):
    def on_enter(self):
...
class ReadyToWalkIn_FromLeft03(common.Trigger):
    def on_enter(self):
...
# 오른쪽에서 진입
class ReadyToWalkIn_FromRight01(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[4030], visible=False, arg3=0, delay=0, scale=0) # RoundBarrier
...
class ReadyToWalkIn_FromRight02(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=1310, key='RouteSelected', value=1)
        self.set_user_value(triggerId=2310, key='RouteSelected', value=1)
...
class ReadyToWalkIn_FromRight03(common.Trigger):
    def on_enter(self):
...
class Round10_Start(common.Trigger):
    def on_enter(self):
...
class Round10_Sucess01(common.Trigger):
    def on_enter(self):
...
class Round10_RouteSelect(common.Trigger):
    def on_enter(self):
...
class Round10_PickRoute_Left(common.Trigger):
    def on_enter(self):
...
class GoToPortal17(common.Trigger):
    def on_enter(self):
...
class Round10_PickRoute_Right(common.Trigger):
    def on_enter(self):
...
class GoToPortal18(common.Trigger):
    def on_enter(self):
