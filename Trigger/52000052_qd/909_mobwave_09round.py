...
class FirstWaveDirection10(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90900,90902,90904,90906,90908], animationEffect=False)
...
class FirstWaveDirection11(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90901,90903,90905,90907,90909], animationEffect=False)
...
class FirstWaveDirection20(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90910,90912,90914,90916,90918], animationEffect=False)
...
class FirstWaveDirection21(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90911,90913,90915,90917,90919], animationEffect=False)
...
class FirstWaveDirection30(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90920,90922,90924,90926,90928], animationEffect=False)
...
class FirstWaveDirection31(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90921,90923,90925,90927,90929], animationEffect=False)
...
class FirstWaveDirection40(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90930,90932,90934,90936,90938], animationEffect=False)
...
class FirstWaveDirection41(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90931,90933,90935,90937,90939], animationEffect=False)
...
class FirstWaveDirection50(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90940,90942,90944,90946,90948], animationEffect=False)
...
class FirstWaveDirection51(trigger_api.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[90941,90943,90945,90947,90949], animationEffect=False)
...
class NpcDownPenaltyStart(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=1109, script='$52000052_QD__901_MOBWAVE_01ROUND__2$', arg4=4, arg5=4) # 틴차이
