...
class FirstWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[90100,90102], arg2=False)
...
class FirstWaveDelayRandom(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90105,90107,90109], arg2=False)
...
class SecondWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[90116,90118], arg2=False)
...
class SecondWaveDelayRandom(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90113,90115,90117], arg2=False)
...
class ThirdWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[90124,90126], arg2=False)
...
class ThirdWaveDelay(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90121,90125,90129], arg2=False)
...
class FifthWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[90192,90196], arg2=False)
...
class FifthWaveDelay(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90195,90197,90199], arg2=False)
...
class NpcDownPenaltyStart(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1101, script='$52000052_QD__901_MOBWAVE_01ROUND__2$', arg4=4, arg5=4) # 틴차이
