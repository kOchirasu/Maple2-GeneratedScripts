...
class FirstWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90584,90586], arg2=False)
...
class FirstWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90583,90589], arg2=False)
...
class SecondWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90590,90592], arg2=False)
...
class SecondWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90595,90597], arg2=False)
