...
class 제이든_등장_대기(common.Trigger):
    def on_enter(self):
...
class 제이든등장_스킵완료(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=4)
