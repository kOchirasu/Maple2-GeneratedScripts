...
class ReadyToWalkIn_FromPortal02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=105, script='$02000378_BF__05_FINDWAY__1$', arg4=3, arg5=0)
...
class Round05_Start(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1005, script='$02000378_BF__05_FINDWAY__2$', arg4=3, arg5=2) # 틴차이
...
class Round05_Sucess(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=105, script='$02000378_BF__05_FINDWAY__3$', arg4=2, arg5=1) # 틴차이
