...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5002], visible=False) # 02Round_BridgeApp
        self.set_mesh(trigger_ids=[130200,130201,130202,130203,130204,130205,130206,130207,130208,130209,130210,130211,130212,130213,130214,130215,130216,130217,130218,130219,130220,130221], visible=False, start_delay=0, interval=0, fade=0) # Fake
        self.set_mesh(trigger_ids=[330200,330201,330202,330203,330204,330205,330206,330207,330208,330209,330210,330211,330212,330213,330214,330215,330216,330217,330218,330219,330220,330221], visible=False, start_delay=0, interval=0, fade=0) # Real
...
class StartDazzlingRandom01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_random_mesh(trigger_ids=[130200,130201,130202,130203,130204,130205,130206,130207,130208,130209,130210,130211,130212,130213,130214,130215,130216,130217,130218,130219,130220,130221], visible=False, start_delay=22, interval=0, fade=0) # Fake
...
class MakeTrue(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[130200,130201,130202,130203,130204,130205,130206,130207,130208,130209,130210,130211,130212,130213,130214,130215,130216,130217,130218,130219,130220,130221], visible=False, start_delay=0, interval=0, fade=5) # Fake
        ...
        self.set_agent(trigger_ids=[18021], visible=False)
        self.set_agent(trigger_ids=[18022], visible=False)
        self.set_agent(trigger_ids=[18023], visible=False)
        self.set_agent(trigger_ids=[18024], visible=False)
