...
class StartDazzlingRandom01(common.Trigger):
    ...
    def on_exit(self):
        self.set_random_mesh(triggerIds=[130200,130201,130202,130203,130204,130205,130206,130207,130208,130209,130210,130211,130212,130213,130214,130215,130216,130217,130218,130219,130220,130221], visible=False, meshCount=22, arg4=0, delay=0) # Fake
