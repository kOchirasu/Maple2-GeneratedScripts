...
class FirstWaveStart(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02000378_BF__909_MOBWAVE_09ROUND__0$', arg3='6000', arg4='0')
...
class FirstWaveDirection10(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90900,90902,90904], arg2=False) # ,90906,90908
...
class FirstWaveDirection11(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90901,90903,90905], arg2=False) # ,90907,90909
...
class FirstWaveDirection20(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90910,90912,90914], arg2=False) # ,90916,90918
...
class FirstWaveDirection21(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90911,90913,90915], arg2=False) # ,90917,90919
...
class FirstWaveDirection30(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90920,90922,90924], arg2=False) # ,90926,90928
...
class FirstWaveDirection31(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90921,90923,90925], arg2=False) # ,90927,90929
...
class FirstWaveDirection40(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90930,90932,90934], arg2=False) # ,90936,90938
...
class FirstWaveDirection41(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90931,90933,90935], arg2=False) # ,90937,90939
...
class FirstWaveDirection50(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90940,90942,90944], arg2=False) # ,90946,90948
...
class FirstWaveDirection51(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90941,90943,90945], arg2=False) # ,90947,90949
...
class SecondWaveDirection10(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90904,90906,90908], arg2=False) # 90900,90902,
...
class SecondWaveDirection11(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90905,90907,90909], arg2=False) # 90901,90903,
...
class SecondWaveDirection20(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90914,90916,90918], arg2=False) # 90910,90912,
...
class SecondWaveDirection21(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90915,90917,90919], arg2=False) # 90911,90913,
...
class SecondWaveDirection30(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90924,90926,90928], arg2=False) # 90920,90922,
...
class SecondWaveDirection31(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90925,90927,90929], arg2=False) # 90921,90923,
...
class SecondWaveDirection40(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90934,90936,90938], arg2=False) # 90930,90932,
...
class SecondWaveDirection41(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90935,90937,90939], arg2=False) # 90931,90933,
...
class SecondWaveDirection50(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90944,90946,90948], arg2=False) # 90940,90942,
...
class SecondWaveDirection51(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90945,90947,90949], arg2=False) # 90941,90943,
...
class ThirdWaveDirection10(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90900,90902,90908], arg2=False) # 90904,90906,
...
class ThirdWaveDirection11(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90901,90903,90909], arg2=False) # 90905,90907,
...
class ThirdWaveDirection20(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90910,90912,90918], arg2=False) # 90914,90916,
...
class ThirdWaveDirection21(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90911,90913,90919], arg2=False) # 90915,90917,
...
class ThirdWaveDirection30(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90920,90922,90928], arg2=False) # 90924,90926,
...
class ThirdWaveDirection31(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90921,90923,90929], arg2=False) # 90925,90927,
...
class ThirdWaveDirection40(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90930,90932,90938], arg2=False) # 90934,90936,
...
class ThirdWaveDirection41(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90931,90933,90939], arg2=False) # 90935,90937,
...
class ThirdWaveDirection50(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90940,90942,90948], arg2=False) # 90944,90946,
...
class ThirdWaveDirection51(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90941,90943,90949], arg2=False) # 90945,90947,
...
class FourthWaveDirection10(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90900,90906,90908], arg2=False) # ,90902,90904
...
class FourthWaveDirection11(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90901,90907,90909], arg2=False) # ,90903,90905
...
class FourthWaveDirection20(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90910,90916,90918], arg2=False) # ,90912,90914
...
class FourthWaveDirection21(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90911,90917,90919], arg2=False) # ,90913,90915
...
class FourthWaveDirection30(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90920,90926,90928], arg2=False) # ,90922,90924
...
class FourthWaveDirection31(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90921,90927,90929], arg2=False) # ,90923,90925
...
class FourthWaveDirection40(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90930,90936,90938], arg2=False) # ,90932,90934
...
class FourthWaveDirection41(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90931,90937,90939], arg2=False) # ,90933,90935
...
class FourthWaveDirection50(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90940,90946,90948], arg2=False) # ,90942,90944
...
class FourthWaveDirection51(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90941,90947,90949], arg2=False) # ,90943,90945
...
class FifthWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[90990,90992,90994], arg2=False) # - ,90996,90998
...
class FifthWaveDelay(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90991,90993,90995], arg2=False) # ,90997,90999
...
class NpcDownPenaltyStart(state.State):
    def on_enter(self):
        ...
        set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        set_event_ui(type=1, arg2='$02000378_BF__909_MOBWAVE_09ROUND__1$', arg3='4000', arg4='0')
        set_conversation(type=1, spawnId=1109, script='$02000378_BF__909_MOBWAVE_09ROUND__2$', arg4=4, arg5=4) # 틴차이
...
class ReturnToWave(state.State):
    def on_enter(self):
        set_user_value(key='PenaltyFinish', value=0)
        set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        set_event_ui(type=1, arg2='$02000378_BF__909_MOBWAVE_09ROUND__3$', arg3='4000', arg4='0')
