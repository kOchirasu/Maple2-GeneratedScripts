...
class FirstWaveStart(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02000378_BF__912_MOBWAVE_12ROUND__0$', arg3='6000', arg4='0')
        set_user_value(key='WaveTime', value=1) # 웨이브 진행 순서 기억
        set_effect(triggerIds=[5112], visible=True) # 12Round_ShadowApp
        create_monster(spawnIds=[91200,91202,91204], arg2=False) # ,91206,91208
...
class FirstWaveDelayRandom(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91201,91203,91205], arg2=False) # ,91207,91209
...
class SecondWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[91210,91212,91214], arg2=False) # ,91216,91218
...
class SecondWaveDelayRandom(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91211,91213,91215], arg2=False) # ,91217,91219
...
class ThirdWaveDirection10(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91220,91222,91224], arg2=False) # ,91226,91228
...
class ThirdWaveDirection11(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91221,91223,91225], arg2=False) # ,91227,91229
...
class ThirdWaveDirection20(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91230,91232,91234], arg2=False) # ,91236,91238
...
class ThirdWaveDirection21(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91231,91233,91235], arg2=False) # ,91237,91239
...
class ThirdWaveDirection30(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91240,91242,91244], arg2=False) # ,91246,91248
...
class ThirdWaveDirection31(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91241,91243,91245], arg2=False) # ,91247,91249
...
class ThirdWaveDirection40(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91250,91252,91254], arg2=False) # ,91256,91258
...
class ThirdWaveDirection41(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91251,91253,91255], arg2=False) # ,91257,91259
...
class ThirdWaveDirection50(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91260,91262,91264], arg2=False) # ,91266,91268
...
class ThirdWaveDirection51(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91261,91263,91265], arg2=False) # ,91267,91269
...
class ThirdWaveDirection60(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91270,91272,91274], arg2=False) # ,91276,91278
...
class ThirdWaveDirection61(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91271,91273,91275], arg2=False) # ,91277,91279
...
class SeventhWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[91290,91292,91294], arg2=False) # ,91296,91298
...
class SeventhWaveDelay(state.State):
    def on_enter(self):
        create_monster(spawnIds=[91291,91293,91295], arg2=False) # ,91297,91299
...
class NpcDownPenaltyStart(state.State):
    def on_enter(self):
        ...
        set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        set_event_ui(type=1, arg2='$02000378_BF__912_MOBWAVE_12ROUND__1$', arg3='4000', arg4='0')
        set_conversation(type=1, spawnId=1112, script='$02000378_BF__912_MOBWAVE_12ROUND__2$', arg4=4, arg5=4) # 틴차이
...
class ReturnToWave(state.State):
    def on_enter(self):
        set_user_value(key='PenaltyFinish', value=0)
        set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        set_event_ui(type=1, arg2='$02000378_BF__912_MOBWAVE_12ROUND__3$', arg3='4000', arg4='0')
