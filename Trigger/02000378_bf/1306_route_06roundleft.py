...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4013], visible=True, start_delay=0, interval=0, fade=0) # PortalBarrier
        self.set_agent(trigger_ids=[18061], visible=True)
        self.set_agent(trigger_ids=[18062], visible=True)
        self.set_effect(trigger_ids=[5006], visible=False) # 06Round_BridgeApp
        self.set_mesh(trigger_ids=[130600,130601,130602,130603,130604,130605,130606,130607,130608,130609,130610,130611,130612,130613,130614,130615,130616,130617,130618,130619,130620,130621,130622,130623,130624,130625], visible=False, start_delay=0, interval=0, fade=0) # Fake
        self.set_mesh(trigger_ids=[330600,330601,330602,330603,330604,330605,330606,330607,330608,330609,330610,330611,330612,330613,330614,330615,330616,330617,330618,330619,330620,330621,330622,330623,330624,330625], visible=False, start_delay=0, interval=0, fade=0) # Real
...
class StartDazzlingRandom01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_random_mesh(trigger_ids=[130600,130601,130602,130603,130604,130605,130606,130607,130608,130609,130610,130611,130612,130613,130614,130615,130616,130617,130618,130619,130620,130621,130622,130623,130624,130625], visible=False, start_delay=26, interval=0, fade=0) # Fake
...
class MakeTrue(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[130600,130601,130602,130603,130604,130605,130606,130607,130608,130609,130610,130611,130612,130613,130614,130615,130616,130617,130618,130619,130620,130621,130622,130623,130624,130625], visible=False, start_delay=0, interval=0, fade=5) # Fake
        ...
        self.set_agent(trigger_ids=[18061], visible=False)
        self.set_agent(trigger_ids=[18062], visible=False)
        self.set_portal(portal_id=13, visible=True, enable=True, minimap_visible=False)
        self.set_mesh(trigger_ids=[4013], visible=False, start_delay=0, interval=0, fade=0) # PortalBarrier
