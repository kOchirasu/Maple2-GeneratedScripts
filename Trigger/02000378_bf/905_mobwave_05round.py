...
class FirstWaveStart(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02000378_BF__905_MOBWAVE_05ROUND__0$', arg3='6000', arg4='0')
...
class FirstWaveDirection10(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90500,90502,90504], arg2=False) # ,90506,90508
...
class FirstWaveDirection11(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90501,90503,90505], arg2=False) # ,90507,90509
...
class FirstWaveDirection20(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90510,90512,90514], arg2=False) # ,90516,90518
...
class FirstWaveDirection21(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90511,90513,90515], arg2=False) # ,90517,90519
...
class FirstWaveDirection30(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90520,90522,90524], arg2=False) # ,90526,90528
...
class FirstWaveDirection31(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90521,90523,90525], arg2=False) # ,90527,90529
...
class FirstWaveDirection40(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90530,90532,90534], arg2=False) # ,90536,90538
...
class FirstWaveDirection41(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90531,90533,90535], arg2=False) # ,90537,90539
...
class FirstWaveDirection50(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90540,90542,90544], arg2=False) # ,90546,90548
...
class FirstWaveDirection51(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90541,90543,90545], arg2=False) # ,90547,90549
...
class FifthWaveStart(state.State):
    def on_enter(self):
        ...
        create_monster(spawnIds=[90590,90592,90594], arg2=False) # ,90596,90598
...
class FifthWaveDelay(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90591,90593,90595], arg2=False) # ,90597,90599
...
class NpcDownPenaltyStart(state.State):
    def on_enter(self):
        ...
        set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        set_event_ui(type=1, arg2='$02000378_BF__905_MOBWAVE_05ROUND__1$', arg3='4000', arg4='0')
        set_conversation(type=1, spawnId=1105, script='$02000378_BF__905_MOBWAVE_05ROUND__2$', arg4=4, arg5=4) # 틴차이
...
class ReturnToWave(state.State):
    def on_enter(self):
        set_user_value(key='PenaltyFinish', value=0)
        set_effect(triggerIds=[5000], visible=True) # 가이드 서머리 사운드 이펙트
        set_event_ui(type=1, arg2='$02000378_BF__905_MOBWAVE_05ROUND__3$', arg3='4000', arg4='0')
