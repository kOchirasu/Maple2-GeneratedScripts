...
class FirstWaveStart01(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90380,90382,90384,90386,90388], arg2=False)
...
class FirstWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90381,90383,90385,90387,90389], arg2=False)
...
class SecondWaveStart02(state.State):
    def on_enter(self):
        create_monster(spawnIds=[90391,90393,90395,90397,90399], arg2=False)
