...
class ReadyToWalkIn01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[4027], visible=False, arg3=0, delay=0, scale=0)
        self.move_npc(spawnId=102, patrolName='MS2PatrolData_107')
        self.move_npc(spawnId=202, patrolName='MS2PatrolData_207')
        self.set_conversation(type=1, spawnId=202, script='$02000378_BF__07_FINDWAY__0$', arg4=2, arg5=0)
...
class ReadyToWalkIn03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=102, script='$02000378_BF__07_FINDWAY__1$', arg4=2, arg5=2)
