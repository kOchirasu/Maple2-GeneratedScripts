...
class Round09_Start(common.Trigger):
    def on_enter(self):
...
class Round09_Sucess(common.Trigger):
    def on_enter(self):
...
class Round09_RouteSelect(common.Trigger):
    def on_enter(self):
...
class Round09_PickRoute_Left(common.Trigger):
    def on_enter(self):
...
class GoToPortal15(common.Trigger):
    def on_enter(self):
...
class Round09_PickRoute_Right(common.Trigger):
    def on_enter(self):
...
class GoToPortal16(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=12, key='FindWay', value=1)
