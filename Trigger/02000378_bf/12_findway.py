...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5012], visible=False) # 12Round_BridgeApp
        self.set_effect(trigger_ids=[5013], visible=False) # Sound_StoneGate
        self.set_mesh(trigger_ids=[331200,331201,331202,331203,331204,331205,331206,331207,331208,331209,331210,331211,331212,331213,331214,331215,331216,331217,331218,331219,331220,331221,331222,331223,331224,331225,331226,331227,331228,331229,331230,331231,331232,331233,331234,331235,331236,331237,331238,331239,331240,331241,331242,331243,331244,331245,331246,331247,331248,331249,331250,331251,331252,331253,331254,331255,331256,331257,331258,331259,331260,331261,331262,331263,331264,331265,331266,331267,331268,331269,331270,331271,331272,331273,331274,331275,331276,331277], visible=False, start_delay=0, interval=0, fade=0) # Stairs
        self.set_mesh(trigger_ids=[4032], visible=True, start_delay=0, interval=0, fade=0) # RoundBarrier
        self.set_mesh(trigger_ids=[3012], visible=True, start_delay=0, interval=0, fade=0) # CrystalOff
        self.set_mesh(trigger_ids=[3112], visible=False, start_delay=0, interval=0, fade=0) # CrystalOn
        self.set_mesh_animation(trigger_ids=[3012], visible=True, start_delay=0, interval=0) # CrystalOff
        self.set_mesh_animation(trigger_ids=[3112], visible=False, start_delay=0, interval=0) # CrystalOn
        self.set_effect(trigger_ids=[5212], visible=False) # Sound_CrystalOn
...
class ReadyToWalkIn01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[4032], visible=False, start_delay=0, interval=0, fade=0) # RoundBarrier
...
class Round12_Sucess02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3012], visible=False, start_delay=100, interval=0, fade=0) # CrystalOff
        self.set_mesh(trigger_ids=[3112], visible=True, start_delay=0, interval=0, fade=0) # CrystalOn
        self.set_mesh_animation(trigger_ids=[3012], visible=False, start_delay=0, interval=0) # CrystalOff
        self.set_mesh_animation(trigger_ids=[3112], visible=True, start_delay=0, interval=0) # CrystalOn
        self.set_effect(trigger_ids=[5212], visible=True) # Sound_CrystalOn
        self.set_agent(trigger_ids=[28120], visible=False)
        self.set_agent(trigger_ids=[28121], visible=False)
        self.set_agent(trigger_ids=[28122], visible=False)
...
class Round12_RouteSelect(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=113, script='$02000378_BF__12_FINDWAY__3$', time=3, arg5=0) # 틴차이
