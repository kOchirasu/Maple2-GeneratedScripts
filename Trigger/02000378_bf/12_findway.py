...
class ReadyToWalkIn01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=212, script='$02000378_BF__12_FINDWAY__0$', arg4=3, arg5=1) # 준타
...
class ReadyToWalkIn02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=112, script='$02000378_BF__12_FINDWAY__1$', arg4=3, arg5=1) # 틴차이
...
class Round12_Start(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1012, script='$02000378_BF__12_FINDWAY__2$', arg4=3, arg5=2) # 틴차이
...
class Round12_RouteSelect(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=113, script='$02000378_BF__12_FINDWAY__3$', arg4=3, arg5=0) # 틴차이
