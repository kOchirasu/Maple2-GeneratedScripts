...
class Round01_Start(common.Trigger):
    def on_enter(self):
...
class Round01_Sucess(common.Trigger):
    def on_enter(self):
...
class Round01_RouteSelect(common.Trigger):
    def on_enter(self):
...
# 02번 계단으로
class Round01_PickRoute_Left(common.Trigger):
    def on_enter(self):
...
class GoToRound02(common.Trigger):
    def on_enter(self):
...
# 03번 계단으로
class Round01_PickRoute_Right(common.Trigger):
    def on_enter(self):
...
class GoToRound03(common.Trigger):
    def on_enter(self):
...
# 04번 포탈로
class Round01_PortalOn_04(common.Trigger):
    def on_enter(self):
...
# 05번 포탈로
class Round01_PortalOn_05(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3101], visible=False, arg3=0, delay=0, scale=3) # CrystalOn
        self.set_mesh_animation(triggerIds=[3101], visible=False, arg3=0, arg4=3) # CrystalOn
...
class GoToRound05(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=101, patrolName='MS2PatrolData_101New')
...
# 06번 포탈로
class Round01_PortalOn_06(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3101], visible=False, arg3=0, delay=0, scale=3) # CrystalOn
        self.set_mesh_animation(triggerIds=[3101], visible=False, arg3=0, arg4=3) # CrystalOn
...
class GoToRound06(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=101, patrolName='MS2PatrolData_101New')
...
# 07번 포탈로
class Round01_PortalOn_07(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3101], visible=False, arg3=0, delay=0, scale=3) # CrystalOn
        self.set_mesh_animation(triggerIds=[3101], visible=False, arg3=0, arg4=3) # CrystalOn
...
# 08번 포탈로
class Round01_PortalOn_08(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3101], visible=False, arg3=0, delay=0, scale=3) # CrystalOn
        self.set_mesh_animation(triggerIds=[3101], visible=False, arg3=0, arg4=3) # CrystalOn
...
# 09번 포탈로
class Round01_PortalOn_09(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3101], visible=False, arg3=0, delay=0, scale=3) # CrystalOn
        self.set_mesh_animation(triggerIds=[3101], visible=False, arg3=0, arg4=3) # CrystalOn
...
# 10번 포탈로
class Round01_PortalOn_10(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3101], visible=False, arg3=0, delay=0, scale=3) # CrystalOn
        self.set_mesh_animation(triggerIds=[3101], visible=False, arg3=0, arg4=3) # CrystalOn
...
# 11번 포탈로
class Round01_PortalOn_11(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3101], visible=False, arg3=0, delay=0, scale=3) # CrystalOn
        self.set_mesh_animation(triggerIds=[3101], visible=False, arg3=0, arg4=3) # CrystalOn
...
class MoveToPortal(common.Trigger):
    def on_enter(self):
