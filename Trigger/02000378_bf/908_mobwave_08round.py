...
class FirstWaveDirection10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90800,90802,90804], animationEffect=False) # ,90806,90808
...
class FirstWaveDirection11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90801,90803,90805], animationEffect=False) # ,90807,90809
...
class FirstWaveDirection20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90810,90812,90814], animationEffect=False) # ,90816,90818
...
class FirstWaveDirection21(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90811,90813,90815], animationEffect=False) # ,90817,90819
...
class FirstWaveDirection30(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90820,90822,90824], animationEffect=False) # ,90826,90828
...
class FirstWaveDirection31(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90821,90823,90825], animationEffect=False) # ,90827,90829
...
class FirstWaveDirection40(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90830,90832,90834], animationEffect=False) # ,90836,90838
...
class FirstWaveDirection41(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90831,90833,90835], animationEffect=False) # ,90837,90839
...
class FirstWaveDirection50(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90840,90842,90844], animationEffect=False) # ,90846,90848
...
class FirstWaveDirection51(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90841,90843,90845], animationEffect=False) # ,90847,90849
...
class FifthWaveStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.create_monster(spawnIds=[90890,90892,90894], animationEffect=False) # ,90896,90898
...
class FifthWaveDelay(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[90891,90893,90895], animationEffect=False) # ,90897,90899
...
class NpcDownPenaltyStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=1, spawnId=1108, script='$02000378_BF__908_MOBWAVE_08ROUND__2$', arg4=4, arg5=4) # 틴차이
