...
class ReadyToWalkIn_FromPortal02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=106, script='$02000378_BF__06_FINDWAY__1$', arg4=3, arg5=0)
...
class Round06_Start(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1006, script='$02000378_BF__06_FINDWAY__2$', arg4=3, arg5=2) # 틴차이
...
class Round06_Sucess(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=106, script='$02000378_BF__06_FINDWAY__3$', arg4=2, arg5=1) # 틴차이
