...
class 몬스터등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015], visible=False, start_delay=0, interval=200, fade=0.5)
        ...
        self.set_mesh(trigger_ids=[1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021,1022,1023,1024,1025], visible=False, start_delay=0, interval=200, fade=0.5)
...
class 두번째전투판이동다리생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[5001,5002], visible=False, start_delay=0, interval=0, fade=0)
...
class 연출종료(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # 스타팅 포인트에서 다리가 사라지면 맵으로 바로 순간이동하는 맵 내부 포탈 설정
        self.set_portal(portal_id=10, visible=False, enable=False, minimap_visible=False)
        self.set_mesh(trigger_ids=[1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021,1022,1023,1024,1025], visible=True, start_delay=1, interval=1, fade=1) # BridgeStart
        self.set_mesh(trigger_ids=[3001,3002,3003,3004,3005,3006,3007,3008,3009,3010,3011,3012,3013,3014], visible=False, start_delay=0, interval=0, fade=0) # 시작지점 철창벽
