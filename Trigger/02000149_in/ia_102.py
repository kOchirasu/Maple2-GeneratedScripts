...
class 오브젝트반응(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_actor(trigger_id=202, visible=False, initial_sequence='Sit_Chair_Idle_A')
...
class NPC이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=402, script='$02000149_IN__IA_102__0$', time=2, arg5=0)
