...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[302], auto_target=True) # 연출용 흑성회 행동대장
        self.spawn_monster(spawn_ids=[404,405,406,407,408,409,410,411], auto_target=True) # 연출용 흑성회
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003193, msg='$52000020_QD__MAIN_02__0$', duration=2000, align='center')
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=29000266, msg='$52000020_QD__MAIN_02__1$', duration=2000, align='left')
...
class scene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=29000266, msg='$52000020_QD__MAIN_02__2$', duration=2000, align='center')
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=29000266, msg='$52000020_QD__MAIN_02__3$', duration=2000, align='center')
...
class scene_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=404, msg='$52000020_QD__MAIN_02__4$', duration=2000, delay_tick=0)
        self.add_balloon_talk(spawn_id=405, msg='$52000020_QD__MAIN_02__5$', duration=2000, delay_tick=0)
        self.add_balloon_talk(spawn_id=406, msg='$52000020_QD__MAIN_02__6$', duration=2000, delay_tick=0)
        self.add_balloon_talk(spawn_id=407, msg='$52000020_QD__MAIN_02__7$', duration=2000, delay_tick=0)
        self.add_balloon_talk(spawn_id=408, msg='$52000020_QD__MAIN_02__8$', duration=2000, delay_tick=0)
        self.add_balloon_talk(spawn_id=409, msg='$52000020_QD__MAIN_02__9$', duration=2000, delay_tick=0)
        self.add_balloon_talk(spawn_id=410, msg='$52000020_QD__MAIN_02__10$', duration=2000, delay_tick=0)
        self.add_balloon_talk(spawn_id=411, msg='$52000020_QD__MAIN_02__11$', duration=2000, delay_tick=0)
...
class battle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[604,605], auto_target=True) # 몬스터 흑성회
...
class round_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[606,607,608,609], auto_target=True) # 몬스터 흑성회
...
class round_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[610,611,502], auto_target=True) # 몬스터 흑성회
