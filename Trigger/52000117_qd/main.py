...
class jordyidle(common.Trigger):
    def on_enter(self):
...
class scene_fadeout(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class scene_fadein(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_scene_skip()
...
class endmessage(common.Trigger):
    def on_enter(self):
