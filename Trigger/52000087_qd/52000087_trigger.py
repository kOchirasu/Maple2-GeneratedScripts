...
class 에레브_1skip(common.Trigger):
    def on_enter(self):
...
class 에레브_2skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 에레브_3skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 블랙아이_1skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 블랙아이_1askip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 프레이_1skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 구르는천둥_1skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 오스칼_1skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 블랙아이_2skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 블랙아이_2askip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 블랙아이_3skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 에레브_4skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 알론_4askip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 에레브_5skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 에레브_6skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 에레브_7skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 에레브_8skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 완료연출01_20002265(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
...
class 완료연출02_20002265(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
...
class 완료연출03_20002265(common.Trigger):
    def on_enter(self):
...
class 완료연출04_20002265(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=3)
...
class 완료연출04_b20002265(common.Trigger):
    def on_enter(self):
...
class 완료연출04_c20002265(common.Trigger):
    def on_enter(self):
...
class 완료연출05_20002265(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[600], visible=False)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 완료연출01_난입20002266(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[1003], animationEffect=False) # 오르데
...
class 완료연출01_20002266(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 완료연출02_20002266(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
...
class 완료연출03_20002266(common.Trigger):
    def on_enter(self):
...
class 완료연출04_20002266(common.Trigger):
    def on_enter(self):
...
class 완료연출05_20002266(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 용무없는유저는아웃(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
# 챕터10 에필로그 연출
class 챕터10에필로그연출01(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
        self.move_user(mapId=52000087, portalId=10)
        self.set_cinematic_ui(type=1)
...
class 챕터10에필로그연출02(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출03(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출05(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출05b(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출06(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출06스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출07(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출07스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출08(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출08스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출09(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출10(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=9)
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 챕터10에필로그연출10스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출11(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출11스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출12(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출13(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출13_b(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=9)
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 챕터10에필로그연출13b스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출14(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출14스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출15(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출15스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출16(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출16스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 챕터10에필로그연출17(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=5000):
            return 챕터10에필로그연출18(self.ctx)


class 챕터10에필로그연출18(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출18b(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출19(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출20(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출21(common.Trigger):
    def on_enter(self):
...
class 챕터10에필로그연출22(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=9)
