...
class 첫번째몬스터전투시작(common.Trigger):
    def on_enter(self):
...
class 첫번째연구실몬스터정리(common.Trigger):
    def on_enter(self):
...
class 첫번째연구실나오기(common.Trigger):
    def on_enter(self):
...
class 두번째전투판몬스터생성(common.Trigger):
    def on_enter(self):
...
class 두번째연구실몬스터정리(common.Trigger):
    def on_enter(self):
...
class 두번째연구실몬스터정리2(common.Trigger):
    def on_enter(self):
...
class 두번째연구실나오기(common.Trigger):
    def on_enter(self):
...
class 세번째전투판몬스터생성(common.Trigger):
    def on_enter(self):
...
class 네번째연구소로이동(common.Trigger):
    def on_enter(self):
...
class 번연구실모두정리4(common.Trigger):
    def on_enter(self):
...
class 업그레이드성공체크(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=100):
