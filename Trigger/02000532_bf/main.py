...
class 통신을받은제이부하(common.Trigger):
    def on_enter(self):
...
class 통신을받은제이부하2(common.Trigger):
    def on_enter(self):
...
class 길목에서나오는몬스터(common.Trigger):
    def on_enter(self):
