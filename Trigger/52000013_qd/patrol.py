...
class 어린벨라패트롤01(common.Trigger):
    def on_enter(self):
...
class 어린벨라패트롤02(common.Trigger):
    def on_enter(self):
...
class 어린벨라패트롤03(common.Trigger):
    def on_enter(self):
