...
class 준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[500], visible=False)
        self.set_effect(trigger_ids=[501], visible=False)
        self.set_effect(trigger_ids=[502], visible=False)
...
class 크림슨발록비춤1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[10000], visible=False) # 스폰 발판 지움
        self.set_mesh(trigger_ids=[10001], visible=False) # 공습용발판 지움
        self.set_scene_skip(state=게임시작, action='nextState')
        self.select_camera(trigger_id=4001, enable=True)
        self.add_cinematic_talk(npc_id=11003781, msg='$52010055_QD__52010055__0$', duration=3000, align='right')
        self.add_cinematic_talk(npc_id=11003781, msg='$52010055_QD__52010055__1$', duration=3000, align='right')
...
class 크림슨이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=29000378, msg='$52010055_QD__52010055__2$', duration=3000, align='right')
...
class 함교비춤1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003536, illust_id='Neirin_surprise', msg='$52010055_QD__52010055__3$', duration=3000, align='left')
        self.add_cinematic_talk(npc_id=11003682, illust_id='Bliche_closeEye', msg='$52010055_QD__52010055__4$', duration=4000, align='Center')
...
class 함교비춤2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=1, rotation=180)
        self.set_npc_emotion_sequence(spawn_id=1, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003533, illust_id='Bliche_normal', msg='$52010055_QD__52010055__5$', duration=3000, align='right')
...
class 콘대르대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003776, illust_id='Conder_normal', msg='$52010055_QD__52010055__6$', duration=2000, align='left')
...
class 콘대르이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003584, illust_id='Schatten_normal', msg='$52010055_QD__52010055__7$', duration=2000, align='Reft')
...
class 샤텐이동(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003586, illust_id='Mason_closeEye', msg='$52010055_QD__52010055__8$', duration=3000, align='Left')
...
class 함교비춤3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=1, rotation=270)
        self.set_npc_emotion_sequence(spawn_id=1, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003533, illust_id='Bliche_normal', msg='$52010055_QD__52010055__9$', duration=3000, align='right')
...
class 함교비춤4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_sequence(spawn_id=2, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003536, illust_id='Neirin_surprise', msg='$52010055_QD__52010055__10$', duration=2000, align='left')
        self.set_npc_emotion_sequence(spawn_id=1, sequence_name='Talk_A')
        self.set_npc_rotation(spawn_id=1, rotation=170)
        self.add_cinematic_talk(npc_id=11003533, illust_id='Bliche_normal', msg='$52010055_QD__52010055__11$', duration=3000, align='left')
...
class 함교비춤5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_sequence(spawn_id=1, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003533, illust_id='Bliche_normal', msg='$52010055_QD__52010055__12$', duration=3000, align='Left')
        self.set_npc_emotion_sequence(spawn_id=2, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003536, illust_id='Neirin_surprise', msg='$52010055_QD__52010055__13$', duration=3000, align='Right')
        self.set_npc_emotion_sequence(spawn_id=1, sequence_name='Talk_A')
...
class 차발록스피어스폰1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=4019, enable=True)
        self.set_mesh(trigger_ids=[10000], visible=False) # 스폰 발판 제거
        self.spawn_monster(spawn_ids=[1], auto_target=False) # 함교 연출용 블리체
        self.spawn_monster(spawn_ids=[2], auto_target=False) # 함교 연출용 네이린
        self.spawn_monster(spawn_ids=[10000], auto_target=False) # 함교 연출용 해군
        self.spawn_monster(spawn_ids=[10001], auto_target=False) # 함교 연출용 해군
...
class 공습준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[30000], visible=False)
...
class 공습1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.spawn_monster(spawn_ids=[600], auto_target=False, delay=0)
        self.spawn_monster(spawn_ids=[601], auto_target=False, delay=0)
        self.spawn_monster(spawn_ids=[602], auto_target=False, delay=0)
...
class 공습2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[500], auto_target=True, delay=0)
        self.spawn_monster(spawn_ids=[501], auto_target=True, delay=0)
        self.spawn_monster(spawn_ids=[502], auto_target=True, delay=0)
...
class 공습3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[400], auto_target=True, delay=0)
...
class 공습4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[501], auto_target=True, delay=0)
        self.spawn_monster(spawn_ids=[502], auto_target=True, delay=0)
        self.spawn_monster(spawn_ids=[600], auto_target=True, delay=0)
        self.spawn_monster(spawn_ids=[601], auto_target=True, delay=0)
        self.spawn_monster(spawn_ids=[602], auto_target=True, delay=0)
...
class 보스전연출시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=4006, enable=True)
        self.spawn_monster(spawn_ids=[1], auto_target=False) # 함교 연출용 블리체
        self.spawn_monster(spawn_ids=[2], auto_target=False) # 함교 연출용 네이린
...
class 보스전연출1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=29000382, msg='$52010055_QD__52010055__21$', duration=3000, align='right')
...
class 보스전시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[2001], auto_target=True) # 전투용 보스 소환
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 보스전끝크림슨발록대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[10002,10003,10004,10005], visible=False) # 1차 전투 링 해제
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.spawn_monster(spawn_ids=[1], auto_target=False) # 함교 연출용 블리체
        self.spawn_monster(spawn_ids=[2], auto_target=False) # 함교 연출용 네이린
...
class 엔딩연출크림슨발록보스1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=14, rotation=-10)
        self.set_npc_rotation(spawn_id=15, rotation=10)
        self.select_camera(trigger_id=4006, enable=True)
        ...
        self.add_cinematic_talk(npc_id=29000382, msg='$52010055_QD__52010055__22$', duration=3000, align='right')
...
class 엔딩연출크림슨발록보스2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003776, illust_id='Conder_normal', msg='$52010055_QD__52010055__23$', duration=2000, align='right')
...
class 엔딩연출샤텐1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003584, illust_id='Schatten_normal', msg='$52010055_QD__52010055__24$', duration=3000, align='Reft')
        self.select_camera_path(path_ids=[4009,4010], return_view=False)
        self.select_camera(trigger_id=4010, enable=True)
...
class 엔딩연출메이슨1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003586, illust_id='Mason_closeEye', msg='$52010055_QD__52010055__25$', duration=1500, align='Reft')
        self.select_camera(trigger_id=4014, enable=True)
...
class 엔딩연출콘대르1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003776, illust_id='Conder_normal', msg='$52010055_QD__52010055__26$', duration=3000, align='Reft')
...
class 엔딩연출클림슨발록사망1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_sequence(spawn_id=2003, sequence_name='Dead_01_A')
        self.add_cinematic_talk(npc_id=29000382, msg='$52010055_QD__52010055__27$', duration=3000, align='right') # 크아악
...
class 엔딩연출크림슨발록대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.visible_my_pc(is_visible=True)
        self.select_camera(trigger_id=4006, enable=True)
        self.add_cinematic_talk(npc_id=29000382, msg='$52010055_QD__52010055__28$', duration=3000, align='right')
...
class 엔딩연출크림슨카메라1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=4023, enable=True)
...
class 엔딩연출크림슨대사1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=29000378, msg='$52010055_QD__52010055__29$', duration=3000, align='right')
...
class 엔딩이동준비2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=4024, enable=True)
        self.spawn_monster(spawn_ids=[1], auto_target=False) # 함교 연출용 블리체
        self.spawn_monster(spawn_ids=[2], auto_target=False) # 함교 연출용 네이린
...
class 엔딩대사콘대르1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=15, rotation=60)
        self.set_npc_rotation(spawn_id=14, rotation=330)
        self.set_npc_emotion_sequence(spawn_id=13, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003776, illust_id='Conder_normal', msg='$52010055_QD__52010055__30$', duration=3000, align='Left')
...
class 엔딩대사샤텐1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003584, illust_id='Schatten_normal', msg='$52010055_QD__52010055__31$', duration=3000, align='Left')
...
class 엔딩대사메이슨1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[10002], visible=False)
        self.set_mesh(trigger_ids=[10003], visible=False)
        self.set_mesh(trigger_ids=[10004], visible=False)
        self.set_npc_emotion_sequence(spawn_id=14, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003586, illust_id='Mason_closeEye', msg='$52010055_QD__52010055__32$', duration=3000, align='Left')
...
class 함교로카메라전환1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=4025, enable=True)
        self.visible_my_pc(is_visible=False) # 캐릭터 숨김
...
class 엔딩대사네이린1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003536, illust_id='Neirin_normal', msg='$52010055_QD__52010055__33$', duration=4000, align='right')
        self.add_cinematic_talk(npc_id=11003536, illust_id='Neirin_normal', msg='$52010055_QD__52010055__34$', duration=4000, align='right')
...
class 엔딩대사블리체1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003533, illust_id='Bliche_normal', msg='$52010055_QD__52010055__35$', duration=3000, align='right')
        self.add_cinematic_talk(npc_id=11003533, illust_id='Bliche_normal', msg='$52010055_QD__52010055__36$', duration=5000, align='right')
