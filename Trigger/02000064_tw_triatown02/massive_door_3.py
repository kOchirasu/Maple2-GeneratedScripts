...
class 클로즈5초전(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.notice(type=0, script='$02000064_TW_Triatown02__MASSIVE_DOOR_3__0$', arg3=True)
...
class 클로즈중2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.notice(type=0, script='$02000064_TW_Triatown02__MASSIVE_DOOR_3__1$', arg3=True)
