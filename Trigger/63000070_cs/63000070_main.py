...
class scene1_start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004289, illustId='Rue_Halloween', msg='$63000070_CS__63000070_MAIN__0$', duration=3000)
...
class scene1_ladymonologue1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # 고아가 된 어린애나,\n유언장을 찾겠다고 나서는 것들이나….
        self.add_cinematic_talk(npcId=11004289, illustId='Rue_Halloween', msg='$63000070_CS__63000070_MAIN__1$', duration=4000)
...
class scene1_ladyzoomin(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml') # 불켜기
        # 어리석은 자들!\n아무 것도 바꿀 수 없어!
        self.add_cinematic_talk(npcId=11004289, msg='$63000070_CS__63000070_MAIN__3$', duration=4000)
...
class scene1_ladygoback1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # 하지만 여기까지 온 것이 가상하니까,\n제안을 하나 하지.
        self.add_cinematic_talk(npcId=11004289, illustId='Rue_Halloween', align='right', msg='$63000070_CS__63000070_MAIN__4$', duration=5000)
...
class scene1_ladygoback2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # 자, 네가 원하던 것!\n가질 수 있다면 가져봐.
        self.add_cinematic_talk(npcId=11004289, illustId='Rue_Halloween', align='right', msg='$63000070_CS__63000070_MAIN__5$', duration=3000)
...
class scene1_ladygoback3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004289, illustId='Rue_Halloween', align='right', msg='$63000070_CS__63000070_MAIN__6$', duration=4000)
...
class scene2_marienneappears_ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.destroy_monster(spawnIds=[101,105,111,112,113,114,115,116,117,118,119,120,1001,1011,1021])
...
class scene2_marienneappears_set(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_interact_object(triggerIds=[32000015], state=1)
...
class scene3_start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.select_camera_path(pathIds=[8020,8021], returnView=False)
...
class scene3_girltalk1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004308, msg='$63000070_CS__63000070_MAIN__13$', duration=5000)
...
class scene3_girltalk2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npcId=11004308, msg='$63000070_CS__63000070_MAIN__14$', duration=4500)
