...
class NPC스폰조건01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[9000], questIds=[50001605], questStates=[2]):
            return 탈주이후(self.ctx)
        if self.quest_user_detected(boxIds=[9000], questIds=[50001605], questStates=[1]):
...
class NPC스폰조건02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[9000], questIds=[50001605], questStates=[2]):
            return 탈주이후(self.ctx)
        if self.quest_user_detected(boxIds=[9000], questIds=[50001605], questStates=[1]):
...
class 케이틀린대사01_skip(common.Trigger):
    def on_enter(self):
...
class 케이틀린대사02_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 호르헤대사01_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 케이틀린대사03_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 호르헤대사02_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 케이틀린대사04_skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 케이틀린슬픔_스킵완료(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
