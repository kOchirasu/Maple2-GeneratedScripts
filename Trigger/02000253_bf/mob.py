...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_ladder(trigger_ids=[1701], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[1702], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[1703], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[1704], visible=False, enable=False, fade=0)
...
class 몹1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.spawn_monster(spawn_ids=[4002], auto_target=True)
        # self.spawn_monster(spawn_ids=[4003], auto_target=True)
        # self.spawn_monster(spawn_ids=[4004], auto_target=True)
        # self.spawn_monster(spawn_ids=[4005], auto_target=True)
        # self.spawn_monster(spawn_ids=[4006], auto_target=True)
        # self.spawn_monster(spawn_ids=[4007], auto_target=True)
        # self.spawn_monster(spawn_ids=[4008], auto_target=True)
...
class 몹10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entity_id=20002533, text_id=20002533)
        self.set_timer(timer_id='1', seconds=20)
        self.spawn_monster(spawn_ids=[4009], auto_target=True)
        self.spawn_monster(spawn_ids=[4010], auto_target=True)
        self.spawn_monster(spawn_ids=[4011], auto_target=True)
        self.spawn_monster(spawn_ids=[4012], auto_target=True)
        self.spawn_monster(spawn_ids=[4013], auto_target=True)
        self.spawn_monster(spawn_ids=[4014], auto_target=True)
        self.spawn_monster(spawn_ids=[4015], auto_target=True)
        self.spawn_monster(spawn_ids=[4016], auto_target=True)
