...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[8041], visible=False)
        self.set_effect(trigger_ids=[8042], visible=False)
        self.set_effect(trigger_ids=[8043], visible=False)
        self.set_effect(trigger_ids=[8044], visible=False)
...
class 번1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_mesh(trigger_ids=[265,266,267,268,269,270,271,272,273,274,275,276,277,278,279,280,281,282,283,284,285,286,287,288,289,290,291,292,293,294,295,296], visible=False, start_delay=0, interval=200)
        ...
        self.set_breakable(trigger_ids=[905,906,907,908,909,910,911,912,913,914,915,916,1905,1906,1907,1908,1909,1910,1911,1912,1913,1914,1915,1916,2905,2906,2907,2908,2909,2910,2911,2912,2913,2914,2915,2916,3905,3906,3907,3908,3909,3910,3911,3912,3913,3914,3915,3916], enable=False)
...
class 번2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entity_id=20002523, text_id=20002523)
        self.set_timer(timer_id='1', seconds=10)
        # self.set_mesh(trigger_ids=[297,298,299,300,301,302,303,304,305,306,307,308,309,310,311,312,313,314,315,316,317,318,319,320,321,322,323,324,325,326,327,328], visible=False, start_delay=0, interval=200)
        self.set_breakable(trigger_ids=[905,906,907,908,1905,1906,1907,1908,2905,2906,2907,2908,3905,3906,3907,3908], enable=True)
        self.set_breakable(trigger_ids=[901,902,903,904,909,910,911,912,913,914,915,916,1901,1902,1903,1904,1909,1910,1911,1912,1913,1914,1915,1916,2901,2902,2903,2904,2909,2910,2911,2912,2913,2914,2915,2916,3901,3902,3903,3904,3909,3910,3911,3912,3913,3914,3915,3916], enable=False)
...
class 번3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entity_id=20002523, text_id=20002523)
        self.set_timer(timer_id='1', seconds=10)
        # self.set_mesh(trigger_ids=[233,234,235,236,237,238,239,240,241,242,243,244,245,246,247,248,249,250,251,252,253,254,255,256,257,258,259,260,261,262,263,264], visible=False, start_delay=0, interval=200)
        self.set_breakable(trigger_ids=[909,910,911,912,1909,1910,1911,1912,2909,2910,2911,2912,3909,3910,3911,3912], enable=True)
        self.set_breakable(trigger_ids=[901,902,903,904,905,906,907,908,913,914,915,916,1901,1902,1903,1904,1905,1906,1907,1908,1913,1914,1915,1916,2901,2902,2903,2904,2905,2906,2907,2908,2913,2914,2915,2916,3901,3902,3903,3904,3905,3906,3907,3908,3913,3914,3915,3916], enable=False)
...
class 번4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entity_id=20002523, text_id=20002523)
        self.set_timer(timer_id='1', seconds=10)
        # self.set_mesh(trigger_ids=[201,202,203,204,205,206,207,208,209,210,211,212,213,214,215,216,217,218,219,220,221,222,223,224,225,226,227,228,229,230,231,232], visible=False, start_delay=0, interval=200)
        self.set_breakable(trigger_ids=[913,914,915,916,1913,1914,1915,1916,2913,2914,2915,2916,3913,3914,3915,3916], enable=True)
        self.set_breakable(trigger_ids=[901,902,903,904,905,906,907,908,909,910,911,912,1901,1902,1903,1904,1905,1906,1907,1908,1909,1910,1911,1912,2901,2902,2903,2904,2905,2906,2907,2908,2909,2910,2911,2912,3901,3902,3903,3904,3905,3906,3907,3908,3909,3910,3911,3912], enable=False)
