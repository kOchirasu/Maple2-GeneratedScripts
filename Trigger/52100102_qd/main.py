...
class 검은군단물러서기_1(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[600], visible=False)
...
class 검은군단돌아보기_1(common.Trigger):
    def on_enter(self):
...
class 검은군단물러서기_2(common.Trigger):
    def on_enter(self):
...
class 검은군단물러서기_3(common.Trigger):
    def on_enter(self):
...
class 검은군단소멸시키기(common.Trigger):
    def on_enter(self):
...
class 투르카공격1To1(common.Trigger):
    def on_enter(self):
...
class 투르카공격1To2(common.Trigger):
    def on_enter(self):
...
class 투르카공격1To3(common.Trigger):
    def on_enter(self):
...
class 투르카공격1To4(common.Trigger):
    def on_enter(self):
...
class 투르카질문_2To1(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_loop(spawnId=301, sequenceName='Bore_B', duration=3667)
...
class 투르카공격2To1(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_loop(spawnId=301, sequenceName='Attack_01_B', duration=600)
        self.set_effect(triggerIds=[601], visible=True)
...
class 투르카공격2To2(common.Trigger):
    def on_enter(self):
...
class 투르카엔딩대사_1(common.Trigger):
    def on_enter(self):
