...
# 스트라이커 연출 2차 입장
class StrikerSetting02(common.Trigger):
    def on_enter(self):
...
# 스트라이커 연출 2.5차 입장
class StrikerSetting05(common.Trigger):
    def on_enter(self):
...
# 스트라이커 연출 3차 입장
class StrikerSetting03(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=4000, visible=True, initialSequence='Dead_A') # NelfActor
        self.create_monster(spawnIds=[101], animationEffect=False) # NelfDummyNPC
...
# 스트라이커 연출 상황 종료
class StrikerSetting04(common.Trigger):
    def on_enter(self):
        self.set_portal(portalId=2, visible=True, enable=True, minimapVisible=True)


# 스트라이커 연출 최초 입장
class StrikerSetting01(common.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=4000, visible=True, initialSequence='Dead_A') # NelfActor
...
class ComeAcrossSB01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class ComeAcrossSB02(common.Trigger):
    def on_enter(self):
...
class ComeAcrossSB03(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return SBRunAway01(self.ctx)


class SBRunAway01(common.Trigger):
    def on_enter(self):
...
class SBRunAway02(common.Trigger):
    def on_enter(self):
...
class SBRunAway03(common.Trigger):
    def on_enter(self):
...
class StepInside01(common.Trigger):
    def on_enter(self):
...
class StepInside02(common.Trigger):
    def on_enter(self):
...
class TalkJabethNBravo01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class TalkJabethNBravo02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class TalkJabethNBravo03(common.Trigger):
    def on_enter(self):
...
class TalkJabethNBravo04(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
...
class ReadyToLeave02(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
        self.set_cinematic_ui(type=0)
...
class ReadyToLeave03(common.Trigger):
    def on_enter(self):
...
class ReadyToLeave04(common.Trigger):
    def on_enter(self):
...
class ReadyToLeave05(common.Trigger):
    def on_enter(self):
