...
class idle(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002074], arg2=0):
            return Ready()
...
class Event_03_b(state.State):
    def on_enter(self):
        ...
        set_npc_emotion_loop(spawnId=165, sequenceName='Down_Idle_A', duration=600000)
        set_conversation(type=1, spawnId=165, script='$52100041_QD__MAGIC_03__0$', arg4=3, arg5=0)
        set_conversation(type=1, spawnId=169, script='$52100041_QD__MAGIC_03__1$', arg4=3, arg5=2)
        set_conversation(type=1, spawnId=168, script='$52100041_QD__MAGIC_03__2$', arg4=3, arg5=1)
        set_conversation(type=1, spawnId=168, script='$52100041_QD__MAGIC_03__3$', arg4=3, arg5=6)
