...
class idle(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002075], arg2=0):
            return Ready()
...
class Event_04_b(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=144, script='$52100041_QD__MAGIC_04__0$', arg4=2, arg5=2)
        set_conversation(type=1, spawnId=144, script='$52100041_QD__MAGIC_04__1$', arg4=4, arg5=5)
...
class Event_04_c(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=144, script='$52100041_QD__MAGIC_04__2$', arg4=3, arg5=1)
        set_conversation(type=1, spawnId=144, script='$52100041_QD__MAGIC_04__3$', arg4=3, arg5=4)
