...
class idle(common.Trigger):
    ...
    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10002073], stateValue=0):
...
class Event_02_b(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=1122, script='$52100041_QD__MAGIC_02__0$', arg4=3, arg5=0)
        self.set_conversation(type=1, spawnId=1121, script='$52100041_QD__MAGIC_02__1$', arg4=3, arg5=3)
