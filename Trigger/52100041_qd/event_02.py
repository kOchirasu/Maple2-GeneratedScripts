...
class scene_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.shadow_expedition(type='OpenBossGauge', title='$52100041_QD__EVENT_02__4$', max_gauge_point=1000) # 진행 바 표기
        self.destroy_monster(spawn_ids=[199])
...
class scene_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=184, script='$52100041_QD__EVENT_02__8$', time=3, arg5=0)
