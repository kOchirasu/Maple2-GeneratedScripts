...
class idle(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002071], arg2=0):
            return Ready()
...
class scene_02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001956, script='$52100041_QD__EVENT_02__0$', arg4=5)
...
class scene_03(state.State):
    def on_enter(self):
        set_skip(state=scene_06_ready)
        set_conversation(type=2, spawnId=11001956, script='$52100041_QD__EVENT_02__1$', arg4=5)
...
class scene_04(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001956, script='$52100041_QD__EVENT_02__2$', arg4=5)
...
class scene_05(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001956, script='$52100041_QD__EVENT_02__3$', arg4=5)
...
class scene_06_ready(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10002072], state=1)
        set_interact_object(triggerIds=[10002073], state=1)
        set_interact_object(triggerIds=[10002074], state=1)
        set_interact_object(triggerIds=[10002075], state=1)
        set_interact_object(triggerIds=[10002076], state=1)
        set_interact_object(triggerIds=[10002077], state=1)
        destroy_monster(spawnIds=[199])
        set_skip()
...
class scene_07(state.State):
    def on_enter(self):
        shadow_expedition(type='OpenBossGauge', title='$52100041_QD__EVENT_02__4$', maxGaugePoint=1000) # 진행 바 표기
        destroy_monster(spawnIds=[199])
...
class scene_09(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=181, script='$52100041_QD__EVENT_02__5$', arg4=3, arg5=2)
        set_conversation(type=1, spawnId=182, script='$52100041_QD__EVENT_02__6$', arg4=3, arg5=4)
        set_conversation(type=1, spawnId=183, script='$52100041_QD__EVENT_02__7$', arg4=3, arg5=8)
        set_conversation(type=1, spawnId=184, script='$52100041_QD__EVENT_02__8$', arg4=3, arg5=0)
