...
class 준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3100,3101,3102,3103,3104,3105,3106,3107,3108,3109,3110,3111,3112,3113,3114,3115,3116,3117,3118,3119,3120,3121,3122,3123], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3200,3201,3202,3203,3204,3205,3206,3207,3208,3209,3210,3211,3212,3213,3214,3215,3216,3217,3218,3219,3220,3221,3222], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3315,3316,3317,3318,3319,3320,3321], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3130,3131,3132,3133,3134,3135,3136], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3600,3601,3602,3603,3604,3605,3606,3607,3608,3609,3610,3611,3612,3613,3614,3615,3616,3617,3618,3619,3620], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3500,3501,3502,3503,3504,3505,3506,3507,3508,3509,3510,3511,3512,3513,3514,3515,3516,3517,3518,3519,3520], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3330], visible=False, start_delay=0, interval=0, fade=0)
        ...
        self.set_effect(trigger_ids=[621], visible=False)
        self.set_effect(trigger_ids=[622], visible=False)
...
class 반응대기03(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10000858], state=0):
            ...
            self.set_mesh(trigger_ids=[3200,3201,3202,3203,3204,3205,3206,3207,3208,3209,3210,3211,3212,3213,3214,3215,3216,3217,3218,3219,3220,3221,3222], visible=True, start_delay=0, interval=50, fade=1)
            self.set_mesh(trigger_ids=[3100,3101,3102,3103,3104,3105,3106,3107,3108,3109,3110,3111,3112,3113,3114,3115,3116,3117,3118,3119,3120,3121,3122,3123], visible=True, start_delay=0, interval=50, fade=1)
            self.set_mesh(trigger_ids=[3600,3601,3602,3603,3604,3605,3606,3607,3608,3609,3610,3611,3612,3613,3614,3615,3616,3617,3618,3619,3620], visible=True, start_delay=0, interval=50, fade=1)
            self.set_mesh(trigger_ids=[3500,3501,3502,3503,3504,3505,3506,3507,3508,3509,3510,3511,3512,3513,3514,3515,3516,3517,3518,3519,3520], visible=True, start_delay=0, interval=50, fade=1)
...
class 별생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3315,3316,3317,3318,3319,3320,3321], visible=True, start_delay=0, interval=500, fade=3)
        self.set_timer(timer_id='3', seconds=3)

    def on_tick(self) -> trigger_api.Trigger:
        if self.time_expired(timer_id='3'):
            self.set_mesh(trigger_ids=[3315,3316,3317,3318,3319,3320,3321], visible=False, start_delay=0, interval=900, fade=2)
...
class 반응대기06(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[10000859], state=0):
            self.set_mesh(trigger_ids=[3330], visible=True, start_delay=0, interval=0, fade=3)
...
class 그라즈나전투(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[625], visible=False)
        self.set_effect(trigger_ids=[626], visible=False)
        self.set_effect(trigger_ids=[627], visible=False)
        self.set_effect(trigger_ids=[628], visible=False)
        self.set_effect(trigger_ids=[629], visible=False)
        self.set_effect(trigger_ids=[6004], visible=False)
...
class 포털생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3130,3131,3132,3133,3134,3135,3136], visible=True, start_delay=0, interval=0, fade=0)
