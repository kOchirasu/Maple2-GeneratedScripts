...
class 시작_원경을보여주자_02(common.Trigger):
    def on_enter(self):
...
class 시작_원경을보았으니이제시작하자(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 차전투시작_몬스터스폰1(common.Trigger):
    def on_enter(self):
...
class 차전투시작_몬스터스폰_02_1(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[4016], returnView=False)
...
class 차전투시작_몬스터스폰_black1(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 시작_괴롭힘당하는바야르_02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 시작_괴롭힘당하는바야르_02_01(common.Trigger):
    def on_enter(self):
...
class 시작_괴롭힘당하는바야르_03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 시작_괴롭힘당하는바야르_03_01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 시작_괴롭힘당하는바야르_04(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4005], returnView=False)
...
class 시작_괴롭힘당하는바야르_05(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[4016], returnView=False)
...
class 차전투시작_01_1(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_1(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_1_1(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 차전투시작_03_1(common.Trigger):
    def on_enter(self):
...
class 차전투시작_01_2(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_2(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 차전투시작_02_01_2(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_01_01_2(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 차전투시작_02_02_2(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_03_2(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_04_2(common.Trigger):
    def on_enter(self):
...
class 차전투시작_03_2(common.Trigger):
    def on_enter(self):
...
class 차전투시작_03_1_2(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 차전투시작_04_2(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.reset_camera(interpolationTime=1)
...
class 차전투종료_01_2(common.Trigger):
    def on_enter(self):
...
class 차전투시작_01_3(common.Trigger):
    def on_enter(self):
...
class 차전투시작_01_1_3(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 차전투시작_02_3(common.Trigger):
    def on_enter(self):
        self.reset_camera(interpolationTime=1)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 차전투시작_02_직후3(common.Trigger):
    def on_enter(self):
...
class 차전투시작_01_4(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_01_4(common.Trigger):
    def on_enter(self):
...
class 차전투시작_02_4(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[4004], returnView=False)
...
class 차전투시작_03_4(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4004], returnView=False)
...
class 차전투시작_04_4(common.Trigger):
    def on_enter(self):
...
class 차전투시작_05_4(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5001], visible=False)
...
class 차전투시작_06_4(common.Trigger):
    def on_enter(self):
...
class 차전투시작_07_4(common.Trigger):
    def on_enter(self):
...
class 차전투시작_08_4(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[4005], returnView=False)
...
class 차전투시작_09_4(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[4007], returnView=False)
...
class 차전투시작_09_01_4(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[4005], returnView=False)
...
class 에바고르전투_01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[4005], returnView=False)
...
class 에바고르전투_01_1(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 에바고르전투_02(common.Trigger):
    def on_enter(self):
...
class 에바고르전투_03(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=7, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 에바고르전투_04(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
