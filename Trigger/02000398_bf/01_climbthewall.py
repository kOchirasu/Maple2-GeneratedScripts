...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10001132], state=1) # Lever
        set_interact_object(triggerIds=[10001133], state=1) # Lever
...
class TerraceMobAttack01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=901, script='$02000398_BF__01_CLIMBTHEWALL__0$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=902, script='$02000398_BF__01_CLIMBTHEWALL__1$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=903, script='$02000398_BF__01_CLIMBTHEWALL__2$', arg4=2, arg5=1)
...
class TowerUnderMobAttack01(state.State):
    ...
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001132], arg2=0):
...
class GuidePullTheLever01(state.State):
    ...
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001133], arg2=0):
