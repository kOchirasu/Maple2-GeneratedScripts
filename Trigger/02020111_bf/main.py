...
class 보스전_시작(trigger_api.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=900012, key='SkillBreakMissionReset', value=1) # <스킬브레이크 던전 미션 체크시작>
...
class 보스전_리셋세팅(trigger_api.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=900012, key='SkillBreakMissionReset', value=0) # <스킬브레이크 던전 미션 리셋>
