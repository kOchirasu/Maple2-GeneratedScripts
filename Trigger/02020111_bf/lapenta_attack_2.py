...
class 대기(common.Trigger):
    def on_enter(self):
        self.side_npc_talk(type='talk', npcId=23501011, illust='Turned_Renduebian_normal', script='$02020111_BF__LAPENTA_ATTACK_2__0$', duration=3525, voice='ko/Npc/00002200')
        self.set_ambient_light(primary=[52,48,38])
        self.set_directional_light(diffuseColor=[0,0,0], specularColor=[206,174,84])

    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=3525):
