...
class scene_02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001956, script='$99999909__EVENT_02__0$', arg4=5)
...
class scene_03(state.State):
    def on_enter(self):
        set_skip(state=scene_06_ready)
        set_conversation(type=2, spawnId=11001956, script='$99999909__EVENT_02__1$', arg4=5)
...
class scene_04(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[1002], visible=True, arg3=0, arg4=200, arg5=25)
        ...
        set_conversation(type=2, spawnId=11001956, script='$99999909__EVENT_02__2$', arg4=5)
...
class scene_05(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001956, script='$99999909__EVENT_02__3$', arg4=5)
...
class scene_07(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$99999909__EVENT_02__4$', arg3='3000')
