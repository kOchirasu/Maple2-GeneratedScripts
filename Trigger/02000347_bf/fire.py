...
class 대기(common.Trigger):
    def on_enter(self):
        ...
        self.set_skill(triggerIds=[7041], enable=False)
        self.set_skill(triggerIds=[7042], enable=False)
        self.set_skill(triggerIds=[7043], enable=False)
        self.set_skill(triggerIds=[7044], enable=False)
        self.set_skill(triggerIds=[7045], enable=False)
        self.set_skill(triggerIds=[7046], enable=False)
        self.set_skill(triggerIds=[7047], enable=False)
        self.set_skill(triggerIds=[7048], enable=False)
        self.set_skill(triggerIds=[7049], enable=False)
        self.set_skill(triggerIds=[7050], enable=False)
        ...
        self.set_effect(triggerIds=[619], visible=False)
        ...
        self.set_effect(triggerIds=[623], visible=False)
        self.set_effect(triggerIds=[624], visible=False)
        ...
        self.set_effect(triggerIds=[631], visible=False)
        self.set_effect(triggerIds=[632], visible=False)
        self.set_effect(triggerIds=[633], visible=False)
        self.set_effect(triggerIds=[634], visible=False)
        self.set_effect(triggerIds=[635], visible=False)
        self.set_effect(triggerIds=[636], visible=False)
        self.set_effect(triggerIds=[637], visible=False)
        self.set_effect(triggerIds=[638], visible=False)
        self.set_effect(triggerIds=[639], visible=False)
        self.set_effect(triggerIds=[640], visible=False)
        self.set_effect(triggerIds=[641], visible=False)
        self.set_effect(triggerIds=[642], visible=False)
        self.set_effect(triggerIds=[643], visible=False)
        self.set_effect(triggerIds=[644], visible=False)
        self.set_effect(triggerIds=[645], visible=False)
        self.set_effect(triggerIds=[646], visible=False)
        self.set_effect(triggerIds=[647], visible=False)
        self.set_effect(triggerIds=[648], visible=False)
