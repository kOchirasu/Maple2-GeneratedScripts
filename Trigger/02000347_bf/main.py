...
class 대기(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10000787], state=0) # 보상 상태 (없음)
        set_mesh(triggerIds=[6001,6011], visible=True) # 벽 생성
        set_mesh(triggerIds=[6001,6002,6003,6004,6005,6006,6007,6008,6009,6010], visible=False) # 길 차단
...
class 오브젝티브_02(state.State):
    def on_enter(self):
        ...
        set_cinematic_ui(type=3, script='$02000347_BF__MAIN1__0$') # 오브젝티브
...
class 시작_01(state.State):
    def on_enter(self):
        show_count_ui(text='$02000347_BF__MAIN1__2$', stage=0, count=3)
...
class 클리어(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=7, arg2='$02000347_BF__MAIN1__1$', arg3='3000')
        set_mesh(triggerIds=[6001,6002,6003,6004,6005,6006,6007,6008,6009,6010], visible=True, arg4=0, arg5=10) # 길 생성
        set_mesh(triggerIds=[6011], visible=False, arg4=0, arg5=0) # 벽 삭제
        set_interact_object(triggerIds=[10000787], state=1) # 보상 상태 (없음)
