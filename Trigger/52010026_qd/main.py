...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[221], visible=False)
...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[1001], auto_target=False, delay=0) # 조디
        self.spawn_monster(spawn_ids=[601,602,603], auto_target=False, delay=0) # 연출용 엔피씨 (상인)
...
class 연출시작_깨어난PC(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.set_pc_emotion_loop(sequence_name='Sit_Ground_Idle_A', duration=29000)
...
class 첫번째연출_조디대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003344, illust_id='Peach_normal', msg='$52010026_QD__MAIN__9$', duration=3000, align='Right')
...
class 첫번째연출_조디대사04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=1001, sequence_name='Trigger_Idle_A', duration=10000)
...
class 두번째연출_black(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[101], auto_target=False, delay=0)
        self.spawn_monster(spawn_ids=[102], auto_target=False, delay=0)
        self.set_npc_emotion_loop(spawn_id=1000, sequence_name='Down_Idle_A', duration=70000)
...
class 두번째연출_피치전투01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_onetime_effect(id=2, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.add_balloon_talk(spawn_id=1000, msg='$52010026_QD__MAIN__24$', duration=1000, delay_tick=0)
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class 두번째연출_피치전투03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=1000, msg='$52010026_QD__MAIN__27$', duration=2000, delay_tick=0)
        ...
        self.spawn_monster(spawn_ids=[103], auto_target=False, delay=0)
        self.spawn_monster(spawn_ids=[104], auto_target=False, delay=0)
        self.spawn_monster(spawn_ids=[105], auto_target=False, delay=0)
...
class 두번째연출_잠시쉬기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003343, illust_id='Peach_normal', align='Left', msg='$52010026_QD__MAIN__29$', duration=2000)
...
class 세번째연출_대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=2)
        self.set_onetime_effect(id=102, enable=False, path='BG/Common/Eff_Com_Vibrate_Short.xml')
        self.add_balloon_talk(spawn_id=0, msg='$52010026_QD__MAIN__32$', duration=2000, delay_tick=0)
...
class 피치탈출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=1000, msg='$52010026_QD__MAIN__42$', duration=2000, delay_tick=0)
...
class 다섯번째연출_엘리트몬스터(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=1000, sequence_name='Trigger_Hurt_A', duration=28000)
        ...
        self.spawn_monster(spawn_ids=[131], auto_target=True, delay=0)
        self.show_caption(scale=2.3, type='NameCaption', title='$52010026_QD__MAIN__50$', desc='$52010026_QD__MAIN__51$', align='centerLeft', offset_rate_x=-0.15, duration=4000)
        self.set_onetime_effect(id=103, enable=False, path='BG/Common/Eff_Com_Vibrate_Short.xml')
...
class 다섯번째연출_대화02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.face_emotion(spawn_id=0, emotion_name='Trigger_disappoint')
        self.set_pc_emotion_loop(sequence_name='Down_B', duration=18000)
        self.set_onetime_effect(id=6, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
