...
class 연출시작_깨어난PC(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 연출시작_PC대사01(common.Trigger):
    def on_enter(self):
        self.face_emotion(spawnId=0, emotionName='Trigger_disappoint')
...
class 연출시작_조디대사01(common.Trigger):
    def on_enter(self):
...
class 첫번째연출_PC대사02(common.Trigger):
    def on_enter(self):
...
class 첫번째연출_조디대사02(common.Trigger):
    def on_enter(self):
...
class 첫번째연출_PC대사03(common.Trigger):
    def on_enter(self):
...
class 첫번째연출_조디대사03(common.Trigger):
    def on_enter(self):
...
class 첫번째연출_PC대사04(common.Trigger):
    def on_enter(self):
...
class 첫번째연출_조디대사04(common.Trigger):
    def on_enter(self):
        self.visible_my_pc(isVisible=False)
...
class 첫번째연출_조디대사05(common.Trigger):
    def on_enter(self):
...
class 첫번째연출_PC대사05(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4001], returnView=False)
        self.face_emotion(spawnId=0, emotionName='Trigger_serious')
...
class 첫번째연출_조디대사06(common.Trigger):
    def on_enter(self):
        self.visible_my_pc(isVisible=True)
...
class 두번째연출_ready(common.Trigger):
    def on_enter(self):
        self.visible_my_pc(isVisible=True)
...
class 두번째연출_black(common.Trigger):
    def on_enter(self):
...
class 두번째연출_피치발견01(common.Trigger):
    def on_enter(self):
...
class 두번째연출_피치발견02(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=201, enable=False, path='BG/Common/Eff_Com_Vibrate_Short.xml')
...
class 두번째연출_피치전투01(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=2, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 두번째연출_피치전투02(common.Trigger):
    def on_enter(self):
...
class 두번째연출_딜레이01(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5001], visible=False)
        self.set_effect(triggerIds=[5002], visible=False)
...
class 두번째연출_피치전투03(common.Trigger):
    def on_enter(self):
...
class 두번째연출_딜레이02(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=202, enable=False, path='BG/Common/Eff_Com_Vibrate_Short.xml')
        self.set_effect(triggerIds=[5003], visible=False)
        self.set_effect(triggerIds=[5004], visible=False)
...
class 두번째연출_PC대사01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 두번째연출_잠시쉬기(common.Trigger):
    def on_enter(self):
...
class 세번째연출_포털개방(common.Trigger):
    def on_enter(self):
...
class 세번째연출_포털개방02(common.Trigger):
    def on_enter(self):
...
class 세번째연출_대사01(common.Trigger):
    def on_enter(self):
        self.reset_camera(interpolationTime=0)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 세번째연출_대사02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[201], visible=False)
        self.set_effect(triggerIds=[221], visible=False)
        self.set_cinematic_ui(type=1)
...
class 세번째연출_대사02_1(common.Trigger):
    def on_enter(self):
...
class 다섯번째연출_ready(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 다섯번째연출_엘리트몬스터(common.Trigger):
    def on_enter(self):
...
class 다섯번째연출_엘리트몬스터대사(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=7, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class 다섯번째연출_전투(common.Trigger):
    def on_enter(self):
        self.reset_camera(interpolationTime=0)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 다섯번째연출_마지막(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class 다섯번째연출_대화02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.face_emotion(spawnId=0, emotionName='Trigger_disappoint')
...
class 다섯번째연출_암전(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=7, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 다섯번째연출_의문의목소리암전(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
