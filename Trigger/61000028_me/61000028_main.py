...
class StateNone(state.State):
    def on_enter(self):
        ...
        field_game_constant(key='InvincibleMessage', value='$61000028_ME__61000028_MAIN__6$') # 대기지역 포탈 아이디
        ...
        field_game_constant(key='LoserRewardItemCount', value='1', feature='MassiveHideAndSeek', locale='CN') # NA 승리팀 보상 id, rank, count
        field_game_constant(key='WinnerRewardItemID', value='30000610', feature='MassiveHideAndSeek', locale='NA')
        field_game_constant(key='WinnerRewardItemRank', value='1', feature='MassiveHideAndSeek', locale='NA')
        field_game_constant(key='WinnerRewardItemCount', value='2', feature='MassiveHideAndSeek', locale='NA') # NA 패배팀 보상 id, rank, count
        field_game_constant(key='LoserRewardItemID', value='30000610', feature='MassiveHideAndSeek', locale='NA')
        field_game_constant(key='LoserRewardItemRank', value='1', feature='MassiveHideAndSeek', locale='NA')
        field_game_constant(key='LoserRewardItemCount', value='1', feature='MassiveHideAndSeek', locale='NA') # 관전 CameraID
