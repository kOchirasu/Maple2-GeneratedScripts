...
class ready(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.quest_user_detected(box_ids=[701], quest_ids=[10003051], quest_states=[1]):
            ...
            self.set_actor(trigger_id=3010, visible=False, initial_sequence='Idle_A')
...
class start(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=7001, enable=True)
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_2001')
...
class scene_b_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=122, script='$52000039_QD__MAIN__1$', time=3, arg5=0)
        self.set_actor(trigger_id=3001, visible=True, initial_sequence='sf_fi_funct_door_A01_Opened')
        self.set_mesh(trigger_ids=[6001], visible=False)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(box_id=703, spawn_ids=[122]):
            self.set_cinematic_ui(type=1)
            self.set_cinematic_ui(type=3)
            self.select_camera(trigger_id=7002, enable=True)
...
class scene_b_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=7003, enable=True)
...
class scene_b_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[111,132], auto_target=True)
...
class scene_b_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=132, sequence_name='Sit_Down_A', duration=3000)
        self.set_npc_emotion_loop(spawn_id=111, sequence_name='Sit_Down_A', duration=3000)
...
class scene_b_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=132, sequence_name='Stun_A', duration=3000)
        self.set_npc_emotion_loop(spawn_id=111, sequence_name='Stun_A', duration=3000)
...
class LookAround01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='$52000039_QD__MAIN__7$', time=2, arg5=0)
...
class LookAround02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='$52000039_QD__MAIN__8$', time=2, arg5=0)
...
class LookAround03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='$52000039_QD__MAIN__9$', time=2, arg5=0)
