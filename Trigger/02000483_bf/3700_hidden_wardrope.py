...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002044], state=0) # Wardrope
...
class Opened(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002044], state=1) # Wardrope

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002044], arg2=0):
            return LadderOn()
