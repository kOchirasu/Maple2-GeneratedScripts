...
class MobTrapOn01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=901, script='$02000483_BF__04_HALLWAYBATTLE__0$', time=2, arg5=0)
        self.set_dialogue(type=1, spawn_id=902, script='$02000483_BF__04_HALLWAYBATTLE__1$', time=2, arg5=0)
        self.set_dialogue(type=1, spawn_id=903, script='$02000483_BF__04_HALLWAYBATTLE__2$', time=2, arg5=0)
