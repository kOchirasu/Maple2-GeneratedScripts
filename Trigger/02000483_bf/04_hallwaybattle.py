...
class Wait(common.Trigger):
    def on_enter(self):
        self.set_mesh(triggerIds=[3800,3900], visible=True, arg3=0, delay=0, scale=0) # InvisibleBarrier_AlwaysOn
        self.set_portal(portalId=20, visible=False, enable=False, minimapVisible=False)
        self.set_interact_object(triggerIds=[10002045], state=0) # Key
...
class MobTrapOn01(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=901, script='$02000483_BF__04_HALLWAYBATTLE__0$', arg4=2, arg5=0)
        self.set_conversation(type=1, spawnId=902, script='$02000483_BF__04_HALLWAYBATTLE__1$', arg4=2, arg5=0)
        self.set_conversation(type=1, spawnId=903, script='$02000483_BF__04_HALLWAYBATTLE__2$', arg4=2, arg5=0)
...
class MobTrapOn02(common.Trigger):
    def on_enter(self):
...
class MobTrapOn03(common.Trigger):
    def on_enter(self):
...
class GuideUseKey(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
        self.show_guide_summary(entityId=20039705, textId=20039705) # 가이드 : 다른 방으로 이동할 단서를 찾으세요
        self.set_interact_object(triggerIds=[10002045], state=1) # Key

    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10002045], stateValue=0):
