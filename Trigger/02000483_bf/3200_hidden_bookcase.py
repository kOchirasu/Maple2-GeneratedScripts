...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002039], state=0) # Bookcase
...
class Opened(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002039], state=1) # Bookcase

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002039], arg2=0):
            return LadderOn()
