...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10002038], state=0) # Fireplace
...
class Opened(common.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10002038], state=1) # Fireplace

    def on_tick(self) -> common.Trigger:
        if self.object_interacted(interactIds=[10002038], stateValue=0):
