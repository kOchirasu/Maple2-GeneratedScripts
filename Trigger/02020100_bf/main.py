...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_ladder(trigger_ids=[2001], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[2002], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[2003], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[2004], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[2005], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[2006], visible=False, enable=False, fade=0)
        self.set_ladder(trigger_ids=[2007], visible=False, enable=False, fade=0)
        self.set_mesh(trigger_ids=[1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014], visible=False, start_delay=0, interval=0)
        self.set_mesh(trigger_ids=[1101,1102,1103,1104,1105,1106,1107,1108,1109,1110,1111,1112,1113,1114], visible=True, start_delay=0, interval=0)
        self.set_mesh(trigger_ids=[1201,1202,1203,1204,1205,1206,1207,1208,1209,1210,1211,1212,1213,1214,1215,1216,1217,1218,1219,1220,1221,1222,1223,1224,1225,1226,1227,1228,1229,1230], visible=True, start_delay=0, interval=0)
        ...
        self.set_mesh(trigger_ids=[1301,1302,1303,1304], visible=False, start_delay=0, interval=0)
        ...
        self.set_breakable(trigger_ids=[5001,5002,5003,5004,5005,5006,5007,5008,5009], enable=False)
        self.set_breakable(trigger_ids=[5011,5012,5013,5014,5015,5016,5017,5018,5019], enable=False)
...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1101,1102,1103,1104,1105,1106,1107,1108,1109,1110,1111,1112,1113,1114], visible=False, start_delay=0, interval=0)
...
class 씨앗체험(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1007,1008,1009,1010], visible=True, start_delay=0, interval=250, fade=3)
...
class 씨앗체험_씨앗들기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_mesh(trigger_ids=[1301], visible=True, start_delay=0, interval=0)
...
class 씨앗체험_나무심기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.set_mesh(trigger_ids=[1301], visible=False, start_delay=0, interval=0)
...
class 씨앗체험_끝(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1011,1012,1013,1014], visible=True, start_delay=0, interval=250, fade=3)
...
class 씨앗1_전투(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_agent(trigger_ids=[9016], visible=False)
        self.set_agent(trigger_ids=[9017], visible=False)
        self.set_agent(trigger_ids=[9018], visible=False)
        self.spawn_monster(spawn_ids=[213,214,215,216], auto_target=False)
        self.set_mesh(trigger_ids=[1201,1202,1203,1204,1205,1206,1207,1208,1209,1210], visible=False, start_delay=0, interval=0)
...
class 씨앗1_심기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[9019], visible=False)
        self.set_agent(trigger_ids=[9020], visible=False)
        self.set_agent(trigger_ids=[9021], visible=False)
        self.set_agent(trigger_ids=[9022], visible=False)
        self.set_mesh(trigger_ids=[1001,1002,1003,1004], visible=True, start_delay=0, interval=250, fade=3)
...
class 씨앗2_활성화(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_agent(trigger_ids=[9024], visible=False)
        self.enable_spawn_point_pc(spawn_id=1, is_enable=False)
        ...
        self.set_mesh(trigger_ids=[1005,1006], visible=True, start_delay=0, interval=250, fade=3)
...
class 씨앗2_전투(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[9025], visible=False)
        self.set_agent(trigger_ids=[9026], visible=False)
        self.set_agent(trigger_ids=[9027], visible=False)
        self.set_agent(trigger_ids=[9028], visible=False)
        self.set_agent(trigger_ids=[9029], visible=False)
        ...
        self.set_mesh(trigger_ids=[1211,1212,1213,1214,1215,1216,1217,1218,1219,1220], visible=False, start_delay=0, interval=0)
...
class 발판1_지역감지(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_agent(trigger_ids=[9030], visible=False)
        ...
        self.set_agent(trigger_ids=[9034], visible=False)
        self.set_actor(trigger_id=1403, visible=True, initial_sequence='Interaction_lapentatree_A01_On')
        self.set_mesh(trigger_ids=[1221,1222,1223,1224,1225,1226,1227,1228,1229,1230], visible=False, start_delay=0, interval=0)
