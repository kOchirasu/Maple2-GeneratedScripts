...
class 씨앗체험_씨앗들기(common.Trigger):
    def on_enter(self):
...
class 씨앗체험_나무심기(common.Trigger):
    def on_enter(self):
...
class 발판1_활성화대기(common.Trigger):
    def on_enter(self):
...
class 발판1_몬스터처리(common.Trigger):
    def on_enter(self):
