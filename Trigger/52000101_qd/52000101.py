...
class 엘리니아전경씬01(common.Trigger):
    def on_enter(self):
...
class 엘리니아전경씬02(common.Trigger):
    def on_enter(self):
...
class 엘리니아전경씬03(common.Trigger):
    def on_enter(self):
...
# ########################씬2 케이틀린 등장########################
class 케이틀린등장씬01(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
        self.set_cinematic_ui(type=1)
...
class 케이틀린등장씬02(common.Trigger):
    def on_enter(self):
...
class 케이틀린등장씬03(common.Trigger):
    def on_enter(self):
...
class 케이틀린등장씬04_b(common.Trigger):
    def on_enter(self):
...
class 케이틀린등장씬04(common.Trigger):
    def on_enter(self):
...
class 케이틀린등장씬04_1(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
...
class 케이틀린등장씬05(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
...
class 케이틀린화남05_1(common.Trigger):
    def on_enter(self):
        self.set_scene_skip()
