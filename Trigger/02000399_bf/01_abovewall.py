...
class Wait(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10001150], state=0) # LeverForLadder01
        self.set_interact_object(triggerIds=[10001151], state=0) # LeverForRope
        self.set_interact_object(triggerIds=[10001152], state=0) # LeverForLadder02
...
class MobActorSpawn(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=901, script='$02000399_BF__01_ABOVEWALL__0$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=902, script='$02000399_BF__01_ABOVEWALL__1$', arg4=2, arg5=1)
        self.set_conversation(type=1, spawnId=903, script='$02000399_BF__01_ABOVEWALL__2$', arg4=2, arg5=1)
...
class Battle01Start(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10001150], state=1) # LeverForLadder01

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10001150], stateValue=0):
...
class Battle03Start(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10001151], state=1) # LeverForRope

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10001151], stateValue=0):
...
class Battle04Start(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[10001152], state=1) # LeverForLadder02

    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[10001152], stateValue=0):
