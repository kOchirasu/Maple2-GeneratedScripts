...
class 전투시작01(state.State):
    def on_enter(self):
        side_npc_talk(npcId=11003533, illust='Bliche_nomal', duration=5000, script='$02000410_BF__PopUpCinema__0$', voice='ko/Npc/00002157')
...
class 전투시작03(state.State):
    def on_enter(self):
        side_npc_talk(npcId=11003795, illust='infernog_nomal', duration=5000, script='$02000410_BF__PopUpCinema__2$', voice='ko/Monster/60000724')
...
class 전투시작04(state.State):
    def on_enter(self):
        side_npc_talk(npcId=11003795, illust='infernog_nomal', duration=5000, script='$02000410_BF__PopUpCinema__3$', voice='ko/Monster/60000725')
...
class 전투시작05(state.State):
    def on_enter(self):
        side_npc_talk(npcId=11000144, illust='tristan_normal', duration=5000, script='$02000410_BF__PopUpCinema__4$', voice='ko/Npc/00002172')

    def on_tick(self) -> state.State:
        if dungeon_check_play_time(playSeconds=240):
            return 두번째팝업영상출력()
...
class 두번째팝업영상출력02(state.State):
    def on_enter(self):
        side_npc_talk(npcId=11003533, illust='Bliche_nomal', duration=5000, script='$02000410_BF__PopUpCinema__6$', voice='ko/Npc/00002173')

    def on_tick(self) -> state.State:
        if dungeon_check_play_time(playSeconds=480):
            return 세번째팝업영상출력()
...
class 세번째팝업영상출력04(state.State):
    def on_enter(self):
        side_npc_talk(npcId=11003533, illust='Bliche_nomal', duration=5000, script='$02000410_BF__PopUpCinema__10$', voice='ko/Npc/00002175')
...
class 네번째팝업영상출력02(state.State):
    def on_enter(self):
        side_npc_talk(npcId=11003533, illust='Bliche_nomal', duration=5000, script='$02000410_BF__PopUpCinema__12$', voice='ko/Npc/00002176')
