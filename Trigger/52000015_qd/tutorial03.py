...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5000], visible=False) # 위험 연출 이펙트 01
        self.set_effect(trigger_ids=[5001], visible=False) # 위험 연출 이펙트 02
        self.set_effect(trigger_ids=[5002], visible=False) # 위험 연출 사운드 이펙트
        self.set_effect(trigger_ids=[6000], visible=False) # 이슈라 음성 사운드 이펙트 01
        ...
        self.set_effect(trigger_ids=[6003], visible=False) # 이슈라 음성 사운드 이펙트 04
...
class 전투시작01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.destroy_monster(spawn_ids=[901,902,903,904])
        self.spawn_monster(spawn_ids=[911,912,913,914], auto_target=True)
