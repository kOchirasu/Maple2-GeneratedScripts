...
class 묘지전경씬02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$52000152_QD__52000152__0$', desc='$52000152_QD__52000152__1$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=5000, scale=2.5)
...
class Quit02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000152_QD__52000152__2$', duration=6000, delay_tick=1000)
