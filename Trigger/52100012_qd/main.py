...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[7013], visible=False)
        self.set_mesh(trigger_ids=[3007,3008,3009], visible=True, start_delay=0, interval=0, fade=0)
        ...
        self.set_actor(trigger_id=3101, visible=False, initial_sequence='Run_A')
        self.set_actor(trigger_id=3102, visible=False, initial_sequence='Run_A')
        self.set_actor(trigger_id=3103, visible=False, initial_sequence='Run_A')
        self.set_actor(trigger_id=3104, visible=False, initial_sequence='Run_A')
        self.set_breakable(trigger_ids=[1801,1802,1803,1804,1805,1806,1807], enable=False)
        self.set_local_camera(camera_id=8100, enable=False) # LocalTargetCamera
        self.set_local_camera(camera_id=8101, enable=False) # LocalTargetCamera
        self.set_mesh(trigger_ids=[1001], visible=False, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[1990,1991,1992,1993], visible=True, start_delay=0, interval=0, fade=0)
...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.set_mesh(trigger_ids=[3007,3008,3009], visible=False, start_delay=0, interval=0, fade=0)
        # self.set_actor(trigger_id=3001, visible=False, initial_sequence='Run_A')
        # self.set_actor(trigger_id=3002, visible=False, initial_sequence='Run_A')
        # self.set_actor(trigger_id=3003, visible=False, initial_sequence='Run_A')
        # self.set_actor(trigger_id=3004, visible=False, initial_sequence='Attack_Idle_A')
        # self.set_actor(trigger_id=3005, visible=False, initial_sequence='Attack_Idle_A')
        # self.set_actor(trigger_id=3006, visible=False, initial_sequence='Attack_Idle_A')
        self.set_skip(state=start_ready)
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Walk_A', duration=1E+16)
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Walk_A', duration=1E+16)
...
class ready_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003889, illust_id='Firis_normal', msg='$52100012_QD__MAIN__0$', align='left', duration=2000)
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$52100012_QD__MAIN__1$', align='left', duration=2000)
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003889, illust_id='Firis_normal', msg='$52100012_QD__MAIN__6$', align='left', duration=2000)
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$52100012_QD__MAIN__7$', align='left', duration=2000)
...
class boss_leftTurn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=302, script='$52100012_QD__MAIN__8$', time=3, arg5=0)
...
class boss_rightTurn(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.move_npc(spawn_id=102, patrol_name='MS2PatrolData_2003')
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_2003')
        self.set_dialogue(type=1, spawn_id=301, script='$52100012_QD__MAIN__10$', time=3, arg5=0)
...
class boss_leftTurn_b_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # 난파가 될 시 멈출 블록들
        self.set_dialogue(type=1, spawn_id=305, script='$52100012_QD__MAIN__11$', time=3, arg5=0)
...
class Ending_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1990,1991,1992,1993], visible=False, start_delay=0, interval=0, fade=0)
        ...
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.add_cinematic_talk(npc_id=11003889, illust_id='Firis_normal', msg='$52100012_QD__MAIN__12$', align='left', duration=2000)
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$52100012_QD__MAIN__13$', align='right', duration=2000)
