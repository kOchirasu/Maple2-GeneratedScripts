...
class scene_01(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=202, script='$52100012_QD__MAIN__3$', arg4=2, arg5=4)
        self.set_conversation(type=1, spawnId=204, script='$52100012_QD__MAIN__4$', arg4=2, arg5=6)
...
class boss_rightTurn(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.move_npc(spawnId=102, patrolName='MS2PatrolData_2003')
        self.move_npc(spawnId=101, patrolName='MS2PatrolData_2003')
        self.set_conversation(type=1, spawnId=301, script='$52100012_QD__MAIN__10$', arg4=3, arg5=0)
...
class Ending_01(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.add_cinematic_talk(npcId=11003889, illustId='Firis_normal', msg='$52100012_QD__MAIN__12$', align='left', duration=2000)
        self.add_cinematic_talk(npcId=11003888, illustId='Celine_normal', msg='$52100012_QD__MAIN__13$', align='right', duration=2000)
...
class End(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_effect(triggerIds=[7012], visible=False)
        self.set_effect(triggerIds=[7013], visible=False)
        self.set_conversation(type=1, spawnId=104, script='$52100012_QD__MAIN__14$', arg4=2, arg5=2)
        self.set_conversation(type=1, spawnId=103, script='$52100012_QD__MAIN__15$', arg4=2, arg5=4)
        self.set_conversation(type=1, spawnId=104, script='$52100012_QD__MAIN__16$', arg4=2, arg5=7)
        self.set_conversation(type=1, spawnId=103, script='$52100012_QD__MAIN__17$', arg4=2, arg5=9)
