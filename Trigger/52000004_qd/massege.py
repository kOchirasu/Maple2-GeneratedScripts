...
class 메세지02대기(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[104]):
            return 메세지03(self.ctx)


class 메세지03(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='3', seconds=3)
...
class 메세지03대기(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[105]):
            return 메세지04(self.ctx)


class 메세지04(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='3', seconds=3)
...
class 메세지04대기(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[106]):
            return 메세지05(self.ctx)


class 메세지05(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='3', seconds=3)
...
class 메세지05대기(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[107]):
            return 메세지06(self.ctx)


class 메세지06(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='3', seconds=3)
