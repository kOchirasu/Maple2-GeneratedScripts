...
class idle(state.State):
    ...
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[12000032], arg2=0):
            return Ready()
...
class Event_02_b(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1122, script='$02000403_BF__MAGIC_02__0$', arg4=3, arg5=0)
        set_conversation(type=1, spawnId=1121, script='$02000403_BF__MAGIC_02__1$', arg4=3, arg5=3)
