...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000030], stateValue=0):
...
class scene_02(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001956, script='$02000403_BF__EVENT_02__0$', arg4=5)
...
class scene_03(trigger_api.Trigger):
    def on_enter(self):
        self.set_skip(state=scene_06_ready)
        self.set_conversation(type=2, spawnId=11001956, script='$02000403_BF__EVENT_02__1$', arg4=5)
...
class scene_04(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001956, script='$02000403_BF__EVENT_02__2$', arg4=5)
...
class scene_05(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001956, script='$02000403_BF__EVENT_02__3$', arg4=5)
...
class scene_06_ready(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_interact_object(triggerIds=[12000032], state=1)
        self.set_interact_object(triggerIds=[12000033], state=1)
        self.set_interact_object(triggerIds=[12000034], state=1)
        self.set_interact_object(triggerIds=[12000035], state=1)
        self.set_interact_object(triggerIds=[12000036], state=1)
        self.destroy_monster(spawnIds=[199])
        self.set_skip()
...
class scene_07(trigger_api.Trigger):
    def on_enter(self):
        self.shadow_expedition(type='OpenBossGauge', title='$02000403_BF__EVENT_02__9$', maxGaugePoint=1000) # 진행 바 표기
        self.destroy_monster(spawnIds=[199])
...
class scene_09(trigger_api.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=181, script='$02000403_BF__EVENT_02__5$', arg4=3, arg5=2)
        self.set_conversation(type=1, spawnId=182, script='$02000403_BF__EVENT_02__6$', arg4=3, arg5=4)
        self.set_conversation(type=1, spawnId=183, script='$02000403_BF__EVENT_02__7$', arg4=3, arg5=8)
        self.set_conversation(type=1, spawnId=184, script='$02000403_BF__EVENT_02__8$', arg4=3, arg5=0)
