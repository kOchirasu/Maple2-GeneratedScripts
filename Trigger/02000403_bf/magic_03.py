...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000033], stateValue=0):
...
class Event_03_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawnId=165, sequenceName='Down_Idle_A', duration=600000)
        self.set_conversation(type=1, spawnId=165, script='$02000403_BF__MAGIC_03__0$', arg4=3, arg5=0)
        self.set_conversation(type=1, spawnId=169, script='$02000403_BF__MAGIC_03__1$', arg4=3, arg5=2)
        self.set_conversation(type=1, spawnId=168, script='$02000403_BF__MAGIC_03__2$', arg4=3, arg5=1)
        self.set_conversation(type=1, spawnId=168, script='$02000403_BF__MAGIC_03__3$', arg4=3, arg5=6)
