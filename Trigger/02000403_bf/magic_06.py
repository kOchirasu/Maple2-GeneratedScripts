...
class Event_06_h(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=1107, script='$02000403_BF__MAGIC_06__3$', time=5, arg5=0)
...
class Event_06_i(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1107, script='$02000403_BF__MAGIC_06__5$', time=5, arg5=0)
