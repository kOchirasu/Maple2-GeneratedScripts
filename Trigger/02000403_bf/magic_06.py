...
class idle(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[12000036], arg2=0):
            return Ready()
...
class Event_06_b(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1103, script='$02000403_BF__MAGIC_06__0$', arg4=3, arg5=1)
        set_npc_emotion_sequence(spawnId=1103, sequenceName='Talk_A')
        set_conversation(type=1, spawnId=1104, script='$02000403_BF__MAGIC_06__1$', arg4=3, arg5=4)
        set_conversation(type=1, spawnId=1103, script='$02000403_BF__MAGIC_06__2$', arg4=3, arg5=7)
        set_conversation(type=1, spawnId=1104, script='$02000403_BF__MAGIC_06__8$', arg4=3, arg5=10)
...
class Event_06_h(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=1107, script='$02000403_BF__MAGIC_06__3$', arg4=5, arg5=0)
        set_conversation(type=1, spawnId=1108, script='$02000403_BF__MAGIC_06__4$', arg4=3, arg5=3)
...
class Event_06_i(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1107, script='$02000403_BF__MAGIC_06__5$', arg4=5, arg5=0)
        set_conversation(type=1, spawnId=1108, script='$02000403_BF__MAGIC_06__6$', arg4=3, arg5=3)
        set_conversation(type=1, spawnId=1107, script='$02000403_BF__MAGIC_06__7$', arg4=3, arg5=5)
