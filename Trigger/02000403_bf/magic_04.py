...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000034], stateValue=0):
...
class Event_04_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=144, script='$02000403_BF__MAGIC_04__0$', arg4=2, arg5=2)
        self.set_conversation(type=1, spawnId=144, script='$02000403_BF__MAGIC_04__1$', arg4=4, arg5=5)
...
class Event_04_c(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=1, spawnId=144, script='$02000403_BF__MAGIC_04__2$', arg4=3, arg5=1)
        self.set_conversation(type=1, spawnId=144, script='$02000403_BF__MAGIC_04__3$', arg4=3, arg5=4)
