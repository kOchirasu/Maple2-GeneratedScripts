...
class idle(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[12000035], arg2=0):
            return Ready()
...
class Event_05_b(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=147, script='$02000403_BF__MAGIC_05__0$', arg4=2, arg5=2)
        set_conversation(type=1, spawnId=145, script='$02000403_BF__MAGIC_05__1$', arg4=3, arg5=4)
        set_conversation(type=1, spawnId=146, script='$02000403_BF__MAGIC_05__2$', arg4=3, arg5=5)
        set_conversation(type=1, spawnId=147, script='$02000403_BF__MAGIC_05__3$', arg4=3, arg5=6)
