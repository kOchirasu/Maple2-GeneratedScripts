...
class idle(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000035], stateValue=0):
...
class Event_05_b(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=147, script='$02000403_BF__MAGIC_05__0$', arg4=2, arg5=2)
        self.set_conversation(type=1, spawnId=145, script='$02000403_BF__MAGIC_05__1$', arg4=3, arg5=4)
        self.set_conversation(type=1, spawnId=146, script='$02000403_BF__MAGIC_05__2$', arg4=3, arg5=5)
        self.set_conversation(type=1, spawnId=147, script='$02000403_BF__MAGIC_05__3$', arg4=3, arg5=6)
