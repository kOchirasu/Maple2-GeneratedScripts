...
class idle(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[12000031], arg2=0):
            return Ready()
...
class Event_01_b(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=161, script='$02000403_BF__MAGIC_01__0$', arg4=3, arg5=2)
        set_conversation(type=1, spawnId=162, script='$02000403_BF__MAGIC_01__1$', arg4=3, arg5=4)
        set_conversation(type=1, spawnId=163, script='$02000403_BF__MAGIC_01__2$', arg4=3, arg5=6)
