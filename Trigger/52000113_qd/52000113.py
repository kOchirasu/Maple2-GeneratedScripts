...
class 대기01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_npc_range(range_ids=[202,203,204,205,206,207,208,209,210,211,212,213,214,215,216,217,218,219,220,221], is_auto_targeting=False)
...
class camera04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003338, illust_id='0', msg='$52000113_QD__52000113__0$', duration=4000, align='right')
...
class camera05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003185, illust_id='0', msg='$52000113_QD__52000113__1$', duration=4000, align='right')
...
class camera06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003185, illust_id='0', msg='$52000113_QD__52000113__2$', duration=4000, align='right')
...
class camera07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003185, illust_id='0', msg='$52000113_QD__52000113__3$', duration=5000, align='right')
...
class camera08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003185, illust_id='0', msg='$52000113_QD__52000113__4$', duration=5000, align='right')
