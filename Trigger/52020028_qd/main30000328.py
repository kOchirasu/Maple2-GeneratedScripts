...
class 아크로폴리스내부확인(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='아크로폴리스', desc='고대 크리티아스 지식의 안식처', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=4000, scale=2)
...
class 유저자격확인하기전(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Idle_A', duration=6000)
        self.add_balloon_talk(spawn_id=0, msg='?!', duration=3000)
        self.add_balloon_talk(spawn_id=0, msg='이... 이건?', duration=3000, delay_tick=3000)
...
class 유저자격확인2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.face_emotion(spawn_id=0, emotion_name='Trigger_panic')
        self.set_pc_emotion_loop(sequence_name='Attack_Idle_A', duration=18000)
        self.set_effect(trigger_ids=[5003], visible=True)
        self.add_balloon_talk(spawn_id=0, msg='자격을 확인한다고? 잠깐!!!', duration=3000)
...
class 유저자격확인3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='잠시 이야기를 들어줘!', duration=3000, delay_tick=4000)
...
class 아르케온등장2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='아니 대화가 전혀 안 통하잖아!', duration=2000, delay_tick=0)
...
class 등장연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='아르케온', desc='아크로폴리스의 수호자', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=4000, scale=2)
...
class 이오네독백준비_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=4011, enable=True)
...
class 이오네독백(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='이오네', desc='크리티아스의 왕녀', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=4000, scale=2)
