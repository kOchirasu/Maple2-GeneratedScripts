...
class ArriveBlock_Delay_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_2__0$', duration=3000)
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_2__1$', duration=4000)
...
class ArriveBlock_Delay_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_2__2$', duration=3000)
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_2__3$', duration=4000)
...
class ArriveBlock_Delay_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_2__4$', duration=3000)
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_2__5$', duration=4000)
...
class CableOn_07_08(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[12000507], state=0):
            ...
            self.set_mesh(trigger_ids=[1101001,1101002,1101003,1101004,1101005,1101006,1101007,1101008,1101009,1101010], visible=False, start_delay=0, interval=0, fade=0)
        ...
        if self.object_interacted(interact_ids=[12000508], state=0):
            ...
            self.set_mesh(trigger_ids=[1102001,1102002,1102003,1102004,1102005,1102006,1102007,1102008,1102009,1102010], visible=False, start_delay=0, interval=0, fade=0)
...
class CableOn_09_10(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[12000509], state=0):
            ...
            self.set_mesh(trigger_ids=[1103001,1103002,1103003,1103004,1103005,1103006,1103007,1103008,1103009,1103010], visible=False, start_delay=0, interval=0, fade=0)
        ...
        if self.object_interacted(interact_ids=[12000510], state=0):
            ...
            self.set_mesh(trigger_ids=[1104001,1104002,1104003,1104004,1104005,1104006,1104007,1104008,1104009,1104010], visible=False, start_delay=0, interval=0, fade=0)
...
class CableOn_11_12(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interact_ids=[12000511], state=0):
            ...
            self.set_mesh(trigger_ids=[1105001,1105002,1105003,1105004,1105005,1105006,1105007,1105008,1105009,1105010], visible=False, start_delay=0, interval=0, fade=0)
        ...
        if self.object_interacted(interact_ids=[12000512], state=0):
            ...
            self.set_mesh(trigger_ids=[1106001,1106002,1106003,1106004,1106005,1106006,1106007,1106008,1106009,1106010], visible=False, start_delay=0, interval=0, fade=0)
...
class CableDelay_07_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_normal', script='$52100302_QD__FIELD_2__30$', duration=6000)
...
class CableDelay_08_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_normal', script='$52100302_QD__FIELD_2__31$', duration=6000)
...
class CableDelay_09_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_normal', script='$52100302_QD__FIELD_2__32$', duration=6000)
...
class CableDelay_10_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_normal', script='$52100302_QD__FIELD_2__33$', duration=6000)
...
class CableDelay_11_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_normal', script='$52100302_QD__FIELD_2__34$', duration=6000)
...
class CableDelay_12_5(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_normal', script='$52100302_QD__FIELD_2__35$', duration=6000)
