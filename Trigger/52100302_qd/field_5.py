...
class Archeon_Ready(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[1117,1501,1502,1503,1504,1505,1506,1507,1508,1509,1510,1511,1512,1513]):
            self.side_npc_talk(type='talk', npc_id=11004607, illust='Neirin_normal', script='$52100302_QD__FIELD_5__0$', duration=5000)
...
class Archeon_Move1_0(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1000):
            ...
            self.set_portal(portal_id=10003, visible=False, enable=True, minimap_visible=False)
            # self.set_portal(portal_id=10004, visible=False, enable=True, minimap_visible=False)
            ...
            # self.move_user_to_pos(pos=[8700,-4950,2800], rot=[0,0,0])
...
class Archeon_Arrive(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_5__1$', duration=6500)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[10001,10002,10003,10004,10005,10006,10007,10008,10009,10010,10011,10012,10013,10014,10015,10016,10017,10018,10019,10020,10021,10022,10023,10024,10025,10026,10027,10028,10029]):
            ...
            self.side_npc_talk(type='talk', npc_id=11004582, illust='Eone_serious', script='$52100302_QD__FIELD_5__2$', duration=5000)
...
class Archeon_Move2_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1500):
            ...
            self.set_portal(portal_id=10007, visible=False, enable=True, minimap_visible=False)
            # self.set_portal(portal_id=10008, visible=False, enable=True, minimap_visible=False)
...
class 마를레네_연출_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004680, illust_id='Eone_normal', align='right', msg='$52100302_QD__FIELD_5__3$', duration=4000)
...
class 마를레네_연출_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=999, sequence_name='Talk_A', duration=8000)
        self.add_cinematic_talk(npc_id=11004680, illust_id='Eone_normal', align='right', msg='$52100302_QD__FIELD_5__4$', duration=4000)
        self.add_cinematic_talk(npc_id=11004680, illust_id='Eone_normal', align='right', msg='$52100302_QD__FIELD_5__5$', duration=4000)
