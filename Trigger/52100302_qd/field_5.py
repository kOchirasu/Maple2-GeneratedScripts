...
class Archeon_Move1_0(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class Archeon_Arrive(common.Trigger):
    def on_enter(self):
...
class Archeon_Move2_1(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class Archeon_Leave(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[9100]):
            return Archeon_OffDelay(self.ctx)


class Archeon_OffDelay(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1500):
            return Archeon_Off(self.ctx)


class Archeon_Off(common.Trigger):
    def on_enter(self):
...
class 마를레네_연출_02(common.Trigger):
    def on_enter(self):
...
class 마를레네_연출_03(common.Trigger):
    def on_enter(self):
...
class 마를레네_연출_04(common.Trigger):
    def on_enter(self):
...
class 마를레네_연출_05(common.Trigger):
    def on_enter(self):
...
class 마를레네_연출_06(common.Trigger):
    def on_enter(self):
