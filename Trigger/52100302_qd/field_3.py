...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_interact_object(triggerIds=[12000513], state=2)
        self.set_interact_object(triggerIds=[12000514], state=2)
        self.set_interact_object(triggerIds=[12000515], state=2)
        self.set_interact_object(triggerIds=[12000516], state=2)
        self.set_interact_object(triggerIds=[12000517], state=2)
        self.set_interact_object(triggerIds=[12000518], state=2)
...
class ArriveBlock_Delay_1(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.monster_dead(boxIds=[1110,1303,1304,1309,1310,1311,1312,1313,1314]):
            ...
            self.set_interact_object(triggerIds=[12000513], state=1)
...
class ArriveBlock_Delay_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.monster_dead(boxIds=[1111,1301,1302,1321,1322,1323,1324,1325,1326]):
            self.set_ai_extra_data(key='BossDie', value=2)
            self.set_interact_object(triggerIds=[12000514], state=1)
            self.set_interact_object(triggerIds=[12000515], state=1)
            self.create_monster(spawnIds=[1114], animationEffect=False)
            self.create_monster(spawnIds=[1115], animationEffect=False)
            self.create_monster(spawnIds=[1116], animationEffect=False)
            self.create_monster(spawnIds=[1401,1402,1403,1404,1405,1406,1407,1408,1409,1410], animationEffect=False)
...
class ArriveBlock_Delay_3(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.monster_dead(boxIds=[1112,1307,1308,1327,1328,1329,1330,1331,1332]):
            self.set_ai_extra_data(key='BossDie', value=2)
            self.set_interact_object(triggerIds=[12000516], state=1)
            self.set_interact_object(triggerIds=[12000517], state=1)
            self.create_monster(spawnIds=[1114], animationEffect=False)
            self.create_monster(spawnIds=[1115], animationEffect=False)
            self.create_monster(spawnIds=[1116], animationEffect=False)
            self.create_monster(spawnIds=[1401,1402,1403,1404,1405,1406,1407,1408,1409,1410], animationEffect=False)
...
class ArriveBlock_Delay_4(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.monster_dead(boxIds=[1113,1305,1306,1315,1316,1317,1318,1319,1320]):
            self.set_ai_extra_data(key='BossDie', value=2)
            self.set_interact_object(triggerIds=[12000518], state=1)
            self.create_monster(spawnIds=[1114], animationEffect=False)
            self.create_monster(spawnIds=[1115], animationEffect=False)
            self.create_monster(spawnIds=[1116], animationEffect=False)
            self.create_monster(spawnIds=[1401,1402,1403,1404,1405,1406,1407,1408,1409,1410], animationEffect=False)
...
class Block_4(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(boxIds=[1113,1305,1306,1315,1316,1317,1318,1319,1320]):
            self.destroy_monster(spawnIds=[2007], arg2=False)
            self.set_interact_object(triggerIds=[12000518], state=1)
            self.create_monster(spawnIds=[1114], animationEffect=False)
            self.create_monster(spawnIds=[1115], animationEffect=False)
            self.create_monster(spawnIds=[1116], animationEffect=False)
...
class CableOn_13(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000513], stateValue=0):
...
class CableOn_14_15(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000514], stateValue=0):
        ...
        if self.object_interacted(interactIds=[12000515], stateValue=0):
...
class CableOn_16_17(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000516], stateValue=0):
        ...
        if self.object_interacted(interactIds=[12000517], stateValue=0):
            self.set_interact_object(triggerIds=[12000516], state=0)
            self.set_interact_object(triggerIds=[12000517], state=0)
...
class CableOn_18(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.object_interacted(interactIds=[12000518], stateValue=0):
