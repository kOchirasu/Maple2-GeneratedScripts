...
class 룬블영상준비_01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=2000):
            return 룬블영상재생_01(self.ctx)


class 룬블영상재생_01(common.Trigger):
    def on_enter(self):
        self.create_widget(type='SceneMovie')
        self.widget_action(type='SceneMovie', func='Clear')
...
class 룬블영상완료_01(common.Trigger):
    def on_enter(self):
...
class 키타입설정안내01(common.Trigger):
    def on_enter(self):
...
class 퀘스트수락유도01(common.Trigger):
    def on_enter(self):
