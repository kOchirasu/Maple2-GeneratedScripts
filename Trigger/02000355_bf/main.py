...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3999], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3900], visible=True, start_delay=0, interval=0, fade=0)
        ...
        self.set_mesh(trigger_ids=[3801,3802,3803,3804,3805,3806,3807,3808], visible=False, start_delay=0, interval=0, fade=0)
...
class 카드반교체(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=299, visible=False, initial_sequence='Dead_Idle_A')
...
class 연출종료(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=1500):
            self.set_mesh(trigger_ids=[3900], visible=False, start_delay=0, interval=0, fade=0)
...
class 연출종료2(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=500):
            self.dungeon_clear()
            self.set_mesh(trigger_ids=[3801,3802,3803,3804,3805,3806,3807,3808], visible=True, start_delay=0, interval=50, fade=2)
