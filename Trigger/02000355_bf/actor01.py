...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_actor(triggerId=201, visible=True, initialSequence='Damg_B')
...
class 더미해제(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(triggerId=201, visible=False, initialSequence='Damg_B')
...
class 리젠준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(triggerId=201, visible=True, initialSequence='Regen_A')
