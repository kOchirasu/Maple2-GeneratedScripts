...
class 연출시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,2001,2002], auto_target=True)
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001230, script='$52000031_QD__MAIN__0$', time=3, arg5=0)
...
class 연출시작10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11000076, script='$52000031_QD__MAIN__1$', time=3, arg5=0)
...
class 연출시작20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001581, script='$52000031_QD__MAIN__2$', time=3, arg5=0)
...
class 연출시작30(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000032, script='$52000031_QD__MAIN__3$', time=5, arg5=0)
...
class 연출시작40(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001578, script='$52000031_QD__MAIN__4$', time=3, arg5=0)
...
class 연출시작50(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11000015, script='$52000031_QD__MAIN__5$', time=3, arg5=0)
...
class 연출시작60(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001583, script='$52000031_QD__MAIN__6$', time=3, arg5=0)
...
class 연출시작70(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001586, script='$52000031_QD__MAIN__7$', time=3, arg5=0)
...
class 연출시작80(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001584, script='$52000031_QD__MAIN__8$', time=3, arg5=0)
...
class 차전투2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[2003,2004], auto_target=True)
...
class 렌듀비앙대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001230, script='$52000031_QD__MAIN__9$', time=3, arg5=0)
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000031_QD__MAIN__10$', time=3, arg5=0)
...
class 유페리아대사_기타음성1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001564, script='$52000031_QD__MAIN__11$', time=3, arg5=0)
...
class 이슈라외침01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000031_QD__MAIN__12$', time=2, arg5=0)

    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=2000):
            self.move_user(map_id=52000032, portal_id=0)
            return 종료(self.ctx)
