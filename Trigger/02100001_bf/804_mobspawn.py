...
class Wait(state.State):
    def on_enter(self):
        ...
        set_mesh(triggerIds=[3204], visible=False, arg3=0, arg4=0, arg5=0) # Egg
...
class MobSpawn(state.State):
    def on_enter(self):
        create_monster(spawnIds=[804], arg2=False)
        set_mesh(triggerIds=[3204], visible=True, arg3=0, arg4=0, arg5=0) # Egg
