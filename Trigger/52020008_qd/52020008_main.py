...
class 연출카메라1_세리하대사1(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_크란츠대사1(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_PC대사1(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_이오네대사1(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_세리하대사2(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=503, enable=True)
...
class 연출카메라1_흑성회등장(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=501, enable=True)
...
class 연출카메라1_탈출장치(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_벽부수기세팅(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_레지스탕스등장(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_체키대사1(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_세리하대사3(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=504, enable=True)
...
class 연출카메라1_세리하대사4(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_체키대사2(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=502, enable=True)
        self.set_visible_breakable_object(triggerIds=[6001,6002], visible=False)
        self.set_visible_breakable_object(triggerIds=[7001,7002], visible=False)
...
class 연출카메라1_체키대사3(common.Trigger):
    def on_enter(self):
...
class 연출카메라1_세리하대사5(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=501, enable=True)
