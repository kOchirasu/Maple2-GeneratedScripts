...
class 연출출력체크50001536(common.Trigger):
...
class 디나대화05To1(common.Trigger):
    def on_enter(self):
...
class 검사시네마틱대사02(common.Trigger):
    def on_enter(self):
