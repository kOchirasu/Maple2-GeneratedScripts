...
class 웨이브1알림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[2400,2401,2402,2403,2404], visible=True, start_delay=0, interval=200) # #####1번 지역 리젠 알림#####
...
class 웨이브2알림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[2500,2501,2502,2503,2504], visible=True, start_delay=0, interval=200) # #####2번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2606], visible=True)
...
class 웨이브3알림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[2600,2601,2602,2603,2604], visible=True, start_delay=0, interval=200) # #####2번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2606], visible=True)
...
class 웨이브5알림(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[2400,2401,2402,2403,2404], visible=True, start_delay=0, interval=200) # #####2번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2600,2601,2602,2603,2604], visible=True, start_delay=0, interval=200) # #####1번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2606], visible=True)
