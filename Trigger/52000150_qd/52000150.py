...
class Wait01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[2605], visible=False)
...
class 차원의숲전경씬02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$52000150_QD__52000150__8$', desc='$52000150_QD__52000150__9$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=5500, scale=2.5)
...
class 결계흑화연출03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003439, msg='$52000150_QD__52000150__1$', duration=4000, align='right') # 호르헤 대사
...
class 결계흑화연출03_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=201, sequence_name='Traped_Idle', duration=999999)
...
class 결계흑화연출04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003442, msg='$52000150_QD__52000150__2$', duration=5000, align='right') # 케이틀린 대사
...
class 결계흑화연출05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=202, sequence_name='Attack_Idle_A', duration=999999)
        self.set_effect(trigger_ids=[2606], visible=True)
        self.select_camera_path(path_ids=[3004,3005], return_view=False)
        self.add_cinematic_talk(npc_id=11003442, msg='$52000150_QD__52000150__3$', duration=5000, align='right') # 케이틀린 대사
        # ########################선생님!! 정신 차리세요, 선생님!!!!########################
...
class 결계흑화연출06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[2300,2301,2302,2303,2304], visible=True, start_delay=0, interval=200) # #####2번 지역 리젠 알림#####
...
class 결계흑화연출07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003442, msg='$52000150_QD__52000150__4$', duration=4000, align='right') # 케이틀린 대사
...
class 결계흑화연출08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[2500,2501,2502,2503,2504], visible=True, start_delay=400, interval=200) # #####2번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2600,2601,2602,2603,2604], visible=True, start_delay=600, interval=200) # #####2번 지역 리젠 알림#####
        self.add_cinematic_talk(npc_id=11003442, msg='$52000150_QD__52000150__5$', duration=4000, align='right') # 케이틀린 대사
        # ########################…어떤 대가를 치루더라도…당신 만큼은…########################
...
class 결계흑화연출09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003442, msg='$52000150_QD__52000150__6$', duration=4000, align='right') # 케이틀린 대사
...
class 결계흑화연출10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003442, msg='$52000150_QD__52000150__7$', duration=4000, align='right') # 케이틀린 대사
        # ########################MyPcName!! 어서 준비해!########################
...
class Skip_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=4)
        self.set_effect(trigger_ids=[2605], visible=False)
        self.set_effect(trigger_ids=[2606], visible=False)
        self.set_effect(trigger_ids=[2607], visible=False)
        self.set_effect(trigger_ids=[2608], visible=False)
        self.set_effect(trigger_ids=[2300,2301,2302,2303,2304], visible=False, start_delay=0, interval=200) # #####2번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2400,2401,2402,2403,2404], visible=False, start_delay=200, interval=200) # #####1번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2500,2501,2502,2503,2504], visible=False, start_delay=400, interval=200) # #####2번 지역 리젠 알림#####
        self.set_effect(trigger_ids=[2600,2601,2602,2603,2604], visible=False, start_delay=600, interval=200) # #####2번 지역 리젠 알림#####
        self.move_user(map_id=52000150, portal_id=10)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
        self.set_onetime_effect(id=2, enable=False, path='BG/Common/ScreenMask/Eff_CameraMasking_FastFadeIn.xml')
...
class 아노스흑화전대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003440, msg='$52000150_QD__52000150__11$', duration=4000, align='right') # 아노스 대사
...
class 아노스흑화전대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003442, illust_id='Caitlyn_serious', msg='$52000150_QD__52000150__12$', duration=3000, align='right') # 케이틀린 대사
...
class 아노스흑화전대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003440, msg='$52000150_QD__52000150__13$', duration=3000, align='right') # 아노스 대사
        # #######################아노스#윽…!\n으으…으아아!!###scriptkey:없음####################
...
class 아노스흑화전대사04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.select_camera_path(path_ids=[3002], return_view=False)
        self.add_cinematic_talk(npc_id=11003442, illust_id='Caitlyn_serious', msg='$52000150_QD__52000150__14$', duration=3000, align='right') # 케이틀린 대사
...
class 아노스흑화전대사05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003438, illust_id='Horrhe_normal', msg='$52000150_QD__52000150__15$', duration=3000, align='left') # 호르헤 대사
...
class 아노스흑화전대사06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003440, msg='$52000150_QD__52000150__16$', duration=3000, align='right') # 아노스 대사
...
class 아노스흑화07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_time_scale(enable=True, start_scale=0.5, end_scale=0.3, duration=15, interpolator=1) # 2초간 느려지기 시작
