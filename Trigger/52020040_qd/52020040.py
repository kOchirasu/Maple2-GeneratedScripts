...
class 크리티아스로_02(common.Trigger):
    def on_enter(self):
...
class 크리티아스로_02_01(common.Trigger):
    def on_enter(self):
...
class 크리티아스로_03(common.Trigger):
    def on_enter(self):
...
class 크리티아스로_04(common.Trigger):
    def on_enter(self):
...
class 경보끝_02_01(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=101, enable=False, path='BG/Common/Eff_Com_Vibrate_Short.xml')
...
class 경보끝_02_02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=4000):
            return 경보끝_02(self.ctx)


class 경보끝_02(common.Trigger):
    def on_enter(self):
