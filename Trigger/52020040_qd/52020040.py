...
class 크리티아스로_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Talk_B', duration=1E+11)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='left', msg='$52020040_QD__52020040__0$', duration=3000)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_smile', align='right', msg='$52020040_QD__52020040__1$', duration=3000)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='left', msg='$52020040_QD__52020040__2$', duration=3000)
...
class 크리티아스로_02_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='HorizonCaption', title='$52020040_QD__52020040__3$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=5000, scale=2.5)
...
class 크리티아스로_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004436, illust_id='Schatten_smile', align='left', msg='$52020040_QD__52020040__4$', duration=3000)
        self.add_cinematic_talk(npc_id=11004438, illust_id='Mason_closeEye', align='right', msg='$52020040_QD__52020040__5$', duration=3000)
        self.add_cinematic_talk(npc_id=11004435, illust_id='Conder_smile', align='left', msg='$52020040_QD__52020040__6$', duration=3000)
...
class 크리티아스로_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004435, illust_id='Conder_normal', align='left', msg='$52020040_QD__52020040__7$', duration=2500)
...
class 경보_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__8$', duration=2500)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__9$', duration=2800)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='right', msg='$52020040_QD__52020040__10$', duration=2800)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__11$', duration=2800)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='right', msg='$52020040_QD__52020040__12$', duration=2400)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__13$', duration=2800)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_mad', align='right', msg='$52020040_QD__52020040__14$', duration=2800)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__15$', duration=2400)
...
class 경보끝_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004435, illust_id='Conder_normal', align='right', msg='$52020040_QD__52020040__19$', duration=3000)
...
class 경보끝_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__20$', duration=2800)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__21$', duration=2800)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__22$', duration=3000)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='right', msg='$52020040_QD__52020040__23$', duration=3000)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='right', msg='$52020040_QD__52020040__24$', duration=3000)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_surprise', align='left', msg='$52020040_QD__52020040__25$', duration=3000)
        self.add_cinematic_talk(npc_id=11004435, illust_id='Conder_normal', align='right', msg='$52020040_QD__52020040__26$', duration=3000)
        self.add_cinematic_talk(npc_id=11004436, illust_id='Schatten_surprise', align='left', msg='$52020040_QD__52020040__27$', duration=3000)
        self.add_cinematic_talk(npc_id=11004435, illust_id='Conder_normal', align='right', msg='$52020040_QD__52020040__28$', duration=2500)
        self.add_cinematic_talk(npc_id=11004438, illust_id='Mason_normal', align='left', msg='$52020040_QD__52020040__29$', duration=3000)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='right', msg='$52020040_QD__52020040__30$', duration=2500)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_normal', align='right', msg='$52020040_QD__52020040__31$', duration=3000)
        self.add_cinematic_talk(npc_id=11004438, illust_id='Mason_normal', align='left', msg='$52020040_QD__52020040__32$', duration=3000)
...
class 경보끝_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # self.set_pc_emotion_loop(sequence_name='Talk_A', duration=1E+13)
        self.add_cinematic_talk(npc_id=11004438, illust_id='Mason_normal', msg='$52020040_QD__52020040__34$', align='left', duration=3000)
        ...
        self.add_cinematic_talk(npc_id=11004436, illust_id='Schatten_surprise', align='left', msg='$52020040_QD__52020040__37$', duration=3500)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_normal', align='right', msg='$52020040_QD__52020040__38$', duration=3000)
        self.add_cinematic_talk(npc_id=0, msg='$52020040_QD__52020040__39$', duration=3000)
        self.add_cinematic_talk(npc_id=11004434, illust_id='Bliche_closeEye', align='left', msg='$52020040_QD__52020040__40$', duration=2800)
        self.add_cinematic_talk(npc_id=11004437, illust_id='Neirin_normal', align='right', msg='$52020040_QD__52020040__41$', duration=3000)
