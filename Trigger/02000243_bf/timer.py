...
class 초재기2(state.State):
    def on_enter(self):
        set_timer(timerId='99', seconds=3)
        set_event_ui(type=1, arg2='$02000243_BF__TIMER__0$', arg3='3000', arg4='0')
...
class 딜레이(state.State):
    def on_enter(self):
        set_timer(timerId='99', seconds=3)
        set_event_ui(type=1, arg2='$02000243_BF__TIMER__1$', arg3='3000', arg4='0')
...
class 초재기3(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02000243_BF__TIMER__2$', arg3='5000', arg4='0')
