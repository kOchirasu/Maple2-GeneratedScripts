...
class 몬스터체크(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entityId=1, textId=26300739, duration=10000)
...
class 길을열어라(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.hide_guide_summary(entityId=1)
...
class 문열기00(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entityId=2, textId=26300740, duration=10000)
