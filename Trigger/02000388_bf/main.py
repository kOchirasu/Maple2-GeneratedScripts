...
class mermaid_02_talk(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000388_BF__MAIN__0$', time=2, arg5=0)
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$02000388_BF__MAIN__2$', time=3, arg5=0)
...
class open_door_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000388_BF__MAIN__6$', time=2, arg5=0)
...
class battle_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_local_camera(camera_id=8100, enable=True) # LocalTargetCamera
        self.set_dialogue(type=1, spawn_id=102, script='$02000388_BF__MAIN__8$', time=2, arg5=0)
...
class open_door_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=101, script='$02000388_BF__MAIN__12$', time=2, arg5=0)
...
class battle_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000388_BF__MAIN__13$', time=2, arg5=0)
...
class battle_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$02000388_BF__MAIN__15$', time=2, arg5=0)
...
class ship_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=102, script='$02000388_BF__MAIN__17$', time=2, arg5=0)
...
class ending_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_user(map_id=2000389, portal_id=0)
