...
class 웨이홍_대사01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11003124, script='$02000337_BF__BOSS__0$', arg4=3) # 웨이홍 대사
...
class 웨이홍_대사02(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11003124, script='$02000337_BF__BOSS__1$', arg4=3) # 웨이홍 대사
        set_skip(state=종료)
        set_timer(timerId='3', seconds=3, display=False)
...
class 웨이홍_대사03(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11003124, script='$02000337_BF__BOSS__2$', arg4=3) # 웨이홍 대사
        set_skip(state=종료)
