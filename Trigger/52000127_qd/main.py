...
# PC 꿈
class dreamscene_01(common.Trigger):
    def on_enter(self):
...
class dreamscene_02(common.Trigger):
    def on_enter(self):
...
class dreamscene_03(common.Trigger):
    def on_enter(self):
...
class dreamscene_04(common.Trigger):
    def on_enter(self):
...
class dreamscene_05(common.Trigger):
    def on_enter(self):
...
class dreamscene_06(common.Trigger):
    def on_enter(self):
...
class dreamscene_07(common.Trigger):
    def on_enter(self):
