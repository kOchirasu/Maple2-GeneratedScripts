...
class TalkKay03(common.Trigger):
    def on_enter(self):
...
class TalkKay04(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7205], visible=False) # Voice Speenchi 03000907
...
class TalkKay10(common.Trigger):
    def on_enter(self):
...
class TalkKay11(common.Trigger):
    def on_enter(self):
...
class FirstChampoin01(common.Trigger):
    def on_enter(self):
...
class FirstChampoin02(common.Trigger):
    def on_enter(self):
...
class FirstChampoin03(common.Trigger):
    def on_enter(self):
...
class FirstChampoin04(common.Trigger):
    def on_enter(self):
...
class FirstChampoin05(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7207], visible=False) # Voice Speenchi 03000909
        self.remove_cinematic_talk()
        self.set_cinematic_ui(type=1)
...
class FirstChampoin06(common.Trigger):
    def on_enter(self):
...
class FirstBattle02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7210], visible=False) # Voice Speenchi 03000912
        self.remove_cinematic_talk()
        self.set_skip()
...
class FirstBattle03(common.Trigger):
    def on_enter(self):
...
class SecondChampoin01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class SecondChampoin02(common.Trigger):
    def on_enter(self):
...
class SecondChampoin03(common.Trigger):
    def on_enter(self):
...
class SecondChampoin04(common.Trigger):
    def on_enter(self):
...
class SecondChampoin05(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7208], visible=False) # Voice Speenchi 03000910
        self.remove_cinematic_talk()
        self.set_cinematic_ui(type=1)
...
class SecondChampoin06(common.Trigger):
    def on_enter(self):
        self.move_user(mapId=63000020, portalId=2)
...
class SecondBattle02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7210], visible=False) # Voice Speenchi 03000912
        self.remove_cinematic_talk()
        self.set_skip()
...
class SecondBattle03(common.Trigger):
    def on_enter(self):
...
class ThirdChampoin01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera_path(pathIds=[600,601], returnView=False)
...
class ThirdChampoin02(common.Trigger):
    def on_enter(self):
...
class ThirdChampoin03(common.Trigger):
    def on_enter(self):
...
class ThirdChampoin04(common.Trigger):
    def on_enter(self):
...
class ThirdChampoin05(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7209], visible=False) # Voice Speenchi 03000911
        self.remove_cinematic_talk()
        self.set_cinematic_ui(type=1)
...
class ThirdChampoin06(common.Trigger):
    def on_enter(self):
        self.move_user(mapId=63000020, portalId=2)
...
class ThirdBattle02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7210], visible=False) # Voice Speenchi 03000912
        self.remove_cinematic_talk()
        self.set_skip()
...
class ThirdBattle03(common.Trigger):
    def on_enter(self):
...
class TalkKay20(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class TalkKay21(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Talk_A')
        self.select_camera(triggerId=502, enable=True)
...
class TalkKay22(common.Trigger):
    def on_enter(self):
...
# PC 현기증 Blur
class PCFeelDizzy01(common.Trigger):
    def on_enter(self):
...
class PCFeelDizzy02(common.Trigger):
    def on_enter(self):
...
class PCFeelDizzy03(common.Trigger):
    def on_enter(self):
...
class PCFeelDizzy04(common.Trigger):
    def on_enter(self):
...
class PCFeelOkay01(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7001], visible=False) # VibrateDizzy
...
class PCFeelOkay02(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=703, enable=True)
...
class PCFeelOkay03(common.Trigger):
    def on_enter(self):
...
class PCFeelOkay04(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[6000], visible=True) # RingBellStart
...
class TalkKay23(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Talk_A')
...
class TalkKay24(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class TalkKay25(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7200], visible=False) # Voice Speenchi 03000902
...
class TalkKay26(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Talk_A')
...
class TalkKay27(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Idle_A')
        self.remove_cinematic_talk()
        self.set_skip()
...
class TalkKay28(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera(triggerId=502, enable=True)
...
class TalkKay29(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7202], visible=False) # Voice Speenchi 03000904
        self.remove_cinematic_talk()
        self.set_skip()
...
class LastChampoin01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.select_camera(triggerId=601, enable=True)
...
class LastChampoin02(common.Trigger):
    def on_enter(self):
...
class LastChampoin03(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Talk_A')
...
class LastChampoin04(common.Trigger):
    def on_enter(self):
...
class LastChampoin05(common.Trigger):
    def on_enter(self):
...
class LastChampoin06(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7203], visible=False) # Voice Speenchi 03000905
        self.remove_cinematic_talk()
        self.set_cinematic_ui(type=1)
...
class LastChampoin07(common.Trigger):
    def on_enter(self):
        self.move_user(mapId=63000020, portalId=2)
...
class LastBattle01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_npc_emotion_sequence(spawnId=101, sequenceName='Talk_A')
...
# 조정 필요
class LastBattle02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7204], visible=False) # Voice Speenchi 03000906
        self.remove_cinematic_talk()
        self.set_skip()
...
class LastBattle03(common.Trigger):
    def on_enter(self):
...
class LastBattle04(common.Trigger):
    def on_enter(self):
...
class TalkChen10(common.Trigger):
    def on_enter(self):
...
class TalkChen11(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7100], visible=False) # Voice VasaraChen 00001349
        self.remove_cinematic_talk()
...
class BattleStart02(common.Trigger):
    def on_enter(self):
        self.set_agent(triggerIds=[8000], visible=False)
        self.set_agent(triggerIds=[8001], visible=False)
        self.set_agent(triggerIds=[8002], visible=False)
...
class CameraAct01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class CameraAct02(common.Trigger):
    def on_enter(self):
...
class PCAttack01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class PCAttack02(common.Trigger):
    def on_enter(self):
...
class KnockBack01(common.Trigger):
    def on_enter(self):
...
class KnockBack02(common.Trigger):
    def on_enter(self):
...
class KnockBack03(common.Trigger):
    def on_enter(self):
...
# PC 1인칭 시점 Blur 연출
class BlurAct01(common.Trigger):
    def on_enter(self):
...
class BlurAct02(common.Trigger):
    def on_enter(self):
...
class BlurAct03(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=3000):
            return BlurAct04(self.ctx)


class BlurAct04(common.Trigger):
    def on_enter(self):
...
class BlurAct05(common.Trigger):
    def on_enter(self):
...
class BlurAct06(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class BlurAct07(common.Trigger):
    def on_enter(self):
...
class BlurAct08(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class TalkChen01(common.Trigger):
    def on_enter(self):
...
class TalkChen02(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7101], visible=False) # Voice VasaraChen 00001350
        self.remove_cinematic_talk()
        self.set_skip()
...
class TalkChen03(common.Trigger):
    def on_enter(self):
...
class TalkChen04(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7103], visible=False) # Voice VasaraChen 00001374
        self.remove_cinematic_talk()
        self.set_skip()
...
class TalkChen05(common.Trigger):
    def on_enter(self):
...
class TalkChen06(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class LastAttack00(common.Trigger):
    def on_enter(self):
...
class LastAttack01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.add_buff(boxIds=[9900], skillId=70000095, level=1)
...
class LastAttack02(common.Trigger):
    def on_enter(self):
...
class LastAttack03(common.Trigger):
    def on_enter(self):
...
class PCFainted02(common.Trigger):
    def on_enter(self):
        self.add_buff(boxIds=[9900], skillId=70000095, level=1)
...
class PCFainted03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class PlayerDown01(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class PlayerDown02(common.Trigger):
    def on_enter(self):
        self.add_buff(boxIds=[9900], skillId=70000096, level=1)
...
class PlayerDown03(common.Trigger):
    def on_enter(self):
...
class PlayerDown04(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class PlayerDown05(common.Trigger):
    def on_enter(self):
...
class PlayerDown06(common.Trigger):
    def on_enter(self):
...
class PlayerDown07(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
