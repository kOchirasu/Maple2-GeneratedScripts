...
class 삼자대면_02_01(common.Trigger):
    def on_enter(self):
...
class 삼자대면_02_02(common.Trigger):
    def on_enter(self):
...
class 삼자대면_02_03(common.Trigger):
    def on_enter(self):
...
class 삼자대면_02_04(common.Trigger):
    def on_enter(self):
...
class 삼자대면_03_00(common.Trigger):
    def on_enter(self):
...
class 삼자대면_03_01(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_loop(spawnId=101, sequenceName='Talk_A', duration=5000)
...
class 삼자대면_03_02(common.Trigger):
    def on_enter(self):
...
class 삼자대면_03_03(common.Trigger):
    def on_enter(self):
...
class 삼자대면_03_04(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_loop(spawnId=102, sequenceName='Talk_A', duration=4500)
...
class 삼자대면_04_01(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_loop(spawnId=102, sequenceName='Talk_A', duration=4500)
...
class 삼자대면_04_02(common.Trigger):
    def on_enter(self):
