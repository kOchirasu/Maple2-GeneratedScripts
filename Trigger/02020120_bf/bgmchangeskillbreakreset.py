...
class Ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portalId=1220, visible=False, enable=False, minimapVisible=False)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(boxId=299, minUsers='1'):
...
class 던전시간작동대기(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(boxId=399, minUsers='1'):
...
class 스킬브레이크신호대기_BGM교체(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_sound(triggerId=19600, enable=True)
...
class 스킬브레이크실패초기화처리(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portalId=1220, visible=True, enable=True, minimapVisible=True)
