...
class 던전미션_체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.check_npc_extra_data(spawnPointID='99', extraDataKey='brokenShieldRemainTick', extraDataValue='8000', operator='GreaterEqual') and self.check_npc_additional_effect(spawnId=99, additionalEffectId=70002171, level=1):
...
class 던전미션_스킬브레이크저지_성공(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dungeon_mission_complete(missionId=23037004)
