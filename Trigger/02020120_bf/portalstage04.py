...
class 스테이지4_왼쪽_왼쪽진행(common.Trigger):
    def on_enter(self):
...
class 스테이지4_왼쪽_왼쪽가운데진행(common.Trigger):
    def on_enter(self):
...
class 스테이지4_가운데_왼쪽가운데진행(common.Trigger):
    def on_enter(self):
...
class 스테이지4_가운데_오른쪽가운데진행(common.Trigger):
    def on_enter(self):
...
class 스테이지4_오른쪽_오른쪽가운데진행(common.Trigger):
    def on_enter(self):
...
class 스테이지4_오른쪽_오른쪽진행(common.Trigger):
    def on_enter(self):
