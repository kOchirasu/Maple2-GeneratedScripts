...
class 시작대기중(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1920,1921,1922,1923,1924,1925,1926,1927,1928,1929,1930,1931,1932,1933,1934,1935,1936,1937], visible=False)
...
class 보스등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portal_id=9901, visible=False, enable=False, minimap_visible=False)
...
class 던전초기화진행(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=23000113, illust='Ishura_Dark_smile', script='$02020120_BF__BOSSSPAWN__1$', duration=7000, voice='ko/Npc/00002193')
...
class 종료딜레이(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=8000):
            ...
            self.set_skill(trigger_ids=[2222], enable=False)
