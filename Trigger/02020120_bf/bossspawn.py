...
class 시작대기중(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[1920,1921,1922,1923,1924,1925,1926,1927,1928,1929,1930,1931,1932,1933,1934,1935,1936,1937], visible=False)
...
class 보스등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portalId=9901, visible=False, enable=False, minimapVisible=False)
        ...
        self.set_portal(portalId=9902, visible=False, enable=False, minimapVisible=False)
...
class 던전초기화진행(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.move_user(mapId=2020120, portalId=9903)
        # 던전 초기화 되면 노말 BGM으로 교체함, 보스 BGM 교체 설정은 BgmChangeSkillBreakReset.xml 트리거에 설정 되어있음
        self.set_sound(triggerId=19601, enable=True)
