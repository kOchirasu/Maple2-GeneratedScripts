...
class 스폰1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021], is_auto_targeting=False, score=100)
...
class 스폰2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[1022,1023,1024,1025,1026,1027,1028,1029,1030,1031,1032,1033,1034,1035,1036,1037,1038,1039,1040,1041,1042], is_auto_targeting=False, score=100)
...
class 스폰3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[1043,1044,1045,1046,1047,1048,1049,1050,1051,1052], is_auto_targeting=False, score=100)
...
class 스폰4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[1053,1054,1055,1056,1057,1058,1059], is_auto_targeting=False, score=100)
...
class 스폰5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[1060,1061,1062,1063,1064,1065,1066,1067,1068,1069,1070,1071,1072,1073], is_auto_targeting=False, score=100)
...
class 스폰6(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[1074,1075,1076,1077,1078,1079,1080,1081,1082,1083], is_auto_targeting=False, score=100)
