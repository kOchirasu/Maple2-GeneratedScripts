...
class 라오즈대사01스킵(common.Trigger):
    def on_enter(self):
...
class 라오즈대사02스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class 라오즈대사03스킵(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
