...
class 전투시작_2(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.user_value(key='summon_2_3', value=1):
...
class 몬스터소환(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=401, script='$02020027_BF__battle_1__1$', time=3, arg5=0)
        self.set_dialogue(type=1, spawn_id=403, script='$02020027_BF__battle_1__2$', time=3, arg5=0)
        self.set_dialogue(type=1, spawn_id=405, script='$02020027_BF__battle_1__3$', time=3, arg5=0)
