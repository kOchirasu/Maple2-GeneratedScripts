...
class Event_01_Idle(common.Trigger):
    def on_enter(self):
...
class real_end2(common.Trigger):
    def on_enter(self):
...
class real_end3(common.Trigger):
    def on_enter(self):
...
class real_end4(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='3', seconds=3)
