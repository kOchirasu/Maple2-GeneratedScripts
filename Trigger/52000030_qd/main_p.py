...
class 이슈라대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001578, script='$52000030_QD__MAIN_P__0$', time=2, arg5=0)
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000030_QD__MAIN_P__1$', time=3, arg5=0)
...
class 이슈라대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001230, script='$52000030_QD__MAIN_P__2$', time=2, arg5=0)
...
class 이슈라대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_dialogue(type=2, spawn_id=11001578, script='$52000030_QD__MAIN_P__3$', time=3, arg5=0)
