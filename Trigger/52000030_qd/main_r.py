...
class 이슈라대사01(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001230, script='$52000030_QD__MAIN_R__0$', arg4=3, arg5=0)
        self.set_conversation(type=2, spawnId=11000015, script='$52000030_QD__MAIN_R__1$', arg4=3, arg5=0)
...
class 이슈라대사02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_conversation(type=2, spawnId=11000015, script='$52000030_QD__MAIN_R__2$', arg4=3, arg5=0)
...
class 이슈라대사03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_conversation(type=2, spawnId=11001244, script='$52000030_QD__MAIN_R__3$', arg4=3, arg5=0)
