...
class 이슈라대사01(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000030_QD__MAIN__0$', arg4=3, arg5=0) # 음성 코드 00001301
...
class 이슈라대사02(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001230, script='$52000030_QD__MAIN__1$', arg4=2, arg5=0) # 음성 코드 00001158
...
class 이슈라대사03(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_cinematic_ui(type=3)
        self.set_effect(triggerIds=[601], visible=True)
        self.set_conversation(type=2, spawnId=11001244, script='$52000030_QD__MAIN__2$', arg4=2, arg5=0) # 음성 코드 00001158
