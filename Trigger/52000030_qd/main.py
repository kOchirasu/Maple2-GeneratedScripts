...
class 이슈라대사01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000030_QD__MAIN__0$', time=3, arg5=0) # 음성 코드 00001301
...
class 이슈라대사02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001230, script='$52000030_QD__MAIN__1$', time=2, arg5=0) # 음성 코드 00001158
...
class 이슈라대사03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.set_effect(trigger_ids=[601], visible=True)
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000030_QD__MAIN__2$', time=2, arg5=0) # 음성 코드 00001158
