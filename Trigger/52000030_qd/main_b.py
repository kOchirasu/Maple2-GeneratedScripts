...
class 이슈라대사01(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001581, script='$52000030_QD__MAIN_B__0$', arg4=3, arg5=0)
        set_conversation(type=2, spawnId=11001583, script='$52000030_QD__MAIN_B__1$', arg4=3, arg5=0)
...
class 이슈라대사02(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11001230, script='$52000030_QD__MAIN_B__2$', arg4=2, arg5=0)
...
class 이슈라대사03(state.State):
    def on_enter(self):
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        set_conversation(type=2, spawnId=11001581, script='$52000030_QD__MAIN_B__3$', arg4=3, arg5=0)
