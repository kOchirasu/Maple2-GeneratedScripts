...
class 경험치구슬01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.give_exp(box_id=100, rate=36)
...
class 그림자원정대게이지04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.shadow_expedition(type='OpenBossGauge', title='$02000401_BF__MADRICANSIEGE_Gauge$', max_gauge_point=1000)
...
class PC이동테스트05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.move_npc_to_pos(spawn_id=101, pos=[702,767,151], rot=[0,0,45])
