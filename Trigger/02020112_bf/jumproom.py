...
class 성공(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[1501,1502,1503,1504,1505,1506,1507,1508,1509], visible=False, start_delay=0, interval=20, fade=3)
        self.set_mesh(trigger_ids=[1510,1511,1512,1513,1514,1515,1516,1517,1518], visible=False, start_delay=0, interval=20, fade=3)
        self.set_mesh(trigger_ids=[1519,1520,1521,1522,1523,1524,1525,1526,1527], visible=False, start_delay=0, interval=20, fade=3)
        self.set_mesh(trigger_ids=[1528,1529,1530,1531,1532,1533,1534,1535,1536], visible=False, start_delay=0, interval=20, fade=3)
        ...
        self.set_actor(trigger_id=9907, visible=False, initial_sequence='Interaction_Lapentafoothold_A01_On')
        self.set_actor(trigger_id=9908, visible=False, initial_sequence='Interaction_Lapentafoothold_A01_On')
