...
class 대기(state.State):
    def on_enter(self):
        set_user_value(triggerId=99990015, key='Extinction_2_check', value=0)
...
class 시작(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$02020112_BF__ROOM2__0$', arg3='3000')
...
class 격리(state.State):
    def on_enter(self):
        ...
        set_event_ui(type=1, arg2='$02020112_BF__ROOM2__1$', arg3='5000', arg4='932')
...
class 종료(state.State):
    def on_enter(self):
        set_user_value(triggerId=99990015, key='Extinction_2_check', value=2)
