...
class eventscene_end(common.Trigger):
    def on_enter(self):
...
class fadeout_03(common.Trigger):
    def on_enter(self):
...
class fadein_03(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
# 랄프:11003187 / 조디:11003169 / 코쿤:11003171
class bossscene_01(common.Trigger):
    def on_enter(self):
...
class bossscene_02(common.Trigger):
    def on_enter(self):
...
class bossscene_03(common.Trigger):
    def on_enter(self):
...
class bossscene_04(common.Trigger):
    def on_enter(self):
...
class bossscene_05(common.Trigger):
    def on_enter(self):
...
class bossscene_06(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4010], returnView=False)
...
class bossscene_07(common.Trigger):
    def on_enter(self):
...
class fadeout_04(common.Trigger):
    def on_enter(self):
...
class fadein_04(common.Trigger):
    def on_enter(self):
...
class fadeout_05(common.Trigger):
    def on_enter(self):
