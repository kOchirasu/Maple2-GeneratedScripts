...
class intro(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[921,922,923,924,925,926,927,928,929], auto_target=True) # 기본 배치 몬스터
        self.spawn_monster(spawn_ids=[104,105], auto_target=True) # 104:랄프
...
class fadein_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Sit_Down_A', duration=900000)
...
class eventscene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.add_cinematic_talk(npc_id=11003169, illust_id='Jordy_normal', msg='$52000119_QD__MAIN__0$', duration=3000, align='Left')
...
class eventscene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000173, script='$52000119_QD__MAIN__1$', time=3, arg5=0) # 브로커 랄프
...
class eventscene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000173, script='$52000119_QD__MAIN__3$', time=3, arg5=0) # 브로커 랄프
...
class eventscene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11003171, script='$52000119_QD__MAIN__4$', time=3, arg5=0) # 코쿤
...
class eventscene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_sequence(spawn_id=101, sequence_name='Bore_A')
        self.set_dialogue(type=2, spawn_id=11000173, script='$52000119_QD__MAIN__5$', time=3, arg5=0) # 브로커 랄프
...
class hintmsg(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=0, script='$52000119_QD__MAIN__11$', time=3, arg5=0)
...
class fadeout_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[104,105,106], auto_target=True)
...
class fadein_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52000119_QD__MAIN__12$', duration=2000, delay_tick=0)
...
class bossscene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=105, sequence_name='Sit_Down_A', duration=150000)
        self.set_dialogue(type=2, spawn_id=11003187, script='$52000119_QD__MAIN__13$', time=3, arg5=0) # 랄프
...
class bossscene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11003187, script='$52000119_QD__MAIN__14$', time=3, arg5=0) # 랄프
...
class bossscene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11003187, script='$52000119_QD__MAIN__15$', time=3, arg5=0) # 랄프
...
class bossscene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_sequence(spawn_id=104, sequence_name='Bore_A')
        self.set_dialogue(type=2, spawn_id=11003187, script='$52000119_QD__MAIN__17$', time=3, arg5=0) # 랄프
...
class bossscene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11003187, script='$52000119_QD__MAIN__18$', time=3, arg5=0) # 랄프
...
class bossscene_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.face_emotion(spawn_id=0, emotion_name='Object_React_A')
        self.set_dialogue(type=2, spawn_id=11003171, script='$52000119_QD__MAIN__19$', time=3, arg5=0) # 코쿤
...
class fadeout_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[997], auto_target=True) # 999: 코쿤
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
...
class fadein_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.add_balloon_talk(spawn_id=997, msg='$52000119_QD__MAIN__21$', duration=2000, delay_tick=0)
...
class wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=104, msg='$52000119_QD__MAIN__23$', duration=2000, delay_tick=0)
