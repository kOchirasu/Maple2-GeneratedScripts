...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[105,106], auto_target=True)
...
class scene_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=105, sequence_name='Sit_Down_A', duration=6000)
        self.set_npc_emotion_sequence(spawn_id=104, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003187, msg='$52000119_QD__MAIN2__0$', duration=3000, align='Left')
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003187, msg='$52000119_QD__MAIN2__1$', duration=3000, align='Left')
        self.set_dialogue(type=1, spawn_id=105, script='$52000119_QD__MAIN2__2$', time=3, arg5=0) # 조디
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003187, msg='$52000119_QD__MAIN2__3$', duration=3000, align='Left')
        self.set_dialogue(type=1, spawn_id=105, script='$52000119_QD__MAIN2__4$', time=3, arg5=0) # 조디
...
class scene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_sequence(spawn_id=104, sequence_name='Bore_A')
        self.add_cinematic_talk(npc_id=11003187, msg='$52000119_QD__MAIN2__5$', duration=4989, align='Left')
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_sequence(spawn_id=104, sequence_name='Talk_A')
        self.add_cinematic_talk(npc_id=11003187, msg='$52000119_QD__MAIN2__6$', duration=8254, align='Left')
...
class scene_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003171, msg='$52000119_QD__MAIN2__7$', duration=3000, align='Left')
...
class scene_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003171, msg='$52000119_QD__MAIN2__8$', duration=3000, align='Left')
...
class scene_08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=106, sequence_name='Attack_Idle_A', duration=8000)
        self.add_cinematic_talk(npc_id=11003171, msg='$52000119_QD__MAIN2__9$', duration=3000, align='Left')
...
class scene_09(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.face_emotion(spawn_id=0, emotion_name='Object_React_A')
        self.add_cinematic_talk(npc_id=11003171, msg='$52000119_QD__MAIN2__10$', duration=3000, align='Left')
...
class scene_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003171, msg='$52000119_QD__MAIN2__11$', duration=3000, align='Left')
...
class fadeout_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[998], auto_target=True) # 998: 강해진 코쿤
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class msg(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=997, msg='$52000119_QD__MAIN2__14$', duration=2000, delay_tick=0)
