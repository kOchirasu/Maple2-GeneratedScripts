...
class Ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[101], auto_target=True) # 이름 없는 유령
...
class Event_Ready_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=101, msg='이름... 내 이름이 기억나지 않아...', duration=2800, delay_tick=0)
...
class Event_Ready_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=101, msg='누가 내 이름 좀 찾아줘!', duration=2800, delay_tick=0)
...
class Event_A(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=101, msg='아니야! 그건 내 이름이 적힌 책이 아니라고!', duration=2800, delay_tick=0)
...
class Event_A_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=101, msg='그건 왕의 비밀병기와 관련된 책이란 말이야!', duration=2800, delay_tick=0)
...
class Event_B(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=101, msg='$map:02020010$의 거대 병기?', duration=2800, delay_tick=0)
...
class Event_B_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=101, msg='그런 책에 내 이름이 적혀 있을 리가 없잖아!', duration=2800, delay_tick=0)
...
class Event_C(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=101, msg='그 책은! 내 일기장!', duration=2800, delay_tick=0)
...
class Event_C_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=101, msg='그래... 기억났다. 내 이름...', duration=2800, delay_tick=0)
...
class Event_D(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=102, msg='내 이름은 $npcName:11003602$.', duration=2800, delay_tick=0)
...
class Event_D_End(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=102, msg='크리티아스의 관찰자.', duration=2800, delay_tick=0)
