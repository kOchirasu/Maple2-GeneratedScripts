...
class Event_Ready_01(common.Trigger):
    def on_enter(self):
...
class Event_Ready_02(common.Trigger):
    def on_enter(self):
...
class Event_B_End(common.Trigger):
    def on_enter(self):
...
class Event_C_End(common.Trigger):
    def on_enter(self):
...
class New_Event(common.Trigger):
    def on_enter(self):
...
class Event_D_End(common.Trigger):
    def on_enter(self):
