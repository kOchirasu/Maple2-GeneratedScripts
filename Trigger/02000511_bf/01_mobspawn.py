...
class Stage01MobSpawn(common.Trigger):
    def on_enter(self):
...
class Stage01DoorOpen(common.Trigger):
    def on_enter(self):
...
class Stage02MobSpawn(common.Trigger):
    def on_enter(self):
...
class Stage02DoorOpen(common.Trigger):
    def on_enter(self):
...
class Stage03MobSpawn(common.Trigger):
    def on_enter(self):
...
class Stage03DoorOpen(common.Trigger):
    def on_enter(self):
...
class Stage04MobSpawn(common.Trigger):
    def on_enter(self):
...
class Stage04DoorOpen(common.Trigger):
    def on_enter(self):
...
class Stage05MobSpawn(common.Trigger):
    def on_enter(self):
...
class Stage05DoorOpen(common.Trigger):
    def on_enter(self):
