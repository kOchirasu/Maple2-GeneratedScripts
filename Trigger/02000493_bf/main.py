...
class 연출시작(state.State):
    def on_enter(self):
        create_monster(spawnIds=[101,102,103,111,112,113,114,115,116,119,121,122,123,124,125,126,127], arg2=False)
...
class 전투01(state.State):
    def on_tick(self) -> state.State:
        if monster_dead(boxIds=[101,102,103,111,112,113,114,115,116,119,121,122,123,124,125,126,127]):
            return 전투02()
