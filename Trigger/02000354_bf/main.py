...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[7701], visible=False)
        self.set_effect(trigger_ids=[7702], visible=False)
        self.set_effect(trigger_ids=[7703], visible=False)
        self.set_effect(trigger_ids=[7704], visible=False)
...
class 관문_03_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6111,6112,6113,6114,6115,6116,6117,6118,6119,6120,6121,6122,6123], visible=False, interval=0, fade=10) # 벽 해제
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=113, text_id=40011) # 다음 지역으로 이동하세요
...
class 관문_04_개방(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6151,6152,6153,6154,6155,6156,6157,6158,6159,6160,6161,6162,6163,6164,6165,6166], visible=False, interval=0, fade=10) # 벽 해제
        self.play_system_sound_in_box(sound='System_Space_PopUp_01')
        self.show_guide_summary(entity_id=113, text_id=40011) # 다음 지역으로 이동하세요
