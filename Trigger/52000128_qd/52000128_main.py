...
class 빅스소개_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003272, msg='$52000128_QD__52000128_MAIN__0$', duration=2000, align='left')
...
class 빅스소개_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_caption(type='VerticalCaption', title='$52000128_QD__52000128_MAIN__1$', desc='$52000128_QD__52000128_MAIN__2$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2.5)
...
class 제시소개_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003273, msg='$52000128_QD__52000128_MAIN__3$', duration=2000, align='left')
...
class 제시소개_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_caption(type='VerticalCaption', title='$52000128_QD__52000128_MAIN__4$', desc='$52000128_QD__52000128_MAIN__5$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2.5)
...
class 카일소개_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003280, msg='$52000128_QD__52000128_MAIN__6$', duration=2351, align='left')
...
class 카일소개_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_caption(type='VerticalCaption', title='$52000128_QD__52000128_MAIN__7$', desc='$52000128_QD__52000128_MAIN__8$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2.5)
...
class 퀘스트진행_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5003,5004,5005,5006,5007,5008,5009], visible=False)
...
class 잡담_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000128_QD__52000128_MAIN__9$', time=2, arg5=0)
...
class 잡담_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=104, script='$52000128_QD__52000128_MAIN__10$', time=2, arg5=0)
...
class 교도관등장_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=111, script='$52000128_QD__52000128_MAIN__21$', time=2, arg5=0)
...
class 교도관등장_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000128_QD__52000128_MAIN__11$', time=3, arg5=0)
...
class 교도관전투_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[108,110,112,114,116], auto_target=True)
...
class 교도관전투끝_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=117, sequence_name='Dead_Idle_A', duration=3600000)
        self.set_npc_emotion_loop(spawn_id=118, sequence_name='Dead_Idle_B', duration=3600000)
        self.set_npc_emotion_loop(spawn_id=119, sequence_name='Dead_Idle_B', duration=3600000)
        self.set_npc_emotion_loop(spawn_id=120, sequence_name='Dead_Idle_B', duration=3600000)
        self.set_npc_emotion_loop(spawn_id=121, sequence_name='Dead_Idle_A', duration=3600000)
...
class 전투끝_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$52000128_QD__52000128_MAIN__12$', duration=3000, align='right')
...
class 전투끝_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$52000128_QD__52000128_MAIN__13$', duration=3000, align='right')
...
class 벨마등장_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003274, msg='$52000128_QD__52000128_MAIN__14$', duration=3000, align='right')
...
class 벨마등장_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=0, msg='$52000128_QD__52000128_MAIN__15$', duration=4000, align='right')
...
class 벨마등장_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003274, msg='$52000128_QD__52000128_MAIN__16$', duration=3000, align='right')
...
class 전투후대화_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_sequence(sequence_names=['Talk_A'])
        self.add_cinematic_talk(npc_id=0, msg='$52000128_QD__52000128_MAIN__17$', duration=3000, align='right')
        self.add_cinematic_talk(npc_id=0, msg='$52000128_QD__52000128_MAIN__18$', duration=3000, align='right')
...
class 탈출_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=0, script='$52000128_QD__52000128_MAIN__19$', time=2, arg5=0)
...
class 탈출_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[8008], return_view=False)
        self.set_npc_emotion_sequence(spawn_id=105, sequence_name='Attack_01_B')
        self.add_cinematic_talk(npc_id=11003274, msg='$52000128_QD__52000128_MAIN__20$', duration=2000, align='right')
