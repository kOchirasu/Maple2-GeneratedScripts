...
class idle(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[101], auto_target=True) # 연출용 마크(11003205)
...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[301], auto_target=True) # 연출용 디나(11003214)
        self.spawn_monster(spawn_ids=[302], auto_target=True)
        self.spawn_monster(spawn_ids=[303], auto_target=True) # 연출용 디오(11003212)
...
class scene_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003205, msg='$52000125_QD__MAIN__0$', duration=3000, align='center')
...
class scene_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003214, msg='$52000125_QD__MAIN__1$', duration=3000, align='left')
...
class scene_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003214, msg='$52000125_QD__MAIN__2$', duration=3000, align='left')
...
class scene_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003213, msg='$52000125_QD__MAIN__3$', duration=3000, align='left')
...
class scene_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003205, msg='$52000125_QD__MAIN__4$', duration=3000, align='center')
...
class scene_07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003212, msg='$52000125_QD__MAIN__5$', duration=3000, align='left')
...
class winready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[304,305,306], auto_target=True)
...
class bye(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003214, msg='$52000125_QD__MAIN__10$', duration=3000, align='left')
...
class run(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003214, msg='$52000125_QD__MAIN__11$', duration=3000, align='left')
...
class end(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[102], auto_target=True) # 퀘스트용 마크(11003206)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.reset_camera(interpolation_time=0)
