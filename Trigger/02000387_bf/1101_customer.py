...
class RightItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=1101, script='$02000387_BF__1101_CUSTOMER__0$', time=3, arg5=0)
...
class WrongItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_effect_nif(spawn_id=1101)
        self.set_dialogue(type=1, spawn_id=1101, script='$02000387_BF__1101_CUSTOMER__1$', time=3, arg5=0)
