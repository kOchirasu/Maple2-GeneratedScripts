...
class RightItem(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=4204, script='$02000387_BF__4204_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(boxId=9304, spawnIds=[4204]):
...
class WrongItem(trigger_api.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4204)
        self.set_conversation(type=1, spawnId=4204, script='$02000387_BF__4204_CUSTOMER__1$', arg4=3, arg5=0)
