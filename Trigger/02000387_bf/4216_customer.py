...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[4216], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4216, patrolName='MS2PatrolData_401')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4216, patrolName='MS2PatrolData_402')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4216, patrolName='MS2PatrolData_403')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9143, spawnIds=[4216]):
...
class PickItem_30000635(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4216, nifPath='Map/Kerningcity/Indoor/ke_in_prop_tv_C01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4216)
        self.set_conversation(type=1, spawnId=4216, script='$02000387_BF__4216_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4216, patrolName='MS2PatrolData_444')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9304, spawnIds=[4216]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[4216])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4216)
        self.set_conversation(type=1, spawnId=4216, script='$02000387_BF__4216_CUSTOMER__1$', arg4=3, arg5=0)
