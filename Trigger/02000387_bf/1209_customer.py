...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1209, patrolName='MS2PatrolData_101')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1209, patrolName='MS2PatrolData_102')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1209, patrolName='MS2PatrolData_103')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9113, spawnIds=[1209]):
...
class PickItem_30000663(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=1209, nifPath='Map/Royalcity/Indoor/ry_in_prop_running_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=1209)
        self.set_conversation(type=1, spawnId=1209, script='$02000387_BF__1209_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1209, patrolName='MS2PatrolData_111')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9301, spawnIds=[1209]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[1209])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=1209)
        self.set_conversation(type=1, spawnId=1209, script='$02000387_BF__1209_CUSTOMER__1$', arg4=3, arg5=0)
