...
class CustomerEnter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.create_monster(spawnIds=[2218], animationEffect=False)
...
class Patrol01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawnId=2218, patrolName='MS2PatrolData_201')
...
class Patrol02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawnId=2218, patrolName='MS2PatrolData_202')
...
class Patrol03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawnId=2218, patrolName='MS2PatrolData_203')
...
class PatrolEnd(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(boxId=9123, spawnIds=[2218]):
            # 카운터 앞에 도착했으면
...
class WaitGreeting(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(triggerIds=[10001089], state=2)
        # Greeting
...
class PickItem_30000664(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_effect_nif(spawnId=2218, nifPath='Map/Royalcity/Indoor/ry_in_prop_trampoline_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_effect_nif(spawnId=2218)
        self.set_conversation(type=1, spawnId=2218, script='$02000387_BF__2218_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.move_npc(spawnId=2218, patrolName='MS2PatrolData_222')

    def on_tick(self) -> trigger_api.Trigger:
        if self.npc_detected(boxId=9302, spawnIds=[2218]):
            return Quit(self.ctx)


class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.destroy_monster(spawnIds=[2218])
...
class WrongItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_effect_nif(spawnId=2218)
        self.set_conversation(type=1, spawnId=2218, script='$02000387_BF__2218_CUSTOMER__1$', arg4=3, arg5=0)
