...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[2122], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2122, patrolName='MS2PatrolData_201')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2122, patrolName='MS2PatrolData_202')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2122, patrolName='MS2PatrolData_203')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9123, spawnIds=[2122]):
...
class PickItem_30000652(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=2122, nifPath='Map/Common/Indoor/co_in_prop_brazier_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000680(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=2122, nifPath='Map/Royalcity/Indoor/ry_in_prop_grill_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=2122)
        self.set_conversation(type=1, spawnId=2122, script='$02000387_BF__2122_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2122, patrolName='MS2PatrolData_222')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9302, spawnIds=[2122]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[2122])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=2122)
        self.set_conversation(type=1, spawnId=2122, script='$02000387_BF__2122_CUSTOMER__1$', arg4=3, arg5=0)
