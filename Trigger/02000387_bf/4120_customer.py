...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[4120], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4120, patrolName='MS2PatrolData_401')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4120, patrolName='MS2PatrolData_402')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4120, patrolName='MS2PatrolData_403')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9143, spawnIds=[4120]):
...
class PickItem_30000635(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4120, nifPath='Map/Kerningcity/Indoor/ke_in_prop_tv_C01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000649(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4120, nifPath='Map/Tria/Indoor/tr_in_prop_mirror_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000655(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4120, nifPath='Map/Royalcity/Indoor/ry_in_prop_amp_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000701(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4120, nifPath='Map/Common/Indoor/co_in_prop_security_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000708(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4120, nifPath='Effect/BG/Liftup/co_liftup_piano_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4120)
        self.set_conversation(type=1, spawnId=4120, script='$02000387_BF__4120_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4120, patrolName='MS2PatrolData_444')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9304, spawnIds=[4120]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[4120])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4120)
        self.set_conversation(type=1, spawnId=4120, script='$02000387_BF__4120_CUSTOMER__1$', arg4=3, arg5=0)
