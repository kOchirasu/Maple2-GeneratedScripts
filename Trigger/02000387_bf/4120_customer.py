...
class WaitGreeting(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_interact_object(trigger_ids=[10001102], state=2)
        # Greeting
...
class RightItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=4120, script='$02000387_BF__4120_CUSTOMER__0$', time=3, arg5=0)
...
class WrongItem(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.remove_effect_nif(spawn_id=4120)
        self.set_dialogue(type=1, spawn_id=4120, script='$02000387_BF__4120_CUSTOMER__1$', time=3, arg5=0)
