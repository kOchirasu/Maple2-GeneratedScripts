...
class Wait(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10001094], state=0) # Greeting
...
class Patrol01(state.State):
    def on_enter(self):
        move_npc(spawnId=3007, patrolName='MS2PatrolData_301')
...
class Patrol02(state.State):
    def on_enter(self):
        move_npc(spawnId=3007, patrolName='MS2PatrolData_302')
...
class Patrol03(state.State):
    def on_enter(self):
        move_npc(spawnId=3007, patrolName='MS2PatrolData_303')
...
class PatrolEnd(state.State):
    def on_tick(self) -> state.State:
        if npc_detected(boxId=9133, spawnIds=[3007]):
            return WaitGreeting()


class WaitGreeting(state.State):
    def on_enter(self):
        set_interact_object(triggerIds=[10001094], state=1) # Greeting

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10001094], arg2=0):
            return OrderRandomPick()

    def on_exit(self):
        set_interact_object(triggerIds=[10001094], state=2) # Greeting
...
class PickItem_30000617(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Field/co_fi_prop_game_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000618(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Field/co_fi_prop_game_A02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000619(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Field/co_fi_prop_lamp_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000619(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000619):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000619):
            return WrongItem()
...
class PickItem_30000620(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Henesys/Indoor/he_in_prop_fireplace_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000620(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000620):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000620):
            return WrongItem()
...
class PickItem_30000621(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_sandbag_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000621(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000621):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000621):
            return WrongItem()
...
class PickItem_30000622(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Iceland/Indoor/ic_in_prop_snowball_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000622(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000622):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000622):
            return WrongItem()
...
class PickItem_30000623(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_bath_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000624(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_bath_C01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000624(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000624):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000624):
            return WrongItem()
...
class PickItem_30000625(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_shower_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000626(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_fridge_C02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000626(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000626):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000626):
            return WrongItem()
...
class PickItem_30000627(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_fridge_D03.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000627(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000627):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000627):
            return WrongItem()
...
class PickItem_30000628(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_display_C01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000628(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000628):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000628):
            return WrongItem()
...
class PickItem_30000629(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_fridge_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000629(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000629):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000629):
            return WrongItem()
...
class PickItem_30000630(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_display_C02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000631(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_washstand_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000631(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000631):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000631):
            return WrongItem()
...
class PickItem_30000632(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_sink_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000632(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000632):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000632):
            return WrongItem()
...
class PickItem_30000633(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_sink_A03.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000633(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000633):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000633):
            return WrongItem()
...
class PickItem_30000634(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_tv_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000634(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000634):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000634):
            return WrongItem()
...
class PickItem_30000635(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_tv_C01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000635(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000635):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000635):
            return WrongItem()
...
class PickItem_30000636(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_toilet_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000636(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000636):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000636):
            return WrongItem()
...
class PickItem_30000637(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_washer_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000637(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000637):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000637):
            return WrongItem()
...
class PickItem_30000638(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_fan_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000638(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000638):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000638):
            return WrongItem()
...
class PickItem_30000639(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_machine_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000639(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000639):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000639):
            return WrongItem()
...
class PickItem_30000640(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_cutter_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000640(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000640):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000640):
            return WrongItem()
...
class PickItem_30000641(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Henesys/Indoor/he_in_prop_kettle_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000641(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000641):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000641):
            return WrongItem()
...
class PickItem_30000642(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_locker_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000642(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000642):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000642):
            return WrongItem()
...
class PickItem_30000643(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_locker_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000643(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000643):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000643):
            return WrongItem()
...
class PickItem_30000644(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Iceland/Indoor/ic_in_cubric_box_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000645(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Field/tr_fi_prop_swing_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000645(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000645):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000645):
            return WrongItem()
...
class PickItem_30000646(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/UGC/Indoor/ugc_in_funct_cook_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000646(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000646):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000646):
            return WrongItem()
...
class PickItem_30000647(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/UGC/Indoor/ugc_in_funct_alchemy_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000647(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000647):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000647):
            return WrongItem()
...
class PickItem_30000648(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/UGC/Indoor/ugc_in_funct_alchemy_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000648(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000648):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000648):
            return WrongItem()
...
class PickItem_30000649(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_mirror_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000649(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000649):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000649):
            return WrongItem()
...
class PickItem_30000650(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_easel_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000650(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000650):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000650):
            return WrongItem()
...
class PickItem_30000651(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_wardrop_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000651(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000651):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000651):
            return WrongItem()
...
class PickItem_30000652(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Indoor/co_in_prop_brazier_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000652(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000652):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000652):
            return WrongItem()
...
class PickItem_30000653(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_tray_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000654(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_sofa_E01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000654(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000654):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000654):
            return WrongItem()
...
class PickItem_30000655(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_amp_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000655(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000655):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000655):
            return WrongItem()
...
class PickItem_30000656(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/SF/Indoor/sf_in_prop_bed_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000656(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000656):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000656):
            return WrongItem()
...
class PickItem_30000657(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Iceland/Indoor/ic_in_prop_bed_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000657(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000657):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000657):
            return WrongItem()
...
class PickItem_30000658(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_ringer_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000659(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Indoor/co_in_prop_guestbook_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000659(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000659):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000659):
            return WrongItem()
...
class PickItem_30000660(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_display_B02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000660(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000660):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000660):
            return WrongItem()
...
class PickItem_30000661(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_cubric_fishtank_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000661(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000661):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000661):
            return WrongItem()
...
class PickItem_30000662(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_basketball_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000662(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000662):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000662):
            return WrongItem()
...
class PickItem_30000663(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_running_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000663(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000663):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000663):
            return WrongItem()
...
class PickItem_30000664(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_trampoline_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000664(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000664):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000664):
            return WrongItem()
...
class PickItem_30000665(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_baseballcart_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000665(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000665):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000665):
            return WrongItem()
...
class PickItem_30000666(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_basketball_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000666(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000666):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000666):
            return WrongItem()
...
class PickItem_30000667(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_handball_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000667(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000667):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000667):
            return WrongItem()
...
class PickItem_30000668(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_cranegame_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000669(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_chandelier_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000669(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000669):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000669):
            return WrongItem()
...
class PickItem_30000670(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_goalpost_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000670(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000670):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000670):
            return WrongItem()
...
class PickItem_30000671(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_photosticker_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000672(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_pingpong_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000673(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_pooltable_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000674(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_pump_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000675(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_sewingmachine_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000675(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000675):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000675):
            return WrongItem()
...
class PickItem_30000676(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_soccertable_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000677(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Field/ry_fi_prop_plane_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000678(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Field/ry_fi_prop_hammock_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000678(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000678):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000678):
            return WrongItem()
...
class PickItem_30000679(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Field/ry_fi_prop_yacht_A02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000680(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_grill_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000680(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000680):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000680):
            return WrongItem()
...
class PickItem_30000681(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Orient/Field/or_fi_prop_seesaw_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000681(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000681):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000681):
            return WrongItem()
...
class PickItem_30000682(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_display_E01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000682(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000682):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000682):
            return WrongItem()
...
class PickItem_30000683(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Orient/Field/or_fi_prop_ship_A02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000684(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Ludibrium/Field/lu_fi_prop_rocket_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000685(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Lith/Field/li_fi_prop_anchor_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000686(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Lith/Field/li_fi_prop_tube_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000687(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_beanbag_A02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000687(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000687):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000687):
            return WrongItem()
...
class PickItem_30000688(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_surgerylamp_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000689(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_surgery_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000690(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_sofa_D01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000690(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000690):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000690):
            return WrongItem()
...
class PickItem_30000691(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_paintbag_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000691(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000691):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000691):
            return WrongItem()
...
class PickItem_30000692(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_dresser_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000693(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_massage_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000693(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000693):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000693):
            return WrongItem()
...
class PickItem_30000694(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Indoor/ke_in_prop_catower_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000694(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000694):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000694):
            return WrongItem()
...
class PickItem_30000695(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Npc/Etc/UGC_SportsCar_Npc/UGC_SportsCar_Npc_02.nif', isOutline=True, scale=1.2, rotateZ=315)
...
class DetectItem_30000695(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000695):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000695):
            return WrongItem()
...
class PickItem_30000696(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Npc/Etc/UGC_F1RacingCar/UGC_F1RacingCar_01.nif', isOutline=True, scale=1.2, rotateZ=315)
...
class PickItem_30000697(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Npc/Etc/UGC_Poclain/UGC_Poclain_01.nif', isOutline=True, scale=1.2, rotateZ=315)
...
class PickItem_30000698(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Npc/Etc/UGC_FlameBike_Npc/UGC_FlameBike_03.nif', isOutline=True, scale=1.2, rotateZ=315)
...
class PickItem_30000699(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Field/co_fi_prop_tent_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000699(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000699):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000699):
            return WrongItem()
...
class PickItem_30000700(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Royalcity/Indoor/ry_in_prop_djtable_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000700(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000700):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000700):
            return WrongItem()
...
class PickItem_30000701(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Indoor/co_in_prop_security_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000701(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000701):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000701):
            return WrongItem()
...
class PickItem_30000702(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Tria/Indoor/tr_in_prop_workit_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000702(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000702):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000702):
            return WrongItem()
...
class PickItem_30000703(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Steampunk/Field/sp_fi_prop_anvil_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000703(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000703):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000703):
            return WrongItem()
...
class PickItem_30000704(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Steampunk/Field/sp_fi_prop_bellows_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000704(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000704):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000704):
            return WrongItem()
...
class PickItem_30000705(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Steampunk/Field/sp_fi_prop_brazier_C01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000705(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000705):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000705):
            return WrongItem()
...
class PickItem_30000706(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Indoor/co_in_prop_icebox_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000706(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000706):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000706):
            return WrongItem()
...
class PickItem_30000707(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Henesys/Indoor/he_in_prop_cushiona_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000707(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000707):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000707):
            return WrongItem()
...
class PickItem_30000708(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Effect/BG/Liftup/co_liftup_piano_B01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000708(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000708):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000708):
            return WrongItem()
...
class PickItem_30000709(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Effect/BG/Liftup/co_liftup_vibraphone_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000709(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000709):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000709):
            return WrongItem()
...
class PickItem_30000710(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Common/Indoor/co_in_prop_camera_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000710(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000710):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000710):
            return WrongItem()
...
class PickItem_30000711(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/UGC/Indoor/ugc_in_funct_workstone_G01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000711(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000711):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000711):
            return WrongItem()
...
class PickItem_30000712(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Orient/Indoor/or_in_prop_incense_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000712(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000712):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000712):
            return WrongItem()
...
class PickItem_30000713(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Steampunk/Indoor/sp_in_prop_desk_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000713(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000713):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000713):
            return WrongItem()
...
class PickItem_30000714(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/SF/Field/sf_fi_prop_incubator_D01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000714(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000714):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000714):
            return WrongItem()
...
class PickItem_30000715(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Steampunk/Field/sp_fi_prop_brazier_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class DetectItem_30000715(state.State):
    def on_tick(self) -> state.State:
        if detect_liftable_object(boxIds=[9203], itemId=30000715):
            return RightItem()
        if not detect_liftable_object(boxIds=[9203], itemId=30000715):
            return WrongItem()
...
class PickItem_30000716(state.State):
    def on_enter(self):
        ...
        add_effect_nif(spawnId=3007, nifPath='Map/Kerningcity/Field/ke_fi_prop_tire_A02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(state.State):
    def on_enter(self):
        ...
        remove_effect_nif(spawnId=3007)
        set_conversation(type=1, spawnId=3007, script='$02000387_BF__3007_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(state.State):
    def on_enter(self):
        move_npc(spawnId=3007, patrolName='MS2PatrolData_333')

    def on_tick(self) -> state.State:
        if npc_detected(boxId=9303, spawnIds=[3007]):
            return Quit()
...
class WrongItem(state.State):
    def on_enter(self):
        ...
        remove_effect_nif(spawnId=3007)
        set_conversation(type=1, spawnId=3007, script='$02000387_BF__3007_CUSTOMER__1$', arg4=3, arg5=0)
