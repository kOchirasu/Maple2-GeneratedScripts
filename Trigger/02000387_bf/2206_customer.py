...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[2206], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2206, patrolName='MS2PatrolData_201')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2206, patrolName='MS2PatrolData_202')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2206, patrolName='MS2PatrolData_203')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9123, spawnIds=[2206]):
...
class PickItem_30000682(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=2206, nifPath='Map/Kerningcity/Indoor/ke_in_prop_display_E01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=2206)
        self.set_conversation(type=1, spawnId=2206, script='$02000387_BF__2206_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=2206, patrolName='MS2PatrolData_222')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9302, spawnIds=[2206]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[2206])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=2206)
        self.set_conversation(type=1, spawnId=2206, script='$02000387_BF__2206_CUSTOMER__1$', arg4=3, arg5=0)
