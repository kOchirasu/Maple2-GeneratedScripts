...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[3103], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3103, patrolName='MS2PatrolData_301')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3103, patrolName='MS2PatrolData_302')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3103, patrolName='MS2PatrolData_303')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9133, spawnIds=[3103]):
...
class PickItem_30000677(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=3103, nifPath='Map/Royalcity/Field/ry_fi_prop_plane_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000679(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=3103, nifPath='Map/Royalcity/Field/ry_fi_prop_yacht_A02.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000684(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=3103, nifPath='Map/Ludibrium/Field/lu_fi_prop_rocket_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class PickItem_30000697(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=3103, nifPath='Npc/Etc/UGC_Poclain/UGC_Poclain_01.nif', isOutline=True, scale=1.2, rotateZ=315)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=3103)
        self.set_conversation(type=1, spawnId=3103, script='$02000387_BF__3103_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3103, patrolName='MS2PatrolData_333')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9303, spawnIds=[3103]):
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=3103)
        self.set_conversation(type=1, spawnId=3103, script='$02000387_BF__3103_CUSTOMER__1$', arg4=3, arg5=0)
