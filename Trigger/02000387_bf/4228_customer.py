...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[4228], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4228, patrolName='MS2PatrolData_401')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4228, patrolName='MS2PatrolData_402')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4228, patrolName='MS2PatrolData_403')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9143, spawnIds=[4228]):
...
class PickItem_30000659(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4228, nifPath='Map/Common/Indoor/co_in_prop_guestbook_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4228)
        self.set_conversation(type=1, spawnId=4228, script='$02000387_BF__4228_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4228, patrolName='MS2PatrolData_444')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9304, spawnIds=[4228]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[4228])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4228)
        self.set_conversation(type=1, spawnId=4228, script='$02000387_BF__4228_CUSTOMER__1$', arg4=3, arg5=0)
