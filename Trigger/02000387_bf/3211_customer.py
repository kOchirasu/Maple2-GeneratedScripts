...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[3211], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3211, patrolName='MS2PatrolData_301')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3211, patrolName='MS2PatrolData_302')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3211, patrolName='MS2PatrolData_303')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9133, spawnIds=[3211]):
...
class PickItem_30000620(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=3211, nifPath='Map/Henesys/Indoor/he_in_prop_fireplace_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=3211)
        self.set_conversation(type=1, spawnId=3211, script='$02000387_BF__3211_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=3211, patrolName='MS2PatrolData_333')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9303, spawnIds=[3211]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[3211])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=3211)
        self.set_conversation(type=1, spawnId=3211, script='$02000387_BF__3211_CUSTOMER__1$', arg4=3, arg5=0)
