...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[1213], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1213, patrolName='MS2PatrolData_101')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1213, patrolName='MS2PatrolData_102')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1213, patrolName='MS2PatrolData_103')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9113, spawnIds=[1213]):
...
class PickItem_30000691(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=1213, nifPath='Map/Tria/Indoor/tr_in_prop_paintbag_A01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=1213)
        self.set_conversation(type=1, spawnId=1213, script='$02000387_BF__1213_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=1213, patrolName='MS2PatrolData_111')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9301, spawnIds=[1213]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[1213])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=1213)
        self.set_conversation(type=1, spawnId=1213, script='$02000387_BF__1213_CUSTOMER__1$', arg4=3, arg5=0)
