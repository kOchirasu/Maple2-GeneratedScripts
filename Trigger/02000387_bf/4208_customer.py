...
class CustomerEnter(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[4208], animationEffect=False)
...
class Patrol01(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4208, patrolName='MS2PatrolData_401')
...
class Patrol02(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4208, patrolName='MS2PatrolData_402')
...
class Patrol03(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4208, patrolName='MS2PatrolData_403')
...
class PatrolEnd(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9143, spawnIds=[4208]):
...
class PickItem_30000628(common.Trigger):
    def on_enter(self):
        ...
        self.add_effect_nif(spawnId=4208, nifPath='Map/Kerningcity/Indoor/ke_in_prop_display_C01.nif', isOutline=True, scale=1.2, rotateZ=225)
...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4208)
        self.set_conversation(type=1, spawnId=4208, script='$02000387_BF__4208_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=4208, patrolName='MS2PatrolData_444')

    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9304, spawnIds=[4208]):
            return Quit(self.ctx)


class Quit(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[4208])
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=4208)
        self.set_conversation(type=1, spawnId=4208, script='$02000387_BF__4208_CUSTOMER__1$', arg4=3, arg5=0)
