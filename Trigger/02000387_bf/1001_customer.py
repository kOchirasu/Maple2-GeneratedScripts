...
class RightItem(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=1, spawnId=1001, script='$02000387_BF__1001_CUSTOMER__0$', arg4=3, arg5=0)
...
class CustomerLeave(common.Trigger):
    ...
    def on_tick(self) -> common.Trigger:
        if self.npc_detected(boxId=9301, spawnIds=[1001]):
...
class WrongItem(common.Trigger):
    def on_enter(self):
        ...
        self.remove_effect_nif(spawnId=1001)
        self.set_conversation(type=1, spawnId=1001, script='$02000387_BF__1001_CUSTOMER__1$', arg4=3, arg5=0)
