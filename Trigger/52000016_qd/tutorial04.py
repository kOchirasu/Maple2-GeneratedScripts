...
class 첫번째돌들기가이드01(common.Trigger):
    def on_enter(self):
...
class 척후병전투시작01(common.Trigger):
    def on_enter(self):
...
class 연출종료01_skip(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101]) # 전투용 척후병 삭제
...
class 마무리연출04대기(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class 마무리연출05대기(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class 마무리연출06대기(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class 마무리연출07대기(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class 마무리연출08대기(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
