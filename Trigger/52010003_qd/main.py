...
class B_Event_01(common.Trigger):
    def on_enter(self):
...
class B_Event_02_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return B_Event_02(self.ctx)


class B_Event_02(common.Trigger):
    def on_enter(self):
...
class B_Event_03_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return B_Event_03(self.ctx)


class B_Event_03(common.Trigger):
    def on_enter(self):
...
class B_Event_04_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return B_Event_04(self.ctx)


class B_Event_04(common.Trigger):
    def on_enter(self):
...
class B_Event_05_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return B_Event_05(self.ctx)


class B_Event_05(common.Trigger):
    def on_enter(self):
...
class B_Event_06_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return B_Event_06(self.ctx)


class B_Event_06(common.Trigger):
    def on_enter(self):
...
class B_Event_07_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return B_Event_07(self.ctx)


class B_Event_07(common.Trigger):
    def on_enter(self):
...
class B_Event_08_IDLE(common.Trigger):
    pass
...
class Event_02_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
...
class Event_03_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
...
class Event_04_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
...
class Event_05_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
...
class Event_06_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
...
class Event_07_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
...
class Event_08_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return Event_08(self.ctx)


class Event_08(common.Trigger):
    def on_enter(self):
...
class Event_09_IDLE(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
            return Event_09(self.ctx)


class Event_09(common.Trigger):
    def on_enter(self):
...
class PlayMovie_01(common.Trigger):
    def on_enter(self):
...
class PlayMovie_02(common.Trigger):
    def on_enter(self):
