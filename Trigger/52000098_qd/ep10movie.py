...
class Epilogue10Talk1(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk3(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk4(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk5(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk6(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk7(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk8(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk9(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk10(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk11(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk12(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk13(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk14(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk16(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk17(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class Epilogue10Talk18(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk19(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk20(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk21(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk22(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk23(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk24(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk25(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk27(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk28(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk29(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk30(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk31(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk32(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk33(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk34(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class Epilogue10Talk35(common.Trigger):
    def on_enter(self):
...
class Epilogue10Talk36(common.Trigger):
    def on_enter(self):
