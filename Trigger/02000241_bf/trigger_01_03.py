...
class 대기(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[302], visible=True, arg3=0, arg4=0, arg5=0)
...
class 버튼눌림(state.State):
    def on_enter(self):
        set_mesh(triggerIds=[302], visible=False, arg3=0, arg4=0, arg5=0)
        set_actor(triggerId=503, visible=True, initialSequence='Opened')
        set_actor(triggerId=504, visible=True, initialSequence='Opened')
        create_monster(spawnIds=[603,604], arg2=False)
        move_npc(spawnId=603, patrolName='MS2PatrolData_603')
        move_npc(spawnId=604, patrolName='MS2PatrolData_604')
