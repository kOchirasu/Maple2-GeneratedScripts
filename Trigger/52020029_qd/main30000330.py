...
class 정보검색첫번째2_1(common.Trigger):
    def on_enter(self):
...
class 정보검색첫번째3_1(common.Trigger):
    def on_enter(self):
...
class 정보검색첫번째4_2(common.Trigger):
    def on_enter(self):
...
class 정보검색첫번째4_3(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4004], returnView=False)
...
class 정보검색첫번째4_4(common.Trigger):
    def on_enter(self):
...
class 정보검색첫번째5_1(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4009], returnView=False)
        self.set_npc_emotion_loop(spawnId=103, sequenceName='Talk_A', duration=9000)
...
class 정보검색첫번째5_2(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4008], returnView=False)
...
class 정보검색첫번째5_3(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4009], returnView=False)
        self.set_npc_emotion_loop(spawnId=103, sequenceName='Talk_A', duration=3000)
...
class 정보검색첫번째7_1(common.Trigger):
    def on_enter(self):
...
class 정보검색첫번째8_1(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=104, sequenceName='Emotion_Troubled_A')
...
class 정보검색첫번째9_1(common.Trigger):
    def on_enter(self):
...
class 정보검색첫번째10(common.Trigger):
    def on_enter(self):
