...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[301,302], visible=True, start_delay=0, interval=0)
        self.set_interact_object(trigger_ids=[10000414], state=0)
        self.set_ladder(trigger_ids=[321], visible=False, enable=False)
        self.set_ladder(trigger_ids=[322], visible=False, enable=False)
        self.set_ladder(trigger_ids=[323], visible=False, enable=False)
...
class 생성(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[301,302], visible=False, start_delay=0, interval=0)
