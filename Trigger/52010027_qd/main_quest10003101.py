...
class 집에서나옴(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52010027_QD__MAIN_QUEST10003101__0$', duration=3000, delay_tick=500)
...
class 집에서나와서대사침(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52010027_QD__MAIN_QUEST10003101__1$', duration=2000, delay_tick=0)
...
class 전투시작03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[802], auto_target=True)
...
class 전투종료02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=803, sequence_name='Stun_A', duration=160000000)
