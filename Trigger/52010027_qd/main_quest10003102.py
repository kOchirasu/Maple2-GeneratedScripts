...
class 보스몬스터는소멸준비(common.Trigger):
    def on_enter(self):
...
class 보스몬스터는소멸준비01(common.Trigger):
    def on_enter(self):
...
class 보스몬스터는소멸준비02(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4013], returnView=False)
...
class 보스몬스터는소멸_01(common.Trigger):
    def on_enter(self):
