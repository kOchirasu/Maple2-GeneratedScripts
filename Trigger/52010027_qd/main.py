...
class Ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[301], auto_target=True) # 습격지역 꼭대기 집
        self.spawn_monster(spawn_ids=[302], auto_target=True) # 습격지역 꼭대기 입구
        self.spawn_monster(spawn_ids=[303], auto_target=True) # 습격지역 꼭대기 주민
        self.spawn_monster(spawn_ids=[304], auto_target=True) # 진입부 주민 1층
        self.spawn_monster(spawn_ids=[305], auto_target=True) # 진입부 주민 2층
        self.spawn_monster(spawn_ids=[401], auto_target=True) # 악당NPC_1
        self.spawn_monster(spawn_ids=[402], auto_target=True) # 악당NPC_2
        self.spawn_monster(spawn_ids=[403], auto_target=True) # 악당NPC_3
        self.spawn_monster(spawn_ids=[404], auto_target=True) # 악당NPC_4
        self.spawn_monster(spawn_ids=[405], auto_target=True) # 악당NPC_5
        self.spawn_monster(spawn_ids=[406], auto_target=True) # 악당NPC_6
        self.spawn_monster(spawn_ids=[407], auto_target=True) # 악당NPC_7
        self.spawn_monster(spawn_ids=[408], auto_target=True) # 악당NPC_8
        self.spawn_monster(spawn_ids=[409], auto_target=True) # 악당NPC_9
        self.spawn_monster(spawn_ids=[501], auto_target=True) # 보스NPC_1
        self.spawn_monster(spawn_ids=[502], auto_target=True) # 보스NPC_1
...
class 카메라_전환(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$52010027_QD__MAIN__0$', desc='$52010027_QD__MAIN__1$', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2)
        self.set_npc_emotion_loop(spawn_id=303, sequence_name='Down_Idle_A', duration=150000)
...
class 연출_습격현장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=301, msg='$52010027_QD__MAIN__2$', duration=3000, delay_tick=0)
        self.add_balloon_talk(spawn_id=403, msg='$52010027_QD__MAIN__3$', duration=3000, delay_tick=0)
...
class 연출_습격현장_02_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawn_id=401, msg='$52010027_QD__MAIN__5$', duration=2000, delay_tick=0)
        ...
        self.set_npc_emotion_loop(spawn_id=305, sequence_name='Down_Idle_A', duration=150000)
...
class 연출_습격현장확인_PC(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52010027_QD__MAIN__10$', duration=2000, delay_tick=6000)
...
class 연출_습격현장_보스등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$52010027_QD__MAIN__12$', desc='$52010027_QD__MAIN__13$', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2)
...
class 연출_습격현장_PC연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Attack_Idle_A', duration=3500)
...
class 연출_습격현장_전투준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[601], auto_target=True) # 악당Mob_1
        self.spawn_monster(spawn_ids=[602], auto_target=True) # 악당Mob_2
        self.spawn_monster(spawn_ids=[603], auto_target=True) # 악당Mob_3
        self.spawn_monster(spawn_ids=[604], auto_target=True) # 악당Mob_4
        self.spawn_monster(spawn_ids=[605], auto_target=True) # 악당Mob_5
        self.spawn_monster(spawn_ids=[606], auto_target=True) # 악당Mob_6
        self.add_balloon_talk(spawn_id=602, msg='$52010027_QD__MAIN__20$', duration=2000, delay_tick=0)
...
class 차_전투2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[701], auto_target=True) # 악당Mob_1
        self.spawn_monster(spawn_ids=[702], auto_target=True) # 악당Mob_2
        self.spawn_monster(spawn_ids=[703], auto_target=True) # 악당Mob_3
        self.spawn_monster(spawn_ids=[704], auto_target=True) # 악당Mob_4
        self.spawn_monster(spawn_ids=[705], auto_target=True) # 악당Mob_5
        self.spawn_monster(spawn_ids=[706], auto_target=True) # 악당Mob_6
        self.add_balloon_talk(spawn_id=701, msg='$52010027_QD__MAIN__26$', duration=2000, delay_tick=0)
...
class 연출_페리온영웅등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.select_camera_path(path_ids=[4004], return_view=False)
        self.set_npc_emotion_loop(spawn_id=501, sequence_name='Attack_Idle_A', duration=16000)
...
class 연출_페리온영웅등장_보스대사_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=501, msg='$52010027_QD__MAIN__30$', duration=2000, delay_tick=0)
...
class 연출_페리온영웅등장_보스대사_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=501, msg='$52010027_QD__MAIN__33$', duration=2000, delay_tick=0)
        self.add_cinematic_talk(npc_id=11003431, msg='$52010027_QD__MAIN__34$', duration=3000)
        self.spawn_monster(spawn_ids=[201], auto_target=True) # 에바고르: 11003391
        self.spawn_monster(spawn_ids=[101], auto_target=True) # 시끄러운 주먹: 11003388
...
class 연출_페리온영웅등장_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.show_caption(type='VerticalCaption', title='$52010027_QD__MAIN__35$', desc='$52010027_QD__MAIN__36$', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2)
...
class 연출_페리온영웅과대화(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera_path(path_ids=[4008], return_view=False)
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Bore_B', duration=3000)
        self.set_npc_emotion_loop(spawn_id=201, sequence_name='Attack_Idle_A', duration=3000)
...
class 연출_페리온영웅과대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera_path(path_ids=[4010], return_view=False)
        self.set_pc_emotion_loop(sequence_name='Talk_A', duration=29000)
