...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[5001], visible=False) # 종이문서 발견 사운드 이펙트
        self.set_effect(trigger_ids=[6001], visible=False) # Ishura Voice 00001274
        self.set_effect(trigger_ids=[6002], visible=False) # Ishura Voice 00001275
        self.set_effect(trigger_ids=[6003], visible=False) # Ishura Voice 00001276
        self.set_effect(trigger_ids=[6004], visible=False) # Ishura Voice 00001277
        self.set_effect(trigger_ids=[6005], visible=False) # Ishura Voice 00001278
        self.set_effect(trigger_ids=[6006], visible=False) # Ishura Voice 00001279
        self.set_effect(trigger_ids=[6007], visible=False) # Ishura Voice 00001280
        self.set_effect(trigger_ids=[6008], visible=False) # Ishura Voice 00001281
        self.set_effect(trigger_ids=[6009], visible=False) # Ishura Voice 00001282
...
class 전투준비01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__0$', time=6, arg5=0) # 음성코드 	00001274
...
class 전투준비02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__1$', time=4, arg5=0) # 음성코드 	00001275
...
class 이슈라대화01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__2$', time=8, arg5=0) # 음성코드 	00001276
...
class 이슈라대화02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__3$', time=8, arg5=0) # 음성코드 	00001277
...
class 이슈라대화03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__4$', time=7, arg5=0) # 음성코드 	00001278
...
class 이슈라대화04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__5$', time=6, arg5=0) # 음성코드 	00001279
...
class 수색종료02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=103, script='$52000023_QD__MAIN01__6$', time=3, arg5=0) # 음성코드 	00001280
...
class 정리대화01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__7$', time=9, arg5=0) # 음성코드 	00001281
...
class 정리대화02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000023_QD__MAIN01__8$', time=5, arg5=0) # 음성코드 	00001282
