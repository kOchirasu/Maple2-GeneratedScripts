...
class DungeonStart(state.DungeonStart):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000015, script='$52100031_QD__MADRICANSIEGE__0$', arg4=4, arg5=0)
...
class 던전시작(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=1001, script='$52100031_QD__MADRICANSIEGE__1$', arg4=3, arg5=0)
...
class 암전(state.State):
    def on_enter(self):
        ...
        set_cinematic_ui(type=1)
        set_cinematic_ui(type=3)
        move_user(mapId=52100031, portalId=3)
        ...
        spawn_npc_range(rangeIds=[1901,1902,1903,1904,1905,1906,1907,1908,1909,1910,1911,1912,1913,1914,1915,1916,1917,1918,1919,1920,1921,1922], isAutoTargeting=False)
...
class 던전종료연출시작(state.State):
    def on_enter(self):
        ...
        set_npc_emotion_loop(spawnId=1922, sequenceName='Talk_A', duration=3000)
        add_cinematic_talk(npcId=11001567, illustId='11001567', msg='$52100031_QD__MADRICANSIEGE__2$', duration=3000, align='Right')
...
class 던전종료연출01(state.State):
    def on_enter(self):
        ...
        set_npc_emotion_loop(spawnId=1921, sequenceName='Talk_A', duration=3000)
        add_cinematic_talk(npcId=11001566, illustId='11001566', msg='$52100031_QD__MADRICANSIEGE__3$', duration=3000, align='left')
...
class 던전종료연출02(state.State):
    def on_enter(self):
        set_npc_rotation(spawnId=1920, rotation=180)
        set_npc_emotion_loop(spawnId=1920, sequenceName='Talk_A', duration=3000)
        add_cinematic_talk(npcId=11001568, illustId='11001568', msg='$52100031_QD__MADRICANSIEGE__4$', duration=3000, align='left')
...
class 룬블레이더이동(state.State):
    def on_enter(self):
        move_npc(spawnId=1920, patrolName='MS2PatrolData_1920')
        move_npc(spawnId=1921, patrolName='MS2PatrolData_1921')
        move_npc(spawnId=1922, patrolName='MS2PatrolData_1922')
...
class 던전종료연출종료(state.State):
    def on_enter(self):
        destroy_monster(spawnIds=[1920,1921,1922], arg2=False)
        set_skip()
        set_cinematic_ui(type=0)
        set_cinematic_ui(type=2)
        reset_camera(interpolationTime=0)
