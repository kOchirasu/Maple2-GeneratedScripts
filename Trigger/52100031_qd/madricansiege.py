...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3000,3001,3002,3003,3004], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3101,3102,3103,3104,3105], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3201,3202,3203,3204,3205,3206,3207], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3801,3802,3803,3804], visible=True, start_delay=0, interval=0, fade=0)
        ...
        self.set_actor(trigger_id=205, visible=False, initial_sequence='Dead_A')
        self.set_actor(trigger_id=206, visible=False, initial_sequence='Dead_A')
        self.set_actor(trigger_id=207, visible=False, initial_sequence='Dead_A')
        self.set_actor(trigger_id=208, visible=False, initial_sequence='Dead_A')
        self.set_actor(trigger_id=209, visible=False, initial_sequence='Dead_A')
        self.set_actor(trigger_id=210, visible=False, initial_sequence='Dead_A')
...
class DungeonStart(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000015, script='$52100031_QD__MADRICANSIEGE__0$', time=4, arg5=0)
...
class 던전시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_agent(trigger_ids=[8001,8002,8003,8004,8005,8006], visible=False)
        self.set_dialogue(type=1, spawn_id=1001, script='$52100031_QD__MADRICANSIEGE__1$', time=3, arg5=0)

    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2000,2001]):
            self.set_mesh(trigger_ids=[3101,3102,3103,3104,3105], visible=False, start_delay=0, interval=0, fade=5)
            self.set_agent(trigger_ids=[8101,8102,8103,8104,8105,8106], visible=False)
...
class 차지원1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_npc_range(range_ids=[2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023,2024,2025,2026,2027,2028,2029,2030], is_auto_targeting=False)
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2901]):
            ...
            self.set_agent(trigger_ids=[8201,8202,8203,8204,8205,8206], visible=False)
            self.set_mesh(trigger_ids=[3201,3202,3203,3204,3205,3206,3207], visible=False, start_delay=0, interval=0, fade=5)
            return 다리건넘(self.ctx)


class 다리건넘(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.shadow_expedition(type='OpenBossGauge', max_gauge_point=1000)
...
class 암전(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_npc_range(range_ids=[1901,1902,1903,1904,1905,1906,1907,1908,1909,1910,1911,1912,1913,1914,1915,1916,1917,1918,1919,1920,1921,1922], is_auto_targeting=False)
...
class 던전종료연출시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=1922, sequence_name='Talk_A', duration=3000)
        self.add_cinematic_talk(npc_id=11001567, illust_id='11001567', msg='$52100031_QD__MADRICANSIEGE__2$', duration=3000, align='Right')
    ...
    def on_exit(self) -> None:
        self.set_mesh(trigger_ids=[3801,3802,3803,3804], visible=False, start_delay=0, interval=0, fade=5)


class 던전종료연출01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=304, enable=True)
        self.set_npc_emotion_loop(spawn_id=1921, sequence_name='Talk_A', duration=3000)
        self.add_cinematic_talk(npc_id=11001566, illust_id='11001566', msg='$52100031_QD__MADRICANSIEGE__3$', duration=3000, align='left')
...
class 던전종료연출02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_rotation(spawn_id=1920, rotation=180)
        self.set_npc_emotion_loop(spawn_id=1920, sequence_name='Talk_A', duration=3000)
        self.add_cinematic_talk(npc_id=11001568, illust_id='11001568', msg='$52100031_QD__MADRICANSIEGE__4$', duration=3000, align='left')
