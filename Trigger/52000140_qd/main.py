...
class 삼자대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__1$', duration=3000, align='center')
...
class 삼자대화_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__2$', duration=2500, align='right')
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_2003')
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__3$', duration=2500, align='right')
...
class 어둠의졸개_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[103,104], auto_target=True)
...
class 알론과대화_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__5$', duration=3000, align='right')
...
class 알론과대화_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__7$', duration=2500, align='right')
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__8$', duration=2500, align='right')
...
class 알론과대화_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__10$', duration=2000, align='right')
...
class 차삼자대화_01_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__11$', duration=3000, align='right')
...
class 차삼자대화_03_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__13$', duration=2500, align='right')
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__14$', duration=2500, align='right')
...
class 차삼자대화_04_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__15$', duration=2500, align='center')
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__16$', duration=2500, align='center')
...
class 차삼자대화_05_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__17$', duration=2500, align='right')
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__18$', duration=2500, align='right')
...
class 차삼자대화_06_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__19$', duration=2500, align='center')
...
class 차삼자대화_07_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__20$', duration=2500, align='right')
...
class 차삼자대화_08_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__21$', duration=2000, align='center')
...
class 차삼자대화_01_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__22$', duration=2500, align='right')
        self.add_cinematic_talk(npc_id=11003329, msg='$52000140_QD__MAIN__23$', duration=2500, align='right')
...
class 차삼자대화_03_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003328, msg='$52000140_QD__MAIN__25$', duration=2000, align='center')
