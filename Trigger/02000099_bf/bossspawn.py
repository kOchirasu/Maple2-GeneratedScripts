...
class 시작대기중(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[3201,3202,3203,3204,3205,3206,3207,3208], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[3301,3302,3303,3304,3305,3306,3307,3308,3309,3310,3311], visible=True, start_delay=0, interval=0, fade=0)
...
class 차등장1(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.user_value(key='SetSkillA') >= 1:
            self.set_mesh(trigger_ids=[3101,3102,3103,3104,3105,3106], visible=False, start_delay=0, interval=0, fade=0)
...
class 차등장2(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.user_value(key='SetSkillB') >= 1:
            self.set_mesh(trigger_ids=[3201,3202,3203,3204,3205,3206,3207,3208], visible=False, start_delay=0, interval=0, fade=0)
...
class 엘리트등장(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[2000]):
            ...
            self.set_mesh(trigger_ids=[3301,3302,3303,3304,3305,3306,3307,3308,3309,3310,3311], visible=False, start_delay=0, interval=0, fade=0)
