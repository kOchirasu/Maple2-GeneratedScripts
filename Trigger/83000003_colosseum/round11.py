...
class 대기(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.user_value(key='StartRound11', value=1):
...
class 라운드조건체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.dungeon_round_require(round=11):
            self.side_npc_talk(type='talk', npcId=11004288, illust='nagi_normal', script='$83000003_COLOSSEUM__ROUND11__0$', duration=5000)
            # self.set_event_ui(type=1, arg2='전투에서 승리하셨습니다. 이제 부터는 벅찬 상대가 나올 수 있습니다. 마음 단단히 먹으십시오.', arg3='3000')
            return 라운드대기(self.ctx)
        if self.true():
            self.side_npc_talk(type='talk', npcId=11004288, illust='nagi_switchon', script='$83000003_COLOSSEUM__ROUND11__1$', duration=3000)
...
class 라운드대기(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(waitTick=5000):
            self.side_npc_talk(type='cutin', illust='ArcaneBlader_normal', duration=3000)
...
class 몬스터스폰(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_buff(boxIds=[111], skillId=69000501, level=1, isPlayer=True)
...
class 카운트(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.show_count_ui(text='$83000003_COLOSSEUM__ROUND11__2$', count=3, soundType=2)
...
class 스폰대사(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_balloon_talk(spawnId=111, msg='$83000003_COLOSSEUM__ROUND11__3$', duration=3000)
        self.set_timer(timerId='LimitTimer', seconds=180, startDelay=1)
        self.set_npc_duel_hp_bar(isOpen=True, spawnId=[111], durationTick=180000, npcHpStep=10)

    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(boxIds=[111]):
            self.add_balloon_talk(spawnId=111, msg='$83000003_COLOSSEUM__ROUND11__4$', duration=3000)
            self.set_npc_duel_hp_bar(isOpen=False, spawnId=[111])
        ...
        if self.time_expired(timerId='LimitTimer'):
            ...
            self.side_npc_talk(type='talk', npcId=11004288, illust='nagi_switchon', script='$83000003_COLOSSEUM__ROUND11__5$', duration=3000)
        ...
        if self.user_detected(boxIds=[902]):
            ...
            self.side_npc_talk(type='talk', npcId=11004288, illust='nagi_switchon', script='$83000003_COLOSSEUM__ROUND11__6$', duration=3000)
            self.destroy_monster(spawnIds=[111])
            self.set_npc_duel_hp_bar(isOpen=False, spawnId=[111])
            self.destroy_monster(spawnIds=[10000])
            self.destroy_monster(spawnIds=[10001])
        ...
        if not self.user_detected(boxIds=[904]):
            ...
            self.side_npc_talk(type='talk', npcId=11004288, illust='nagi_switchon', script='$83000003_COLOSSEUM__ROUND11__8$', duration=3000)
            self.destroy_monster(spawnIds=[111])
            self.set_npc_duel_hp_bar(isOpen=False, spawnId=[111])
            self.destroy_monster(spawnIds=[10000])
            self.destroy_monster(spawnIds=[10001])
...
class ClearRound(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(waitTick=3000):
            ...
            self.side_npc_talk(type='talk', npcId=11004285, illust='Queencbean_Smile', script='$83000003_COLOSSEUM__ROUND11__11$', duration=3000)
            self.set_user_value(triggerId=900001, key='StartRound11', value=2)
...
class FailRound(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(waitTick=3000):
            self.set_user_value(triggerId=900001, key='StartRound11', value=3)
            return 대기(self.ctx)
