...
class 큐브16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[4028], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[5028], visible=True, start_delay=0, interval=0, fade=0)
...
class 큐브제거(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[5028], visible=False, start_delay=0, interval=0, fade=0)
