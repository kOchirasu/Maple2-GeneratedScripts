...
class idle(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002054], state=1)
...
class QuestDungeonStart(state.State):
    ...
    def on_tick(self) -> state.State:
        if quest_user_detected(boxIds=[702], questIds=[50100080], questStates=[1]):
            return mermaid_01()
        if quest_user_detected(boxIds=[702], questIds=[50100080], questStates=[2]):
            return moveuser_00()
        if quest_user_detected(boxIds=[702], questIds=[50100080], questStates=[1]):
            return moveuser_00()
...
class mermaid_02_talk(state.State):
    def on_enter(self):
        add_cinematic_talk(npcId=11003889, illustId='Firis_normal', msg='$52100011_QD__MAIN__0$', align='left', duration=2000)
        add_cinematic_talk(npcId=11003888, illustId='Celine_normal', msg='$52100011_QD__MAIN__1$', align='right', duration=2000)
...
class scene_01(state.State):
    def on_enter(self):
        ...
        add_cinematic_talk(npcId=11003889, illustId='Firis_normal', msg='$52100011_QD__MAIN__2$', align='left', duration=3000)
        add_cinematic_talk(npcId=11003888, illustId='Celine_normal', msg='$52100011_QD__MAIN__3$', align='right', duration=3000)
        add_cinematic_talk(npcId=11003889, illustId='Firis_normal', msg='$52100011_QD__MAIN__4$', align='left', duration=3000)
...
class scene_02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$52100011_QD__MAIN__5$', arg4=2, arg5=1)
...
class open_door_01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100011_QD__MAIN__6$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$52100011_QD__MAIN__7$', arg4=2, arg5=1)
...
class battle_01(state.State):
    def on_enter(self):
        set_local_camera(cameraId=8100, enable=True) # LocalTargetCamera
        set_conversation(type=1, spawnId=102, script='$52100011_QD__MAIN__8$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$52100011_QD__MAIN__9$', arg4=2, arg5=1)
...
class battle_02(state.State):
    def on_enter(self):
        ...
        add_cinematic_talk(npcId=11003888, illustId='Celine_normal', msg='$52100011_QD__MAIN__10$', align='right', duration=3000)
...
class open_door_03(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$52100011_QD__MAIN__11$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=101, script='$52100011_QD__MAIN__12$', arg4=2, arg5=0)
...
class battle_03(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100011_QD__MAIN__13$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$52100011_QD__MAIN__14$', arg4=2, arg5=2)

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002054], arg2=0):
            return battle_04()
...
class battle_04(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=102, script='$52100011_QD__MAIN__15$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$52100011_QD__MAIN__16$', arg4=2, arg5=2)
...
class ship_01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100011_QD__MAIN__17$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$52100011_QD__MAIN__18$', arg4=2, arg5=2)
...
class ship_02(state.State):
    def on_enter(self):
        set_event_ui(type=1, arg2='$52100011_QD__MAIN__19$', arg3='3000')
...
class ship_03(state.State):
    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002056], arg2=0):
            return ship_end()
...
class ending_03(state.State):
    def on_enter(self):
        move_user(mapId=52100012, portalId=0)
