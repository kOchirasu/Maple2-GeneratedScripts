...
class 시간경과대기(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1500):
            return 트리거작동시작(self.ctx)


class 중앙전투판신호(common.Trigger):
    def on_enter(self):
