...
class 순간이동포탈감추기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portalId=9000, visible=False, enable=False, minimapVisible=False)
        ...
        self.set_portal(portalId=10112, visible=False, enable=False, minimapVisible=False)
...
class 순간이동포탈등장(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # 4계절 도로에 2개씩 배치한 순간이동 포탈
        self.set_portal(portalId=9000, visible=True, enable=True, minimapVisible=True)
        ...
        # 중앙 넓은 전투판에서 12시 3시 6시 9시 넓은 전투판으로 가는 순간이동 포탈
        self.set_portal(portalId=10112, visible=True, enable=True, minimapVisible=True)
