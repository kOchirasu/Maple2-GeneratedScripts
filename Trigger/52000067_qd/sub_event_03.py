...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[537,538,539], auto_target=True) # 몬스터
        self.set_npc_emotion_loop(spawn_id=591, sequence_name='Emotion_Failure_Idle_A', duration=600000)
        self.set_npc_emotion_loop(spawn_id=592, sequence_name='Emotion_Failure_Idle_A', duration=600000)
        self.set_dialogue(type=1, spawn_id=591, script='$52000067_QD__SUB_EVENT_03__0$', time=3, arg5=0)
...
class end(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=591, script='$52000067_QD__SUB_EVENT_03__2$', time=3, arg5=0)
