...
class SetOnetimeEffect01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_time_scale(enable=True, start_scale=1, end_scale=0.2, duration=2, interpolator=2)
...
class Quit(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_time_scale(enable=True, start_scale=0.2, end_scale=1, duration=2, interpolator=2)
        self.set_onetime_effect(id=3, enable=False, path='BG/Common/Eff_co_targetBox_test_99999949_01.xml')
        # self.set_time_scale(enable=True, end_scale=1, duration=8, interpolator=2)
