...
class 유저입장01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[9001]):
            return 가이드준비(self.ctx)


class 가이드준비(common.Trigger):
    def on_enter(self):
