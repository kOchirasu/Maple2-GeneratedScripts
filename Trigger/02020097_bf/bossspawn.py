...
class 시작대기중(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portalId=28, visible=False, enable=False, minimapVisible=False)
        # 몬스터는 밟고 플레이어는 밟지 못하는 트리거메쉬 설정하기
        self.set_mesh(triggerIds=[101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,121], visible=False, arg3=0, delay=0, scale=0)
...
class 플레이어3페이지전투판으로오기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_portal(portalId=28, visible=True, enable=True, minimapVisible=True)
