...
class Summon_02(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=102, script='$52100013_QD__SUMMON__0$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=101, script='$52100013_QD__SUMMON__1$', arg4=2, arg5=2)
