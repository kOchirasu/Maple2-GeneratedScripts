...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=1, spawn_id=102, script='$52100013_QD__AI__7$', time=2, arg5=0)
        self.set_dialogue(type=1, spawn_id=101, script='$52100013_QD__AI__0$', time=2, arg5=0)
...
class Ending_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11003889, illust_id='Firis_normal', msg='$52100013_QD__AI__1$', align='right', duration=2000)
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$52100013_QD__AI__2$', align='left', duration=2000)
...
class Ending_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=202, script='$52100013_QD__AI__3$', time=2, arg5=0)
        self.add_cinematic_talk(npc_id=11003888, illust_id='Celine_normal', msg='$52100013_QD__AI__4$', align='left', duration=2000)
        self.add_cinematic_talk(npc_id=11003889, illust_id='Firis_normal', msg='$52100013_QD__AI__5$', align='right', duration=2000)
