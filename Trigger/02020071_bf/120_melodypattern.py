...
class MelodyPlay01_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11207], visible=True) # Bell F
        set_actor(triggerId=11007, visible=True, initialSequence='ks_quest_musical_B01_purple') # Bell F
...
class MelodyPlay01_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11007, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay02_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11208], visible=True) # Bell D
        set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_pink') # Bell D
...
class MelodyPlay02_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell D
...
class MelodyPlay03_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11207], visible=True) # Bell A
        set_actor(triggerId=11007, visible=True, initialSequence='ks_quest_musical_B01_purple') # Bell A
...
class MelodyPlay03_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11007, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11206], visible=True) # Bell B
        set_actor(triggerId=11006, visible=True, initialSequence='ks_quest_musical_B01_navy') # Bell B
...
class MelodyPlay04_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11006, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell B
...
class CheckAnswer01_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000064], state=1) # Lever F
...
class CheckAnswer02_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000065], state=1) # Lever D
...
class CheckAnswer03_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000064], state=1) # Lever A
...
class CheckAnswer04_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000063], state=1) # Lever B
