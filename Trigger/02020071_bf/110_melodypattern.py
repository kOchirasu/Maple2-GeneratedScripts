...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11201], visible=True) # Bell A
        self.set_actor(triggerId=11001, visible=True, initialSequence='ks_quest_musical_B01_red') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11001, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class MelodyPlay04_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11202], visible=True) # Bell B
        self.set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_orange') # Bell B
...
class MelodyPlay04_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11002, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell B
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000058], state=1) # Lever A
