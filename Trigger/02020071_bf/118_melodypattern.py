...
class MelodyPlay02_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11207], visible=True) # Bell D
        self.set_actor(triggerId=11007, visible=True, initialSequence='ks_quest_musical_B01_purple') # Bell D
...
class MelodyPlay02_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11007, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell D
...
class MelodyPlay03_Start(trigger_api.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[11208], visible=True) # Bell A
        self.set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_pink') # Bell A
...
class MelodyPlay03_End(trigger_api.Trigger):
    def on_enter(self):
        self.set_actor(triggerId=11008, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell A
...
class CheckAnswer01_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000063], state=1) # Lever F
...
class CheckAnswer02_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000064], state=1) # Lever D
...
class CheckAnswer03_Delay(trigger_api.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[12000065], state=1) # Lever A
