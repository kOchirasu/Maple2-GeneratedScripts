...
class MelodyPlay01_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11206], visible=True) # Bell F
        set_actor(triggerId=11006, visible=True, initialSequence='ks_quest_musical_B01_navy') # Bell F
...
class MelodyPlay01_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11006, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell F
...
class MelodyPlay05_Start(state.State):
    def on_enter(self):
        set_effect(triggerIds=[11203], visible=True) # Bell HighC
        set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_yellow') # Bell HighC
...
class MelodyPlay05_End(state.State):
    def on_enter(self):
        set_actor(triggerId=11003, visible=True, initialSequence='ks_quest_musical_B01_off') # Bell HighC
...
class CheckAnswer01_Delay(state.State):
    ...
    def on_exit(self):
        set_interact_object(triggerIds=[12000063], state=1) # Lever F
