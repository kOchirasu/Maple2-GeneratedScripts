...
class 투르카대면_02_01(common.Trigger):
    def on_enter(self):
...
class 투르카대면_07_01(common.Trigger):
    def on_enter(self):
...
class 투르카대면_13_02(common.Trigger):
    def on_enter(self):
...
class 투르카대면_13_03(common.Trigger):
    def on_enter(self):
...
class 투르카대면_13_04(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_sequence(spawnId=209, sequenceName='Bore_A')
...
class 투르카대면_13_05(common.Trigger):
    def on_enter(self):
...
class 투르카대면_13_06(common.Trigger):
    def on_enter(self):
