...
class 투르카대면_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004678, illust_id='Neirin_surprise', align='left', msg='$52100208_QD__52100208__0$', duration=4000)
        self.add_cinematic_talk(npc_id=11004675, illust_id='Bliche_mad', align='right', msg='$52100208_QD__52100208__1$', duration=4500)
...
class 투르카대면_07_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=208, sequence_name='Attack_Idle_A', duration=100000000)
        self.add_cinematic_talk(npc_id=11004682, illust_id='ArcaneBlader_unfair', align='right', msg='$52100208_QD__52100208__8$', duration=3000)
        self.add_cinematic_talk(npc_id=11004680, illust_id='Eone_serious', align='right', msg='$52100208_QD__52100208__9$', duration=3000)
...
class 투르카대면_10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004675, illust_id='Bliche_mad', align='right', msg='$52100208_QD__52100208__12$', duration=4000)
        self.add_cinematic_talk(npc_id=11004588, illust_id='Conder_normal', align='left', msg='$52100208_QD__52100208__13$', duration=4000)
...
class 투르카대면_13_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004588, illust_id='Conder_normal', align='right', msg='$52100208_QD__52100208__17$', duration=4000)
        self.add_cinematic_talk(npc_id=11004588, illust_id='Conder_normal', align='right', msg='$52100208_QD__52100208__18$', duration=4000)
...
class 투르카대면_13_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=202, sequence_name='Stun_A', duration=100000000)
...
class 투르카대면_13_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_cinematic_talk(npc_id=11004678, illust_id='Neirin_surprise', align='left', msg='$52100208_QD__52100208__21$', duration=4000)
        self.add_cinematic_talk(npc_id=11004677, illust_id='Schatten_surprise', align='right', msg='$52100208_QD__52100208__22$', duration=4000)
