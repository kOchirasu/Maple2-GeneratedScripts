...
class Wait(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P01Set', value=1):
            return NumberOnP01()
        if user_value(key='G03P02Set', value=1):
            return NumberOnP02()
        if user_value(key='G03P03Set', value=1):
            return NumberOnP03()
        if user_value(key='G03P04Set', value=1):
            return NumberOnP04()
        if user_value(key='G03P05Set', value=1):
            return NumberOnP05()
        if user_value(key='G03P06Set', value=1):
            return NumberOnP06()
        if user_value(key='G03P07Set', value=1):
            return NumberOnP07()
        if user_value(key='G03P08Set', value=1):
            return NumberOnP08()
        if user_value(key='G03P09Set', value=1):
            return NumberOnP09()
        if user_value(key='G03P10Set', value=1):
            return NumberOnP10()
        if user_value(key='G03P11Set', value=1):
            return NumberOnP11()
        if user_value(key='G03P12Set', value=1):
            return NumberOnP12()
        if user_value(key='G03P13Set', value=1):
            return NumberOnP13()
        if user_value(key='G03P14Set', value=1):
            return NumberOnP14()
        if user_value(key='G03P15Set', value=1):
            return NumberOnP15()
        if user_value(key='G03P16Set', value=1):
            return NumberOnP16()
        if user_value(key='G03P17Set', value=1):
            return NumberOnP17()
        if user_value(key='G03P18Set', value=1):
            return NumberOnP18()
        if user_value(key='G03P19Set', value=1):
            return NumberOnP19()
        if user_value(key='G03P20Set', value=1):
            return NumberOnP20()
        if user_value(key='G03P21Set', value=1):
            return NumberOnP21()
        if user_value(key='G03P22Set', value=1):
            return NumberOnP22()
        if user_value(key='G03P23Set', value=1):
            return NumberOnP23()
        if user_value(key='G03P24Set', value=1):
            return NumberOnP24()
        if user_value(key='G03P25Set', value=1):
            return NumberOnP25()
        if user_value(key='G03P26Set', value=1):
            return NumberOnP26()
        if user_value(key='G03P27Set', value=1):
            return NumberOnP27()
        if user_value(key='G03P28Set', value=1):
            return NumberOnP28()
        if user_value(key='G03P29Set', value=1):
            return NumberOnP29()
        if user_value(key='G03P30Set', value=1):
            return NumberOnP30()
...
class NumberOnP01(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P01TimeLimit', value=1):
            return CheckP01()
...
class ResetP01(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P01End', value=1)
        set_user_value(key='G03P01Set', value=0)
        set_user_value(key='G03P01TimeLimit', value=0)
...
class NumberOnP02(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P02TimeLimit', value=1):
            return CheckP02()
...
class ResetP02(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P02End', value=1)
        set_user_value(key='G03P02Set', value=0)
        set_user_value(key='G03P02TimeLimit', value=0)
...
class NumberOnP03(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P03TimeLimit', value=1):
            return CheckP03()
...
class ResetP03(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P03End', value=1)
        set_user_value(key='G03P03Set', value=0)
        set_user_value(key='G03P03TimeLimit', value=0)
...
class NumberOnP04(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P04TimeLimit', value=1):
            return CheckP04()
...
class ResetP04(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P04End', value=1)
        set_user_value(key='G03P04Set', value=0)
        set_user_value(key='G03P04TimeLimit', value=0)
...
class NumberOnP05(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P05TimeLimit', value=1):
            return CheckP05()
...
class ResetP05(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P05End', value=1)
        set_user_value(key='G03P05Set', value=0)
        set_user_value(key='G03P05TimeLimit', value=0)
...
class NumberOnP06(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P06TimeLimit', value=1):
            return CheckP06()
...
class ResetP06(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P06End', value=1)
        set_user_value(key='G03P06Set', value=0)
        set_user_value(key='G03P06TimeLimit', value=0)
...
class NumberOnP07(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P07TimeLimit', value=1):
            return CheckP07()
...
class ResetP07(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P07End', value=1)
        set_user_value(key='G03P07Set', value=0)
        set_user_value(key='G03P07TimeLimit', value=0)
...
class NumberOnP08(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P08TimeLimit', value=1):
            return CheckP08()
...
class ResetP08(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P08End', value=1)
        set_user_value(key='G03P08Set', value=0)
        set_user_value(key='G03P08TimeLimit', value=0)
...
class NumberOnP09(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P09TimeLimit', value=1):
            return CheckP09()
...
class ResetP09(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P09End', value=1)
        set_user_value(key='G03P09Set', value=0)
        set_user_value(key='G03P09TimeLimit', value=0)
...
class NumberOnP10(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P10TimeLimit', value=1):
            return CheckP10()
...
class ResetP10(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P10End', value=1)
        set_user_value(key='G03P10Set', value=0)
        set_user_value(key='G03P10TimeLimit', value=0)
...
class NumberOnP11(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P11TimeLimit', value=1):
            return CheckP11()
...
class ResetP11(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P11End', value=1)
        set_user_value(key='G03P11Set', value=0)
        set_user_value(key='G03P11TimeLimit', value=0)
...
class NumberOnP12(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P12TimeLimit', value=1):
            return CheckP12()
...
class ResetP12(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P12End', value=1)
        set_user_value(key='G03P12Set', value=0)
        set_user_value(key='G03P12TimeLimit', value=0)
...
class NumberOnP13(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P13TimeLimit', value=1):
            return CheckP13()
...
class ResetP13(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P13End', value=1)
        set_user_value(key='G03P13Set', value=0)
        set_user_value(key='G03P13TimeLimit', value=0)
...
class NumberOnP14(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P14TimeLimit', value=1):
            return CheckP14()
...
class ResetP14(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P14End', value=1)
        set_user_value(key='G03P14Set', value=0)
        set_user_value(key='G03P14TimeLimit', value=0)
...
class NumberOnP15(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P15TimeLimit', value=1):
            return CheckP15()
...
class ResetP15(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P15End', value=1)
        set_user_value(key='G03P15Set', value=0)
        set_user_value(key='G03P15TimeLimit', value=0)
...
class NumberOnP16(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P16TimeLimit', value=1):
            return CheckP16()
...
class ResetP16(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P16End', value=1)
        set_user_value(key='G03P16Set', value=0)
        set_user_value(key='G03P16TimeLimit', value=0)
...
class NumberOnP17(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P17TimeLimit', value=1):
            return CheckP17()
...
class ResetP17(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P17End', value=1)
        set_user_value(key='G03P17Set', value=0)
        set_user_value(key='G03P17TimeLimit', value=0)
...
class NumberOnP18(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P18TimeLimit', value=1):
            return CheckP18()
...
class ResetP18(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P18End', value=1)
        set_user_value(key='G03P18Set', value=0)
        set_user_value(key='G03P18TimeLimit', value=0)
...
class NumberOnP19(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P19TimeLimit', value=1):
            return CheckP19()
...
class ResetP19(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P19End', value=1)
        set_user_value(key='G03P19Set', value=0)
        set_user_value(key='G03P19TimeLimit', value=0)
...
class NumberOnP20(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P20TimeLimit', value=1):
            return CheckP20()
...
class ResetP20(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P20End', value=1)
        set_user_value(key='G03P20Set', value=0)
        set_user_value(key='G03P20TimeLimit', value=0)
...
class NumberOnP21(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P21TimeLimit', value=1):
            return CheckP21()
...
class ResetP21(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P21End', value=1)
        set_user_value(key='G03P21Set', value=0)
        set_user_value(key='G03P21TimeLimit', value=0)
...
class NumberOnP22(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P22TimeLimit', value=1):
            return CheckP22()
...
class ResetP22(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P22End', value=1)
        set_user_value(key='G03P22Set', value=0)
        set_user_value(key='G03P22TimeLimit', value=0)
...
class NumberOnP23(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P23TimeLimit', value=1):
            return CheckP23()
...
class ResetP23(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P23End', value=1)
        set_user_value(key='G03P23Set', value=0)
        set_user_value(key='G03P23TimeLimit', value=0)
...
class NumberOnP24(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P24TimeLimit', value=1):
            return CheckP24()
...
class ResetP24(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P24End', value=1)
        set_user_value(key='G03P24Set', value=0)
        set_user_value(key='G03P24TimeLimit', value=0)
...
class NumberOnP25(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P25TimeLimit', value=1):
            return CheckP25()
...
class ResetP25(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P25End', value=1)
        set_user_value(key='G03P25Set', value=0)
        set_user_value(key='G03P25TimeLimit', value=0)
...
class NumberOnP26(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P26TimeLimit', value=1):
            return CheckP26()
...
class ResetP26(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P26End', value=1)
        set_user_value(key='G03P26Set', value=0)
        set_user_value(key='G03P26TimeLimit', value=0)
...
class NumberOnP27(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P27TimeLimit', value=1):
            return CheckP27()
...
class ResetP27(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P27End', value=1)
        set_user_value(key='G03P27Set', value=0)
        set_user_value(key='G03P27TimeLimit', value=0)
...
class NumberOnP28(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P28TimeLimit', value=1):
            return CheckP28()
...
class ResetP28(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P28End', value=1)
        set_user_value(key='G03P28Set', value=0)
        set_user_value(key='G03P28TimeLimit', value=0)
...
class NumberOnP29(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P29TimeLimit', value=1):
            return CheckP29()
...
class ResetP29(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P29End', value=1)
        set_user_value(key='G03P29Set', value=0)
        set_user_value(key='G03P29TimeLimit', value=0)
...
class NumberOnP30(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G03P30TimeLimit', value=1):
            return CheckP30()
...
class ResetP30(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G03P30End', value=1)
        set_user_value(key='G03P30Set', value=0)
        set_user_value(key='G03P30TimeLimit', value=0)
