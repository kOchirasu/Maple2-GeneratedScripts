...
class Wait(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P01Set', value=1):
            return NumberOnP01()
        if user_value(key='G04P02Set', value=1):
            return NumberOnP02()
        if user_value(key='G04P03Set', value=1):
            return NumberOnP03()
        if user_value(key='G04P04Set', value=1):
            return NumberOnP04()
        if user_value(key='G04P05Set', value=1):
            return NumberOnP05()
        if user_value(key='G04P06Set', value=1):
            return NumberOnP06()
        if user_value(key='G04P07Set', value=1):
            return NumberOnP07()
        if user_value(key='G04P08Set', value=1):
            return NumberOnP08()
        if user_value(key='G04P09Set', value=1):
            return NumberOnP09()
        if user_value(key='G04P10Set', value=1):
            return NumberOnP10()
        if user_value(key='G04P11Set', value=1):
            return NumberOnP11()
        if user_value(key='G04P12Set', value=1):
            return NumberOnP12()
        if user_value(key='G04P13Set', value=1):
            return NumberOnP13()
        if user_value(key='G04P14Set', value=1):
            return NumberOnP14()
        if user_value(key='G04P15Set', value=1):
            return NumberOnP15()
        if user_value(key='G04P16Set', value=1):
            return NumberOnP16()
        if user_value(key='G04P17Set', value=1):
            return NumberOnP17()
        if user_value(key='G04P18Set', value=1):
            return NumberOnP18()
        if user_value(key='G04P19Set', value=1):
            return NumberOnP19()
        if user_value(key='G04P20Set', value=1):
            return NumberOnP20()
        if user_value(key='G04P21Set', value=1):
            return NumberOnP21()
        if user_value(key='G04P22Set', value=1):
            return NumberOnP22()
        if user_value(key='G04P23Set', value=1):
            return NumberOnP23()
        if user_value(key='G04P24Set', value=1):
            return NumberOnP24()
        if user_value(key='G04P25Set', value=1):
            return NumberOnP25()
        if user_value(key='G04P26Set', value=1):
            return NumberOnP26()
        if user_value(key='G04P27Set', value=1):
            return NumberOnP27()
        if user_value(key='G04P28Set', value=1):
            return NumberOnP28()
        if user_value(key='G04P29Set', value=1):
            return NumberOnP29()
        if user_value(key='G04P30Set', value=1):
            return NumberOnP30()
        if user_value(key='G04P31Set', value=1):
            return NumberOnP31()
        if user_value(key='G04P32Set', value=1):
            return NumberOnP32()
        if user_value(key='G04P33Set', value=1):
            return NumberOnP33()
        if user_value(key='G04P34Set', value=1):
            return NumberOnP34()
        if user_value(key='G04P35Set', value=1):
            return NumberOnP35()
        if user_value(key='G04P36Set', value=1):
            return NumberOnP36()
        if user_value(key='G04P37Set', value=1):
            return NumberOnP37()
        if user_value(key='G04P38Set', value=1):
            return NumberOnP38()
        if user_value(key='G04P39Set', value=1):
            return NumberOnP39()
        if user_value(key='G04P40Set', value=1):
            return NumberOnP40()
...
class NumberOnP01(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P01TimeLimit', value=1):
            return CheckP01()
...
class ResetP01(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P01End', value=1)
        set_user_value(key='G04P01Set', value=0)
        set_user_value(key='G04P01TimeLimit', value=0)
...
class NumberOnP02(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P02TimeLimit', value=1):
            return CheckP02()
...
class ResetP02(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P02End', value=1)
        set_user_value(key='G04P02Set', value=0)
        set_user_value(key='G04P02TimeLimit', value=0)
...
class NumberOnP03(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P03TimeLimit', value=1):
            return CheckP03()
...
class ResetP03(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P03End', value=1)
        set_user_value(key='G04P03Set', value=0)
        set_user_value(key='G04P03TimeLimit', value=0)
...
class NumberOnP04(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P04TimeLimit', value=1):
            return CheckP04()
...
class ResetP04(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P04End', value=1)
        set_user_value(key='G04P04Set', value=0)
        set_user_value(key='G04P04TimeLimit', value=0)
...
class NumberOnP05(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P05TimeLimit', value=1):
            return CheckP05()
...
class ResetP05(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P05End', value=1)
        set_user_value(key='G04P05Set', value=0)
        set_user_value(key='G04P05TimeLimit', value=0)
...
class NumberOnP06(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P06TimeLimit', value=1):
            return CheckP06()
...
class ResetP06(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P06End', value=1)
        set_user_value(key='G04P06Set', value=0)
        set_user_value(key='G04P06TimeLimit', value=0)
...
class NumberOnP07(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P07TimeLimit', value=1):
            return CheckP07()
...
class ResetP07(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P07End', value=1)
        set_user_value(key='G04P07Set', value=0)
        set_user_value(key='G04P07TimeLimit', value=0)
...
class NumberOnP08(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P08TimeLimit', value=1):
            return CheckP08()
...
class ResetP08(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P08End', value=1)
        set_user_value(key='G04P08Set', value=0)
        set_user_value(key='G04P08TimeLimit', value=0)
...
class NumberOnP09(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P09TimeLimit', value=1):
            return CheckP09()
...
class ResetP09(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P09End', value=1)
        set_user_value(key='G04P09Set', value=0)
        set_user_value(key='G04P09TimeLimit', value=0)
...
class NumberOnP10(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P10TimeLimit', value=1):
            return CheckP10()
...
class ResetP10(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P10End', value=1)
        set_user_value(key='G04P10Set', value=0)
        set_user_value(key='G04P10TimeLimit', value=0)
...
class NumberOnP11(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P11TimeLimit', value=1):
            return CheckP11()
...
class ResetP11(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P11End', value=1)
        set_user_value(key='G04P11Set', value=0)
        set_user_value(key='G04P11TimeLimit', value=0)
...
class NumberOnP12(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P12TimeLimit', value=1):
            return CheckP12()
...
class ResetP12(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P12End', value=1)
        set_user_value(key='G04P12Set', value=0)
        set_user_value(key='G04P12TimeLimit', value=0)
...
class NumberOnP13(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P13TimeLimit', value=1):
            return CheckP13()
...
class ResetP13(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P13End', value=1)
        set_user_value(key='G04P13Set', value=0)
        set_user_value(key='G04P13TimeLimit', value=0)
...
class NumberOnP14(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P14TimeLimit', value=1):
            return CheckP14()
...
class ResetP14(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P14End', value=1)
        set_user_value(key='G04P14Set', value=0)
        set_user_value(key='G04P14TimeLimit', value=0)
...
class NumberOnP15(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P15TimeLimit', value=1):
            return CheckP15()
...
class ResetP15(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P15End', value=1)
        set_user_value(key='G04P15Set', value=0)
        set_user_value(key='G04P15TimeLimit', value=0)
...
class NumberOnP16(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P16TimeLimit', value=1):
            return CheckP16()
...
class ResetP16(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P16End', value=1)
        set_user_value(key='G04P16Set', value=0)
        set_user_value(key='G04P16TimeLimit', value=0)
...
class NumberOnP17(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P17TimeLimit', value=1):
            return CheckP17()
...
class ResetP17(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P17End', value=1)
        set_user_value(key='G04P17Set', value=0)
        set_user_value(key='G04P17TimeLimit', value=0)
...
class NumberOnP18(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P18TimeLimit', value=1):
            return CheckP18()
...
class ResetP18(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P18End', value=1)
        set_user_value(key='G04P18Set', value=0)
        set_user_value(key='G04P18TimeLimit', value=0)
...
class NumberOnP19(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P19TimeLimit', value=1):
            return CheckP19()
...
class ResetP19(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P19End', value=1)
        set_user_value(key='G04P19Set', value=0)
        set_user_value(key='G04P19TimeLimit', value=0)
...
class NumberOnP20(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P20TimeLimit', value=1):
            return CheckP20()
...
class ResetP20(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P20End', value=1)
        set_user_value(key='G04P20Set', value=0)
        set_user_value(key='G04P20TimeLimit', value=0)
...
class NumberOnP21(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P21TimeLimit', value=1):
            return CheckP21()
...
class ResetP21(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P21End', value=1)
        set_user_value(key='G04P21Set', value=0)
        set_user_value(key='G04P21TimeLimit', value=0)
...
class NumberOnP22(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P22TimeLimit', value=1):
            return CheckP22()
...
class ResetP22(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P22End', value=1)
        set_user_value(key='G04P22Set', value=0)
        set_user_value(key='G04P22TimeLimit', value=0)
...
class NumberOnP23(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P23TimeLimit', value=1):
            return CheckP23()
...
class ResetP23(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P23End', value=1)
        set_user_value(key='G04P23Set', value=0)
        set_user_value(key='G04P23TimeLimit', value=0)
...
class NumberOnP24(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P24TimeLimit', value=1):
            return CheckP24()
...
class ResetP24(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P24End', value=1)
        set_user_value(key='G04P24Set', value=0)
        set_user_value(key='G04P24TimeLimit', value=0)
...
class NumberOnP25(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P25TimeLimit', value=1):
            return CheckP25()
...
class ResetP25(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P25End', value=1)
        set_user_value(key='G04P25Set', value=0)
        set_user_value(key='G04P25TimeLimit', value=0)
...
class NumberOnP26(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P26TimeLimit', value=1):
            return CheckP26()
...
class ResetP26(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P26End', value=1)
        set_user_value(key='G04P26Set', value=0)
        set_user_value(key='G04P26TimeLimit', value=0)
...
class NumberOnP27(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P27TimeLimit', value=1):
            return CheckP27()
...
class ResetP27(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P27End', value=1)
        set_user_value(key='G04P27Set', value=0)
        set_user_value(key='G04P27TimeLimit', value=0)
...
class NumberOnP28(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P28TimeLimit', value=1):
            return CheckP28()
...
class ResetP28(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P28End', value=1)
        set_user_value(key='G04P28Set', value=0)
        set_user_value(key='G04P28TimeLimit', value=0)
...
class NumberOnP29(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P29TimeLimit', value=1):
            return CheckP29()
...
class ResetP29(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P29End', value=1)
        set_user_value(key='G04P29Set', value=0)
        set_user_value(key='G04P29TimeLimit', value=0)
...
class NumberOnP30(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P30TimeLimit', value=1):
            return CheckP30()
...
class ResetP30(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P30End', value=1)
        set_user_value(key='G04P30Set', value=0)
        set_user_value(key='G04P30TimeLimit', value=0)
...
class NumberOnP31(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P31TimeLimit', value=1):
            return CheckP31()
...
class ResetP31(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P31End', value=1)
        set_user_value(key='G04P31Set', value=0)
        set_user_value(key='G04P31TimeLimit', value=0)
...
class NumberOnP32(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P32TimeLimit', value=1):
            return CheckP32()
...
class ResetP32(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P32End', value=1)
        set_user_value(key='G04P32Set', value=0)
        set_user_value(key='G04P32TimeLimit', value=0)
...
class NumberOnP33(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P33TimeLimit', value=1):
            return CheckP33()
...
class ResetP33(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P33End', value=1)
        set_user_value(key='G04P33Set', value=0)
        set_user_value(key='G04P33TimeLimit', value=0)
...
class NumberOnP34(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P34TimeLimit', value=1):
            return CheckP34()
...
class ResetP34(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P34End', value=1)
        set_user_value(key='G04P34Set', value=0)
        set_user_value(key='G04P34TimeLimit', value=0)
...
class NumberOnP35(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P35TimeLimit', value=1):
            return CheckP35()
...
class ResetP35(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P35End', value=1)
        set_user_value(key='G04P35Set', value=0)
        set_user_value(key='G04P35TimeLimit', value=0)
...
class NumberOnP36(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P36TimeLimit', value=1):
            return CheckP36()
...
class ResetP36(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P36End', value=1)
        set_user_value(key='G04P36Set', value=0)
        set_user_value(key='G04P36TimeLimit', value=0)
...
class NumberOnP37(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P37TimeLimit', value=1):
            return CheckP37()
...
class ResetP37(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P37End', value=1)
        set_user_value(key='G04P37Set', value=0)
        set_user_value(key='G04P37TimeLimit', value=0)
...
class NumberOnP38(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P38TimeLimit', value=1):
            return CheckP38()
...
class ResetP38(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P38End', value=1)
        set_user_value(key='G04P38Set', value=0)
        set_user_value(key='G04P38TimeLimit', value=0)
...
class NumberOnP39(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P39TimeLimit', value=1):
            return CheckP39()
...
class ResetP39(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P39End', value=1)
        set_user_value(key='G04P39Set', value=0)
        set_user_value(key='G04P39TimeLimit', value=0)
...
class NumberOnP40(state.State):
    ...
    def on_tick(self) -> state.State:
        if user_value(key='G04P40TimeLimit', value=1):
            return CheckP40()
...
class ResetP40(state.State):
    def on_enter(self):
        set_user_value(triggerId=1, key='G04P40End', value=1)
        set_user_value(key='G04P40Set', value=0)
        set_user_value(key='G04P40TimeLimit', value=0)
