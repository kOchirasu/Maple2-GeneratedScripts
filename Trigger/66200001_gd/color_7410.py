...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[841], visible=True, arg3=0, delay=0, scale=0) # yellow
        self.set_mesh(triggerIds=[941], visible=False, arg3=0, delay=0, scale=0) # green
        self.set_mesh(triggerIds=[1041], visible=False, arg3=0, delay=0, scale=0) # red
...
class YellowBefore(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[841], visible=True, arg3=0, delay=0, scale=2) # yellow
        self.set_mesh(triggerIds=[941], visible=False, arg3=0, delay=0, scale=0) # green
        self.set_mesh(triggerIds=[1041], visible=False, arg3=0, delay=0, scale=0) # red
...
class RedBefore(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[1041], visible=True, arg3=0, delay=0, scale=0) # red
        self.set_mesh(triggerIds=[941], visible=False, arg3=0, delay=0, scale=0) # green
        self.set_mesh(triggerIds=[841], visible=False, arg3=0, delay=0, scale=0) # yellow
...
class GreenAfter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[941], visible=True, arg3=0, delay=0, scale=0) # green
...
class YellowAfter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[841], visible=True, arg3=0, delay=0, scale=2) # yellow
        self.set_mesh(triggerIds=[941], visible=False, arg3=0, delay=0, scale=0) # green
        self.set_mesh(triggerIds=[1041], visible=False, arg3=100, delay=0, scale=0) # red
...
class RedAfter(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[1041], visible=True, arg3=0, delay=0, scale=0) # red
        self.set_mesh(triggerIds=[941], visible=False, arg3=0, delay=0, scale=0) # green
        self.set_mesh(triggerIds=[841], visible=False, arg3=100, delay=0, scale=0) # yellow
...
class Clear(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(triggerIds=[941], visible=False, arg3=0, delay=0, scale=2) # green
        self.set_mesh(triggerIds=[841], visible=False, arg3=0, delay=0, scale=2) # yellow
        self.set_mesh(triggerIds=[1041], visible=False, arg3=0, delay=0, scale=2) # red
...
class Regen(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[841], visible=True, arg3=400, delay=0, scale=0) # yellow
        self.set_mesh(triggerIds=[941], visible=False, arg3=0, delay=0, scale=0) # green
        self.set_mesh(triggerIds=[1041], visible=False, arg3=0, delay=0, scale=0) # red
