...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[513], visible=True, start_delay=0, interval=0, fade=0) # 13 / Ground outter
        self.set_mesh(trigger_ids=[5130], visible=True, start_delay=0, interval=0, fade=0) # 13 / Ground inner
...
class Pass(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[513], visible=False, start_delay=0, interval=0, fade=2) # 13 / Ground outter
...
class Fail(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[513], visible=False, start_delay=0, interval=0, fade=2) # 13 / Ground outter
        self.set_mesh(trigger_ids=[5130], visible=False, start_delay=0, interval=0, fade=0) # 13 / Ground inner
