...
class CheckSameUserTag7332(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.all_of():
...
class CheckSameUserTag7333(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.all_of():
...
class CheckSameUserTag7334(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.all_of():
...
class CheckSameUserTag7335(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.all_of():
