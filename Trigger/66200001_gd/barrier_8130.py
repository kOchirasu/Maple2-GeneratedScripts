...
class CheckSameUserTag7132(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9130) and self.count_users(boxId=9130, minUsers='2', operator='Equal'):
...
class CheckSameUserTag7133(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9130) and self.count_users(boxId=9130, minUsers='3', operator='Equal'):
...
class CheckSameUserTag7134(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9130) and self.count_users(boxId=9130, minUsers='4', operator='Equal'):
...
class CheckSameUserTag7135(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9130) and self.count_users(boxId=9130, minUsers='5', operator='Equal'):
