...
class Notice_90sec_Left(common.Trigger):
    def on_enter(self):
...
class Notice_till75sec_01(common.Trigger):
    def on_enter(self):
...
class Notice_till75sec_02(common.Trigger):
    def on_enter(self):
...
class Notice_75sec_Left(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class Notice_till60sec_01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620106, textId=26620106, duration=5000) # 다른 친구들이 올 때까지 조금만 기다려주세요.
...
class Notice_till60sec_02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620107, textId=26620107, duration=5000) # 한 팀의 입장 인원이 [b:10명보다 적으면 기권 처리] 됩니다.
...
class Notice_60sec_Left(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class Notice_till45sec_01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620106, textId=26620106, duration=5000) # 다른 친구들이 올 때까지 조금만 기다려주세요.
...
class Notice_till45sec_02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620107, textId=26620107, duration=5000) # 한 팀의 입장 인원이 [b:10명보다 적으면 기권 처리] 됩니다.
...
class Notice_45sec_Left(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class Notice_till30sec_01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620106, textId=26620106, duration=5000) # 다른 친구들이 올 때까지 조금만 기다려주세요.
...
class Notice_till30sec_02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620107, textId=26620107, duration=5000) # 한 팀의 입장 인원이 [b:10명보다 적으면 기권 처리] 됩니다.
...
class Notice_30sec_Left(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class Notice_till15sec_01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620106, textId=26620106, duration=5000) # 다른 친구들이 올 때까지 조금만 기다려주세요.
...
class Notice_till15sec_02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620107, textId=26620107, duration=5000) # 한 팀의 입장 인원이 [b:10명보다 적으면 기권 처리] 됩니다.
...
class Notice_15sec_Left(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class Notice_till0sec_01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620106, textId=26620106, duration=5000) # 다른 친구들이 올 때까지 조금만 기다려주세요.
...
class Notice_till0sec_02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=26620107, textId=26620107, duration=5000) # 한 팀의 입장 인원이 [b:10명보다 적으면 기권 처리] 됩니다.
