...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_sound(triggerId=40000, enable=False) # Puzzle
        self.set_effect(triggerIds=[8000], visible=False) # Scratch
        self.set_effect(triggerIds=[8002], visible=False) # BlueTeamBox
        self.set_effect(triggerIds=[8003], visible=False) # BlueTeamArrow
        self.set_effect(triggerIds=[8004], visible=False) # RedTeamBox
        self.set_effect(triggerIds=[8005], visible=False) # RedTeamArrow
        self.set_mesh(triggerIds=[601,602,603,604,605,606,607,608,609,610,611,612,613,614,615,616,617,618,619,620,621,622,623,624,625,626,627,628,629,630,631,632,633], visible=True, arg3=0, delay=0, scale=0) # Dance
        self.set_mesh(triggerIds=[511,512,513,514], visible=True, arg3=0, delay=0, scale=0) # Row1
        self.set_mesh(triggerIds=[521,522,523,524], visible=True, arg3=0, delay=0, scale=0) # Row2
        self.set_mesh(triggerIds=[531,532,533,534], visible=True, arg3=0, delay=0, scale=0) # Row3
        self.set_mesh(triggerIds=[541,542,543,544], visible=True, arg3=0, delay=0, scale=0) # Row4
        self.set_mesh(triggerIds=[110,111,112,113,114,115], visible=False, arg3=0, delay=0, scale=0) # 1,1 / 0 to 5
        self.set_mesh(triggerIds=[120,121,122,123,124,125], visible=False, arg3=0, delay=0, scale=0) # 1,2 / 0 to 5
        self.set_mesh(triggerIds=[130,131,132,133,134,135], visible=False, arg3=0, delay=0, scale=0) # 1,3 / 0 to 5
        self.set_mesh(triggerIds=[140,141,142,143,144,145], visible=False, arg3=0, delay=0, scale=0) # 1,4 / 0 to 5
        self.set_mesh(triggerIds=[210,211,212,213,214,215], visible=False, arg3=0, delay=0, scale=0) # 2,1 / 0 to 5
        self.set_mesh(triggerIds=[220,221,222,223,224,225], visible=False, arg3=0, delay=0, scale=0) # 2,2 / 0 to 5
        self.set_mesh(triggerIds=[230,231,232,233,234,235], visible=False, arg3=0, delay=0, scale=0) # 2,3 / 0 to 5
        self.set_mesh(triggerIds=[240,241,242,243,244,245], visible=False, arg3=0, delay=0, scale=0) # 2,4 / 0 to 5
        self.set_mesh(triggerIds=[310,311,312,313,314,315], visible=False, arg3=0, delay=0, scale=0) # 3,1 / 0 to 5
        self.set_mesh(triggerIds=[320,321,322,323,324,325], visible=False, arg3=0, delay=0, scale=0) # 3,2 / 0 to 5
        self.set_mesh(triggerIds=[330,331,332,333,334,335], visible=False, arg3=0, delay=0, scale=0) # 3,3 / 0 to 5
        self.set_mesh(triggerIds=[340,341,342,343,344,345], visible=False, arg3=0, delay=0, scale=0) # 3,4 / 0 to 5
        self.set_mesh(triggerIds=[410,411,412,413,414,415], visible=False, arg3=0, delay=0, scale=0) # 4,1 / 0 to 5
        self.set_mesh(triggerIds=[420,421,422,423,424,425], visible=False, arg3=0, delay=0, scale=0) # 4,2 / 0 to 5
        self.set_mesh(triggerIds=[430,431,432,433,434,435], visible=False, arg3=0, delay=0, scale=0) # 4,3 / 0 to 5
        self.set_mesh(triggerIds=[440,441,442,443,444,445], visible=False, arg3=0, delay=0, scale=0) # 4,4 / 0 to 5
        self.set_mesh(triggerIds=[8900,8901,8902,8903,8904,8905,8906,8907,8908,8909,8910,8911,8912,8913,8914], visible=False, arg3=0, delay=0, scale=0) # Barrier
        self.set_interact_object(triggerIds=[10001180], state=0) # 7000ms
        self.set_interact_object(triggerIds=[10001181], state=2) # 9000ms
        self.set_interact_object(triggerIds=[10001182], state=2) # 12000ms
        self.set_interact_object(triggerIds=[10001183], state=2) # 15000ms
        self.set_user_value(key='Round', value=0)
        self.set_user_value(key='DanceTime', value=0)
        self.set_user_value(key='WinnerTeam', value=0)
        self.set_portal(portalId=4, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=5, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=7, visible=False, enable=False, minimapVisible=False) # LeavePortal_EndGame
        self.set_portal(portalId=8, visible=False, enable=False, minimapVisible=False) # LeavePortal_EndGame
        self.set_portal(portalId=9, visible=False, enable=False, minimapVisible=False) # LeavePortal_EndGame
        self.set_portal(portalId=10, visible=False, enable=False, minimapVisible=False) # LeavePortal_EndGame
...
class EntryDelay(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=9, key='MoveToTeamPortal', value=1) # 팀 대기 공간으로 이동 시작
        self.set_user_value(triggerId=10, key='BannerCheckIn', value=1) # 대기 공간 인원 체크 시작
        self.set_user_value(triggerId=11, key='BannerCheckIn', value=1) # 게임판 위 인원수 배너 표시
        self.set_timer(timerId='1', seconds=90) # 테스트 수정 가능 지점

    def on_tick(self) -> common.Trigger:
        if self.time_expired(timerId='1'):
            return IsGameStartOrNot(self.ctx)


# 유효 게임 판정 (팀별 인원수 체크)
class IsGameStartOrNot(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.count_users(boxId=9000, boxId=10, operator='GreaterEqual', userTagId=1):
            return IsGameStart_True01(self.ctx)
        if self.count_users(boxId=9000, boxId=10, operator='GreaterEqual', userTagId=2):
            return IsGameStart_Ture02(self.ctx)
        if self.count_users(boxId=9000, boxId=10, operator='Less', userTagId=1):
            return IsGameStart_False(self.ctx)


class IsGameStart_True01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.count_users(boxId=9000, boxId=10, operator='GreaterEqual', userTagId=2):
            return MoveToTeamCamp(self.ctx)
        if self.count_users(boxId=9000, boxId=10, operator='Less', userTagId=2):
            return DefaultbyWin_BlueTeam(self.ctx)


class IsGameStart_Ture02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.count_users(boxId=9000, boxId=10, operator='GreaterEqual', userTagId=1):
            return MoveToTeamCamp(self.ctx)
        if self.count_users(boxId=9000, boxId=10, operator='Less', userTagId=1):
            return DefaultbyWin_RedTeam(self.ctx)


class IsGameStart_False(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.count_users(boxId=9000, boxId=10, operator='Less', userTagId=2):
...
# 팀 대기 공간으로 이동
class MoveToTeamCamp(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=9, key='MoveToTeamPortal', value=2) # 팀 대기 공간으로 이동 종료 = 입장 종료
        self.move_to_portal(userTagId=1, portalId=21) # Tag1=Blue
        self.move_to_portal(userTagId=2, portalId=22) # Tag2=Red
...
class GameGuide01(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=10, key='BannerCheckIn', value=0) # 대기 공간 인원 체크 종료
        self.set_sound(triggerId=30000, enable=False) # Silence
        ...
        self.set_achievement(triggerId=9000, type='trigger', achieve='guildminigame_start') # 이벤트 퀘스트 관련
...
class R01PlayerRandomPick01(common.Trigger):
    def on_enter(self):
...
class PlayerRandomPick02(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9000], sound='BattleField_Event')
        self.set_event_ui(type=1, arg2='$66200001_GD__01_MASSIVEMAIN__5$', arg3='5000', arg4='0')
        self.set_effect(triggerIds=[8002], visible=True) # BlueTeamBox
        self.set_effect(triggerIds=[8003], visible=True) # BlueTeamArrow
        self.set_effect(triggerIds=[8004], visible=True) # RedTeamBox
        self.set_effect(triggerIds=[8005], visible=True) # RedTeamArrow
...
# 무작위 이동 안내 / 라운드 공용
class PlayerRandomPickStartCount(common.Trigger):
    def on_enter(self):
        self.show_count_ui(text='$66200001_GD__01_MASSIVEMAIN__6$', stage=0, count=3)
...
class PlayerRandomPickMove(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[8002], visible=False) # BlueTeamBox
        self.set_effect(triggerIds=[8003], visible=False) # BlueTeamArrow
        self.set_effect(triggerIds=[8004], visible=False) # RedTeamBox
        self.set_effect(triggerIds=[8005], visible=False) # RedTeamArrow
        self.move_random_user(mapId=66200001, portalId=1, triggerId=9031, count=30) # 1번 포탈로 블루팀 최대 30명 이동
        self.move_random_user(mapId=66200001, portalId=2, triggerId=9032, count=30) # 2번 포탈로 블루팀 최대 30명 이동
        self.play_system_sound_in_box(boxIds=[9000], sound='GuildBattle_MemberPick')
...
class CheckTheNumberOfPlayer(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=11, key='BannerCheckIn', value=1) # 게임판 위 인원수 배너 표시
        self.play_system_sound_in_box(boxIds=[9000], sound='BattleField_Event')
...
class R01DanceTime(common.Trigger):
    ...
    def on_exit(self):
        self.set_interact_object(triggerIds=[10001180], state=2) # 7000ms


# Dance 9000ms
class DancePattern01(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
        self.set_interact_object(triggerIds=[10001181], state=1) # 9000ms
...
# Dance 12000ms
class DancePattern02(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
        self.set_interact_object(triggerIds=[10001182], state=1) # 12000ms
...
# Dance 15000ms
class DancePattern03(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
        self.set_interact_object(triggerIds=[10001183], state=1) # 15000ms
...
# Dance 7000ms+ 9000ms
class DancePattern0401(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
        self.set_interact_object(triggerIds=[10001180], state=1) # 7000ms
...
class DancePattern0402(common.Trigger):
    def on_enter(self):
...
class DancePattern0403(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$66200001_GD__01_MASSIVEMAIN__9$', arg3='1500', arg4='0')
        self.set_interact_object(triggerIds=[10001180], state=2) # 7000ms
        self.set_interact_object(triggerIds=[10001181], state=0) # 9000ms
...
class DancePattern0404(common.Trigger):
    def on_enter(self):
        self.set_sound(triggerId=30000, enable=False) # Silence
        self.set_sound(triggerId=20000, enable=True) # Dance
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
...
# Dance 9000ms+ 7000ms
class DancePattern0501(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
        self.set_interact_object(triggerIds=[10001181], state=1) # 9000ms
...
class DancePattern0502(common.Trigger):
    def on_enter(self):
...
class DancePattern0503(common.Trigger):
    def on_enter(self):
...
class DancePattern0504(common.Trigger):
    def on_enter(self):
        self.set_sound(triggerId=30000, enable=False) # Silence
        self.set_sound(triggerId=20000, enable=True) # Dance
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
...
class DancePattern0601(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
        self.set_interact_object(triggerIds=[10001182], state=1) # 12000ms
...
class DancePattern0602(common.Trigger):
    def on_enter(self):
        ...
        self.set_sound(triggerId=30000, enable=True) # Silence
        self.set_effect(triggerIds=[8000], visible=True) # Scratch
        self.set_interact_object(triggerIds=[10001182], state=0) # 12000ms
...
class DancePattern0603(common.Trigger):
    def on_enter(self):
...
class DancePattern0604(common.Trigger):
    def on_enter(self):
        self.set_sound(triggerId=30000, enable=False) # Silence
        self.set_sound(triggerId=20000, enable=True) # Dance
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
...
class DancePattern0701(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
        self.set_interact_object(triggerIds=[10001180], state=1) # 7000ms
...
class DancePattern0702(common.Trigger):
    def on_enter(self):
...
class DancePattern0703(common.Trigger):
    def on_enter(self):
...
class DancePattern0704(common.Trigger):
    def on_enter(self):
        self.set_sound(triggerId=30000, enable=False) # Silence
        self.set_sound(triggerId=20000, enable=True) # Dance
        self.play_system_sound_in_box(boxIds=[9001], sound='DDStop_Stage_Ready_01')
...
class CheckDanceRound(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_value(key='DanceTime', value=1):
            return R01_GameStartDelay(self.ctx)
        if self.user_value(key='DanceTime', value=2):
            return R02_GameStartDelay(self.ctx)
        if self.user_value(key='DanceTime', value=3):
            return R03_GameStartDelay(self.ctx)
        if self.user_value(key='DanceTime', value=4):
            return R04_GameStartDelay(self.ctx)
        if self.user_value(key='DanceTime', value=5):
...
class R01_GameTimerStart(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='11111', seconds=20, startDelay=1, interval=1, vOffset=-40) # Round1 / 20sec  / UI 표시
...
class R01G00Check(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.count_users(boxId=9001, boxId=50, operator='Greater'):
...
class R01EndDelay(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=7110, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7120, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7130, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7140, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7210, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7220, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7230, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7240, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7310, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7320, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7330, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7340, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7410, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7420, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7430, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7440, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=4, key='RoundScoreRecord', value=1) # 스코어 배너 기록
...
class R01End(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=8140, key='Barrier14', value=10)
        self.set_user_value(triggerId=8210, key='Barrier21', value=10)
        self.set_user_value(triggerId=8220, key='Barrier22', value=10)
        self.set_user_value(triggerId=8230, key='Barrier23', value=10)
        self.set_user_value(triggerId=8240, key='Barrier24', value=10)
        self.set_user_value(triggerId=8310, key='Barrier31', value=10)
        self.set_user_value(triggerId=8320, key='Barrier32', value=10)
        self.set_user_value(triggerId=8330, key='Barrier33', value=10)
        self.set_user_value(triggerId=8340, key='Barrier34', value=10)
        self.set_user_value(triggerId=8410, key='Barrier41', value=10)
        self.set_user_value(triggerId=8420, key='Barrier42', value=10)
...
class RoundResultNotice01(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class RoundResult_BlueTeamWin01(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__17$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__18$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouLose_01')
...
class RoundResult_RedTeamWin01(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__19$', duration=4000, userTagId=2)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__20$', duration=4000, userTagId=1)
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouLose_01')
...
class RoundResult_Draw01(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__21$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__22$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_Draw_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_Draw_01')
...
# R01 라운드 승패 판정
class R01RoundScoreRecord(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_value(key='WinnerTeam', value=0):
            return EveryPlayerVacuumGuide(self.ctx)
        if self.user_value(key='WinnerTeam', value=1):
            return BlueTeamWinAlreadyNotice(self.ctx)
        if self.user_value(key='WinnerTeam', value=2):
            return RedTeamWinAlreadyNotice(self.ctx)


# 라운드 종료 멤버 리셋 / 라운드 공용
class EveryPlayerVacuumGuide(common.Trigger):
    def on_enter(self):
...
class EveryPlayerVacuumExecute(common.Trigger):
    def on_enter(self):
        self.move_to_portal(boxId=9001, userTagId=1, portalId=21) # Tag1=Blue 통과자들 진영으로
        self.move_to_portal(boxId=9001, userTagId=2, portalId=22) # Tag2=Red 통과자들 진영으로
...
class R02PlayerRandomPick01(common.Trigger):
    def on_enter(self):
...
class R02Start(common.Trigger):
    def on_enter(self):
        ...
        self.play_system_sound_in_box(boxIds=[9000], sound='DJDD_Dancetime_02')
...
class R02EndDelay(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=7430, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7440, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=4, key='RoundScoreRecord', value=2) # 스코어 배너 기록
        self.set_mesh(triggerIds=[601,602,603,604,605,606,607,608,609,610,611,612,613,614,615,616,617,618,619,620,621,622,623,624,625,626,627,628,629,630,631,632,633], visible=True, arg3=400, delay=0, scale=2) # 스테이지 정리
...
class RoundResultNotice02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.guild_vs_game_scored_team(teamId=1):
...
class RoundResult_BlueTeamWin02(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__26$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__27$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouLose_01')
...
class RoundResult_RedTeamWin02(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__28$', duration=4000, userTagId=2)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__29$', duration=4000, userTagId=1)
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouLose_01')
...
class RoundResult_Draw02(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__30$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__31$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_Draw_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_Draw_01')
...
# R02 라운드 승패 판정
class R02RoundScoreRecord(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_value(key='WinnerTeam', value=0):
            return EveryPlayerVacuumGuide(self.ctx)
        if self.user_value(key='WinnerTeam', value=1):
...
class R03Start(common.Trigger):
    def on_enter(self):
        ...
        self.play_system_sound_in_box(boxIds=[9000], sound='DJDD_Dancetime_03')
        self.set_sound(triggerId=40000, enable=False) # Intro
        self.set_sound(triggerId=30000, enable=True) # Silence
        self.set_effect(triggerIds=[8000], visible=True) # Scratch
...
class R03_GameTimerStart(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='11111', seconds=20, startDelay=1, interval=1, vOffset=-40) # Round3 / 20sec  / UI 표시
        self.set_user_value(triggerId=8, key='CheerUpTimer', value=1) # 이속 증가 버프
        self.set_user_value(triggerId=7, key='GameGuide', value=1) # 가이드 : 숫자 발판
...
class R03EndDelay(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=7430, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7440, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=4, key='RoundScoreRecord', value=3) # 스코어 배너 기록
        self.set_mesh(triggerIds=[601,602,603,604,605,606,607,608,609,610,611,612,613,614,615,616,617,618,619,620,621,622,623,624,625,626,627,628,629,630,631,632,633], visible=True, arg3=400, delay=0, scale=2) # 스테이지 정리
...
class RoundResultNotice03(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.guild_vs_game_scored_team(teamId=1):
...
class RoundResult_BlueTeamWin03(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__34$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__35$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouLose_01')
...
class RoundResult_RedTeamWin03(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__36$', duration=4000, userTagId=2)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__37$', duration=4000, userTagId=1)
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouLose_01')
...
class RoundResult_Draw03(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__38$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__39$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_Draw_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_Draw_01')
...
# R03 라운드 승패 판정
class R03RoundScoreRecord(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_value(key='WinnerTeam', value=0):
            return EveryPlayerVacuumGuide(self.ctx)
        if self.user_value(key='WinnerTeam', value=1):
...
class R04Start(common.Trigger):
    def on_enter(self):
        ...
        self.play_system_sound_in_box(boxIds=[9000], sound='DJDD_Dancetime_04')
        self.set_sound(triggerId=40000, enable=False) # Intro
        self.set_sound(triggerId=30000, enable=True) # Silence
        self.set_effect(triggerIds=[8000], visible=True) # Scratch
...
class R04_GameTimerStart(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='11111', seconds=20, startDelay=1, interval=1, vOffset=-40) # Round4 / 20sec  / UI 표시
        self.set_user_value(triggerId=8, key='CheerUpTimer', value=1) # 이속 증가 버프
        self.set_user_value(triggerId=7, key='GameGuide', value=1) # 가이드 : 숫자 발판
...
class R04EndDelay(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=7430, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7440, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=4, key='RoundScoreRecord', value=4) # 스코어 배너 기록
        self.set_mesh(triggerIds=[601,602,603,604,605,606,607,608,609,610,611,612,613,614,615,616,617,618,619,620,621,622,623,624,625,626,627,628,629,630,631,632,633], visible=True, arg3=400, delay=0, scale=2) # 스테이지 정리
...
class RoundResultNotice04(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.guild_vs_game_scored_team(teamId=1):
...
class RoundResult_BlueTeamWin04(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__42$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__43$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouLose_01')
...
class RoundResult_RedTeamWin04(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__44$', duration=4000, userTagId=2)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__45$', duration=4000, userTagId=1)
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouLose_01')
...
class RoundResult_Draw04(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__46$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__47$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_Draw_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_Draw_01')
...
# R04 라운드 승패 판정
class R04RoundScoreRecord(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_value(key='WinnerTeam', value=0):
            return EveryPlayerVacuumGuide(self.ctx)
        if self.user_value(key='WinnerTeam', value=1):
...
class R05PlayerRandomPick01(common.Trigger):
    def on_enter(self):
...
class R05Start(common.Trigger):
    def on_enter(self):
        ...
        self.play_system_sound_in_box(boxIds=[9000], sound='DJDD_Dancetime_05')
        self.set_sound(triggerId=40000, enable=False) # Intro
        self.set_sound(triggerId=30000, enable=True) # Silence
        self.set_effect(triggerIds=[8000], visible=True) # Scratch
...
class R05_GameTimerStart(common.Trigger):
    def on_enter(self):
        self.set_timer(timerId='11111', seconds=20, startDelay=1, interval=1, vOffset=-40) # Round5 / 20sec  / UI 표시
        self.set_user_value(triggerId=8, key='CheerUpTimer', value=1) # 이속 증가 버프
        self.set_user_value(triggerId=7, key='GameGuide', value=1) # 가이드 : 숫자 발판
...
class R05EndDelay(common.Trigger):
    def on_enter(self):
        ...
        self.set_user_value(triggerId=7430, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=7440, key='ColorEnd', value=1) # color reset
        self.set_user_value(triggerId=4, key='RoundScoreRecord', value=5) # 스코어 배너 기록
        self.set_mesh(triggerIds=[601,602,603,604,605,606,607,608,609,610,611,612,613,614,615,616,617,618,619,620,621,622,623,624,625,626,627,628,629,630,631,632,633], visible=True, arg3=400, delay=0, scale=2) # 스테이지 정리
...
class RoundResultNotice05(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.guild_vs_game_scored_team(teamId=1):
...
class RoundResult_BlueTeamWin05(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__50$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__51$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouLose_01')
...
class RoundResult_RedTeamWin05(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__52$', duration=4000, userTagId=2)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__53$', duration=4000, userTagId=1)
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouLose_01')
...
class RoundResult_Draw05(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__54$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__55$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_Draw_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_Draw_01')
...
# 게임 종료 모든 팀원 각 진영으로
class GameWrapUp_EveryPlayerVacuumExecute(common.Trigger):
    def on_enter(self):
        self.move_to_portal(boxId=9001, userTagId=1, portalId=21) # Tag1=Blue 통과자들 진영으로
        self.move_to_portal(boxId=9001, userTagId=2, portalId=22) # Tag2=Red 통과자들 진영으로
...
# 최종 라운드 승패 판정
class R05RoundScoreRecord(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.guild_vs_game_winner_team(teamId=1):
            return BlueTeamWin_GiveReward(self.ctx)
        if self.guild_vs_game_winner_team(teamId=2):
            return RedTeamWin_GiveReward(self.ctx)
        if self.guild_vs_game_winner_team(teamId=0):
            return DrawGame_GiveReward(self.ctx)


# 5 라운드 이전 승패 판정
class BlueTeamWinAlreadyNotice(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__56$', duration=3000, userTagId=1) # BlueTeam 승리
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__57$', duration=3000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouLose_01')
...
class BlueTeamWinWinAlready_VacuumExecute(common.Trigger):
    def on_enter(self):
        self.move_to_portal(boxId=9001, userTagId=1, portalId=21) # Tag1=Blue 통과자들 진영으로
        self.move_to_portal(boxId=9001, userTagId=2, portalId=22) # Tag2=Red 통과자들 진영으로
...
class RedTeamWinAlreadyNotice(common.Trigger):
    def on_enter(self):
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__58$', duration=3000, userTagId=2) # RedTeam 승리
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__59$', duration=3000, userTagId=1)
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='System_YouWin_01')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='System_YouLose_01')
...
class RedTeamWinAlready_VacuumExecute(common.Trigger):
    def on_enter(self):
        self.move_to_portal(boxId=9001, userTagId=1, portalId=21) # Tag1=Blue 통과자들 진영으로
        self.move_to_portal(boxId=9001, userTagId=2, portalId=22) # Tag2=Red 통과자들 진영으로
...
# 정상 게임 1팀 블루팀 승리
class BlueTeamWin_GiveReward(common.Trigger):
    def on_enter(self):
        self.guild_vs_game_give_reward(type='fund', teamId=1, isWin=True) # BlueTeam 승리
        self.guild_vs_game_give_reward(type='exp', teamId=1, isWin=True) # BlueTeam 승리
        self.guild_vs_game_give_reward(type='guildCoin', teamId=1, isWin=True) # BlueTeam 승리
        self.guild_vs_game_give_contribution(teamId=1, isWin=True) # BlueTeam 승리
        self.guild_vs_game_give_reward(type='fund', teamId=2, isWin=False) # RedTeam 패배
        self.guild_vs_game_give_reward(type='exp', teamId=2, isWin=False) # RedTeam 패배
        self.guild_vs_game_give_reward(type='guildCoin', teamId=2, isWin=False) # RedTeam 패배
        self.guild_vs_game_give_contribution(teamId=2, isWin=False) # RedTeam 패배
...
# 정상 게임 2팀 레드팀 승리
class RedTeamWin_GiveReward(common.Trigger):
    def on_enter(self):
        self.guild_vs_game_give_reward(type='fund', teamId=2, isWin=True) # RedTeam 승리
        self.guild_vs_game_give_reward(type='exp', teamId=2, isWin=True) # RedTeam 승리
        self.guild_vs_game_give_reward(type='guildCoin', teamId=2, isWin=True) # RedTeam 승리
        self.guild_vs_game_give_contribution(teamId=2, isWin=True) # RedTeam 승리
        self.guild_vs_game_give_reward(type='fund', teamId=1, isWin=False) # BlueTeam 패배
        self.guild_vs_game_give_reward(type='exp', teamId=1, isWin=False) # BlueTeam 패배
        self.guild_vs_game_give_reward(type='guildCoin', teamId=1, isWin=False) # BlueTeam 패배
        self.guild_vs_game_give_contribution(teamId=1, isWin=False) # BlueTeam 패배
...
# 정상 게임 무승부
class DrawGame_GiveReward(common.Trigger):
    def on_enter(self):
        self.guild_vs_game_give_reward(type='fund', teamId=1, isWin=False) # BlueTeam 무승부
        self.guild_vs_game_give_reward(type='exp', teamId=1, isWin=False) # BlueTeam 무승부
        self.guild_vs_game_give_reward(type='guildCoin', teamId=1, isWin=False) # BlueTeam 무승부
        self.guild_vs_game_give_contribution(teamId=1, isWin=False) # BlueTeam 무승부
        self.guild_vs_game_give_reward(type='fund', teamId=2, isWin=False) # RedTeam 무승부
        self.guild_vs_game_give_reward(type='exp', teamId=2, isWin=False) # RedTeam 무승부
        self.guild_vs_game_give_reward(type='guildCoin', teamId=2, isWin=False) # RedTeam 무승부
        self.guild_vs_game_give_contribution(teamId=2, isWin=False) # RedTeam 무승부
...
# 블루팀 승리 결과창 팝업
class ResultPopUp_BlueTeamWin(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=0, arg2='0,0')
        self.guild_vs_game_result()
        self.guild_vs_game_log_result()
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='massive_success')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='massive_fail')
        self.set_portal(portalId=7, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=8, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
...
# 레드팀 승리 결과창 팝업
class ResultPopUp_RedTeamWin(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=0, arg2='0,0')
        self.guild_vs_game_result()
        self.guild_vs_game_log_result()
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='massive_success')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='massive_fail')
        self.set_portal(portalId=7, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=8, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
...
# 무승부 결과창 팝업
class ResultPopUp_Draw(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=0, arg2='0,0')
        self.guild_vs_game_result()
        self.guild_vs_game_log_result()
...
# 1팀=블루팀 부전승
class DefaultbyWin_BlueTeam(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=0, arg2='0,0')
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__60$', duration=4000, userTagId=1)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__61$', duration=4000, userTagId=2)
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='massive_success')
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='massive_fail')
...
class DefaultbyWin_BlueTeam_GiveReward(common.Trigger):
    def on_enter(self):
        self.guild_vs_game_give_reward(type='fund', teamId=1, isWin=False) # BlueTeam 부전승
        self.guild_vs_game_give_reward(type='exp', teamId=1, isWin=False) # BlueTeam 부전승
        self.guild_vs_game_give_reward(type='guildCoin', teamId=1, isWin=False) # BlueTeam 부전승
        self.guild_vs_game_give_contribution(teamId=1, isWin=False) # BlueTeam 부전승
        self.set_portal(portalId=7, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=8, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.guild_vs_game_log_won_by_default(teamId=1)
...
# 2팀=레드팀 부전승
class DefaultbyWin_RedTeam(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=0, arg2='0,0')
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__62$', duration=4000, userTagId=2)
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__63$', duration=4000, userTagId=1)
        self.play_system_sound_by_user_tag(userTagId=2, soundKey='massive_success')
        self.play_system_sound_by_user_tag(userTagId=1, soundKey='massive_fail')
...
class DefaultbyWin_RedTeam_GiveReward(common.Trigger):
    def on_enter(self):
        self.guild_vs_game_give_reward(type='fund', teamId=2, isWin=False) # RedTeam 부전승
        self.guild_vs_game_give_reward(type='exp', teamId=2, isWin=False) # RedTeam 부전승
        self.guild_vs_game_give_reward(type='guildCoin', teamId=2, isWin=False) # BlueTeam 부전승
        self.guild_vs_game_give_contribution(teamId=2, isWin=False) # RedTeam 부전승
        self.set_portal(portalId=7, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=8, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.guild_vs_game_log_won_by_default(teamId=2)
...
class GameCancel(common.Trigger):
    def on_enter(self):
        self.set_portal(portalId=7, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=8, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=9, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_portal(portalId=10, visible=True, enable=True, minimapVisible=True) # LeavePortal_EndGame
        self.set_event_ui(type=0, arg2='0,0')
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__64$', duration=4000, triggerBoxId=9000, isOutside=False)
        self.play_system_sound_in_box(boxIds=[9000], sound='massive_fail')
...
class LeaveAll(common.Trigger):
    def on_enter(self):
        ...
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__65$', duration=10000, triggerBoxId=9000, isOutside=False)
...
class RoundCheckOutDelay(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=500):
...
class RoundCheckOut(common.Trigger):
    def on_enter(self):
        self.set_user_value(triggerId=11, key='BannerCheckIn', value=1) # 게임판 위 인원수 배너 표시
        self.guild_vs_game_score_by_user(boxId=9001, score=1) # 이긴팀에게 라운드 스코어 1점 부여
