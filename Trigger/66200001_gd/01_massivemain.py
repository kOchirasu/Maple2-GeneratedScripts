...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[8002], visible=False) # BlueTeamBox
        self.set_effect(trigger_ids=[8003], visible=False) # BlueTeamArrow
        self.set_effect(trigger_ids=[8004], visible=False) # RedTeamBox
        self.set_effect(trigger_ids=[8005], visible=False) # RedTeamArrow
        ...
        self.set_portal(portal_id=7, visible=False, enable=False, minimap_visible=False) # LeavePortal_EndGame
        self.set_portal(portal_id=8, visible=False, enable=False, minimap_visible=False) # LeavePortal_EndGame
        self.set_portal(portal_id=9, visible=False, enable=False, minimap_visible=False) # LeavePortal_EndGame
        self.set_portal(portal_id=10, visible=False, enable=False, minimap_visible=False) # LeavePortal_EndGame
...
class IsGameStartOrNot(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9000, min_users='10', operator='GreaterEqual', user_tag_id=1):
            # 1팀 10명 이상인지
            return IsGameStart_True01(self.ctx)
        if self.count_users(box_id=9000, min_users='10', operator='GreaterEqual', user_tag_id=2):
            # 2팀 10명 이상인지
            return IsGameStart_Ture02(self.ctx)
        if self.count_users(box_id=9000, min_users='10', operator='Less', user_tag_id=1):
            # 1팀 10명 미만이면
...
class IsGameStart_True01(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if self.count_users(box_id=9000, min_users='10', operator='Less', user_tag_id=2):
            # 2팀 10명 미만이면, 1팀 부전승
...
class R01G00Check(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9001, min_users='50', operator='Greater'):
...
class BlueTeamWin_GiveReward(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.guild_vs_game_give_reward(type='fund', team_id=2, is_win=False) # RedTeam 패배
        self.guild_vs_game_give_reward(type='exp', team_id=2, is_win=False) # RedTeam 패배
        self.guild_vs_game_give_reward(type='guildCoin', team_id=2, is_win=False) # RedTeam 패배
        self.guild_vs_game_give_contribution(team_id=2, is_win=False) # RedTeam 패배
...
class RedTeamWin_GiveReward(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.guild_vs_game_give_reward(type='fund', team_id=1, is_win=False) # BlueTeam 패배
        self.guild_vs_game_give_reward(type='exp', team_id=1, is_win=False) # BlueTeam 패배
        self.guild_vs_game_give_reward(type='guildCoin', team_id=1, is_win=False) # BlueTeam 패배
        self.guild_vs_game_give_contribution(team_id=1, is_win=False) # BlueTeam 패배
...
class DrawGame_GiveReward(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.guild_vs_game_give_reward(type='fund', team_id=1, is_win=False) # BlueTeam 무승부
        self.guild_vs_game_give_reward(type='exp', team_id=1, is_win=False) # BlueTeam 무승부
        self.guild_vs_game_give_reward(type='guildCoin', team_id=1, is_win=False) # BlueTeam 무승부
        self.guild_vs_game_give_contribution(team_id=1, is_win=False) # BlueTeam 무승부
        self.guild_vs_game_give_reward(type='fund', team_id=2, is_win=False) # RedTeam 무승부
        self.guild_vs_game_give_reward(type='exp', team_id=2, is_win=False) # RedTeam 무승부
        self.guild_vs_game_give_reward(type='guildCoin', team_id=2, is_win=False) # RedTeam 무승부
        self.guild_vs_game_give_contribution(team_id=2, is_win=False) # RedTeam 무승부
...
class DefaultbyWin_BlueTeam_GiveReward(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.guild_vs_game_give_reward(type='fund', team_id=1, is_win=False) # BlueTeam 부전승
        self.guild_vs_game_give_reward(type='exp', team_id=1, is_win=False) # BlueTeam 부전승
        self.guild_vs_game_give_reward(type='guildCoin', team_id=1, is_win=False) # BlueTeam 부전승
        self.guild_vs_game_give_contribution(team_id=1, is_win=False) # BlueTeam 부전승
        self.set_portal(portal_id=7, visible=True, enable=True, minimap_visible=True) # LeavePortal_EndGame
        self.set_portal(portal_id=8, visible=True, enable=True, minimap_visible=True) # LeavePortal_EndGame
...
class DefaultbyWin_RedTeam_GiveReward(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.guild_vs_game_give_reward(type='fund', team_id=2, is_win=False) # RedTeam 부전승
        self.guild_vs_game_give_reward(type='exp', team_id=2, is_win=False) # RedTeam 부전승
        self.guild_vs_game_give_reward(type='guildCoin', team_id=2, is_win=False) # BlueTeam 부전승
        self.guild_vs_game_give_contribution(team_id=2, is_win=False) # RedTeam 부전승
        self.set_portal(portal_id=7, visible=True, enable=True, minimap_visible=True) # LeavePortal_EndGame
        self.set_portal(portal_id=8, visible=True, enable=True, minimap_visible=True) # LeavePortal_EndGame
...
class GameCancel(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_event_ui(type=0, arg2='0,0')
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__64$', duration=4000, trigger_box_id=9000, is_outside=False)
...
class LeaveAll(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_event_result(type='notice', text='$66200001_GD__01_MASSIVEMAIN__65$', duration=10000, trigger_box_id=9000, is_outside=False)
