...
class CheckSameUserTag7212(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9210) and self.count_users(boxId=9210, minUsers='2', operator='Equal'):
...
class CheckSameUserTag7213(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9210) and self.count_users(boxId=9210, minUsers='3', operator='Equal'):
...
class CheckSameUserTag7214(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9210) and self.count_users(boxId=9210, minUsers='4', operator='Equal'):
...
class CheckSameUserTag7215(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9210) and self.count_users(boxId=9210, minUsers='5', operator='Equal'):
