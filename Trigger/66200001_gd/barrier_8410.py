...
class CheckSameUserTag7412(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9410) and self.count_users(box_id=9410, min_users='2', operator='Equal'):
...
class CheckSameUserTag7413(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9410) and self.count_users(box_id=9410, min_users='3', operator='Equal'):
...
class CheckSameUserTag7414(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9410) and self.count_users(box_id=9410, min_users='4', operator='Equal'):
...
class CheckSameUserTag7415(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9410) and self.count_users(box_id=9410, min_users='5', operator='Equal'):
