...
class CheckSameUserTag7412(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9410) and self.count_users(boxId=9410, minUsers='2', operator='Equal'):
...
class CheckSameUserTag7413(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9410) and self.count_users(boxId=9410, minUsers='3', operator='Equal'):
...
class CheckSameUserTag7414(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9410) and self.count_users(boxId=9410, minUsers='4', operator='Equal'):
...
class CheckSameUserTag7415(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9410) and self.count_users(boxId=9410, minUsers='5', operator='Equal'):
