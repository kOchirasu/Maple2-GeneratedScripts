...
class Wait(common.Trigger):
    def on_enter(self):
        ...
        self.set_mesh(triggerIds=[531], visible=True, arg3=0, delay=0, scale=0) # 31 / Ground outter
        self.set_mesh(triggerIds=[5310], visible=True, arg3=0, delay=0, scale=0) # 31 / Ground inner
...
class Pass(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9310], sound='DDStop_Stage_Pass_01')
        self.set_mesh(triggerIds=[531], visible=False, arg3=0, delay=0, scale=2) # 31 / Ground outter
        self.set_user_value(triggerId=7310, key='ColorReset', value=1) # color reset
...
class Fail(common.Trigger):
    def on_enter(self):
        self.play_system_sound_in_box(boxIds=[9310], sound='DDStop_Stage_Fail_01')
        self.set_mesh(triggerIds=[531], visible=False, arg3=0, delay=0, scale=2) # 31 / Ground outter
        self.set_mesh(triggerIds=[5310], visible=False, arg3=0, delay=0, scale=0) # 31 / Ground inner
        self.set_user_value(triggerId=7310, key='ColorClear', value=1) # color clear
