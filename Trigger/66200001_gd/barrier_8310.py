...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[8311,8312,8313,8314,8315,8316], visible=False, start_delay=0, interval=0, fade=0)
        self.set_effect(trigger_ids=[8310], visible=False)
...
class Sensor7311(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9310, min_users='1', operator='Equal'):
...
class Activate7311(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if not self.count_users(box_id=9310, min_users='1', operator='Equal'):
            return Sensor7311(self.ctx)
        if self.user_value(key='Barrier31', value=10):
            return Reset(self.ctx)
...
class Sensor7312(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9310, min_users='2', operator='Equal'):
...
class SafeGreen7312(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9310, min_users='2', operator='Equal'):
            return Sensor7312(self.ctx)
        if self.user_value(key='Barrier31', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7312(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310, min_users='2', operator='Equal'):
...
class Activate7312(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8311,8312,8313,8314,8315,8316], visible=True, start_delay=0, interval=0, fade=0)
        self.set_interact_object(trigger_ids=[10001193], state=2) # On
...
class Sensor7313(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9310, min_users='3', operator='Equal'):
...
class SafeGreen7313(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9310, min_users='3', operator='Equal'):
            return Sensor7313(self.ctx)
        if self.user_value(key='Barrier31', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7313(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310, min_users='3', operator='Equal'):
...
class Sensor7314(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9310, min_users='4', operator='Equal'):
...
class SafeGreen7314(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9310, min_users='4', operator='Equal'):
            return Sensor7314(self.ctx)
        if self.user_value(key='Barrier31', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7314(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310, min_users='4', operator='Equal'):
...
class Sensor7315(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9310, min_users='5', operator='Equal'):
...
class SafeGreen7315(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9310, min_users='5', operator='Equal'):
            return Sensor7315(self.ctx)
        if self.user_value(key='Barrier31', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7315(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9310) and self.count_users(box_id=9310, min_users='5', operator='Equal'):
