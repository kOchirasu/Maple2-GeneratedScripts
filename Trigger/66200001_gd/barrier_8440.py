...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[8441,8442,8443,8444], visible=False, start_delay=0, interval=0, fade=0)
        self.set_effect(trigger_ids=[8440], visible=False)
...
class Sensor7441(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440, min_users='1', operator='Equal'):
...
class Activate7441(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if not self.count_users(box_id=9440, min_users='1', operator='Equal'):
            return Sensor7441(self.ctx)
        if self.user_value(key='Barrier44', value=10):
            return Reset(self.ctx)
...
class Sensor7442(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440, min_users='2', operator='Equal'):
...
class SafeGreen7442(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9440, min_users='2', operator='Equal'):
            return Sensor7442(self.ctx)
        if self.user_value(key='Barrier44', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7442(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440, min_users='2', operator='Equal'):
...
class Activate7442(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8441,8442,8443,8444], visible=True, start_delay=0, interval=0, fade=0)
        self.set_interact_object(trigger_ids=[10001200], state=2) # On
...
class Sensor7443(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440, min_users='3', operator='Equal'):
...
class SafeGreen7443(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9440, min_users='3', operator='Equal'):
            return Sensor7443(self.ctx)
        if self.user_value(key='Barrier44', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7443(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440, min_users='3', operator='Equal'):
...
class Sensor7444(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440, min_users='4', operator='Equal'):
...
class SafeGreen7444(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9440, min_users='4', operator='Equal'):
            return Sensor7444(self.ctx)
        if self.user_value(key='Barrier44', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7444(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440, min_users='4', operator='Equal'):
...
class Sensor7445(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9440, min_users='5', operator='Equal'):
...
class SafeGreen7445(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9440, min_users='5', operator='Equal'):
            return Sensor7445(self.ctx)
        if self.user_value(key='Barrier44', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7445(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9440) and self.count_users(box_id=9440, min_users='5', operator='Equal'):
