...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[8231,8232,8233,8234,8235,8236,8237,8238], visible=False, start_delay=0, interval=0, fade=0)
        self.set_effect(trigger_ids=[8230], visible=False)
...
class CheckSameUserTag7232(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9230) and self.count_users(box_id=9230, min_users='2', operator='Equal'):
...
class Activate7232(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8231,8232,8233,8234,8235,8236,8237,8238], visible=True, start_delay=0, interval=0, fade=0)
        self.set_interact_object(trigger_ids=[10001191], state=2) # On
...
class CheckSameUserTag7233(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9230) and self.count_users(box_id=9230, min_users='3', operator='Equal'):
...
class CheckSameUserTag7234(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9230) and self.count_users(box_id=9230, min_users='4', operator='Equal'):
...
class CheckSameUserTag7235(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9230) and self.count_users(box_id=9230, min_users='5', operator='Equal'):
