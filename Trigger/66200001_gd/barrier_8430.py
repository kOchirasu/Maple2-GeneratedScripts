...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[8431,8432,8433,8434,8435,8436], visible=False, start_delay=0, interval=0, fade=0)
        self.set_effect(trigger_ids=[8430], visible=False)
...
class Sensor7431(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9430, min_users='1', operator='Equal'):
...
class Activate7431(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if not self.count_users(box_id=9430, min_users='1', operator='Equal'):
            return Sensor7431(self.ctx)
        if self.user_value(key='Barrier43', value=10):
            return Reset(self.ctx)
...
class Sensor7432(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9430, min_users='2', operator='Equal'):
...
class SafeGreen7432(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9430, min_users='2', operator='Equal'):
            return Sensor7432(self.ctx)
        if self.user_value(key='Barrier43', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7432(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430, min_users='2', operator='Equal'):
...
class Activate7432(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8431,8432,8433,8434,8435,8436], visible=True, start_delay=0, interval=0, fade=0)
        self.set_interact_object(trigger_ids=[10001199], state=2) # On
...
class Sensor7433(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9430, min_users='3', operator='Equal'):
...
class SafeGreen7433(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9430, min_users='3', operator='Equal'):
            return Sensor7433(self.ctx)
        if self.user_value(key='Barrier43', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7433(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430, min_users='3', operator='Equal'):
...
class Sensor7434(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9430, min_users='4', operator='Equal'):
...
class SafeGreen7434(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9430, min_users='4', operator='Equal'):
            return Sensor7434(self.ctx)
        if self.user_value(key='Barrier43', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7434(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430, min_users='4', operator='Equal'):
...
class Sensor7435(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.count_users(box_id=9430, min_users='5', operator='Equal'):
...
class SafeGreen7435(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        ...
        if not self.count_users(box_id=9430, min_users='5', operator='Equal'):
            return Sensor7435(self.ctx)
        if self.user_value(key='Barrier43', value=10):
            return Reset(self.ctx)
...
class CheckSameUserTag7435(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9430) and self.count_users(box_id=9430, min_users='5', operator='Equal'):
