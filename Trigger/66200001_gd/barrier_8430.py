...
class CheckSameUserTag7432(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9430) and self.count_users(boxId=9430, minUsers='2', operator='Equal'):
...
class CheckSameUserTag7433(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9430) and self.count_users(boxId=9430, minUsers='3', operator='Equal'):
...
class CheckSameUserTag7434(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9430) and self.count_users(boxId=9430, minUsers='4', operator='Equal'):
...
class CheckSameUserTag7435(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9430) and self.count_users(boxId=9430, minUsers='5', operator='Equal'):
