...
class CheckSameUserTag7322(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9320) and self.count_users(boxId=9320, minUsers='2', operator='Equal'):
...
class CheckSameUserTag7323(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9320) and self.count_users(boxId=9320, minUsers='3', operator='Equal'):
...
class CheckSameUserTag7324(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9320) and self.count_users(boxId=9320, minUsers='4', operator='Equal'):
...
class CheckSameUserTag7325(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(boxId=9320) and self.count_users(boxId=9320, minUsers='5', operator='Equal'):
