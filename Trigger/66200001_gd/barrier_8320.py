...
class Wait(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[8321,8322,8323,8324,8325,8326,8327,8328], visible=False, start_delay=0, interval=0, fade=0)
        self.set_effect(trigger_ids=[8320], visible=False)
...
class CheckSameUserTag7322(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9320) and self.count_users(box_id=9320, min_users='2', operator='Equal'):
...
class Activate7322(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[8321,8322,8323,8324,8325,8326,8327,8328], visible=True, start_delay=0, interval=0, fade=0)
        self.set_interact_object(trigger_ids=[10001194], state=2) # On
...
class CheckSameUserTag7323(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9320) and self.count_users(box_id=9320, min_users='3', operator='Equal'):
...
class CheckSameUserTag7324(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9320) and self.count_users(box_id=9320, min_users='4', operator='Equal'):
...
class CheckSameUserTag7325(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.check_same_user_tag(box_id=9320) and self.count_users(box_id=9320, min_users='5', operator='Equal'):
