...
class DanceGuideP11_01(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620101, textId=26620101, duration=4000)
...
class DanceGuideP11_02(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620102, textId=26620102, duration=4000)
...
class DanceGuideP12_02(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620103, textId=26620103, duration=4000)
...
class DanceGuideP21_01(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620101, textId=26620101, duration=5000)
...
class DanceGuideP21_02(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620102, textId=26620102, duration=5000)
...
class DanceGuideP22_02(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620103, textId=26620103, duration=5000)
...
class DanceGuideP41_01(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620101, textId=26620101, duration=6000)
...
class DanceGuideP52_01(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620102, textId=26620102, duration=6000)
...
class DanceGuideP62_01(state.State):
    def on_enter(self):
        show_guide_summary(entityId=26620103, textId=26620103, duration=6000)
