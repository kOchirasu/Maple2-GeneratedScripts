...
class 추가대사_01(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            ...
            self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Normal', script='$02020300_BF__MAIN__1$', duration=5000)
...
class 추가대사_02(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.monster_dead(spawn_ids=[101,102,103]):
            self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$02020300_BF__MAIN__2$', duration=5000)
...
class 추가대사_03(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_normal', script='$02020300_BF__MAIN__3$', duration=5000)
...
class 엘리베이터_체크(trigger_api.Trigger):
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=5000):
            self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$02020300_BF__MAIN__4$', duration=5000)
...
class 웨이브_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_unfair', script='$02020300_BF__MAIN__6$', duration=5000)
...
class 추가대사_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Normal', script='$02020300_BF__MAIN__7$', duration=5000)
...
class 지뢰방_시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.side_npc_talk(type='talk', npc_id=29500101, illust='ArcheonBlack_Normal', script='$02020300_BF__MAIN__8$', duration=5000)
...
class 추가대사_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$02020300_BF__MAIN__9$', duration=5000)
...
class 추가대사_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=11003536, illust='Neirin_normal', script='$02020300_BF__MAIN__10$', duration=5000)
...
class 보스전(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.side_npc_talk(type='talk', npc_id=29000170, illust='ArcaneBlader_normal', script='$02020300_BF__MAIN__11$', duration=5000)
