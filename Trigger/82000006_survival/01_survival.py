...
class Wait_Talk04(common.Trigger):
    def on_enter(self):
...
class Wait_Talk05(common.Trigger):
    def on_enter(self):
...
class Wait_Talk06(common.Trigger):
    def on_enter(self):
...
class CheckTheNumberOfPlayers_1st(common.Trigger):
    def on_enter(self):
...
class ReadyToMoveStartPosition(common.Trigger):
    def on_enter(self):
...
class GameExplain05(common.Trigger):
    def on_enter(self):
...
class CheckTheNumberOfPlayers_2nd(common.Trigger):
    def on_tick(self) -> common.Trigger:
