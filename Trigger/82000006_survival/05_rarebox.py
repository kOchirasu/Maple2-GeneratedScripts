...
class Tower01to10(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000000,10000001,10000002,10000003,10000004,10000005,10000006,10000007,10000008,10000009], isStart=True)
...
class Tower11to20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000010,10000011,10000012,10000013,10000014,10000015,10000016,10000017,10000018,10000019], isStart=True)
...
class Tower21to30(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000020,10000021,10000022,10000023,10000024,10000025,10000026,10000027,10000028,10000029], isStart=True)
...
class Tower31to40(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.start_combine_spawn(groupId=[10000030,10000031,10000032,10000033,10000034,10000035,10000036,10000037,10000038,10000039], isStart=True)
