...
class quest_end(state.State):
    def on_enter(self):
        set_event_ui(type=7, arg2='$02000384_BF__MAIN__0$', arg3='5000', arg4='0')
        set_conversation(type=1, spawnId=510, script='$02000384_BF__MAIN__1$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=510, script='$02000384_BF__MAIN__2$', arg4=2, arg5=2)
        set_achievement(triggerId=90000, type='trigger', achieve='Madracan_Q03')
        set_portal(portalId=4, visible=True, enabled=True, minimapVisible=True)
