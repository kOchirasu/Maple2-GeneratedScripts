...
class 층1(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.monster_dead(boxIds=[101]):
            return 층레버활성1(self.ctx)


class 층레버활성1(common.Trigger):
    def on_enter(self):
