...
class start_02_resume(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101,102])
        self.create_monster(spawnIds=[111,122], animationEffect=False)
        self.set_cinematic_ui(type=1)
...
class start_02_b(common.Trigger):
    def on_enter(self):
...
class start_02_c(common.Trigger):
    def on_enter(self):
...
class start_02_d(common.Trigger):
    def on_enter(self):
...
class start_02_e(common.Trigger):
    def on_enter(self):
...
class start_02_f(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class start_02_g(common.Trigger):
    def on_enter(self):
...
class start_02_h(common.Trigger):
    def on_enter(self):
...
class start_02_i(common.Trigger):
    def on_enter(self):
        self.set_npc_emotion_loop(spawnId=122, sequenceName='Talk_A', duration=3000)
...
class start_02_j(common.Trigger):
    def on_enter(self):
...
class start_02_j_resume(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101,102])
        self.destroy_monster(spawnIds=[111]) # 퀘스트용 소멸
...
class start_02_k(common.Trigger):
    def on_enter(self):
