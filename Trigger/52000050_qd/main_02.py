...
class ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_actor(trigger_id=7001, visible=False, initial_sequence='Sit_Down_A') # 준타
        self.set_actor(trigger_id=7002, visible=False, initial_sequence='Down_Idle_A') # 틴차이
        self.set_mesh(trigger_ids=[6020,6021,6022,6023,6024,6025,6026,6027,6028,6029,6030], visible=False, start_delay=0, interval=0, fade=0) # 짹쨱이
        self.set_mesh(trigger_ids=[6011], visible=True, start_delay=0, interval=0, fade=0) # 원래 벽돌 안보이게
        self.set_interact_object(trigger_ids=[10000478], state=1)
        self.set_effect(trigger_ids=[7010], visible=False)
        self.set_breakable(trigger_ids=[9010,9011,9012,9013,9014], enable=False) # 참새들 조용히 있음
        self.set_visible_breakable_object(trigger_ids=[9010,9011,9012,9013,9014], visible=False) # 참새들 조용히 있음
...
class start_b(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[6020,6021,6022,6023,6024,6025], visible=True, start_delay=0, interval=0, fade=0) # 짹쨱이
        self.set_mesh_animation(trigger_ids=[6020,6021,6022,6023,6024,6025], visible=True, start_delay=0, interval=0)
        ...
        self.set_mesh(trigger_ids=[6010], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh(trigger_ids=[6011], visible=False, start_delay=0, interval=0, fade=0) # 원래 벽돌 안보이게
...
class start_c(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[6020,6021,6022,6023,6024], visible=True, start_delay=0, interval=0, fade=0) # 짹쨱이
        self.set_mesh_animation(trigger_ids=[6020,6021,6022,6023,6024,6025], visible=True, start_delay=0, interval=0)
        self.destroy_monster(spawn_ids=[101,102,111,112,121,122]) # 퀘스트용 소멸
        self.set_actor(trigger_id=7001, visible=True, initial_sequence='Sit_Down_A') # 준타
        self.set_actor(trigger_id=7002, visible=True, initial_sequence='Down_Idle_A') # 틴차이
        self.set_mesh(trigger_ids=[6010], visible=True, start_delay=0, interval=0, fade=0)
        self.set_mesh_animation(trigger_ids=[6010], visible=True, start_delay=0, interval=0)
...
class start_c_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[6020,6021,6022,6023,6024,6025], visible=False, start_delay=0, interval=0, fade=0) # 짹쨱이
        self.set_mesh(trigger_ids=[6026,6027,6028,6029,6030], visible=True, start_delay=0, interval=0, fade=0) # 짹쨱이
        self.set_mesh_animation(trigger_ids=[6026,6027,6028,6029,6030], visible=True, start_delay=0, interval=0)
        ...
        self.set_dialogue(type=1, spawn_id=0, script='$52000050_QD__MAIN_02__0$', time=3, arg5=0)
...
class start_c_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000050_QD__MAIN_02__1$', time=3, arg5=0)
...
class start_c_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=1, spawn_id=0, script='$52000050_QD__MAIN_02__2$', time=3, arg5=0)
...
class start_c_05(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.wait_tick(wait_tick=4000):
            self.set_mesh(trigger_ids=[6026,6027,6028,6029,6030], visible=False, start_delay=0, interval=0, fade=0) # 짹쨱이
            return start_c_06(self.ctx)


class start_c_06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[7011], visible=False) # 지저귐 삭제
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
        self.select_camera_path(path_ids=[8001], return_view=True)
