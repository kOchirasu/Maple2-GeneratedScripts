...
class start_b_02(common.Trigger):
    def on_enter(self):
...
class start_c_02(common.Trigger):
    def on_enter(self):
...
class start_c_03(common.Trigger):
    def on_enter(self):
...
class start_c_04(common.Trigger):
    def on_enter(self):
...
class start_c_05(common.Trigger):
    def on_enter(self):
...
class start_c_06(common.Trigger):
    def on_enter(self):
...
class start_c_07(common.Trigger):
    pass
