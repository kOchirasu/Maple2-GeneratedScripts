...
class 자베스대사01(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001546, script='$52000050_QD__MAIN_03__0$', arg4=3)
...
class 브라보대사01(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001545, script='$52000050_QD__MAIN_03__1$', arg4=3)
...
class 제이시대사01(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000515, script='$52000050_QD__MAIN_03__2$', arg4=5)
