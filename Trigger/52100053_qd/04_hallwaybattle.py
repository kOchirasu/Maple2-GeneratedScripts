...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002098], state=0) # Key
...
class MobTrapOn01(state.State):
    def on_enter(self):
        set_conversation(type=1, spawnId=901, script='$52100053_QD__04_HALLWAYBATTLE__0$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=902, script='$52100053_QD__04_HALLWAYBATTLE__0$', arg4=2, arg5=0)
        set_conversation(type=1, spawnId=903, script='$52100053_QD__04_HALLWAYBATTLE__0$', arg4=2, arg5=0)
...
class GuideUseKey(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002098], state=1) # Key

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002098], arg2=0):
            return PortalOn()
