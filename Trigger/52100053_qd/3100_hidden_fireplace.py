...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002091], state=0) # Fireplace
...
class Opened(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002091], state=1) # Fireplace

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002091], arg2=0):
            return LadderOn()
