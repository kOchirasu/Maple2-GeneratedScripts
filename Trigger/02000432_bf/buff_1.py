...
class 버프(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_buff(box_ids=[2001], skill_id=40501001, level=1, is_player=True, is_skill_set=False)
...
class 사망_버프제거(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.add_buff(box_ids=[2002], skill_id=40501005, level=1, is_player=True, is_skill_set=False)
