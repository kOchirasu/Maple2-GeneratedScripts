...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3401,3402,3403,3404,3405,3406,3407,3408,3409,3410,3411,3412,3413,3414,3415,3416,3417,3418,3419,3420,3421,3422,3423,3424], visible=True, start_delay=0, interval=0, fade=0)
        self.set_skill(trigger_ids=[706], enable=False)
        self.set_effect(trigger_ids=[640], visible=False)
        self.set_effect(trigger_ids=[650], visible=False)
        self.set_effect(trigger_ids=[6501], visible=False)
        self.set_effect(trigger_ids=[6502], visible=False)
...
class 시작대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=21, ui_duration=3000, damage_penalty=100)
...
class 라운드21(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='SpawnMonster', spawn_ids=[121001], score=110000)
...
class 라운드대기22(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=22, ui_duration=3000, damage_penalty=100)
        self.set_timer(timer_id='3', seconds=3)
...
class 라운드22(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[122001,122002,122003], score=70000)
...
class 라운드대기23(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=23, ui_duration=3000, damage_penalty=100)
...
class 라운드23(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[123001], score=80000)
...
class 라운드대기24(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=24, ui_duration=3000, damage_penalty=100)
...
class 라운드대기25(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=25, ui_duration=3000, damage_penalty=100)
        self.set_timer(timer_id='3', seconds=3)
...
class 라운드25(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[125001,125002], score=750000)
...
class 바닥부심(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.time_expired(timer_id='3'):
            ...
            self.set_mesh(trigger_ids=[3401,3402,3403,3404,3405,3406,3407,3408,3409,3410,3411,3412,3413,3414,3415,3416,3417,3418,3419,3420,3421,3422,3423,3424], visible=False, start_delay=0, interval=0, fade=0)
            return 종료(self.ctx)
