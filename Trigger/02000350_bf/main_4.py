...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3501,3502,3503,3504,3505,3506,3507,3508,3509,3510,3511,3512,3513,3514,3515,3516,3517,3518,3519,3520,3521,3522,3523,3524,3525,3526,3527,3528], visible=True, start_delay=0, interval=0, fade=0)
        self.set_skill(trigger_ids=[705], enable=False)
        self.set_effect(trigger_ids=[6401], visible=False)
        self.set_effect(trigger_ids=[640], visible=False)
...
class 시작대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=16, ui_duration=3000, damage_penalty=50)
...
class 라운드16(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='SpawnMonster', spawn_ids=[116001], score=73000)
...
class 라운드대기17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=17, ui_duration=3000, damage_penalty=50)
        self.set_timer(timer_id='3', seconds=3)
...
class 라운드17(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[117001], score=56250)
...
class 라운드대기18(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_timer(timer_id='3', seconds=3)
        self.dark_stream(type='StartRound', round=18, ui_duration=3000, damage_penalty=50)
...
class 라운드18(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[118001], score=90000)
...
class 라운드대기19(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_timer(timer_id='3', seconds=3)
        self.dark_stream(type='StartRound', round=19, ui_duration=3000, damage_penalty=50)
...
class 라운드19(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[119001,119002], score=80000)
...
class 라운드대기20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_timer(timer_id='3', seconds=3)
        self.dark_stream(type='StartRound', round=20, ui_duration=3000, damage_penalty=50)
...
class 라운드20(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[120001], score=600000)
...
class 바닥부심(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.time_expired(timer_id='3'):
            ...
            self.set_mesh(trigger_ids=[3501,3502,3503,3504,3505,3506,3507,3508,3509,3510,3511,3512,3513,3514,3515,3516,3517,3518,3519,3520,3521,3522,3523,3524,3525,3526,3527,3528], visible=False, start_delay=0, interval=0, fade=0)
            return 종료(self.ctx)
