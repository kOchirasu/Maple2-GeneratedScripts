...
class 레지스탕스_연출시작(common.Trigger):
    def on_enter(self):
...
class 레지스탕스_체키01(common.Trigger):
    def on_enter(self):
...
class 레지스탕스_헨리테01(common.Trigger):
    def on_enter(self):
...
class 레지스탕스_지그문트01(common.Trigger):
    def on_enter(self):
...
class 레지스탕스_마무리(common.Trigger):
    def on_enter(self):
...
class 레지스탕스_스킵완료(common.Trigger):
    def on_enter(self):
...
class 레지스탕스_연출종료(common.Trigger):
    def on_enter(self):
