...
class 세리하와아르망_대기(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101,102,105])
...
class 세리하와아르망_준비(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 세리하와아르망_연출시작(common.Trigger):
    def on_enter(self):
...
class 세리하와아르망_연출01(common.Trigger):
    def on_enter(self):
...
class 세리하와아르망_연출02(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[8000], returnView=False)
...
class 세리하와아르망_연출03(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[8000], returnView=False)
...
class 세리하와아르망_마무리(common.Trigger):
    def on_enter(self):
...
class 세리하와아르망_스킵완료(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101,102,105])
...
class 세리하와아르망_연출종료(common.Trigger):
    def on_enter(self):
...
class 세리하와함께전투_대기(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101,102,105])
        self.create_monster(spawnIds=[101], animationEffect=False)
        self.set_cinematic_ui(type=1)
...
class 세리하와함께전투_준비(common.Trigger):
    def on_enter(self):
...
class 세리하와함께전투_연출시작(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 세리하와함께전투_연출01(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[8000], returnView=False)
...
class 세리하와함께전투_연출02(common.Trigger):
    def on_enter(self):
...
class 세리하와함께전투_연출03(common.Trigger):
    def on_enter(self):
...
class 세리하와함께전투_전투직전스킵(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[101,102,105])
        self.create_monster(spawnIds=[101])
        self.set_cinematic_ui(type=1)
...
class 전투후제이든등장_연출준비(common.Trigger):
    def on_enter(self):
        self.destroy_monster(spawnIds=[111])
        self.create_monster(spawnIds=[110], animationEffect=False)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
...
class 전투후제이든등장_01_세리하소멸(common.Trigger):
    def on_enter(self):
...
class 전투후제이든등장_02_PC독백(common.Trigger):
    def on_enter(self):
...
class 전투후제이든등장_03_제이든등장(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[105], animationEffect=False)
...
class 전투후제이든등장_스킵완료(common.Trigger):
    def on_enter(self):
...
class 세리하와함께전투_제이든등장_연출종료(common.Trigger):
    def on_enter(self):
        self.reset_camera(interpolationTime=2)
        self.set_cinematic_ui(type=0)
        self.set_cinematic_ui(type=2)
