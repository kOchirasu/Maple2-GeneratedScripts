...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(triggerIds=[10001,10002,10003,10004,10005,10006,10007,10008,10009,10010,10011,10012,10013,10014,10015,10016,10017,10018,10019,10020,10021,10022,10023,10024,10025,10026,10027], visible=False)
        self.set_effect(triggerIds=[11001,11002,11003,11004,11005,11006,11007,11008], visible=False)
        self.set_effect(triggerIds=[12001,12002,12003,12004], visible=False)
        self.set_visible_breakable_object(triggerIds=[5010,5011,5012,5013,5014,5110,5111,5112,5113,5114,5210,5211,5212,5213,5214], visible=False)
        self.set_breakable(triggerIds=[5001,5002,5003,5004,5005,5006,5007,5008,5009,5010,5011,5012,5013,5014], enable=False)
        self.set_breakable(triggerIds=[5101,5102,5103,5104,5105,5106,5107,5108,5109,5110,5111,5112,5113,5114], enable=False)
        self.set_breakable(triggerIds=[5201,5202,5203,5204,5205,5206,5207,5208,5209,5210,5211,5212,5213,5214], enable=False)
        self.set_interact_object(triggerIds=[10002149], state=0)
        self.set_interact_object(triggerIds=[10002150], state=0)
        self.set_interact_object(triggerIds=[10002151], state=0)
        self.set_interact_object(triggerIds=[10002152], state=0)
        ...
        self.set_mesh(triggerIds=[1101,1102,1103,1104,1105,1106,1107,1108,1109,1110,1111,1112,1113,1114,1115,1116,1117,1118], visible=True)
        self.set_mesh(triggerIds=[2001,2002,2003,2004,2005,2006,2007,2008,2009], visible=True)
        self.set_mesh(triggerIds=[3001,3002,3003,3004,3005,3006,3007,3008,3009,3010,3011,3012,3013,3014,3015,3016,3017,3018,3019,3020,3021,3022,3023,3024,3025,3026,3027,3028,3029,3030,3031,3032], visible=True)
        ...
        self.set_mesh(triggerIds=[4001,4002,4003,4004,4005,4006,4007,4008,4009,4010,4011,4012,4013,4014,4015,4016,4017,4018,4019,4020,4021,4022,4023,4024,4025,4026,4027,4028,4029,4030,4031,4032], visible=False)
        self.set_mesh(triggerIds=[4101,4102,4103,4104,4105,4106,4107,4108,4109,4110,4111,4112,4113,4114,4115,4116,4117,4118,4119,4120,4121,4122,4123,4124,4125,4126,4127,4128,4129,4130,4131,4132,4133,4134,4135,4136,4137,4138,4139,4140,4141,4142,4143,4144,4145,4146,4147,4148,4149,4150,4151,4152,4153,4154,4155,4156,4157,4158,4159,4160,4161,4162,4163,4164,4165,4166,4167,4168,4169,4170,4171,4172,4173,4174,4175,4176,4177,4178,4179,4180,4181,4182,4183,4184,4185,4186,4187,4188], visible=False)
        self.set_mesh(triggerIds=[4201,4202,4203,4204,4205,4206,4207,4208,4209,4210,4211,4212,4213,4214,4215,4216,4217,4218,4219,4220,4221,4222,4223,4224,4225,4226,4227,4228,4229,4230,4231,4232,4233,4234,4235,4236,4237,4238,4239,4240,4241,4242,4243,4244,4245,4246,4247,4248,4249,4250,4251,4252,4253,4254,4255,4256,4257,4258,4259,4260,4261,4262,4263,4264,4265,4266,4267,4268,4269,4270,4271,4272,4273,4274,4275,4276,4277,4278,4279,4280,4281,4282,4283,4284,4285,4286,4287,4288,4289], visible=False)
        ...
        self.set_mesh_animation(triggerIds=[2001,2002,2003,2004,2005,2006,2007,2008,2009], visible=True)
        self.set_user_value(triggerId=99990002, key='BombOn', value=0)
        self.set_user_value(triggerId=99990003, key='BombOn', value=0)
        self.set_user_value(triggerId=99990004, key='BombOn', value=0)
        self.set_user_value(triggerId=99990005, key='BombOn', value=0)
        self.set_user_value(triggerId=99990006, key='BombOn', value=0)
        self.set_user_value(triggerId=99990007, key='BombOn', value=0)
        self.set_user_value(triggerId=99990008, key='BombOn', value=0)
...
class 엘리베이터_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(triggerIds=[4001,4002,4003,4004,4005,4006,4007,4008,4009,4010,4011,4012,4013,4014,4015,4016,4017,4018,4019,4020,4021,4022,4023,4024,4025,4026,4027,4028,4029,4030,4031,4032], visible=True, delay=80, scale=3)
...
class 번방2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=99990002, key='BombOn', value=1)
...
class 번방_클리어2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=99990004, key='BombOn', value=2)
        self.show_guide_summary(entityId=111, textId=20110001) # 에네르 동력원을 전원부 위로 옮기세요.
...
class 엘리베이터_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.hide_guide_summary(entityId=111)
        self.set_mesh(triggerIds=[4101,4102,4103,4104,4105,4106,4107,4108,4109,4110,4111,4112,4113,4114,4115,4116,4117,4118,4119,4120,4121,4122,4123,4124,4125,4126,4127,4128,4129,4130,4131,4132,4133,4134,4135,4136,4137,4138,4139,4140,4141,4142,4143,4144,4145,4146,4147,4148,4149,4150,4151,4152,4153,4154,4155,4156,4157,4158,4159,4160,4161,4162,4163,4164,4165,4166,4167,4168,4169,4170,4171,4172,4173,4174,4175,4176,4177,4178,4179,4180,4181,4182,4183,4184,4185,4186,4187,4188], visible=True, delay=50, scale=3)
...
class 번방3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=99990005, key='BombOn', value=1)
...
class 번방_클리어3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=99990007, key='BombOn', value=2)
        self.show_guide_summary(entityId=111, textId=20110001) # 에네르 동력원을 전원부 위로 옮기세요.
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
...
class 엘리베이터_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.hide_guide_summary(entityId=111)
        self.set_mesh(triggerIds=[4201,4202,4203,4204,4205,4206,4207,4208,4209,4210,4211,4212,4213,4214,4215,4216,4217,4218,4219,4220,4221,4222,4223,4224,4225,4226,4227,4228,4229,4230,4231,4232,4233,4234,4235,4236,4237,4238,4239,4240,4241,4242,4243,4244,4245,4246,4247,4248,4249,4250,4251,4252,4253,4254,4255,4256,4257,4258,4259,4260,4261,4262,4263,4264,4265,4266,4267,4268,4269,4270,4271,4272,4273,4274,4275,4276,4277,4278,4279,4280,4281,4282,4283,4284,4285,4286,4287,4288,4289], visible=True, delay=50, scale=3)
...
class 번방_클리어4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_user_value(triggerId=99990010, key='BombOn', value=2)
        self.show_guide_summary(entityId=111, textId=20110001) # 에네르 동력원을 전원부 위로 옮기세요.
        self.play_system_sound_in_box(sound='System_ShowGuideSummary_01')
