...
# 퀘스트 수락 후 연출 시작
class idle2(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[702], questIds=[30000317], questStates=[1]):
            return 연출시작2(self.ctx)
        if self.quest_user_detected(boxIds=[702], questIds=[30000317], questStates=[2]):
            return Skip_1(self.ctx)


# 라딘과 대화 시작
class 연출시작2(common.Trigger):
    def on_enter(self):
...
class 라딘과대화시작_02(common.Trigger):
    def on_enter(self):
...
class 라딘과대화시작_03(common.Trigger):
    def on_enter(self):
...
class 라딘과대화시작_04(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4027], returnView=False)
...
class 라딘과대화시작_05(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4028], returnView=False)
...
class 카메라이동(common.Trigger):
    def on_enter(self):
        ...
        self.create_monster(spawnIds=[112], animationEffect=False, animationDelay=0) # 연출바사라첸
        self.create_monster(spawnIds=[113], animationEffect=False, animationDelay=0) # 연출하렌
        self.create_monster(spawnIds=[114], animationEffect=False, animationDelay=0) # 연출카일
...
class 간부얼굴준비(common.Trigger):
    def on_enter(self):
        ...
        self.move_npc(spawnId=113, patrolName='MS2PatrolData_3003')
        self.move_npc(spawnId=114, patrolName='MS2PatrolData_3004')
        self.move_npc(spawnId=115, patrolName='MS2PatrolData_3005')
        self.set_onetime_effect(id=9, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.add_cinematic_talk(npcId=0, msg='<font size=\'40\'>흑성회?!</font>', duration=6000)
...
# 흑성회와 힘을 합치자고 말하는 라딘
class 흑성회와의동맹에대하여(common.Trigger):
    def on_enter(self):
        ...
        self.add_cinematic_talk(npcId=0, msg='흑성회 놈들! 이번에야말로…!', duration=3000)
...
class 흑성회와의동맹에대하여1_2(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4028], returnView=False)
...
class 흑성회와의동맹에대하여1_3(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4029], returnView=False)
        ...
        self.add_cinematic_talk(npcId=0, msg='저들에게 도움을 요청하다니, 도대체 무슨 생각이신거죠!', duration=3000)
...
# 그래 그럽시다
class 흑성회와의동맹에대하여2(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4026], returnView=False)
...
class 흑성회와의동맹에대하여3(common.Trigger):
    def on_enter(self):
...
class 흑성회와의동맹에대하여4(common.Trigger):
    def on_enter(self):
...
class 흑성회와의동맹에대하여5(common.Trigger):
    def on_enter(self):
        self.select_camera(triggerId=4028, enable=True)
...
class 정보전달하기_02(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4028], returnView=False)
...
class 정보전달하기_03(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4029], returnView=False)
...
class 정보전달하기_04(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4026], returnView=False)
...
class 정보전달하기_05(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4028], returnView=False)
...
class 정보전달하기_06(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4026], returnView=False)
...
class 정보전달하기3_1(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4026], returnView=False)
...
class 정보전달하기3_2(common.Trigger):
    def on_enter(self):
        self.select_camera_path(pathIds=[4007], returnView=False)
