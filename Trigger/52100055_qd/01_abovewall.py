...
class Wait(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002101], state=0) # LeverForLadder01
        set_interact_object(triggerIds=[10002102], state=0) # LeverForRope
        set_interact_object(triggerIds=[10002103], state=0) # LeverForLadder02
...
class MobActorSpawn(state.State):
    def on_enter(self):
        ...
        set_conversation(type=1, spawnId=901, script='$52100055_QD__01_ABOVEWALL__0$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=902, script='$52100055_QD__01_ABOVEWALL__0$', arg4=2, arg5=1)
        set_conversation(type=1, spawnId=903, script='$52100055_QD__01_ABOVEWALL__0$', arg4=2, arg5=1)
...
class Battle01Start(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002101], state=1) # LeverForLadder01

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002101], arg2=0):
...
class Battle03Start(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002102], state=1) # LeverForRope

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002102], arg2=0):
            return RopeOn()
...
class Battle04Start(state.State):
    def on_enter(self):
        ...
        set_interact_object(triggerIds=[10002103], state=1) # LeverForLadder02

    def on_tick(self) -> state.State:
        if object_interacted(interactIds=[10002103], arg2=0):
            return PortalOn()
