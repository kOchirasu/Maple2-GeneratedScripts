...
class 첫번째덤불등장01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_guide_summary(entityId=20003312, textId=20003312)
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
    ...
    def on_exit(self) -> None:
        self.set_effect(triggerIds=[777401], visible=True)
        # 덤불 제거01 사운드
...
class 첫번째꼬마찾기시작(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_actor(triggerId=92220, visible=False, initialSequence='Dead_A')
        # 첫번째장벽 덤불 제거
        self.set_effect(triggerIds=[777401], visible=False)
        # 덤불 제거01 사운드
...
class 첫번째힌트발견01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.show_guide_summary(entityId=20003313, textId=20003313)
...
class 두번째덤불등장01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.hide_guide_summary(entityId=20003312)
        self.set_effect(triggerIds=[777402], visible=True)
        # 덤불 제거02 사운드
...
class 두번째꼬마찾기시작(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_actor(triggerId=93330, visible=False, initialSequence='Dead_A')
        # 첫번째장벽 덤불
...
class 세번째덤불등장01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_effect(triggerIds=[777403], visible=True)
        # 덤불 제거03 사운드
...
class 세번째덤불등장02(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.hide_guide_summary(entityId=20003312)
        self.set_effect(triggerIds=[777404], visible=True)
        # 덤불 제거04 사운드
...
class 세번째꼬마찾기시작(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.set_actor(triggerId=94450, visible=False, initialSequence='Dead_A')
        # 첫번째장벽 덤불
...
class 구출안내01_01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.show_guide_summary(entityId=20003314, textId=20003314)
...
class 네번째덤불등장01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.hide_guide_summary(entityId=20003312)
        self.set_effect(triggerIds=[777405], visible=True)
        # 덤불 제거05 사운드
...
class 마지막연출_준비01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        ...
        self.set_interact_object(triggerIds=[10000776], state=0)
...
class 던전클리어01(trigger_api.Trigger):
    ...
    def on_exit(self) -> None:
        self.dungeon_clear()
        self.set_achievement(triggerId=99998, type='trigger', achieve='ClearHideandSeek')
...
class 퇴장시작01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.move_npc(spawnId=111, patrolName='MS2PatrolData_1017')
        # self.move_npc(spawnId=410, patrolName='MS2PatrolData_4008')
        # self.move_npc(spawnId=510, patrolName='MS2PatrolData_5006')
        # self.move_npc(spawnId=210, patrolName='MS2PatrolData_2016')
        # self.move_npc(spawnId=310, patrolName='MS2PatrolData_3012')
        # self.move_npc(spawnId=600, patrolName='MS2PatrolData_6003')
