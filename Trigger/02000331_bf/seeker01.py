...
class 몬스터출현01_시작(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_연출01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_연출02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=500):
            return 몬스터출현01_생성랜덤01(self.ctx)


class 몬스터출현01_생성랜덤01(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 몬스터출현01_1번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_2번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_3번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_4번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_생성랜덤02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=25):
...
class 몬스터출현01_5번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_6번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_7번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_8번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_생성랜덤03(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=25):
...
class 몬스터출현01_9번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_10번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_11번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_12번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현01_종료(common.Trigger):
    def on_enter(self):
...
class 첫번째다리붕괴01(common.Trigger):
    def on_enter(self):
...
class 첫번째무너짐연출시작01(common.Trigger):
    def on_enter(self):
...
class 첫번째다리붕괴02(common.Trigger):
    def on_enter(self):
...
class 첫번째무너짐연출종료01(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[777801], visible=False) # 길 없어짐01 사운드  / 첫 번째 다리
...
class 첫번째덤불등장01(common.Trigger):
    def on_enter(self):
...
class 첫번째덤불제거01(common.Trigger):
    def on_enter(self):
...
class 첫번째꼬마찾기시작(common.Trigger):
    def on_enter(self):
...
class 첫번째힌트발견01(common.Trigger):
    def on_enter(self):
...
class 첫번째힌트수색01(common.Trigger):
    def on_enter(self):
...
class 첫번째꼬마발견01(common.Trigger):
    def on_enter(self):
...
class 첫번째꼬마만남01(common.Trigger):
    def on_enter(self):
...
class 첫번째꼬마교체딜레이01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=500):
            return 첫번째꼬마교체01(self.ctx)


class 첫번째꼬마교체01(common.Trigger):
    def on_enter(self):
...
class 첫번째힌트발견02(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 첫번째힌트수색02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__10$', arg4=2, arg5=0)
...
class 첫번째꼬마발견02(common.Trigger):
    def on_enter(self):
...
class 첫번째꼬마만남02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__12$', arg4=2, arg5=1)
...
class 첫번째꼬마교체딜레이02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=500):
            return 첫번째꼬마교체02(self.ctx)


class 첫번째꼬마교체02(common.Trigger):
    def on_enter(self):
...
class 첫번째힌트발견03(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 첫번째힌트수색03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__10$', arg4=2, arg5=0)
...
class 첫번째꼬마발견03(common.Trigger):
    def on_enter(self):
...
class 첫번째꼬마만남03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__12$', arg4=2, arg5=1)
...
class 첫번째꼬마교체딜레이03(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=500):
            return 첫번째꼬마교체03(self.ctx)


class 첫번째꼬마교체03(common.Trigger):
    def on_enter(self):
...
class 첫번째힌트발견04(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 첫번째힌트수색04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__10$', arg4=2, arg5=0)
...
class 첫번째꼬마발견04(common.Trigger):
    def on_enter(self):
...
class 첫번째꼬마만남04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__12$', arg4=2, arg5=1)
...
class 첫번째꼬마교체딜레이04(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=500):
            return 첫번째꼬마교체04(self.ctx)


class 첫번째꼬마교체04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현02_생성랜덤01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=25):
...
class 몬스터출현02_1번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현02_2번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현02_3번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현02_4번생성(common.Trigger):
    def on_enter(self):
...
class 두번째덤불등장01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003312, textId=20003312) # 가이드 : 스킬을 사용해서 덤불을 없애 주세요.
...
class 두번째덤불제거01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마찾기시작(common.Trigger):
    def on_enter(self):
...
class 두번째몬스터발견01(common.Trigger):
    def on_enter(self):
...
class 두번째힌트발견01(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 두번째힌트수색01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마도움01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마발견01(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 두번째꼬마구출01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마이동01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마만남01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마대화01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체딜레이01(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체01(common.Trigger):
    def on_enter(self):
...
class 두번째힌트발견02(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
        self.move_npc(spawnId=100, patrolName='MS2PatrolData_997')
...
class 두번째힌트수색02(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마도움02(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마발견02(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 두번째꼬마구출02(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마이동02(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마만남02(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마대화02(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체딜레이02(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체02(common.Trigger):
    def on_enter(self):
...
class 두번째힌트발견03(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
        self.move_npc(spawnId=100, patrolName='MS2PatrolData_997')
...
class 두번째힌트수색03(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마도움03(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마발견03(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 두번째꼬마구출03(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마이동03(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마만남03(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마대화03(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체딜레이03(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체03(common.Trigger):
    def on_enter(self):
...
class 두번째힌트발견04(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
        self.move_npc(spawnId=100, patrolName='MS2PatrolData_997')
...
class 두번째힌트수색04(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마도움04(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마발견04(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 두번째꼬마구출04(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마이동04(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마만남04(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마대화04(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체딜레이04(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체04(common.Trigger):
    def on_enter(self):
...
class 두번째힌트발견05(common.Trigger):
    def on_enter(self):
        self.move_npc(spawnId=100, patrolName='MS2PatrolData_997')
        self.move_npc(spawnId=200, patrolName='MS2PatrolData_2013')
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__800$', arg3='3000', arg4='0')
...
class 두번째힌트수색05(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마도움05(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마발견05(common.Trigger):
    def on_tick(self) -> common.Trigger:
...
class 두번째꼬마구출05(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마이동05(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마만남05(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마대화05(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체딜레이05(common.Trigger):
    def on_enter(self):
...
class 두번째꼬마교체05(common.Trigger):
    def on_enter(self):
...
# 세명 패트롤 하다가 덩굴에 막힘
class 세번째덤불등장01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003312, textId=20003312) # 가이드 : 스킬을 사용해서 덤불을 없애 주세요.
...
class 세번째덤불등장02(common.Trigger):
    def on_enter(self):
...
class 세번째덤불등장03(common.Trigger):
    def on_enter(self):
...
class 세번째꼬마찾기시작(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[777403], visible=False) # 덤불 제거03 사운드
        self.set_effect(triggerIds=[777404], visible=False) # 덤불 제거04 사운드
...
class 꼬마셋대화연출01(common.Trigger):
    def on_enter(self):
...
# 세번째스위치01 - 10000784
class 세번째스위치출현01(common.Trigger):
    def on_enter(self):
...
class 구출안내01_01(common.Trigger):
    def on_enter(self):
...
class 구출안내01_02(common.Trigger):
    def on_enter(self):
...
class 구출안내01_03(common.Trigger):
    def on_enter(self):
...
class 구출안내01_04(common.Trigger):
    def on_enter(self):
...
# 세번째스위치02 - 10000792
class 세번째스위치출현02(common.Trigger):
    def on_enter(self):
...
class 구출안내02_01(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__802$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 구출안내02_02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=300, script='$02000331_BF__Seeker01__80$', arg4=2, arg5=0)
...
class 구출안내02_03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=200, script='$02000331_BF__Seeker01__81$', arg4=2, arg5=0)
...
class 구출안내02_04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__82$', arg4=2, arg5=0)
...
# 세번째스위치03 - 10000793
class 세번째스위치출현03(common.Trigger):
    def on_enter(self):
...
class 구출안내03_01(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__802$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 구출안내03_02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=300, script='$02000331_BF__Seeker01__80$', arg4=2, arg5=0)
...
class 구출안내03_03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=200, script='$02000331_BF__Seeker01__81$', arg4=2, arg5=0)
...
class 구출안내03_04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__82$', arg4=2, arg5=0)
...
# 세번째스위치04 - 10000794
class 세번째스위치출현04(common.Trigger):
    def on_enter(self):
...
class 구출안내04_01(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__802$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 구출안내04_02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=300, script='$02000331_BF__Seeker01__80$', arg4=2, arg5=0)
...
class 구출안내04_03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=200, script='$02000331_BF__Seeker01__81$', arg4=2, arg5=0)
...
class 구출안내04_04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__82$', arg4=2, arg5=0)
...
# 세번째스위치05 - 10000795
class 세번째스위치출현05(common.Trigger):
    def on_enter(self):
...
class 구출안내05_01(common.Trigger):
    def on_enter(self):
        self.set_event_ui(type=1, arg2='$02000331_BF__Seeker01__802$', arg3='3000', arg4='0')
        self.set_effect(triggerIds=[7771], visible=True) # UI  메시지 알림 사운드
...
class 구출안내05_02(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=300, script='$02000331_BF__Seeker01__80$', arg4=2, arg5=0)
...
class 구출안내05_03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=200, script='$02000331_BF__Seeker01__81$', arg4=2, arg5=0)
...
class 구출안내05_04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=1, spawnId=100, script='$02000331_BF__Seeker01__82$', arg4=2, arg5=0)
...
class 세번째꼬마만남01(common.Trigger):
    def on_enter(self):
...
class 세번째꼬마만남02(common.Trigger):
    def on_enter(self):
...
class 세번째꼬마만남03(common.Trigger):
    def on_enter(self):
...
class 네번째덤불등장01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003312, textId=20003312) # 가이드 : 스킬을 사용해서 덤불을 없애 주세요.
...
class 네번째덤불제거01(common.Trigger):
    def on_enter(self):
...
class 네번째꼬마찾기시작(common.Trigger):
    def on_enter(self):
...
# 네번째 꼬마 쫓기는 웨이브 시작
class 몬스터출현05_꼬마생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_생성랜덤01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=25):
...
class 몬스터출현05_1번대장생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_2번대장생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_3번대장생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[992], animationEffect=False)
        self.move_npc(spawnId=992, patrolName='MS2PatrolData_905')
...
class 몬스터출현05_4번대장생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[991], animationEffect=False)
        self.move_npc(spawnId=991, patrolName='MS2PatrolData_905')
...
class 몬스터출현05_생성랜덤02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=25):
...
class 몬스터출현05_1번자코생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_2번자코생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_3번자코생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_4번자코생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_생성랜덤03(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=25):
...
class 몬스터출현05_5번대장생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[991], animationEffect=False)
...
class 몬스터출현05_6번대장생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[992], animationEffect=False)
...
class 몬스터출현05_7번대장생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_8번대장생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현05_생성랜덤04(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=25):
...
class 몬스터출현05_5번자코생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[930], animationEffect=False)
...
class 몬스터출현05_6번자코생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[931], animationEffect=False)
...
class 몬스터출현05_7번자코생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[932], animationEffect=False)
        self.move_npc(spawnId=932, patrolName='MS2PatrolData_903')
        self.create_monster(spawnIds=[935], animationEffect=False)
...
class 몬스터출현05_8번자코생성(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[932], animationEffect=False)
...
class 네번째꼬마만남01(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[7776], visible=False) # 추격 소음01 사운드
...
class 네번째꼬마만남02(common.Trigger):
    def on_enter(self):
...
class 네번째꼬마만남03(common.Trigger):
    def on_enter(self):
...
class 네번째꼬마만남04(common.Trigger):
    def on_enter(self):
...
class 두번째무너짐연출시작01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
...
class 두번째다리붕괴02(common.Trigger):
    def on_enter(self):
...
class 두번째무너짐연출종료01(common.Trigger):
    def on_enter(self):
...
# 외다리스위치출현01 -  10000785
class 외다리스위치출현01(common.Trigger):
    def on_enter(self):
...
class 외다리스위치반응01(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003314, textId=20003314) # 가이드 : 주변에서 레버를 찾아 당겨 보세요.
...
# 외다리스위치출현02 -  10000796
class 외다리스위치출현02(common.Trigger):
    def on_enter(self):
...
class 외다리스위치반응02(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003314, textId=20003314) # 가이드 : 주변에서 레버를 찾아 당겨 보세요.
...
# 외다리스위치출현03 -  10000797
class 외다리스위치출현03(common.Trigger):
    def on_enter(self):
...
class 외다리스위치반응03(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003314, textId=20003314) # 가이드 : 주변에서 레버를 찾아 당겨 보세요.
...
# 외다리스위치출현04 -  10000798
class 외다리스위치출현04(common.Trigger):
    def on_enter(self):
...
class 외다리스위치반응04(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003314, textId=20003314) # 가이드 : 주변에서 레버를 찾아 당겨 보세요.
...
# 외다리스위치출현05 -  10000799
class 외다리스위치출현05(common.Trigger):
    def on_enter(self):
...
class 외다리스위치반응05(common.Trigger):
    def on_enter(self):
        self.show_guide_summary(entityId=20003314, textId=20003314) # 가이드 : 주변에서 레버를 찾아 당겨 보세요.
...
class 외다리생성시작01(common.Trigger):
    def on_enter(self):
...
class 다리건너갈준비01(common.Trigger):
    def on_enter(self):
...
class 다리건너갈준비02(common.Trigger):
    def on_enter(self):
...
class 다리건너가기02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.user_detected(boxIds=[99996]):
            return 다리건너가기03(self.ctx)


class 다리건너가기03(common.Trigger):
    def on_enter(self):
...
class 보스등장연출중01(common.Trigger):
    def on_enter(self):
...
class 보스등장연출중01Skip(common.Trigger):
    def on_enter(self):
        self.set_skip()
...
class 보스등장연출중02(common.Trigger):
    def on_enter(self):
...
class 보스등장연출중02Skip(common.Trigger):
    def on_enter(self):
        self.set_skip()
...
class 보스등장연출중03(common.Trigger):
    def on_enter(self):
...
class 보스등장연출중03Skip(common.Trigger):
    def on_enter(self):
        self.set_skip()
...
class 보스등장연출중04(common.Trigger):
    def on_enter(self):
...
class 보스등장연출끝01(common.Trigger):
    def on_enter(self):
...
class 마지막웨이브알림01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_생성랜덤01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=20):
...
class 몬스터출현06_1번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_2번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_3번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_4번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_5번생성(common.Trigger):
    def on_enter(self):
...
# 마지막 웨이브 : 두 번째 소환
class 몬스터출현06_생성랜덤02(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=20):
...
class 몬스터출현06_6번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_7번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_8번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_9번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_10번생성(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_생성랜덤03(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.random_condition(rate=20):
...
class 몬스터출현06_11번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_11번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_11번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_11번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_11번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_11번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_12번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_12번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_12번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_12번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_12번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_12번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_13번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_13번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_13번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_13번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_13번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_13번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_14번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_14번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_14번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_14번생성_04(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[964,965,974], animationEffect=False)
...
class 몬스터출현06_14번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_14번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_15번생성_01(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[948,949,979], animationEffect=False)
...
class 몬스터출현06_15번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_15번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_15번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_15번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_15번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_생성랜덤04(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.true():
...
class 몬스터출현06_16번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_16번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_16번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_16번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_16번생성_05(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[953,954], animationEffect=False)
...
class 몬스터출현06_16번생성_06(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[964,965,974], animationEffect=False)
...
class 몬스터출현06_16번생성_07(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_16번생성_08(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_17번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_17번생성_02(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[964,965,985], animationEffect=False)
...
class 몬스터출현06_17번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_17번생성_04(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[951,953], animationEffect=False)
...
class 몬스터출현06_17번생성_05(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[947,948,949,988], animationEffect=False)
...
class 몬스터출현06_17번생성_06(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[967,968,987], animationEffect=False)
...
class 몬스터출현06_17번생성_07(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[953,954], animationEffect=False)
...
class 몬스터출현06_17번생성_08(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[964,965,974], animationEffect=False)
...
class 몬스터출현06_18번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_18번생성_02(common.Trigger):
    def on_enter(self):
        self.create_monster(spawnIds=[949,940,970], animationEffect=False)
...
class 몬스터출현06_18번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_18번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_18번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_18번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_18번생성_07(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_18번생성_08(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_07(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_19번생성_08(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_01(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_02(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_03(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_04(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_05(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_06(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_07(common.Trigger):
    def on_enter(self):
...
class 몬스터출현06_20번생성_08(common.Trigger):
    def on_enter(self):
...
class 보스전투_준비01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=1000):
            return 보스전투_준비02(self.ctx)


class 보스전투_준비02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
...
class 보스전투_준비03(common.Trigger):
    def on_enter(self):
...
class 보스전투_준비04(common.Trigger):
    def on_enter(self):
...
class 보스전투_시작01(common.Trigger):
    def on_enter(self):
...
class 보스도망준비01(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=4000):
            return 보스도망연출01(self.ctx)


class 보스도망연출01(common.Trigger):
    def on_enter(self):
...
class 마지막연출_준비01(common.Trigger):
    def on_enter(self):
...
class 마지막연출_포털출현01(common.Trigger):
    def on_enter(self):
...
class 마지막연출_포털출현02(common.Trigger):
    def on_enter(self):
...
class 마지막연출_포털출현03(common.Trigger):
    def on_enter(self):
...
class 마지막연출_포털출현04(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[99999], visible=False) # 치유 이펙트
...
class 마지막연출_시작01(common.Trigger):
    def on_enter(self):
...
class 마지막연출_시작02(common.Trigger):
    def on_enter(self):
