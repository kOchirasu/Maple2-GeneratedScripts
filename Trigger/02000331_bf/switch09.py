...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[7773], visible=False) # 발판 휠 내려옴 사운드
        self.set_breakable(trigger_ids=[5001], enable=False)
        self.set_breakable(trigger_ids=[5002], enable=False)
        self.set_breakable(trigger_ids=[5011], enable=False)
        self.set_breakable(trigger_ids=[5012], enable=False)
        self.set_breakable(trigger_ids=[5021], enable=False)
        self.set_breakable(trigger_ids=[5022], enable=False)
        self.set_breakable(trigger_ids=[5031], enable=False)
        self.set_breakable(trigger_ids=[5032], enable=False)
        self.set_mesh(trigger_ids=[40000,40001], visible=False, start_delay=0, interval=0, fade=0) # TOK용 투명한 매쉬
...
class 발판내리기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_mesh(trigger_ids=[40000,40001], visible=True, start_delay=0, interval=0, fade=0) # TOK용 투명한 매쉬
