...
class 시작(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        # self.spawn_monster(spawn_ids=[101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117], auto_target=True)
        self.set_ambient_light(primary=[1,1,1])
        self.set_directional_light(diffuse_color=[1,1,1], specular_color=[0,0,0])
