...
class 대기(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.quest_user_detected(boxIds=[9000], questIds=[10003010], questStates=[1], jobCode=80):
            # 퀘스트 진행 중 상태
...
class 차입장03_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__0$', arg4=3, arg5=0)
...
class 차입장04_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__1$', arg4=4, arg5=0) # 음성 코드 00001155
...
class 차입장03_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__2$', arg4=7, arg5=0) # 음성 코드 00000553
...
class 차입장03_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11001581, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__3$', arg4=4, arg5=0)
...
class 차입장05_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__4$', arg4=4, arg5=0)
...
class 차입장03_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11001583, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__5$', arg4=3, arg5=0)
...
class 차입장05_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__6$', arg4=3, arg5=0)
...
class 차입장07_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__7$', arg4=4, arg5=0)
...
class 차입장09_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11000015, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__8$', arg4=4, arg5=0)
...
class 차입장12_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__9$', arg4=3, arg5=0)
...
class 차입장14_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__10$', arg4=3, arg5=0)
...
class 정렬01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__11$', arg4=5, arg5=0) # 음성 코드 00001338
...
class 본론01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__12$', arg4=10, arg5=0) # 음성 코드 00001339
...
class 본론03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__13$', arg4=6, arg5=0) # 음성 코드 00001340
...
class 본론07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__14$', arg4=5, arg5=0) # 음성 코드 00001292
...
class 정리01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__15$', arg4=6, arg5=0)
...
class 반대01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__16$', arg4=4, arg5=0)
...
class 반대03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__17$', arg4=4, arg5=0)
...
class 반대06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_ASSASSIN__18$', arg4=4, arg5=0)
...
class 반대08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_conversation(type=2, spawnId=11000015, script='상황은 알겠지만 확실치도 않은 일에 무조건 병력을 지원하는 것은… 흠…\\n생각을 좀 해 봐야겠군요. 연락드리죠.', arg4=4, arg5=0)
