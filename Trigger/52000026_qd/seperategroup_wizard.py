...
class 대기(common.Trigger):
    ...
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[9000], questIds=[10002947], questStates=[1], jobCode=30):
...
class 차입장03_1(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_WIZARD__0$', arg4=4, arg5=0)
...
class 차입장04_2(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_WIZARD__1$', arg4=3, arg5=0) # 음성 코드 00001155
...
class 차입장03_3(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_WIZARD__2$', arg4=7, arg5=0) # 음성 코드 00000553
...
class 차입장03_4(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001581, script='$52000026_QD__SEPERATEGROUP_WIZARD__3$', arg4=4, arg5=0)
...
class 차입장05_4(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_WIZARD__4$', arg4=4, arg5=0)
...
class 차입장03_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001583, script='$52000026_QD__SEPERATEGROUP_WIZARD__5$', arg4=3, arg5=0)
...
class 차입장05_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_WIZARD__6$', arg4=4, arg5=0)
...
class 차입장07_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000015, script='$52000026_QD__SEPERATEGROUP_WIZARD__7$', arg4=3, arg5=0)
...
class 차입장10_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_WIZARD__8$', arg4=3, arg5=0)
...
class 차입장12_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_WIZARD__9$', arg4=3, arg5=0)
...
class 정렬01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_WIZARD__10$', arg4=5, arg5=0) # 음성 코드 00001338
...
class 본론01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_WIZARD__11$', arg4=10, arg5=0) # 음성 코드 00001339
...
class 본론03(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_WIZARD__12$', arg4=6, arg5=0) # 음성 코드 00001340
...
class 본론07(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_WIZARD__13$', arg4=5, arg5=0) # 음성 코드 00001292
...
class 정리01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_WIZARD__14$', arg4=6, arg5=0) # 음성 코드 00001159
...
class 반대01(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_WIZARD__15$', arg4=4, arg5=0)
...
class 반대03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_WIZARD__16$', arg4=4, arg5=0)
...
class 반대06(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_WIZARD__17$', arg4=4, arg5=0)
...
class 반대08(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000015, script='$52000026_QD__SEPERATEGROUP_WIZARD__18$', arg4=4, arg5=0)
...
class 요약02(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_WIZARD__19$', arg4=3, arg5=0)
...
class 요약04(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_WIZARD__20$', arg4=4, arg5=0)
...
class 요약06(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_WIZARD__21$', arg4=9, arg5=0) # 음성 코드 00001341
...
class 요약08(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_WIZARD__22$', arg4=4, arg5=0) # 음성 코드 00001342
