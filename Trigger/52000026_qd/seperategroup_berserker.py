...
class 대기(state.State):
    ...
    def on_tick(self) -> state.State:
        if quest_user_detected(boxIds=[9000], questIds=[10002963], questStates=[1], jobCode=20):
            return 연출준비01()
...
class 차입장03_1(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_BERSERKER__0$', arg4=3, arg5=0)
...
class 차입장04_2(state.State):
    def on_enter(self):
        set_effect(triggerIds=[6104], visible=True) # 음성 코드 00001155
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__1$', arg4=3, arg5=0) # 음성 코드 00001155
...
class 차입장06_2(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__2$', arg4=4, arg5=0)
        set_skip(state=차입장07_2)
...
class 차입장03_3(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__3$', arg4=7, arg5=0) # 음성 코드 00000553
...
class 차입장03_4(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001581, script='$52000026_QD__SEPERATEGROUP_BERSERKER__4$', arg4=3, arg5=0)
...
class 차입장05_4(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001581, script='$52000026_QD__SEPERATEGROUP_BERSERKER__5$', arg4=4, arg5=0)
...
class 차입장07_4(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_BERSERKER__6$', arg4=4, arg5=0)
        set_skip(state=차입장08_4)
...
class 차입장03_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001583, script='$52000026_QD__SEPERATEGROUP_BERSERKER__7$', arg4=3, arg5=0)
...
class 차입장05_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_BERSERKER__8$', arg4=4, arg5=0)
...
class 차입장07_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000015, script='$52000026_QD__SEPERATEGROUP_BERSERKER__9$', arg4=3, arg5=0)
...
class 차입장10_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_BERSERKER__10$', arg4=3, arg5=0)
...
class 차입장12_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_BERSERKER__11$', arg4=3, arg5=0)
...
class 정렬01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__12$', arg4=5, arg5=0) # 음성 코드 00001338
        set_skip(state=정렬02)
...
class 본론01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__13$', arg4=10, arg5=0) # 음성 코드 00001339
        set_skip(state=본론02)
...
class 본론03(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__14$', arg4=6, arg5=0) # 음성 코드 00001340
        set_skip(state=본론04)
...
class 본론07(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__15$', arg4=5, arg5=0) # 음성 코드 00001292
        set_skip(state=영상01)
...
class 정리01(state.State):
    def on_enter(self):
        ...
        set_effect(triggerIds=[6105], visible=True) # 음성 코드 00001159
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__16$', arg4=6, arg5=0) # 음성 코드 00001159
        set_skip(state=정리02)
...
class 반대01(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_BERSERKER__17$', arg4=4, arg5=0)
        set_skip(state=반대02)
...
class 반대03(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_BERSERKER__18$', arg4=4, arg5=0)
        set_skip(state=반대04)
...
class 반대06(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_BERSERKER__19$', arg4=4, arg5=0)
        set_skip(state=반대07)
...
class 반대08(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000015, script='$52000026_QD__SEPERATEGROUP_BERSERKER__20$', arg4=4, arg5=0)
        set_skip(state=반대09)
...
class 요약02(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_BERSERKER__21$', arg4=3, arg5=0)
        set_skip(state=요약03)
...
class 요약03(state.State):
    def on_enter(self):
        remove_cinematic_talk()
        set_skip()
        set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_BERSERKER__22$', arg4=4, arg5=0)
        set_skip(state=요약04)
...
class 요약05(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__23$', arg4=9, arg5=0) # 음성 코드 00001341
        set_skip(state=요약06)
...
class 요약07(state.State):
    def on_enter(self):
        set_effect(triggerIds=[6007], visible=True) # 음성 코드 00000561
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__24$', arg4=4, arg5=0) # 음성 코드 00000561
...
class 연출종료01(state.State):
    def on_enter(self):
        remove_cinematic_talk()
        set_skip()
        set_effect(triggerIds=[6007], visible=False) # Asimov Voice 00001342
