...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_sound(trigger_id=10000, enable=False) # TriaAttack
        self.set_effect(trigger_ids=[5000], visible=False) # LeftDoorOpen
        self.set_effect(trigger_ids=[5001], visible=False) # LeftDoorClose
        self.set_effect(trigger_ids=[5002], visible=False) # RightDoorOpen
        self.set_effect(trigger_ids=[5003], visible=False) # RightDoorClose
        self.set_effect(trigger_ids=[5004], visible=False) # blastjump
...
class 연출준비01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=3000, enable=True)
...
class 차입장01_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[101,201], auto_target=True)
...
class 차입장03_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000601, script='$52000026_QD__SEPERATEGROUP_BERSERKER__0$', time=3, arg5=0)
...
class 차입장01_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=3100, enable=True)
...
class 차입장04_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__1$', time=3, arg5=0) # 음성 코드 00001155
...
class 차입장06_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__2$', time=4, arg5=0)
...
class 차입장07_2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.set_effect(trigger_ids=[6101], visible=False) # Ishura Voice 00001291
        ...
        self.select_camera(trigger_id=3101, enable=True)
...
class 차입장03_3(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=3102, enable=True)
        self.set_effect(trigger_ids=[6001], visible=True) # Asimov Voice 00000553
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__3$', time=7, arg5=0) # 음성 코드 00000553
...
class 차입장01_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.set_effect(trigger_ids=[6001], visible=False) # Asimov Voice 00000553
        self.select_camera(trigger_id=3200, enable=True)
        self.set_effect(trigger_ids=[5002], visible=True) # RightDoorOpen
...
class 차입장02_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=3210, enable=True)
...
class 차입장03_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001581, script='$52000026_QD__SEPERATEGROUP_BERSERKER__4$', time=3, arg5=0)
...
class 차입장05_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001581, script='$52000026_QD__SEPERATEGROUP_BERSERKER__5$', time=4, arg5=0)
...
class 차입장06_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.select_camera(trigger_id=3201, enable=True)
        self.spawn_monster(spawn_ids=[801], auto_target=True)
...
class 차입장07_4(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000076, script='$52000026_QD__SEPERATEGROUP_BERSERKER__6$', time=4, arg5=0)
...
class 차입장02_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=3300, enable=True)
...
class 차입장03_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001583, script='$52000026_QD__SEPERATEGROUP_BERSERKER__7$', time=3, arg5=0)
...
class 차입장04_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.select_camera(trigger_id=3301, enable=True)
...
class 차입장05_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001584, script='$52000026_QD__SEPERATEGROUP_BERSERKER__8$', time=4, arg5=0)
...
class 차입장06_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.select_camera(trigger_id=3302, enable=True)
        self.spawn_monster(spawn_ids=[1101], auto_target=True)
...
class 차입장07_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000015, script='$52000026_QD__SEPERATEGROUP_BERSERKER__9$', time=3, arg5=0)
...
class 차입장08_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_skip()
        self.set_effect(trigger_ids=[5002], visible=True) # RightDoorOpen
        self.select_camera(trigger_id=3303, enable=True)
        self.spawn_monster(spawn_ids=[1201], auto_target=True)
...
class 차입장10_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001586, script='$52000026_QD__SEPERATEGROUP_BERSERKER__10$', time=3, arg5=0)
...
class 차입장11_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.select_camera(trigger_id=3304, enable=True)
...
class 차입장12_5(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000076, script='$52000026_QD__SEPERATEGROUP_BERSERKER__11$', time=3, arg5=0)
...
class 정렬01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__12$', time=5, arg5=0) # 음성 코드 00001338
...
class 정렬06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[6002], visible=False) # Asimov Voice 00001338
...
class 본론01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__13$', time=10, arg5=0) # 음성 코드 00001339
...
class 본론03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[6003], visible=False) # Asimov Voice 00001339
        self.set_effect(trigger_ids=[6004], visible=True) # Asimov Voice 00001340
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__14$', time=6, arg5=0) # 음성 코드 00001340
...
class 본론04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_effect(trigger_ids=[6004], visible=False) # Asimov Voice 00001340
        self.select_camera(trigger_id=3500, enable=True)
...
class 본론07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__15$', time=5, arg5=0) # 음성 코드 00001292
...
class 영상01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.set_cinematic_ui(type=4)
        self.set_effect(trigger_ids=[6102], visible=False) # Ishura Voice 00001292
...
class 정리01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=3600, enable=True)
        self.set_effect(trigger_ids=[6105], visible=True) # 음성 코드 00001159
        self.set_dialogue(type=2, spawn_id=11001244, script='$52000026_QD__SEPERATEGROUP_BERSERKER__16$', time=6, arg5=0) # 음성 코드 00001159
...
class 정리02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_effect(trigger_ids=[6103], visible=False) # Ishura Voice 00001293
...
class 반대01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11000076, script='$52000026_QD__SEPERATEGROUP_BERSERKER__17$', time=4, arg5=0)
...
class 반대02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.select_camera(trigger_id=3601, enable=True)
...
class 반대03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001586, script='$52000026_QD__SEPERATEGROUP_BERSERKER__18$', time=4, arg5=0)
...
class 반대05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=3602, enable=True)
...
class 반대06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_dialogue(type=2, spawn_id=11001584, script='$52000026_QD__SEPERATEGROUP_BERSERKER__19$', time=4, arg5=0)
...
class 반대07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera(trigger_id=3603, enable=True)
...
class 반대08(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=3604, enable=True)
        self.set_dialogue(type=2, spawn_id=11000015, script='$52000026_QD__SEPERATEGROUP_BERSERKER__20$', time=4, arg5=0)
...
class 요약01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.select_camera(trigger_id=3700, enable=True)
...
class 요약02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000601, script='$52000026_QD__SEPERATEGROUP_BERSERKER__21$', time=3, arg5=0)
...
class 요약03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.set_dialogue(type=2, spawn_id=11000601, script='$52000026_QD__SEPERATEGROUP_BERSERKER__22$', time=4, arg5=0)
...
class 요약04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.select_camera(trigger_id=3800, enable=True)
...
class 요약05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__23$', time=9, arg5=0) # 음성 코드 00001341
...
class 요약06(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[6005], visible=False) # Asimov Voice 00001341
        self.remove_cinematic_talk()
        # Missing State: State
        self.set_skip()
...
class 요약07(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_dialogue(type=2, spawn_id=11000031, script='$52000026_QD__SEPERATEGROUP_BERSERKER__24$', time=4, arg5=0) # 음성 코드 00000561
...
class 연출종료01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        # Missing State: State
        self.set_skip()
        self.set_effect(trigger_ids=[6007], visible=False) # Asimov Voice 00001342
        self.select_camera(trigger_id=3801, enable=True)
