...
class 대기(common.Trigger):
    ...
    def on_tick(self) -> common.Trigger:
        if self.quest_user_detected(boxIds=[9000], questIds=[10003003], questStates=[1], jobCode=70):
...
class 차입장03_1(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_THIEF__0$', arg4=3, arg5=0)
...
class 차입장04_2(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_THIEF__1$', arg4=3, arg5=0) # 음성 코드 00001155
...
class 차입장06_2(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_THIEF__2$', arg4=4, arg5=0)
...
class 차입장03_3(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_THIEF__3$', arg4=7, arg5=0) # 음성 코드 00000553
...
class 차입장03_4(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001581, script='$52000026_QD__SEPERATEGROUP_THIEF__4$', arg4=4, arg5=0)
...
class 차입장05_4(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_THIEF__5$', arg4=4, arg5=0)
...
class 차입장03_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001583, script='$52000026_QD__SEPERATEGROUP_THIEF__6$', arg4=3, arg5=0)
...
class 차입장05_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_THIEF__7$', arg4=4, arg5=0)
...
class 차입장07_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000015, script='$52000026_QD__SEPERATEGROUP_THIEF__8$', arg4=3, arg5=0)
...
class 차입장10_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_THIEF__9$', arg4=3, arg5=0)
...
class 차입장12_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_THIEF__10$', arg4=3, arg5=0)
...
class 차입장14_5(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_THIEF__11$', arg4=3, arg5=0)
...
class 정렬01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_THIEF__12$', arg4=5, arg5=0) # 음성 코드 00001338
...
class 본론01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_THIEF__13$', arg4=10, arg5=0) # 음성 코드 00001339
...
class 본론03(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_THIEF__14$', arg4=6, arg5=0) # 음성 코드 00001340
...
class 본론07(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_THIEF__15$', arg4=5, arg5=0) # 음성 코드 00001292
...
class 정리01(common.Trigger):
    def on_enter(self):
        ...
        self.set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_THIEF__16$', arg4=6, arg5=0) # 음성 코드 00001159
...
class 반대01(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_THIEF__17$', arg4=4, arg5=0)
...
class 반대03(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_THIEF__18$', arg4=4, arg5=0)
...
class 반대05(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_THIEF__19$', arg4=3, arg5=0)
...
class 반대08(common.Trigger):
    def on_enter(self):
        self.set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_THIEF__20$', arg4=4, arg5=0)
