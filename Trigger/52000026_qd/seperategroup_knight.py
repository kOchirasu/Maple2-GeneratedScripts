...
class 대기(state.State):
    ...
    def on_tick(self) -> state.State:
        if quest_user_detected(boxIds=[9000], questIds=[10002983], questStates=[1], jobCode=10):
            return 연출준비01()
        if quest_user_detected(boxIds=[9000], questIds=[10002983], questStates=[1], jobCode=1):
            return 연출준비01()
...
class 차입장03_1(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000601, script='$52000026_QD__SEPERATEGROUP_KNIGHT__0$', arg4=3, arg5=0)
...
class 차입장04_2(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_KNIGHT__1$', arg4=3, arg5=0) # 음성 코드 00001155
...
class 차입장06_2(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_KNIGHT__2$', arg4=4, arg5=0)
...
class 차입장03_3(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_KNIGHT__3$', arg4=7, arg5=0) # 음성 코드 00000553
...
class 차입장03_4(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001581, script='$52000026_QD__SEPERATEGROUP_KNIGHT__4$', arg4=4, arg5=0)
...
class 차입장05_4(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_KNIGHT__5$', arg4=5, arg5=0)
...
class 차입장07_4(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_KNIGHT__6$', arg4=4, arg5=0)
...
class 차입장03_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001583, script='$52000026_QD__SEPERATEGROUP_KNIGHT__7$', arg4=3, arg5=0)
...
class 차입장05_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_KNIGHT__8$', arg4=4, arg5=0)
...
class 차입장07_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000015, script='$52000026_QD__SEPERATEGROUP_KNIGHT__9$', arg4=3, arg5=0)
...
class 차입장10_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_KNIGHT__10$', arg4=3, arg5=0)
...
class 차입장12_5(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_KNIGHT__11$', arg4=3, arg5=0)
...
class 정렬01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_KNIGHT__12$', arg4=5, arg5=0) # 음성 코드 00001338
...
class 본론01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_KNIGHT__13$', arg4=10, arg5=0) # 음성 코드 00001339
        set_skip(state=본론02)
...
class 본론03(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11000031, script='$52000026_QD__SEPERATEGROUP_KNIGHT__14$', arg4=6, arg5=0) # 음성 코드 00001340
        set_skip(state=본론04)
...
class 본론07(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_KNIGHT__15$', arg4=5, arg5=0) # 음성 코드 00001292
        set_skip(state=영상01)
...
class 정리01(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001244, script='$52000026_QD__SEPERATEGROUP_KNIGHT__16$', arg4=6, arg5=0) # 음성 코드 00001159
        set_skip(state=정리02)
...
class 반대01(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_KNIGHT__17$', arg4=4, arg5=0)
        set_skip(state=반대02)
...
class 반대03(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001586, script='$52000026_QD__SEPERATEGROUP_KNIGHT__18$', arg4=4, arg5=0)
        set_skip(state=반대04)
...
class 반대06(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11001584, script='$52000026_QD__SEPERATEGROUP_KNIGHT__19$', arg4=4, arg5=0)
        set_skip(state=반대07)
...
class 반대08(state.State):
    def on_enter(self):
        ...
        set_conversation(type=2, spawnId=11001583, script='$52000026_QD__SEPERATEGROUP_KNIGHT__20$', arg4=4, arg5=0)
        set_skip(state=반대09)
...
class 반대11(state.State):
    def on_enter(self):
        select_camera(triggerId=3803, enable=True)
...
class 반대12(state.State):
    def on_enter(self):
        set_conversation(type=2, spawnId=11000076, script='$52000026_QD__SEPERATEGROUP_KNIGHT__21$', arg4=5, arg5=0)
