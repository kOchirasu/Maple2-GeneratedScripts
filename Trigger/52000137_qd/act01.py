...
class SetMaskEffect01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=4)
...
class SetMaskEffect02(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_halfsec.xml')
...
class ImprisonDarkAnos01(common.Trigger):
    def on_enter(self):
...
class ImprisonDarkAnos02(common.Trigger):
    def on_enter(self):
...
class AsimovTalk01(common.Trigger):
    def on_enter(self):
...
class AsimovTalk01Skip(common.Trigger):
    def on_enter(self):
...
class ZoominAnos01(common.Trigger):
    def on_enter(self):
...
class AnosTruning01(common.Trigger):
    def on_enter(self):
...
class AnosTruning02(common.Trigger):
    def on_enter(self):
...
class AnosTalk01(common.Trigger):
    def on_enter(self):
...
class AnosTalk01Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class CameraChange00(common.Trigger):
    def on_enter(self):
...
class AsimovTalk02(common.Trigger):
    def on_enter(self):
...
class AsimovTalk02Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class AsimovTalk03(common.Trigger):
    def on_enter(self):
...
class AsimovTalk03Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class CameraChange04(common.Trigger):
    def on_enter(self):
...
class DarkAnosTalk01(common.Trigger):
    def on_enter(self):
...
class DarkAnosTalk01Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
...
class DarkAnosAttackAsimov01(common.Trigger):
    def on_enter(self):
...
class DarkAnosAttackAsimov02(common.Trigger):
    def on_enter(self):
...
class DarkAnosAttackAsimov03(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5500], visible=False) # DarkAura01
        self.set_effect(triggerIds=[5101], visible=False) # RuneShieldThunder
        self.set_effect(triggerIds=[5100], visible=False) # AsimovShield
...
class CameraChange07(common.Trigger):
    def on_enter(self):
...
class AsimovTalk04(common.Trigger):
    def on_enter(self):
...
class AsimovTalk04Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class AsimovFaint01(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_halfsec.xml')
...
class AsimovFaint02(common.Trigger):
    def on_enter(self):
...
class AsimovFaint03(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_halfsec.xml')
...
class DarkAnosApproach01(common.Trigger):
    def on_enter(self):
...
class DarkAnosApproach02(common.Trigger):
    def on_enter(self):
...
class DarkAnosTalk02(common.Trigger):
    def on_enter(self):
...
class DarkAnosTalk02Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class PCTalk03Skip(common.Trigger):
    def on_enter(self):
        self.set_pc_emotion_sequence(sequenceNames=['Idle_A'])
        self.remove_cinematic_talk()
        self.set_skip()
...
class DarkAnosTalk03(common.Trigger):
    def on_enter(self):
...
class DarkAnosTalk01CSkip(common.Trigger):
    def on_enter(self):
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_halfsec.xml')
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
...
class DarkAnosTalk03Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class DarkAnosBattle01(common.Trigger):
    def on_enter(self):
...
class DarkAnosBattle02(common.Trigger):
    def on_enter(self):
...
class DarkAnosDown01(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_halfsec.xml')
...
class PCBalloonTalk01(common.Trigger):
    def on_enter(self):
...
class PCBalloonTalk02(common.Trigger):
    def on_enter(self):
...
class PCBalloonTalk03(common.Trigger):
    def on_enter(self):
...
class KanduraAttack01(common.Trigger):
    def on_enter(self):
...
class KanduraAttack02(common.Trigger):
    def on_enter(self):
...
class CameraChange10(common.Trigger):
    def on_enter(self):
        self.set_cinematic_ui(type=1)
        self.set_cinematic_ui(type=3)
        self.set_onetime_effect(id=1, enable=True, path='BG/Common/ScreenMask/Eff_fadein_halfsec.xml')
...
class KanduraTalk01(common.Trigger):
    def on_enter(self):
...
class KanduraTalk01Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class PCTalk04Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class KanduraMoveToDarkAnos01(common.Trigger):
    def on_enter(self):
...
class KanduraTalk02(common.Trigger):
    def on_enter(self):
...
class KanduraTalk02Skip(common.Trigger):
    def on_enter(self):
        self.remove_cinematic_talk()
        self.set_skip()
...
class KanduraReadyToDisapp01(common.Trigger):
    def on_enter(self):
...
class KanduraReadyToDisapp02(common.Trigger):
    def on_enter(self):
...
class KanduraReadyToDisapp03(common.Trigger):
    def on_enter(self):
        self.set_effect(triggerIds=[5400], visible=False) # DarkStrom01
...
class KanduraReadyToDisapp04(common.Trigger):
    def on_tick(self) -> common.Trigger:
        if self.wait_tick(waitTick=3000):
