...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[6016], visible=False)
        self.set_effect(trigger_ids=[6017], visible=False)
        self.set_effect(trigger_ids=[6018], visible=False)
        self.set_effect(trigger_ids=[6019], visible=False)
        self.set_effect(trigger_ids=[6020], visible=False)
        self.set_effect(trigger_ids=[6021], visible=False)
        self.set_effect(trigger_ids=[6022], visible=False)
        self.set_effect(trigger_ids=[6023], visible=False)
        self.set_effect(trigger_ids=[6024], visible=False)
        self.set_effect(trigger_ids=[6025], visible=False)
        self.set_effect(trigger_ids=[6026], visible=False)
        self.set_effect(trigger_ids=[6027], visible=False)
        self.set_effect(trigger_ids=[6028], visible=False)
        self.set_effect(trigger_ids=[6029], visible=False)
        self.set_effect(trigger_ids=[6030], visible=False)
        self.set_effect(trigger_ids=[6031], visible=False)
        self.set_effect(trigger_ids=[6032], visible=False)
        ...
        self.set_mesh(trigger_ids=[4001,4002,4003,4004,4005,4006,4007,4008,4009,4010,4011,4012], visible=True, start_delay=0, interval=0, fade=0)
