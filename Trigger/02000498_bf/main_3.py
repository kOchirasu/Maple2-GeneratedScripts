...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_mesh(trigger_ids=[3301,3302,3303,3304,3305,3306,3307,3308,3309,3310,3311,3312,3313,3314,3315,3316,3317,3318,3319,3320,3321,3322,3323,3324,3325,3326,3327,3328,3329,3330,3331,3332,3333,3334,3335,3336,3337,3338,3339,3340,3341,3342,3343,3344], visible=True, start_delay=0, interval=0, fade=0)
        self.set_skill(trigger_ids=[704], enable=False)
        self.set_effect(trigger_ids=[630], visible=False)
...
class 시작대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=11, ui_duration=3000, damage_penalty=30)
...
class 라운드11(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='SpawnMonster', spawn_ids=[111001], score=295000)
...
class 라운드대기12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=12, ui_duration=3000, damage_penalty=30)
        self.set_timer(timer_id='3', seconds=3)
...
class 라운드12(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[112001], score=78750)
...
class 라운드대기13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_timer(timer_id='3', seconds=3)
        self.dark_stream(type='StartRound', round=13, ui_duration=3000, damage_penalty=30)
...
class 라운드13(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[113001], score=43750)
...
class 라운드대기14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=14, ui_duration=3000, damage_penalty=30)
        self.set_timer(timer_id='3', seconds=3)
...
class 라운드14(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[114001], score=48750)
...
class 라운드대기15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.dark_stream(type='StartRound', round=15, ui_duration=3000, damage_penalty=30)
        self.set_timer(timer_id='3', seconds=3)
...
class 라운드15(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.dark_stream(type='SpawnMonster', spawn_ids=[115001], score=415000)
...
class 바닥부심(trigger_api.Trigger):
    ...
    def on_tick(self) -> trigger_api.Trigger:
        if self.time_expired(timer_id='3'):
            ...
            self.set_mesh(trigger_ids=[3301,3302,3303,3304,3305,3306,3307,3308,3309,3310,3311,3312,3313,3314,3315,3316,3317,3318,3319,3320,3321,3322,3323,3324,3325,3326,3327,3328,3329,3330,3331,3332,3333,3334,3335,3336,3337,3338,3339,3340,3341,3342,3343,3344], visible=False, start_delay=0, interval=0, fade=0)
            return 종료(self.ctx)
