...
class 웰컴문구1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Emotion_Bloompicnic_A', duration=7000)
        self.spawn_monster(spawn_ids=[9999], auto_target=False, delay=0) # 구르는 천둥:11003390
        self.face_emotion(spawn_id=0, emotion_name='Trigger_disappoint')
        self.show_caption(type='VerticalCaption', title='$52010028_QD__MAIN__0$', desc='$52010028_QD__MAIN__1$', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2)
...
class Skip_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_pc_emotion_loop(sequence_name='Idle_A', duration=500)
        self.destroy_monster(spawn_ids=[9999]) # 구르는 천둥:11003390
...
class Ready(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[101], auto_target=True) # 구르는 천둥:11003390
        self.spawn_monster(spawn_ids=[201], auto_target=True) # 붉은 늑대의 심장:11003387
        ...
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Down_Idle_A', duration=1500000)
        self.set_npc_emotion_loop(spawn_id=201, sequence_name='Attack_Idle_A', duration=1500000)
...
class PC진입(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=0, msg='$52010028_QD__MAIN__11$', duration=2000, delay_tick=1000)
...
class 연출_02_1(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$52010028_QD__MAIN__14$', desc='$52010028_QD__MAIN__15$', align='centerLeft', offset_rate_x=0, offset_rate_y=0, duration=3000, scale=2)
        self.add_cinematic_talk(npc_id=11003390, msg='$52010028_QD__MAIN__16$', duration=3000, illust_id='0', align='Left')
...
class 연출_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_effect(trigger_ids=[5001], visible=False)
        self.add_cinematic_talk(npc_id=11003390, msg='$52010028_QD__MAIN__19$', duration=3000, illust_id='0', align='Left')
        self.set_npc_emotion_loop(spawn_id=201, sequence_name='Idle_A', duration=10000)
...
class 연출_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.select_camera_path(path_ids=[4003], return_view=False)
        self.add_cinematic_talk(npc_id=11003387, msg='$52010028_QD__MAIN__20$', duration=3000, illust_id='0', align='Left')
...
class 연출_05(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.face_emotion(spawn_id=201, emotion_name='Trigger_Crazy')
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Dead_Idle_A', duration=9999999)
...
class 전투준비(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=201, sequence_name='Down_Idle_A', duration=3000)
        self.move_npc(spawn_id=201, patrol_name='MS2PatrolData_3003')
        self.destroy_monster(spawn_ids=[201], arg2=True) # 붉은 늑대의 심장:11003387
        self.spawn_monster(spawn_ids=[501], auto_target=True) # 붉은 늑대의 심장:22000324
...
class 전투종료이후연출(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_cinematic_ui(type=3)
        self.set_onetime_effect(id=1, enable=False, path='BG/Common/ScreenMask/Eff_fadein_1sec.xml')
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Dead_Idle_A', duration=1500000)
        self.face_emotion(spawn_id=101, emotion_name='Trigger_Dead')
        self.select_camera_path(path_ids=[4012], return_view=False)
        self.set_npc_emotion_loop(spawn_id=202, sequence_name='Dead_Idle_A', duration=150000)
...
class 찾으러왔어02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=101, sequence_name='Dead_Idle_A', duration=150000)
        self.face_emotion(spawn_id=101, emotion_name='Trigger_Dead')
...
class 찾으러왔어03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.spawn_monster(spawn_ids=[303], auto_target=True)
...
class 찾으러왔어04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[304], auto_target=True)
        self.spawn_monster(spawn_ids=[305], auto_target=True)
...
class 어서와02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.add_balloon_talk(spawn_id=305, msg='$52010028_QD__MAIN__32$', duration=2000, delay_tick=0)
