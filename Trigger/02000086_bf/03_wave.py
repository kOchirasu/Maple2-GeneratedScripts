...
class 대기(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_effect(trigger_ids=[301,302,303,304,305,306,307,308,309,310,311,312,313,314,315,316,317,318,319,320,321,322,323,324,325,326], visible=False)
        self.set_mesh(trigger_ids=[201,202,203,204,205,206,207,208,209,210,211,212,213,214,215,216,217,218,219,220,221,222,223,224,225,226], visible=False)
...
class 웨이브2(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.spawn_monster(spawn_ids=[101,102,103,104,105,106], auto_target=True)
        self.move_npc(spawn_id=101, patrol_name='MS2PatrolData_601')
        self.move_npc(spawn_id=102, patrol_name='MS2PatrolData_602')
        self.move_npc(spawn_id=103, patrol_name='MS2PatrolData_603')
        self.move_npc(spawn_id=104, patrol_name='MS2PatrolData_604')
