...
class 전투_1라운드세팅(common.Trigger):
    def on_enter(self):
...
class 전투_1라운드시작(common.Trigger):
    def on_enter(self):
...
class 전투_1라운드종료(common.Trigger):
    def on_enter(self):
...
class 전투_2라운드세팅(common.Trigger):
    def on_enter(self):
...
class 전투_2라운드시작(common.Trigger):
    def on_enter(self):
...
class 전투_2라운드종료(common.Trigger):
    def on_enter(self):
...
class 전투_3라운드세팅(common.Trigger):
    def on_enter(self):
...
class 전투_3라운드시작(common.Trigger):
    def on_enter(self):
...
class 전투_3라운드버프(common.Trigger):
    def on_enter(self):
...
class 전투_3라운드종료(common.Trigger):
    def on_enter(self):
...
class 전투_4라운드세팅(common.Trigger):
    def on_enter(self):
...
class 전투_4라운드시작(common.Trigger):
    def on_enter(self):
...
class 전투_4라운드버프(common.Trigger):
    def on_enter(self):
...
class 전투_4라운드종료(common.Trigger):
    def on_enter(self):
...
class 전투_5라운드세팅(common.Trigger):
    def on_enter(self):
...
class 전투_5라운드시작(common.Trigger):
    def on_enter(self):
...
class 전투_5라운드버프(common.Trigger):
    def on_enter(self):
