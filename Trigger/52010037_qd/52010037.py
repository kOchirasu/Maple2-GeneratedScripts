...
# ########################지하기지 전경씬########################
class 지하기지전경씬01(common.Trigger):
    def on_enter(self):
...
class 지하기지전경씬02(common.Trigger):
    def on_enter(self):
...
class 지하기지전경씬02_b(common.Trigger):
    def on_enter(self):
...
class 지하기지전경씬02_c(common.Trigger):
    def on_enter(self):
...
class 지하기지전경씬03(common.Trigger):
    def on_enter(self):
...
class 지하기지전경씬04(common.Trigger):
    def on_enter(self):
...
class 블리체와대장들이동(common.Trigger):
    def on_enter(self):
