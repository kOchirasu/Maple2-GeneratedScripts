...
class 어쌔신과거_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.show_caption(type='VerticalCaption', title='$52000159_QD__52000159__0$', align='bottomLeft', offset_rate_x=0, offset_rate_y=0, duration=5000, scale=2.5)
...
class 남자의죽음_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=102, sequence_name='Dead_B', duration=9E+12)
...
class 남자의죽음_04(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=114, sequence_name='Dead_B', duration=9E+12)
...
class 쉐도클로표창_02(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=104, sequence_name='Attack_Idle_A', duration=4000)
...
class 쉐도클로표창_03(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        ...
        self.set_npc_emotion_loop(spawn_id=104, sequence_name='Attack_01_B', duration=80000)
        self.set_time_scale(enable=True, start_scale=0.1, end_scale=0.1, duration=10, interpolator=1)
...
class 쉐도클로표창_03_01(trigger_api.Trigger):
    def on_enter(self) -> 'trigger_api.Trigger':
        self.set_npc_emotion_loop(spawn_id=115, sequence_name='Dead_A', duration=80000)
        # Missing State: State
        self.set_scene_skip()
